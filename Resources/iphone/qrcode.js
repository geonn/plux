    ...
    var qrcode = function(typeNumber, errorCorrectLevel) {
        ...
        var setupPositionProbePattern = function(row, col) {
            for (var r = -1; 7 >= r; r += 1) {
                ...
                for (var c = -1; 7 >= c; c += 1) {
                    ...
                    _modules[row + r][col + c] = r >= 0 && 6 >= r && (0 == c || 6 == c) || c >= 0 && 6 >= c && (0 == r || 6 == r) || r >= 2 && 4 >= r && c >= 2 && 4 >= c ? true : false;
                }
            }
        };
        ...
        var setupPositionAdjustPattern = function() {
            ...
            for (var i = 0; i < pos.length; i += 1) for (var j = 0; j < pos.length; j += 1) {
                ...
                for (var r = -2; 2 >= r; r += 1) for (var c = -2; 2 >= c; c += 1) _modules[row + r][col + c] = -2 == r || 2 == r || -2 == c || 2 == c || 0 == r && 0 == c ? true : false;
            }
        };
