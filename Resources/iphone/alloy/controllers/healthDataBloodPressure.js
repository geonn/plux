...
function Controller() {
    ...
    $.__views.__alloyId22.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId22;
    ...
    $.__views.__alloyId23.add($.__views.description);
    var __alloyId24 = [];
    ...
    showDatePicker ? $.__views.__alloyId25.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId25!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId26.add($.__views.date_value);
    $.__views.__alloyId28 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId28"
    });
    __alloyId24.push($.__views.__alloyId28);
    showTimePicker ? $.__views.__alloyId28.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId28!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId29.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId24.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId31);
    ...
    $.__views.__alloyId31.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId24.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId33);
    ...
    $.__views.__alloyId33.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId25!click!showDatePicker"] && $.__views.__alloyId25.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId28!click!showTimePicker"] && $.__views.__alloyId28.addEventListener("click", showTimePicker);
