...
function Controller() {
    ...
    $.__views.__alloyId30.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId30;
    ...
    $.__views.__alloyId31.add($.__views.description);
    var __alloyId32 = [];
    ...
    showDatePicker ? $.__views.__alloyId33.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId33!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId34.add($.__views.date_value);
    $.__views.__alloyId36 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId36"
    });
    __alloyId32.push($.__views.__alloyId36);
    showTimePicker ? $.__views.__alloyId36.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId36!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId37.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId32.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId39);
    ...
    $.__views.__alloyId39.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId32.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId41);
    ...
    $.__views.__alloyId41.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId33!click!showDatePicker"] && $.__views.__alloyId33.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId36!click!showTimePicker"] && $.__views.__alloyId36.addEventListener("click", showTimePicker);
