...
function Controller() {
    ...
    $.__views.__alloyId54.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId54;
    ...
    $.__views.__alloyId55.add($.__views.description);
    var __alloyId56 = [];
    ...
    showDatePicker ? $.__views.__alloyId57.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId57!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId58.add($.__views.date_value);
    $.__views.__alloyId60 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId60"
    });
    __alloyId56.push($.__views.__alloyId60);
    showTimePicker ? $.__views.__alloyId60.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId60!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId61.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId56.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId63);
    ...
    $.__views.__alloyId63.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId56.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId65);
    ...
    $.__views.__alloyId65.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId57!click!showDatePicker"] && $.__views.__alloyId57.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId60!click!showTimePicker"] && $.__views.__alloyId60.addEventListener("click", showTimePicker);
