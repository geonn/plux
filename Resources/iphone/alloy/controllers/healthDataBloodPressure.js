...
function Controller() {
    ...
    $.__views.__alloyId55.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId55;
    ...
    showDatePicker ? $.__views.__alloyId58.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId58!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId59.add($.__views.date_value);
    $.__views.__alloyId61 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId61"
    });
    __alloyId57.push($.__views.__alloyId61);
    showTimePicker ? $.__views.__alloyId61.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId61!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId62.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId57.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId64);
    ...
    $.__views.__alloyId64.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId57.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId66);
    ...
    $.__views.__alloyId66.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId58!click!showDatePicker"] && $.__views.__alloyId58.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId61!click!showTimePicker"] && $.__views.__alloyId61.addEventListener("click", showTimePicker);
