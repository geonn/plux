...
function Controller() {
    ...
    $.__views.__alloyId36.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId36;
    ...
    showDatePicker ? $.__views.__alloyId39.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId39!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId40.add($.__views.date_value);
    $.__views.__alloyId42 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId42"
    });
    __alloyId38.push($.__views.__alloyId42);
    showTimePicker ? $.__views.__alloyId42.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId42!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId43.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId38.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId45);
    ...
    $.__views.__alloyId45.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId38.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId47);
    ...
    $.__views.__alloyId47.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId39!click!showDatePicker"] && $.__views.__alloyId39.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId42!click!showTimePicker"] && $.__views.__alloyId42.addEventListener("click", showTimePicker);
