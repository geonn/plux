...
function Controller() {
    ...
    $.__views.loginWin.leftNavButton = $.__views.__alloyId104;
    $.__views.__alloyId105 = Ti.UI.createView({
        id: "__alloyId105"
    });
    $.__views.loginWin.add($.__views.__alloyId105);
    ...
    "iphone" == Ti.Platform.osname && TouchId.authenticate({
    ...
    "android" == Ti.Platform.osname && $.loginWin.addEventListener("android:back", function() {
