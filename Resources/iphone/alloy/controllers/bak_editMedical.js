...
function Controller() {
    ...
    $.__views.recordsTextArea = Ti.UI.createTextArea({
        keyboardToolbar: $.__views.__alloyId16,
        id: "recordsTextArea",
        color: "#888",
        textAlign: "left",
        hintText: "Proceduce",
    ...
    $.__views.__alloyId21.add($.__views.attachment);
    ...
    $.__views.__alloyId23.add($.__views.addLbl);
    ...
    $.__views.__alloyId13.add($.__views.__alloyId24);
    ...
    $.__views.__alloyId26.add($.__views.lastUpdated);
