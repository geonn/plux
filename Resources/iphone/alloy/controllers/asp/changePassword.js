...
function Controller() {
    ...
    $.__views.changePasswordWin.add($.__views.__alloyId101);
    ...
    submitPassword ? $.__views.__alloyId103.addEventListener("touchend", submitPassword) : __defers["$.__views.__alloyId103!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId103!touchend!submitPassword"] && $.__views.__alloyId103.addEventListener("touchend", submitPassword);
    _.extend($, exports);
}
