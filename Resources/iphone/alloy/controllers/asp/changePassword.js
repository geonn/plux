...
function Controller() {
    ...
    $.__views.changePasswordWin.add($.__views.__alloyId97);
    ...
    $.__views.__alloyId97.add($.__views.loadingBar);
    ...
    $.__views.__alloyId97.add($.__views.main);
    ...
    submitPassword ? $.__views.__alloyId100.addEventListener("touchend", submitPassword) : __defers["$.__views.__alloyId100!touchend!submitPassword"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    arguments[0] || {};
    var loginId = Ti.App.Properties.getString("asp_email");
    $.description.text = "You are about to change password for " + loginId;
    __defers["$.__views.__alloyId100!touchend!submitPassword"] && $.__views.__alloyId100.addEventListener("touchend", submitPassword);
    _.extend($, exports);
}
