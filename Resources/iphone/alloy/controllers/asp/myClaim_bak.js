...
function Controller() {
    ...
    $.__views.__alloyId124.add($.__views.claimContainer);
    ...
    $.__views.__alloyId125.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId124.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId127);
    resendVerificationEmail ? $.__views.__alloyId127.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId127!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.__views.__alloyId128.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId128!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId127!touchend!resendVerificationEmail"] && $.__views.__alloyId127.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId128!touchend!checkStatus"] && $.__views.__alloyId128.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
