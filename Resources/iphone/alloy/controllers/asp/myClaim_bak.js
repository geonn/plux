...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId174;
    ...
    $.__views.myClaim.add($.__views.__alloyId176);
    ...
    $.__views.__alloyId177.add($.__views.claimContainer);
    ...
    $.__views.__alloyId178.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId177.add($.__views.verifyContainer);
    ...
    resendVerificationEmail ? $.__views.__alloyId180.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId180!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.__views.__alloyId181.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId181!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId180!touchend!resendVerificationEmail"] && $.__views.__alloyId180.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId181!touchend!checkStatus"] && $.__views.__alloyId181.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
