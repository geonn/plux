...
function Controller() {
    ...
    $.__views.__alloyId126.add($.__views.view_balance);
    ...
    resendVerificationEmail ? $.__views.__alloyId128.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId128!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.__views.__alloyId129.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId129!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId128!touchend!resendVerificationEmail"] && $.__views.__alloyId128.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId129!touchend!checkStatus"] && $.__views.__alloyId129.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
