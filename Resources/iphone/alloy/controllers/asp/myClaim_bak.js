...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId173;
    ...
    $.__views.loadingBar.add($.__views.__alloyId174);
    ...
    $.__views.myClaim.add($.__views.__alloyId175);
    ...
    $.__views.__alloyId176.add($.__views.claimContainer);
    ...
    $.__views.__alloyId177.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId176.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId178);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId179);
    resendVerificationEmail ? $.__views.__alloyId179.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId179!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId180 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    checkStatus ? $.__views.__alloyId180.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId180!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId179!touchend!resendVerificationEmail"] && $.__views.__alloyId179.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId180!touchend!checkStatus"] && $.__views.__alloyId180.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
