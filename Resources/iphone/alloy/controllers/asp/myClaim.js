...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId117;
    ...
    $.__views.myClaim.add($.__views.__alloyId119);
    ...
    $.__views.__alloyId119.add($.__views.claimContainer);
    ...
    $.__views.__alloyId120.add($.__views.view_balance);
    ...
    resendVerificationEmail ? $.__views.__alloyId122.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId122!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.__views.__alloyId123.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId123!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId122!touchend!resendVerificationEmail"] && $.__views.__alloyId122.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId123!touchend!checkStatus"] && $.__views.__alloyId123.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
