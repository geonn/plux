...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId165;
    ...
    $.__views.myClaim.add($.__views.__alloyId167);
    ...
    $.__views.__alloyId168.add($.__views.claimContainer);
    ...
    $.__views.__alloyId168.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId169);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId170);
    resendVerificationEmail ? $.__views.__alloyId170.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId170!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.__views.__alloyId171.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId171!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId170!touchend!resendVerificationEmail"] && $.__views.__alloyId170.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId171!touchend!checkStatus"] && $.__views.__alloyId171.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
