...
function Controller() {
    ...
    $.__views.brochureView.add($.__views.__alloyId167);
    $.__views.scrollview = Ti.UI.createScrollView({
        top: "15",
        id: "scrollview",
        layout: "vertical"
    });
    $.__views.__alloyId167.add($.__views.scrollview);
    ...
    $.__views.mainView.add($.__views.__alloyId168);
    ...
    readLeaflet ? $.__views.__alloyId171.addEventListener("click", readLeaflet) : __defers["$.__views.__alloyId171!click!readLeaflet"] = true;
    ...
    $.__views.__alloyId168.add($.__views.__alloyId176);
    ...
    __defers["$.__views.__alloyId171!click!readLeaflet"] && $.__views.__alloyId171.addEventListener("click", readLeaflet);
