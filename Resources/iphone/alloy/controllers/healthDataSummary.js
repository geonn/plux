...
function Controller() {
    ...
    $.__views.healthDataSummary.add($.__views.__alloyId65);
    ...
    $.__views.__alloyId65.add($.__views.main);
    ...
    $.__views.bmiView.add($.__views.__alloyId67);
    var __alloyId68 = [];
    ...
    addData ? $.__views.__alloyId69.addEventListener("click", addData) : __defers["$.__views.__alloyId69!click!addData"] = true;
    ...
    editData ? $.__views.__alloyId70.addEventListener("click", editData) : __defers["$.__views.__alloyId70!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId69!click!addData"] && $.__views.__alloyId69.addEventListener("click", addData);
    __defers["$.__views.__alloyId70!click!editData"] && $.__views.__alloyId70.addEventListener("click", editData);
    _.extend($, exports);
}
