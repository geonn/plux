...
function Controller() {
    ...
    $.__views.__alloyId58.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId58;
    ...
    $.__views.__alloyId59.add($.__views.description);
    var __alloyId60 = [];
    ...
    showDatePicker ? $.__views.__alloyId61.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId61!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId62.add($.__views.date_value);
    $.__views.__alloyId64 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId64"
    });
    __alloyId60.push($.__views.__alloyId64);
    showTimePicker ? $.__views.__alloyId64.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId64!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId65.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId60.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId67);
    ...
    $.__views.__alloyId67.add($.__views.field1);
    ...
    __defers["$.__views.__alloyId61!click!showDatePicker"] && $.__views.__alloyId61.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId64!click!showTimePicker"] && $.__views.__alloyId64.addEventListener("click", showTimePicker);
