...
function Controller() {
    ...
    $.__views.__alloyId42.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId42;
    ...
    $.__views.__alloyId43.add($.__views.description);
    var __alloyId44 = [];
    ...
    showDatePicker ? $.__views.__alloyId45.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId45!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId46.add($.__views.date_value);
    $.__views.__alloyId48 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId48"
    });
    __alloyId44.push($.__views.__alloyId48);
    showTimePicker ? $.__views.__alloyId48.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId48!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId49.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId44.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId51);
    ...
    $.__views.__alloyId51.add($.__views.field1);
    ...
    __defers["$.__views.__alloyId45!click!showDatePicker"] && $.__views.__alloyId45.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId48!click!showTimePicker"] && $.__views.__alloyId48.addEventListener("click", showTimePicker);
