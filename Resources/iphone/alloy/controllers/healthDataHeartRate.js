...
function Controller() {
    ...
    $.__views.__alloyId45.add($.__views.saveButton);
    ...
    $.__views.healthDataHeartRate.rightNavButton = $.__views.__alloyId45;
    ...
    $.__views.__alloyId46.add($.__views.description);
    var __alloyId47 = [];
    ...
    showDatePicker ? $.__views.__alloyId48.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId48!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId49.add($.__views.date_value);
    $.__views.__alloyId51 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId51"
    });
    __alloyId47.push($.__views.__alloyId51);
    showTimePicker ? $.__views.__alloyId51.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId51!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId52.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId47.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId54);
    ...
    __defers["$.__views.__alloyId48!click!showDatePicker"] && $.__views.__alloyId48.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId51!click!showTimePicker"] && $.__views.__alloyId51.addEventListener("click", showTimePicker);
