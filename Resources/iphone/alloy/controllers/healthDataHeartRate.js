...
function Controller() {
    ...
    $.__views.__alloyId95.add($.__views.saveButton);
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId95;
    ...
    $.__views.__alloyId96.add($.__views.description);
    var __alloyId97 = [];
    ...
    showDatePicker ? $.__views.__alloyId98.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId98!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId99.add($.__views.date_value);
    $.__views.__alloyId101 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId101"
    });
    __alloyId97.push($.__views.__alloyId101);
    showTimePicker ? $.__views.__alloyId101.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId101!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId102.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId97.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId104);
    ...
    $.__views.__alloyId104.add($.__views.field1);
    ...
    __defers["$.__views.__alloyId98!click!showDatePicker"] && $.__views.__alloyId98.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId101!click!showTimePicker"] && $.__views.__alloyId101.addEventListener("click", showTimePicker);
