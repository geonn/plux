...
function Controller() {
    ...
    $.__views.__alloyId59.add($.__views.saveButton);
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId59;
    ...
    $.__views.__alloyId60.add($.__views.description);
    var __alloyId61 = [];
    ...
    showDatePicker ? $.__views.__alloyId62.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId62!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId63.add($.__views.date_value);
    $.__views.__alloyId65 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId65"
    });
    __alloyId61.push($.__views.__alloyId65);
    showTimePicker ? $.__views.__alloyId65.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId65!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId66.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId61.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId68);
    ...
    $.__views.__alloyId68.add($.__views.field1);
    ...
    __defers["$.__views.__alloyId62!click!showDatePicker"] && $.__views.__alloyId62.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId65!click!showTimePicker"] && $.__views.__alloyId65.addEventListener("click", showTimePicker);
