...
function Controller() {
    ...
    $.__views.__alloyId195.add($.__views.moreHealth);
    $.__views.m_myHealth.rightNavButton = $.__views.__alloyId195;
    $.__views.__alloyId196 = Ti.UI.createView({
        id: "__alloyId196"
    });
    $.__views.m_myHealth.add($.__views.__alloyId196);
    ...
    $.__views.__alloyId196.add($.__views.loadingBar);
    ...
    $.__views.__alloyId196.add($.__views.main);
    ...
    $.__views.bmiView.add($.__views.__alloyId198);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId199);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId200);
    ...
    $.__views.heartRateView.add($.__views.__alloyId201);
    ...
    $.__views.heartRateView.add($.__views.__alloyId202);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId203);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId204);
    ...
    $.__views.heightView.add($.__views.__alloyId205);
    ...
    $.__views.heightView.add($.__views.__alloyId206);
    ...
    $.__views.weightView.add($.__views.__alloyId207);
