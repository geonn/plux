...
function Controller() {
    ...
    $.__views.__alloyId192.add($.__views.moreHealth);
    $.__views.m_myHealth.rightNavButton = $.__views.__alloyId192;
    $.__views.__alloyId193 = Ti.UI.createView({
        id: "__alloyId193"
    });
    $.__views.m_myHealth.add($.__views.__alloyId193);
    ...
    $.__views.__alloyId193.add($.__views.loadingBar);
    ...
    $.__views.stepsView.add($.__views.__alloyId195);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId197);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId198);
    ...
    $.__views.heartRateView.add($.__views.__alloyId199);
    ...
    $.__views.heartRateView.add($.__views.__alloyId200);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId201);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId202);
    ...
    $.__views.heightView.add($.__views.__alloyId203);
    ...
    $.__views.heightView.add($.__views.__alloyId204);
    ...
    $.__views.weightView.add($.__views.__alloyId205);
