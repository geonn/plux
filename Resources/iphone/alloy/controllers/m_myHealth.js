...
function Controller() {
    ...
    $.__views.__alloyId213.add($.__views.moreHealth);
    $.__views.m_myHealth.rightNavButton = $.__views.__alloyId213;
    $.__views.__alloyId214 = Ti.UI.createView({
        id: "__alloyId214"
    });
    $.__views.m_myHealth.add($.__views.__alloyId214);
    ...
    $.__views.bmiView.add($.__views.__alloyId216);
