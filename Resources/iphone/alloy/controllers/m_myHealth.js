...
function Controller() {
    ...
    $.__views.m_myHealth.rightNavButton = $.__views.__alloyId206;
    $.__views.__alloyId207 = Ti.UI.createView({
        id: "__alloyId207"
    });
    $.__views.m_myHealth.add($.__views.__alloyId207);
    ...
    $.__views.bmiView.add($.__views.__alloyId209);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId210);
    ...
    $.__views.heartRateView.add($.__views.__alloyId212);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId214);
    ...
    $.__views.__alloyId216 = Ti.UI.createWebView({
        touchEnabled: false,
        width: "100%",
        backgroundColor: "#EBEBEB",
    ...
    $.__views.heightView.add($.__views.__alloyId216);
    ...
    $.__views.weightView.add($.__views.__alloyId218);
