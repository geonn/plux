...
function Controller() {
    ...
    $.__views.__alloyId207.add($.__views.moreHealth);
    $.__views.m_myHealth.rightNavButton = $.__views.__alloyId207;
    $.__views.__alloyId208 = Ti.UI.createView({
        id: "__alloyId208"
    });
    $.__views.m_myHealth.add($.__views.__alloyId208);
    ...
    $.__views.__alloyId208.add($.__views.loadingBar);
    ...
    $.__views.bmiView.add($.__views.__alloyId210);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId211);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId212);
    ...
    $.__views.__alloyId213 = Ti.UI.createWebView({
        touchEnabled: false,
        width: "100%",
        backgroundColor: "#EBEBEB",
    ...
    $.__views.heartRateView.add($.__views.__alloyId213);
    ...
    $.__views.heartRateView.add($.__views.__alloyId214);
    ...
    $.__views.__alloyId215 = Ti.UI.createWebView({
        touchEnabled: false,
        width: "100%",
        backgroundColor: "#EBEBEB",
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId215);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId216);
    ...
    $.__views.__alloyId217 = Ti.UI.createWebView({
        touchEnabled: false,
        width: "100%",
        backgroundColor: "#EBEBEB",
    ...
    $.__views.heightView.add($.__views.__alloyId217);
    ...
    $.__views.heightView.add($.__views.__alloyId218);
    ...
    $.__views.__alloyId219 = Ti.UI.createWebView({
        touchEnabled: false,
        width: "100%",
        backgroundColor: "#EBEBEB",
    ...
    $.__views.weightView.add($.__views.__alloyId219);
