...
function Controller() {
    ...
    $.__views.__alloyId31.add($.__views.saveRecord);
    $.__views.editRecWin.rightNavButton = $.__views.__alloyId31;
    $.__views.__alloyId32 = Ti.UI.createView({
        id: "__alloyId32"
    });
    $.__views.editRecWin.add($.__views.__alloyId32);
    ...
    $.__views.__alloyId32.add($.__views.titleRecord);
    ...
    $.__views.__alloyId32.add($.__views.aView);
    ...
    hideKeyboard ? $.__views.__alloyId40.addEventListener("click", hideKeyboard) : __defers["$.__views.__alloyId40!click!hideKeyboard"] = true;
    $.__views.__alloyId36 = Ti.UI.iOS.createToolbar({
        items: __alloyId38,
        id: "__alloyId36"
    });
    $.__views.proceduceTextArea = Ti.UI.createTextArea({
        keyboardToolbar: $.__views.__alloyId36,
    ...
    hideKeyboard ? $.__views.__alloyId47.addEventListener("click", hideKeyboard) : __defers["$.__views.__alloyId47!click!hideKeyboard"] = true;
    $.__views.__alloyId43 = Ti.UI.iOS.createToolbar({
        items: __alloyId45,
        id: "__alloyId43"
    });
    $.__views.treatmentTextArea = Ti.UI.createTextArea({
        keyboardToolbar: $.__views.__alloyId43,
    ...
    $.__views.__alloyId48.add($.__views.attachment);
    ...
    showCategory ? $.__views.__alloyId49.addEventListener("click", showCategory) : __defers["$.__views.__alloyId49!click!showCategory"] = true;
    ...
    $.__views.__alloyId50.add($.__views.addLbl);
    ...
    $.__views.__alloyId32.add($.__views.__alloyId51);
    ...
    deleteRecord ? $.__views.__alloyId52.addEventListener("click", deleteRecord) : __defers["$.__views.__alloyId52!click!deleteRecord"] = true;
    ...
    $.__views.__alloyId53.add($.__views.lastUpdated);
    ...
    __defers["$.__views.__alloyId40!click!hideKeyboard"] && $.__views.__alloyId40.addEventListener("click", hideKeyboard);
    __defers["$.__views.__alloyId47!click!hideKeyboard"] && $.__views.__alloyId47.addEventListener("click", hideKeyboard);
    __defers["$.__views.__alloyId49!click!showCategory"] && $.__views.__alloyId49.addEventListener("click", showCategory);
    __defers["$.__views.__alloyId52!click!deleteRecord"] && $.__views.__alloyId52.addEventListener("click", deleteRecord);
    _.extend($, exports);
}
