...
function Controller() {
    ...
    $.__views.__alloyId183.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId183;
    ...
    $.__views.loadingBar.add($.__views.__alloyId184);
    ...
    $.__views.__alloyId185.add($.__views.description);
    var __alloyId186 = [];
    ...
    showDatePicker ? $.__views.__alloyId187.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId187!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId188.add($.__views.date_value);
    $.__views.__alloyId190 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId190"
    });
    __alloyId186.push($.__views.__alloyId190);
    showTimePicker ? $.__views.__alloyId190.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId190!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId191.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId186.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId193);
    ...
    $.__views.__alloyId193.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId186.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId195);
    ...
    $.__views.__alloyId195.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId187!click!showDatePicker"] && $.__views.__alloyId187.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId190!click!showTimePicker"] && $.__views.__alloyId190.addEventListener("click", showTimePicker);
