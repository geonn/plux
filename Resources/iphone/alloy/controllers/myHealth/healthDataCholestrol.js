...
function Controller() {
    ...
    $.__views.__alloyId261.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId261;
    ...
    showTimePicker ? $.__views.__alloyId269.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId269!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId270.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId273);
    ...
    $.__views.__alloyId273.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId276);
    ...
    $.__views.__alloyId276.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId269!click!showTimePicker"] && $.__views.__alloyId269.addEventListener("click", showTimePicker);
