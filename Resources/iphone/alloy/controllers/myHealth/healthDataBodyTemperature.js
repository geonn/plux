...
function Controller() {
    ...
    $.__views.__alloyId173.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId173;
    ...
    $.__views.__alloyId174.add($.__views.description);
    var __alloyId175 = [];
    ...
    showDatePicker ? $.__views.__alloyId176.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId176!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId177.add($.__views.date_value);
    $.__views.__alloyId179 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId179"
    });
    __alloyId175.push($.__views.__alloyId179);
    showTimePicker ? $.__views.__alloyId179.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId179!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId180.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId175.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId182);
    ...
    $.__views.__alloyId182.add($.__views.field1);
    ...
    __defers["$.__views.__alloyId176!click!showDatePicker"] && $.__views.__alloyId176.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId179!click!showTimePicker"] && $.__views.__alloyId179.addEventListener("click", showTimePicker);
