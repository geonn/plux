...
function Controller() {
    ...
    $.__views.__alloyId289.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId289;
    ...
    $.__views.__alloyId290.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId292, "click", showDatePicker) : __defers["$.__views.__alloyId292!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId293.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId296);
    showTimePicker ? $.addListener($.__views.__alloyId296, "click", showTimePicker) : __defers["$.__views.__alloyId296!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId297.add($.__views.time_value);
    ...
    $.__views.table.add($.__views.__alloyId299);
    ...
    $.__views.tvrField1.add($.__views.__alloyId300);
    ...
    $.__views.__alloyId300.add($.__views.field1);
    ...
    __defers["$.__views.__alloyId292!click!showDatePicker"] && $.addListener($.__views.__alloyId292, "click", showDatePicker);
    __defers["$.__views.__alloyId296!click!showTimePicker"] && $.addListener($.__views.__alloyId296, "click", showTimePicker);
