...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId247;
    ...
    $.__views.__alloyId248.add($.__views.description);
    ...
    showDatePicker ? $.__views.__alloyId250.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId250!click!showDatePicker"] = true;
    ...
    showTimePicker ? $.__views.__alloyId254.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId254!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId255.add($.__views.time_value);
    ...
    __defers["$.__views.__alloyId250!click!showDatePicker"] && $.__views.__alloyId250.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId254!click!showTimePicker"] && $.__views.__alloyId254.addEventListener("click", showTimePicker);
