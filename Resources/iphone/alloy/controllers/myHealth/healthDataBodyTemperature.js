...
function Controller() {
    ...
    $.__views.__alloyId119.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId119;
    ...
    $.__views.__alloyId120.add($.__views.description);
    var __alloyId121 = [];
    ...
    showDatePicker ? $.__views.__alloyId122.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId122!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId123.add($.__views.date_value);
    $.__views.__alloyId125 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId125"
    });
    __alloyId121.push($.__views.__alloyId125);
    showTimePicker ? $.__views.__alloyId125.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId125!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId126.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId121.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId128);
    ...
    $.__views.__alloyId128.add($.__views.field1);
    ...
    __defers["$.__views.__alloyId122!click!showDatePicker"] && $.__views.__alloyId122.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId125!click!showTimePicker"] && $.__views.__alloyId125.addEventListener("click", showTimePicker);
