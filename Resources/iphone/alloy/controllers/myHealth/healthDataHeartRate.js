...
function Controller() {
    ...
    $.__views.__alloyId161.add($.__views.saveButton);
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId161;
    ...
    $.__views.__alloyId162.add($.__views.description);
    var __alloyId163 = [];
    ...
    showDatePicker ? $.__views.__alloyId164.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId164!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId165.add($.__views.date_value);
    $.__views.__alloyId167 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId167"
    });
    __alloyId163.push($.__views.__alloyId167);
    showTimePicker ? $.__views.__alloyId167.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId167!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId168.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId163.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId170);
    ...
    $.__views.__alloyId170.add($.__views.field1);
    ...
    __defers["$.__views.__alloyId164!click!showDatePicker"] && $.__views.__alloyId164.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId167!click!showTimePicker"] && $.__views.__alloyId167.addEventListener("click", showTimePicker);
