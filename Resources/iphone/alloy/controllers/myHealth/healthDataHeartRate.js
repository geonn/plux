...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId195;
    ...
    $.__views.__alloyId196.add($.__views.description);
    var __alloyId197 = [];
    ...
    showDatePicker ? $.__views.__alloyId198.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId198!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId199.add($.__views.date_value);
    $.__views.__alloyId201 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId201"
    });
    __alloyId197.push($.__views.__alloyId201);
    showTimePicker ? $.__views.__alloyId201.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId201!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId202.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId197.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId204);
    ...
    $.__views.__alloyId204.add($.__views.field1);
    ...
    __defers["$.__views.__alloyId198!click!showDatePicker"] && $.__views.__alloyId198.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId201!click!showTimePicker"] && $.__views.__alloyId201.addEventListener("click", showTimePicker);
