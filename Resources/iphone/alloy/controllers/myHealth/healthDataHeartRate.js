...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId170;
    ...
    $.__views.__alloyId171.add($.__views.description);
    var __alloyId172 = [];
    ...
    showDatePicker ? $.__views.__alloyId173.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId173!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId174.add($.__views.date_value);
    $.__views.__alloyId176 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId176"
    });
    __alloyId172.push($.__views.__alloyId176);
    showTimePicker ? $.__views.__alloyId176.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId176!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId177.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId172.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId179);
    ...
    $.__views.__alloyId179.add($.__views.field1);
    ...
    __defers["$.__views.__alloyId173!click!showDatePicker"] && $.__views.__alloyId173.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId176!click!showTimePicker"] && $.__views.__alloyId176.addEventListener("click", showTimePicker);
