...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId205;
    ...
    $.__views.__alloyId206.add($.__views.description);
    var __alloyId207 = [];
    ...
    showDatePicker ? $.__views.__alloyId208.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId208!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId209.add($.__views.date_value);
    $.__views.__alloyId211 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId211"
    });
    __alloyId207.push($.__views.__alloyId211);
    showTimePicker ? $.__views.__alloyId211.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId211!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId212.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId207.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId214);
    ...
    $.__views.__alloyId214.add($.__views.field1);
    ...
    __defers["$.__views.__alloyId208!click!showDatePicker"] && $.__views.__alloyId208.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId211!click!showTimePicker"] && $.__views.__alloyId211.addEventListener("click", showTimePicker);
