...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId340);
    ...
    $.__views.__alloyId340.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId341);
    ...
    $.__views.__alloyId340.add($.__views.main);
    var __alloyId342 = [];
    var __alloyId345 = {
        font: {
            fontSize: "12dp"
    ...
    __alloyId342.push(__alloyId345);
    var __alloyId346 = {
        font: {
            fontSize: "12dp"
        },
    ...
    __alloyId347.push($.__views.addHealthData);
    addData ? $.addListener($.__views.addHealthData, "click", addData) : __defers["$.__views.addHealthData!click!addData"] = true;
    $.__views.__alloyId348 = Ti.UI.createTableViewRow({
        backgroundSelectedColor: "#FFE1E1",
        title: "Show All Data",
        hasChild: "true",
        id: "__alloyId348"
    });
    __alloyId347.push($.__views.__alloyId348);
    editData ? $.addListener($.__views.__alloyId348, "click", editData) : __defers["$.__views.__alloyId348!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId348!click!editData"] && $.addListener($.__views.__alloyId348, "click", editData);
    _.extend($, exports);
}
