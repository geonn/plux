...
function Controller() {
    ...
    $.__views.healthDataSummary.add($.__views.__alloyId183);
    ...
    $.__views.__alloyId183.add($.__views.loadingBar);
    ...
    $.__views.__alloyId183.add($.__views.main);
    var __alloyId185 = [];
    var __alloyId188 = {
        title: "Month"
    };
    __alloyId185.push(__alloyId188);
    var __alloyId189 = {
        title: "Year"
    };
    __alloyId185.push(__alloyId189);
    ...
    $.__views.bmiView.add($.__views.__alloyId190);
    var __alloyId191 = [];
    ...
    addData ? $.__views.__alloyId192.addEventListener("click", addData) : __defers["$.__views.__alloyId192!click!addData"] = true;
    ...
    __alloyId191.push($.__views.__alloyId193);
    editData ? $.__views.__alloyId193.addEventListener("click", editData) : __defers["$.__views.__alloyId193!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId192!click!addData"] && $.__views.__alloyId192.addEventListener("click", addData);
    __defers["$.__views.__alloyId193!click!editData"] && $.__views.__alloyId193.addEventListener("click", editData);
    _.extend($, exports);
}
