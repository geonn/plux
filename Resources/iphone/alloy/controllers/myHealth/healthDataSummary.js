...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId349);
    ...
    $.__views.__alloyId349.add($.__views.main);
    var __alloyId351 = [];
    var __alloyId354 = {
        font: {
            fontSize: "12dp"
    ...
    __alloyId351.push(__alloyId354);
    var __alloyId355 = {
        font: {
            fontSize: "12dp"
        },
    ...
    __alloyId351.push(__alloyId355);
    ...
    editData ? $.addListener($.__views.__alloyId357, "click", editData) : __defers["$.__views.__alloyId357!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId357!click!editData"] && $.addListener($.__views.__alloyId357, "click", editData);
    _.extend($, exports);
}
