...
function Controller() {
    ...
    $.__views.__alloyId220.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId220;
    $.__views.__alloyId221 = Ti.UI.createView({
        id: "__alloyId221"
    });
    $.__views.myhealth.add($.__views.__alloyId221);
    ...
    $.__views.__alloyId221.add($.__views.loadingBar);
    ...
    $.__views.__alloyId221.add($.__views.main);
    ...
    $.__views.stepsView.add($.__views.__alloyId223);
    ...
    $.__views.__alloyId224.add($.__views.stepsDetailLabel);
    ...
    $.__views.bmiView.add($.__views.__alloyId226);
    ...
    $.__views.__alloyId227.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId229);
    ...
    $.__views.__alloyId230.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId232);
    ...
    $.__views.__alloyId233.add($.__views.heartRateDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId235);
    ...
    $.__views.__alloyId236.add($.__views.bodyTempDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId238);
    ...
    $.__views.__alloyId239.add($.__views.cholestrolDetailLabel);
