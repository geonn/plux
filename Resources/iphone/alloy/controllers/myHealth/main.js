...
function Controller() {
    ...
    $.__views.__alloyId231.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId231;
    $.__views.__alloyId232 = Ti.UI.createView({
        id: "__alloyId232"
    });
    $.__views.myhealth.add($.__views.__alloyId232);
    ...
    $.__views.__alloyId232.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId233);
    $.__views.main = Ti.UI.createView({
        id: "main",
        layout: "vertical",
        backgroundColor: "#ffffff"
    });
    $.__views.__alloyId232.add($.__views.main);
    ...
    $.__views.stepsView.add($.__views.__alloyId234);
    ...
    $.__views.stepsView.add($.__views.__alloyId235);
    ...
    $.__views.__alloyId235.add($.__views.stepsDetailLabel);
    ...
    $.__views.bmiView.add($.__views.__alloyId237);
    ...
    $.__views.bmiView.add($.__views.__alloyId238);
    ...
    $.__views.__alloyId238.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId240);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId241);
    ...
    $.__views.__alloyId241.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId243);
    ...
    $.__views.heartRateView.add($.__views.__alloyId244);
    ...
    $.__views.__alloyId244.add($.__views.heartRateDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId246);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId247);
    ...
    $.__views.__alloyId247.add($.__views.bodyTempDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId249);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId250);
    ...
    $.__views.__alloyId250.add($.__views.cholestrolDetailLabel);
