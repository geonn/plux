...
function Controller() {
    ...
    $.__views.__alloyId347.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId347;
    $.__views.__alloyId348 = Ti.UI.createView({
        id: "__alloyId348"
    });
    $.__views.myhealth.add($.__views.__alloyId348);
    ...
    $.__views.__alloyId348.add($.__views.loadingBar);
    ...
    $.__views.__alloyId348.add($.__views.main);
    ...
    $.__views.stepsView.add($.__views.__alloyId350);
    ...
    $.__views.stepsView.add($.__views.__alloyId351);
    ...
    $.__views.__alloyId351.add($.__views.stepsDetailLabel);
    ...
    $.__views.bmiView.add($.__views.__alloyId353);
    ...
    $.__views.bmiView.add($.__views.__alloyId354);
    ...
    $.__views.__alloyId354.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId356);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId357);
    ...
    $.__views.__alloyId357.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId359);
    ...
    $.__views.heartRateView.add($.__views.__alloyId360);
    ...
    $.__views.__alloyId360.add($.__views.heartRateDetailLabel);
    ...
    $.__views.glucoseView.add($.__views.__alloyId362);
    ...
    $.__views.glucoseView.add($.__views.__alloyId363);
    ...
    $.__views.__alloyId363.add($.__views.glucoseDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId365);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId366);
    ...
    $.__views.__alloyId366.add($.__views.cholestrolDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId368);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId369);
    ...
    $.__views.__alloyId369.add($.__views.bodyTempDetailLabel);
