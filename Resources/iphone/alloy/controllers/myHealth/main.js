...
function Controller() {
    ...
    $.__views.__alloyId171.add($.__views.moreHealth);
    $.__views.main.rightNavButton = $.__views.__alloyId171;
    ...
    $.__views.__alloyId172.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId173);
    $.__views.main = Ti.UI.createView({
        id: "main",
        layout: "vertical",
        backgroundColor: "#ffffff"
    });
    $.__views.__alloyId172.add($.__views.main);
    ...
    $.__views.stepsView.add($.__views.__alloyId174);
    ...
    $.__views.bmiView.add($.__views.__alloyId175);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId176);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId177);
    ...
    $.__views.heartRateView.add($.__views.__alloyId178);
    ...
    $.__views.heartRateView.add($.__views.__alloyId179);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId180);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId181);
    ...
    $.__views.heightView.add($.__views.__alloyId182);
    ...
    $.__views.heightView.add($.__views.__alloyId183);
    ...
    $.__views.weightView.add($.__views.__alloyId184);
