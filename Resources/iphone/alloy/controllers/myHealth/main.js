...
function Controller() {
    ...
    $.__views.__alloyId354.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId354;
    $.__views.__alloyId355 = Ti.UI.createView({
        id: "__alloyId355"
    });
    $.__views.myhealth.add($.__views.__alloyId355);
    ...
    $.__views.__alloyId355.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId356);
    $.__views.main = Ti.UI.createView({
        id: "main",
        layout: "vertical",
        backgroundColor: "#ffffff"
    });
    $.__views.__alloyId355.add($.__views.main);
    ...
    $.__views.stepsView.add($.__views.__alloyId357);
    ...
    $.__views.stepsView.add($.__views.__alloyId358);
    ...
    $.__views.__alloyId358.add($.__views.stepsDetailLabel);
    ...
    $.__views.bmiView.add($.__views.__alloyId360);
    ...
    $.__views.bmiView.add($.__views.__alloyId361);
    ...
    $.__views.__alloyId361.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId363);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId364);
    ...
    $.__views.__alloyId364.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId366);
    ...
    $.__views.heartRateView.add($.__views.__alloyId367);
    ...
    $.__views.__alloyId367.add($.__views.heartRateDetailLabel);
    ...
    $.__views.glucoseView.add($.__views.__alloyId369);
    ...
    $.__views.glucoseView.add($.__views.__alloyId370);
    ...
    $.__views.__alloyId370.add($.__views.glucoseDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId372);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId373);
    ...
    $.__views.__alloyId373.add($.__views.cholestrolDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId375);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId376);
    ...
    $.__views.__alloyId376.add($.__views.bodyTempDetailLabel);
