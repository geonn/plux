...
function Controller() {
    ...
    $.__views.__alloyId199.add($.__views.moreHealth);
    $.__views.main.rightNavButton = $.__views.__alloyId199;
    ...
    $.__views.__alloyId200.add($.__views.loadingBar);
    ...
    $.__views.__alloyId200.add($.__views.main);
    ...
    $.__views.stepsView.add($.__views.__alloyId202);
