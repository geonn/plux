...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId254;
    ...
    showDatePicker ? $.addListener($.__views.__alloyId257, "click", showDatePicker) : __defers["$.__views.__alloyId257!click!showDatePicker"] = true;
    ...
    showTimePicker ? $.addListener($.__views.__alloyId261, "click", showTimePicker) : __defers["$.__views.__alloyId261!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId262.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId265);
    ...
    $.__views.__alloyId265.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId268);
    ...
    $.__views.__alloyId268.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId257!click!showDatePicker"] && $.addListener($.__views.__alloyId257, "click", showDatePicker);
    __defers["$.__views.__alloyId261!click!showTimePicker"] && $.addListener($.__views.__alloyId261, "click", showTimePicker);
