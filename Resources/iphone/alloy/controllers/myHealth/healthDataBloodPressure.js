...
function Controller() {
    ...
    $.__views.__alloyId132.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId132;
    ...
    showDatePicker ? $.__views.__alloyId135.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId135!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId136.add($.__views.date_value);
    $.__views.__alloyId138 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId138"
    });
    __alloyId134.push($.__views.__alloyId138);
    showTimePicker ? $.__views.__alloyId138.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId138!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId139.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId134.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId141);
    ...
    $.__views.__alloyId141.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId134.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId143);
    ...
    $.__views.__alloyId143.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId135!click!showDatePicker"] && $.__views.__alloyId135.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId138!click!showTimePicker"] && $.__views.__alloyId138.addEventListener("click", showTimePicker);
