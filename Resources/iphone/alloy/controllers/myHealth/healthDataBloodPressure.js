...
function Controller() {
    ...
    $.__views.__alloyId139.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId139;
    ...
    $.__views.__alloyId140.add($.__views.description);
    var __alloyId141 = [];
    ...
    showDatePicker ? $.__views.__alloyId142.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId142!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId143.add($.__views.date_value);
    $.__views.__alloyId145 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId145"
    });
    __alloyId141.push($.__views.__alloyId145);
    showTimePicker ? $.__views.__alloyId145.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId145!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId146.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId141.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId148);
    ...
    $.__views.__alloyId148.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId141.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId150);
    ...
    $.__views.__alloyId150.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId142!click!showDatePicker"] && $.__views.__alloyId142.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId145!click!showTimePicker"] && $.__views.__alloyId145.addEventListener("click", showTimePicker);
