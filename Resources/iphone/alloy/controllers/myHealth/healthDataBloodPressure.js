...
function Controller() {
    ...
    $.__views.__alloyId121.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId121;
    ...
    $.__views.__alloyId122.add($.__views.description);
    var __alloyId123 = [];
    ...
    showDatePicker ? $.__views.__alloyId124.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId124!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId125.add($.__views.date_value);
    $.__views.__alloyId127 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId127"
    });
    __alloyId123.push($.__views.__alloyId127);
    showTimePicker ? $.__views.__alloyId127.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId127!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId128.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId123.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId130);
    ...
    $.__views.__alloyId130.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId123.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId132);
    ...
    $.__views.__alloyId132.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId124!click!showDatePicker"] && $.__views.__alloyId124.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId127!click!showTimePicker"] && $.__views.__alloyId127.addEventListener("click", showTimePicker);
