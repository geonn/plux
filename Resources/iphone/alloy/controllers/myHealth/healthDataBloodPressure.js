...
function Controller() {
    ...
    $.__views.__alloyId138.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId138;
    ...
    $.__views.__alloyId139.add($.__views.description);
    var __alloyId140 = [];
    ...
    showDatePicker ? $.__views.__alloyId141.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId141!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId142.add($.__views.date_value);
    $.__views.__alloyId144 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId144"
    });
    __alloyId140.push($.__views.__alloyId144);
    showTimePicker ? $.__views.__alloyId144.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId144!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId145.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId140.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId147);
    ...
    $.__views.__alloyId147.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId140.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId149);
    ...
    $.__views.__alloyId149.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId141!click!showDatePicker"] && $.__views.__alloyId141.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId144!click!showTimePicker"] && $.__views.__alloyId144.addEventListener("click", showTimePicker);
