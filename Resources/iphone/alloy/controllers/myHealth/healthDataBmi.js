...
function Controller() {
    ...
    $.__views.__alloyId108.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId108;
    ...
    $.__views.__alloyId109.add($.__views.description);
    var __alloyId110 = [];
    ...
    showDatePicker ? $.__views.__alloyId111.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId111!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId112.add($.__views.date_value);
    $.__views.__alloyId114 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId114"
    });
    __alloyId110.push($.__views.__alloyId114);
    showTimePicker ? $.__views.__alloyId114.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId114!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId115.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId110.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId117);
    ...
    $.__views.__alloyId117.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId110.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId119);
    ...
    $.__views.__alloyId119.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId111!click!showDatePicker"] && $.__views.__alloyId111.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId114!click!showTimePicker"] && $.__views.__alloyId114.addEventListener("click", showTimePicker);
