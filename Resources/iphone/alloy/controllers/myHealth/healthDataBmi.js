...
function Controller() {
    ...
    $.__views.__alloyId163.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId163;
    ...
    $.__views.__alloyId165.add($.__views.description);
    var __alloyId166 = [];
    ...
    showDatePicker ? $.__views.__alloyId167.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId167!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId168.add($.__views.date_value);
    $.__views.__alloyId170 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId170"
    });
    __alloyId166.push($.__views.__alloyId170);
    showTimePicker ? $.__views.__alloyId170.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId170!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId171.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId166.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId173);
    ...
    $.__views.__alloyId173.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId166.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId175);
    ...
    $.__views.__alloyId175.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId167!click!showDatePicker"] && $.__views.__alloyId167.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId170!click!showTimePicker"] && $.__views.__alloyId170.addEventListener("click", showTimePicker);
