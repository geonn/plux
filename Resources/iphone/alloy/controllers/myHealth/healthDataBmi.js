...
function Controller() {
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId118;
    ...
    $.__views.__alloyId119.add($.__views.description);
    var __alloyId120 = [];
    ...
    showDatePicker ? $.__views.__alloyId121.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId121!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId122.add($.__views.date_value);
    $.__views.__alloyId124 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId124"
    });
    __alloyId120.push($.__views.__alloyId124);
    showTimePicker ? $.__views.__alloyId124.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId124!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId125.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId120.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId127);
    ...
    $.__views.__alloyId127.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId120.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId129);
    ...
    $.__views.__alloyId129.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId121!click!showDatePicker"] && $.__views.__alloyId121.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId124!click!showTimePicker"] && $.__views.__alloyId124.addEventListener("click", showTimePicker);
