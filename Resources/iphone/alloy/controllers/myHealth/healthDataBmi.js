...
function Controller() {
    ...
    $.__views.__alloyId229.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId229;
    ...
    $.__views.__alloyId231.add($.__views.description);
    ...
    showDatePicker ? $.__views.__alloyId233.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId233!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId234.add($.__views.date_value);
    ...
    showTimePicker ? $.__views.__alloyId237.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId237!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId238.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId241);
    ...
    $.__views.__alloyId241.add($.__views.field1);
    ...
    __defers["$.__views.__alloyId233!click!showDatePicker"] && $.__views.__alloyId233.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId237!click!showTimePicker"] && $.__views.__alloyId237.addEventListener("click", showTimePicker);
