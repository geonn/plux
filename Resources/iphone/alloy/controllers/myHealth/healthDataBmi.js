...
function Controller() {
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId174;
    ...
    $.__views.__alloyId176.add($.__views.description);
    var __alloyId177 = [];
    ...
    showDatePicker ? $.__views.__alloyId178.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId178!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId179.add($.__views.date_value);
    $.__views.__alloyId181 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId181"
    });
    __alloyId177.push($.__views.__alloyId181);
    showTimePicker ? $.__views.__alloyId181.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId181!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId182.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId177.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId184);
    ...
    $.__views.__alloyId184.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId177.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId186);
    ...
    $.__views.__alloyId186.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId178!click!showDatePicker"] && $.__views.__alloyId178.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId181!click!showTimePicker"] && $.__views.__alloyId181.addEventListener("click", showTimePicker);
