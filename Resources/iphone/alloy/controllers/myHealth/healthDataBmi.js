...
function Controller() {
    ...
    $.__views.__alloyId146.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId146;
    ...
    $.__views.__alloyId147.add($.__views.description);
    var __alloyId148 = [];
    ...
    showDatePicker ? $.__views.__alloyId149.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId149!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId150.add($.__views.date_value);
    $.__views.__alloyId152 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId152"
    });
    __alloyId148.push($.__views.__alloyId152);
    showTimePicker ? $.__views.__alloyId152.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId152!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId153.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId148.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId155);
    ...
    $.__views.__alloyId155.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId148.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId157);
    ...
    $.__views.__alloyId157.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId149!click!showDatePicker"] && $.__views.__alloyId149.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId152!click!showTimePicker"] && $.__views.__alloyId152.addEventListener("click", showTimePicker);
