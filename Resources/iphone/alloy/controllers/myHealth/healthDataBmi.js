...
function Controller() {
    ...
    $.__views.__alloyId156.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId156;
    ...
    $.__views.__alloyId158.add($.__views.description);
    var __alloyId159 = [];
    ...
    showDatePicker ? $.__views.__alloyId160.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId160!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId161.add($.__views.date_value);
    $.__views.__alloyId163 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId163"
    });
    __alloyId159.push($.__views.__alloyId163);
    showTimePicker ? $.__views.__alloyId163.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId163!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId164.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId159.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId166);
    ...
    $.__views.__alloyId166.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId159.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId168);
    ...
    $.__views.__alloyId168.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId160!click!showDatePicker"] && $.__views.__alloyId160.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId163!click!showTimePicker"] && $.__views.__alloyId163.addEventListener("click", showTimePicker);
