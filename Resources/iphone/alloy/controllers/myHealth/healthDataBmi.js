...
function Controller() {
    ...
    $.__views.__alloyId135.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId135;
    ...
    $.__views.__alloyId136.add($.__views.description);
    var __alloyId137 = [];
    ...
    showDatePicker ? $.__views.__alloyId138.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId138!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId139.add($.__views.date_value);
    $.__views.__alloyId141 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId141"
    });
    __alloyId137.push($.__views.__alloyId141);
    showTimePicker ? $.__views.__alloyId141.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId141!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId142.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId137.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId144);
    ...
    $.__views.__alloyId144.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId137.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId146);
    ...
    $.__views.__alloyId146.add($.__views.field2);
    ...
    __defers["$.__views.__alloyId138!click!showDatePicker"] && $.__views.__alloyId138.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId141!click!showTimePicker"] && $.__views.__alloyId141.addEventListener("click", showTimePicker);
