...
function Controller() {
    ...
    $.__views.__alloyId202.add($.__views.editButton);
    ...
    $.__views.__alloyId202.add($.__views.doneButton);
    doDone ? $.__views.doneButton.addEventListener("touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId202;
    $.__views.__alloyId203 = Ti.UI.createView({
        id: "__alloyId203"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId203);
