...
function Controller() {
    ...
    $.__views.__alloyId220.add($.__views.editButton);
    ...
    $.__views.__alloyId220.add($.__views.doneButton);
    doDone ? $.__views.doneButton.addEventListener("touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId220;
    $.__views.__alloyId221 = Ti.UI.createView({
        id: "__alloyId221"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId221);
