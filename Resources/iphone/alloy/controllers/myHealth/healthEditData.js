...
function Controller() {
    ...
    $.__views.__alloyId184.add($.__views.doneButton);
    doDone ? $.__views.doneButton.addEventListener("touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId184;
    $.__views.__alloyId185 = Ti.UI.createView({
        id: "__alloyId185"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId185);
    ...
    $.__views.__alloyId185.add($.__views.main);
