...
function Controller() {
    ...
    $.__views.__alloyId227.add($.__views.editButton);
    ...
    $.__views.__alloyId227.add($.__views.doneButton);
    doDone ? $.__views.doneButton.addEventListener("touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId227;
    $.__views.__alloyId228 = Ti.UI.createView({
        id: "__alloyId228"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId228);
