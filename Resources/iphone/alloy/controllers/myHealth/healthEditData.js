...
function Controller() {
    ...
    $.__views.__alloyId303.add($.__views.editButton);
    ...
    $.__views.__alloyId303.add($.__views.doneButton);
    doDone ? $.__views.doneButton.addEventListener("touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId303;
    $.__views.__alloyId304 = Ti.UI.createView({
        id: "__alloyId304"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId304);
    ...
    $.__views.__alloyId304.add($.__views.loadingBar);
    ...
    $.__views.__alloyId304.add($.__views.main);
