...
<<<<<<< HEAD
    $.__views.__alloyId184.add($.__views.editButton);
=======
    $.__views.__alloyId182.add($.__views.editButton);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId184.add($.__views.saveButton);
    ...
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId184;
=======
    $.__views.__alloyId182.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId182;
>>>>>>> origin/master
...
<<<<<<< HEAD
    __alloyId185.push($.__views.tvrFieldDate);
...
=======
    __alloyId183.push($.__views.tvrFieldDate);
    showDatePicker ? $.__views.tvrFieldDate.addEventListener("click", showDatePicker) : __defers["$.__views.tvrFieldDate!click!showDatePicker"] = true;
    $.__views.__alloyId184 = Ti.UI.createView({
>>>>>>> origin/master
        layout: "horizontal",
...
<<<<<<< HEAD
    ...
    $.__views.tvrFieldDate.add($.__views.__alloyId186);
    $.__views.__alloyId187 = Ti.UI.createLabel({
=======
        id: "__alloyId184"
    });
    $.__views.tvrFieldDate.add($.__views.__alloyId184);
...
<<<<<<< HEAD
    __alloyId185.push($.__views.tvrFieldGender);
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId188);
    $.__views.__alloyId189 = Ti.UI.createLabel({
=======
    __alloyId183.push($.__views.tvrFieldGender);
    showGenderPicker ? $.__views.tvrFieldGender.addEventListener("click", showGenderPicker) : __defers["$.__views.tvrFieldGender!click!showGenderPicker"] = true;
    $.__views.__alloyId186 = Ti.UI.createView({
        layout: "horizontal",
        height: "45",
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId186);
    $.__views.__alloyId187 = Ti.UI.createLabel({
>>>>>>> origin/master
        width: "40%",
        height: Titanium.UI.SIZE,
...
<<<<<<< HEAD
    $.__views.__alloyId188.add($.__views.gender_value);
=======
    $.__views.__alloyId186.add($.__views.gender_value);
>>>>>>> origin/master
...
<<<<<<< HEAD
    __alloyId185.push($.__views.tvrFieldBloodType);
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId190);
    $.__views.__alloyId191 = Ti.UI.createLabel({
=======
    __alloyId183.push($.__views.tvrFieldBloodType);
    showBloodTypePicker ? $.__views.tvrFieldBloodType.addEventListener("click", showBloodTypePicker) : __defers["$.__views.tvrFieldBloodType!click!showBloodTypePicker"] = true;
    $.__views.__alloyId188 = Ti.UI.createView({
        layout: "horizontal",
        height: "45",
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId188);
    $.__views.__alloyId189 = Ti.UI.createLabel({
>>>>>>> origin/master
        width: "40%",
        height: Titanium.UI.SIZE,
...
<<<<<<< HEAD
    $.__views.__alloyId190.add($.__views.bloodType_value);
    $.__views.table = Ti.UI.createTableView({
        data: __alloyId185,
=======
    $.__views.__alloyId188.add($.__views.bloodType_value);
    $.__views.table = Ti.UI.createTableView({
        data: __alloyId183,
>>>>>>> origin/master
        id: "table",
