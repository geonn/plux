...
function Controller() {
    ...
    $.__views.__alloyId186.add($.__views.editButton);
    ...
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId186;
    ...
    __alloyId187.push($.__views.tvrFieldDate);
    ...
    $.__views.tvrFieldDate.add($.__views.__alloyId188);
    ...
    __alloyId187.push($.__views.tvrFieldGender);
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId190);
    ...
    $.__views.__alloyId190.add($.__views.gender_value);
    $.__views.tvrFieldBloodType = Ti.UI.createTableViewRow({
        id: "tvrFieldBloodType",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId187.push($.__views.tvrFieldBloodType);
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId192);
    ...
    $.__views.__alloyId192.add($.__views.bloodType_value);
