...
function Controller() {
    ...
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId230;
    ...
    __alloyId231.push($.__views.tvrFieldDate);
    ...
    $.__views.tvrFieldDate.add($.__views.__alloyId232);
    ...
    __alloyId231.push($.__views.tvrFieldGender);
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId234);
    ...
    $.__views.__alloyId234.add($.__views.gender_value);
    $.__views.tvrFieldBloodType = Ti.UI.createTableViewRow({
        id: "tvrFieldBloodType",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId231.push($.__views.tvrFieldBloodType);
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId236);
    ...
    $.__views.__alloyId236.add($.__views.bloodType_value);
