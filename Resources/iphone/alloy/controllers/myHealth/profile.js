...
function Controller() {
    ...
    $.__views.__alloyId173.add($.__views.editButton);
    ...
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId173;
    ...
    __alloyId174.push($.__views.tvrFieldDate);
    ...
    $.__views.tvrFieldDate.add($.__views.__alloyId175);
    ...
    __alloyId174.push($.__views.tvrFieldGender);
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId177);
    ...
    $.__views.__alloyId177.add($.__views.gender_value);
    $.__views.tvrFieldBloodType = Ti.UI.createTableViewRow({
        id: "tvrFieldBloodType",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId174.push($.__views.tvrFieldBloodType);
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId179);
    ...
    $.__views.__alloyId179.add($.__views.bloodType_value);
