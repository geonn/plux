...
function Controller() {
    ...
    $.__views.__alloyId212.add($.__views.editButton);
    ...
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId212;
    ...
    __alloyId213.push($.__views.tvrFieldDate);
    ...
    $.__views.tvrFieldDate.add($.__views.__alloyId214);
    ...
    $.__views.__alloyId214.add($.__views.date_value);
    $.__views.tvrFieldGender = Ti.UI.createTableViewRow({
        id: "tvrFieldGender",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId213.push($.__views.tvrFieldGender);
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId216);
    ...
    $.__views.__alloyId216.add($.__views.gender_value);
    $.__views.tvrFieldBloodType = Ti.UI.createTableViewRow({
        id: "tvrFieldBloodType",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId213.push($.__views.tvrFieldBloodType);
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId218);
    ...
    $.__views.__alloyId218.add($.__views.bloodType_value);
