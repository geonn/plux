...
function Controller() {
    ...
    $.__views.__alloyId243.add($.__views.editButton);
    ...
    $.__views.__alloyId243.add($.__views.saveButton);
    ...
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId243;
    ...
    __alloyId244.push($.__views.tvrFieldDate);
    ...
    $.__views.tvrFieldDate.add($.__views.__alloyId245);
    ...
    __alloyId244.push($.__views.tvrFieldGender);
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId247);
    ...
    $.__views.__alloyId247.add($.__views.gender_value);
    $.__views.tvrFieldBloodType = Ti.UI.createTableViewRow({
        id: "tvrFieldBloodType",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId244.push($.__views.tvrFieldBloodType);
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId249);
    ...
    $.__views.__alloyId249.add($.__views.bloodType_value);
