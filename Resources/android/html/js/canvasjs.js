...
(function () {
        ...
        if (this._options.zoomEnabled) {
            ...
            if (!this._resetButton) {
                ...
                addEvent(this._resetButton, "click", function () {
                    ...
                    if (_this._options.axisX && _this._options.axisX.minimum) _this.sessionVariables.axisX.internalMinimum = _this._options.axisX.minimum;else _this.sessionVariables.axisX.internalMinimum = null;

                    if (_this._options.axisX && _this._options.axisX.maximum) _this.sessionVariables.axisX.internalMaximum = _this._options.axisX.maximum;else _this.sessionVariables.axisX.internalMaximum = null;
    ...
    if (!Chart._supportedChartTypes.indexOf) {
        Chart._supportedChartTypes.indexOf = function (elt) {
    ...
    Chart.prototype.render = function (options) {
        ...
        for (var i = 0; i < this.data.length; i++) {
            if (this.data[i].showInLegend) this.legend.dataSeries.push(this.data[i]);
        }
        this.legend.render();
    ...
    Chart.prototype._plotAreaMouseMove = function (x, y) {
        ...
        } else if (this._toolTip.enabled) this._toolTip.mouseMoveHandler(x, y);
    };
    ...
    Chart.prototype.renderIndexLabels = function (targetCtx) {
        ...
        for (var i = 0; i < this._indexLabels.length; i++) {
            ...
            if (indexLabel.chartType === "column" || indexLabel.chartType === "stackedColumn" || indexLabel.chartType === "stackedColumn100" || indexLabel.chartType === "bar" || indexLabel.chartType === "stackedBar" || indexLabel.chartType === "stackedBar100" || indexLabel.chartType === "candlestick" || indexLabel.chartType === "ohlc" || indexLabel.chartType === "rangeColumn" || indexLabel.chartType === "rangeBar") {
                    ...
                    if (orientation === "horizontal") {
                        ...
                        if (direction >= 0) {
                            if (indexLabel.point.y - textSize.height / 2 - offsetY < yMinLimit + textSize.height / 2) {
                                if (placement === "auto") y = Math.min(Math.max(indexLabel.point.y, yMinLimit) + textSize.height / 2 + 1, yMaxLimit - textSize.height / 2 - offsetY);else y = Math.min(yMinLimit + textSize.height / 2 + 1, yMaxLimit - textSize.height / 2 - offsetY);
                            } else {
                            ...
                            if (indexLabel.point.y + textSize.height / 2 + offsetY > yMaxLimit - textSize.height / 2 - 1) {
                                if (placement === "auto") y = Math.max(Math.min(indexLabel.point.y, yMaxLimit) - textSize.height / 2 - 1, yMinLimit + textSize.height / 2 + offsetY);else y = Math.max(yMaxLimit - textSize.height / 2 - 1, yMinLimit + textSize.height / 2 + offsetY);
                            } else {
                        ...
                        if (direction >= 0) {
                            if (indexLabel.point.y - offsetY < yMinLimit + textSize.width + 1) {
                                if (placement === "auto") y = Math.min(Math.max(indexLabel.point.y, yMinLimit) + textSize.width + 1, yMaxLimit);else y = Math.min(yMinLimit + textSize.width + 1, yMaxLimit);
                            } else {
                            ...
                            if (indexLabel.point.y + textSize.width + offsetY > yMaxLimit - 1) {
                                if (placement === "auto") y = Math.max(Math.min(indexLabel.point.y, yMaxLimit) - offsetY, yMinLimit);else y = Math.max(yMaxLimit - 1, yMinLimit);
                            } else {
                    ...
                    if (orientation === "horizontal") {
                        ...
                        if (direction >= 0) {
                            if (indexLabel.point.x + offsetX > xMaxLimit - textSize.width) {
                                if (placement === "auto") x = Math.max(Math.min(indexLabel.point.x, xMaxLimit) - textSize.width, xMinLimit);else x = Math.max(xMaxLimit - textSize.width, xMinLimit);
                            } else {
                                x = Math.max(indexLabel.point.x + offsetX, xMinLimit);
                            }
                        } else {
                            if (indexLabel.point.x - textSize.width - offsetX < xMinLimit) {
                                if (placement === "auto") x = Math.min(Math.max(indexLabel.point.x, xMinLimit) + 1, xMaxLimit);else x = Math.min(xMinLimit + 1, xMaxLimit);
                            } else {
                        ...
                        if (direction >= 0) {
                            if (indexLabel.point.x + textSize.height / 2 + offsetX > xMaxLimit - textSize.height / 2) {
                                if (placement === "auto") x = Math.max(Math.min(indexLabel.point.x, xMaxLimit) - textSize.height / 2, xMinLimit);else x = Math.max(xMaxLimit - textSize.height / 2, xMinLimit);
                            } else {
                            ...
                            if (indexLabel.point.x - textSize.height / 2 - offsetX < xMinLimit + textSize.height / 2) {
                                if (placement === "auto") x = Math.min(Math.max(indexLabel.point.x, xMinLimit) + textSize.height / 2, xMaxLimit + textSize.height / 2);else x = Math.min(xMinLimit + textSize.height / 2, xMaxLimit + textSize.height / 2);
                            } else {
                ...
                if (orientation === "horizontal") {
                    ...
                    if (direction > 0) y = Math.max(indexLabel.point.y - textSize.height / 2 - offsetY, plotArea.y1 + textSize.height / 2);else y = Math.min(indexLabel.point.y + textSize.height / 2 + offsetY, plotArea.y2 - textSize.height / 2);
                } else if (orientation === "vertical") {
                    ...
                    if (direction > 0) y = Math.max(indexLabel.point.y - offsetY, plotArea.y1 + textSize.width);else y = Math.min(indexLabel.point.y + textSize.width + offsetY, plotArea.y2);
        ...
        function renderBezier(pixels) {
            ...
            if (bp.length > 0) {
                ...
                for (var i = 0; i < bp.length - 3; i += 3) {
                    ...
                    if (isCanvasSupported) ghostCtx.bezierCurveTo(bp[i + 1].x, bp[i + 1].y, bp[i + 2].x, bp[i + 2].y, bp[i + 3].x, bp[i + 3].y);
        ...
        for (var j = 0; j < plotUnit.dataSeriesIndexes.length; j++) {
            ...
            if (dataPoints.length > 0) {
                ...
                for (i = 0; i < dataPoints.length; i++) {
                    ...
                    if (isCanvasSupported) drawRect(this._eventManager.ghostCtx, x1, y1, x2, y2, color, 0, null, false, false, false, false);
    ...
    Chart.prototype.renderArea = function (plotUnit) {
        ...
        function closeArea() {
            ...
            if (plotUnit.axisY.minimum <= 0 && plotUnit.axisY.maximum >= 0) {
                baseY = yZeroToPixel;
            } else if (plotUnit.axisY.maximum < 0) baseY = axisYProps.y1;else if (plotUnit.axisY.minimum > 0) baseY = axisXProps.y2;
        ...
        for (var j = 0; j < plotUnit.dataSeriesIndexes.length; j++) {
            ...
            if (allXValues.length > 0) {
                ...
                for (i = 0; i < allXValues.length; i++) {
                    ...
                    if (dataSeries.dataPointIndexes[dataPointX] >= 0) dataPoint = dataPoints[dataSeries.dataPointIndexes[dataPointX]];else dataPoint = { x: dataPointX, y: 0 };
        ...
        for (var j = 0; j < plotUnit.dataSeriesIndexes.length; j++) {
            ...
            if (dataPoints.length > 0) {
                ...
                for (var i = 0; i < dataPoints.length; i++) {
                    ...
                    if (isCanvasSupported) RenderHelper.drawMarker(x, y, this._eventManager.ghostCtx, markerProps.type, markerProps.size, markerColor, markerColor, markerProps.borderThickness);
        ...
        for (var j = 0; j < plotUnit.dataSeriesIndexes.length; j++) {
            ...
            if (dataPoints.length > 0) {
                ...
                for (var i = 0; i < dataPoints.length; i++) {
                    ...
                    if (isCanvasSupported) {
                        RenderHelper.drawMarker(markerProps.x, markerProps.y, this._eventManager.ghostCtx, markerProps.type, markerProps.size, markerColor, markerColor, markerProps.borderThickness);
                    }
    ...
    Chart.prototype.renderPie = function (plotUnit) {
        ...
        function animate(fractionComplete) {
            ...
            for (var i = 0; i < dataPoints.length; i++) {
                ...
                if (endAngle > startAngle) drawSegment(_this.plotArea.ctx, dataPointEOs[i].center, dataPointEOs[i].radius, color, dataSeries.type, startAngle, endAngle, dataSeries.fillOpacity);
                    ...
                    if (otherDataPointIndex !== null) {
                        ...
                        if (distanceFromOtherLabel - tempOffset < minDistanceBetweenLabels) {
                            ...
                            if (+otherDataPointActualOffset.toFixed(precision) > +otherDataPointOffset.toFixed(precision)) {
                                ...
                                if (distanceFromOtherLabel > minDistanceBetweenLabels) actualOffset = -(distanceFromOtherLabel - minDistanceBetweenLabels);else actualOffset = -(tempOffset - (otherDataPointActualOffset - otherDataPointOffset));
                            }
                        }
                    }
                    ...
                    if (otherDataPointIndex !== null) {
                        ...
                        if (distanceFromOtherLabel - tempOffset < minDistanceBetweenLabels) {
                            ...
                            if (+otherDataPointActualOffset.toFixed(precision) < +otherDataPointOffset.toFixed(precision)) {
                                ...
                                if (distanceFromOtherLabel > minDistanceBetweenLabels) actualOffset = distanceFromOtherLabel - minDistanceBetweenLabels;else actualOffset = tempOffset - (otherDataPointOffset - otherDataPointActualOffset);
                            }
                        }
                    }
                }
            ...
            for (j = 0; j < 10 && (j < 1 || deltaR > 0); j++) {
                ...
                for (var k = 0; k < dataPoints.length; k++) {
                    ...
                    if (distanceFromNextLabel < 0 && areDataPointsTooClose(currentDataPoint, nextDataPoint)) {
                        ...
                        if (nextLabelIndex !== overlapStartIndex) overlapEndIndex = nextLabelIndex;
    ...
    Legend.prototype.render = function () {
        ...
        if (this.verticalAlign === "top") {
            if (this.horizontalAlign === "left") left = freeSpace.x1 + 2;else if (this.horizontalAlign === "right") left = freeSpace.x2 - this.width - 2;else left = freeSpace.x1 + freeSpace.width / 2 - this.width / 2;
    ...
    function Axis(chart, options, type, position) {
        ...
        if (this.hasOptionChanged("minimum")) this.sessionVariables.internalMinimum = this.minimum;

        if (this.hasOptionChanged("maximum")) this.sessionVariables.internalMaximum = this.maximum;
        ...
        if ((this._position === "bottom" || this._position === "top") && this.interlacedColor) {
            ...
            for (i = 0; i < this._labels.length; i++) {
                ...
                if (renderInterlacedGrid) {
                    ...
                    if (i + 1 >= this._labels.length) interlacedGridEndPoint = this.getPixelCoordinatesOnAxis(this.maximum);else interlacedGridEndPoint = this.getPixelCoordinatesOnAxis(this._labels[i + 1].position);
            ...
            for (i = 0; i < this._labels.length; i++) {
                ...
                if (renderInterlacedGrid) {
                    ...
                    if (i + 1 >= this._labels.length) interlacedGridStartPoint = this.getPixelCoordinatesOnAxis(this.maximum);else interlacedGridStartPoint = this.getPixelCoordinatesOnAxis(this._labels[i + 1].position);
    ...
    Axis.prototype.renderStripLinesOfThicknessType = function (thicknessType) {
        ...
        for (i = 0; i < this.stripLines.length; i++) {
            ...
            if (thicknessType === "pixel" && (stripLine.value < this.minimum || stripLine.value > this.maximum)) continue;
    ...
    Axis.prototype.calculateAxisParameters = function () {
        ...
        if (this.type === "axisX" && this.chart.plotInfo.axisXValueType === "dateTime") {
            ...
            if (this.sessionVariables.internalMinimum !== null) this.minimum = this.sessionVariables.internalMinimum;else {
                this.minimum = min - minDiff / 2;
            }

            if (this.sessionVariables.internalMaximum) this.maximum = this.sessionVariables.internalMaximum;else this.maximum = max + minDiff / 2;
            ...
            if (this.sessionVariables.internalMinimum !== null) this.minimum = this.sessionVariables.internalMinimum;else this.minimum = Math.floor(min / this.interval) * this.interval;

            if (this.sessionVariables.internalMaximum !== null) this.maximum = this.sessionVariables.internalMaximum;else this.maximum = Math.ceil(max / this.interval) * this.interval;
    ...
    Axis.prototype.getLabelStartPoint = function () {
        ...
        if (this.intervalType === "millisecond") {} else if (this.intervalType === "second") {
    ...
    ToolTip.prototype._updateToolTip = function (mouseX, mouseY) {
        ...
        if (this.shared && this.chart.plotInfo.axisPlacement !== "none") {
            ...
            if (this.currentSeriesIndex >= 0) {
                ...
                } else if (dataSeries.type === "line" || dataSeries.type === "stepLine" || dataSeries.type === "spline" || dataSeries.type === "area" || dataSeries.type === "stepArea" || dataSeries.type === "splineArea" || dataSeries.type === "stackedArea" || dataSeries.type === "stackedArea100" || dataSeries.type === "rangeArea" || dataSeries.type === "rangeSplineArea" || dataSeries.type === "candlestick" || dataSeries.type === "ohlc") {
