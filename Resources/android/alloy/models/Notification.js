    ...
    extendCollection: function(Collection) {
        _.extend(Collection.prototype, {
            ...
            addData: function(entry) {
                ...
                db = Ti.Database.open(collection.config.adapter.db_name);
                var res = db.execute(sql);
                if (res.isValidRow()) sql_query = "UPDATE " + collection.config.adapter.collection_name + " SET member_no='" + entry.member_no + "', subject='" + entry.subject + "', message='" + entry.message + "' , url='" + entry.url + "' ,status='" + entry.status + "' ,  expired='" + entry.expired + "', updated='" + entry.updated + "' WHERE id='" + entry.id + "' "; else {
