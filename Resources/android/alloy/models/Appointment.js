    ...
    extendCollection: function(Collection) {
        _.extend(Collection.prototype, {
            ...
            getAppointmentList: function(ex) {
                var query_doctor_panel_id = "undefined" != typeof ex.doctor_panel_id ? " AND appointment.doctor_panel_id= ? " : "";
                var query_start_date = "undefined" != typeof ex.start_date ? " AND appointment.start_date >= ? AND appointment.start_date < ? " : "";
                var query_uid = "undefined" != typeof ex.u_id ? " AND appointment.u_id=?" : "";
                var collection = this;
                ...
                if ("undefined" != typeof ex.doctor_panel_id) var res = db.execute(sql, ex.doctor_panel_id, ex.start_date, ex.end_date); else {
                    console.log("wrong");
