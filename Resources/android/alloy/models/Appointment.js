    ...
    extendCollection: function(Collection) {
        _.extend(Collection.prototype, {
            ...
            getAppointmentList: function(ex) {
                var query_clinicid = "undefined" != typeof ex.clinicId ? " AND appointment.clinic_id= ? " : "";
                var query_specialty = "undefined" != typeof ex.specialty ? " AND appointment.specialty= ? " : "";
                var query_start_date = "undefined" != typeof ex.start_date ? " AND appointment.start_date >= ? AND appointment.start_date < ? " : "";
                var collection = this;
                ...
                if ("undefined" != typeof ex.clinicId) var res = db.execute(sql, ex.clinicId, ex.specialty, ex.start_date, ex.end_date); else var res = db.execute(sql);
                var listArr = [];
                var count = 0;
