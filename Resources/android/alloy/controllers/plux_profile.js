...
function Controller() {
  ...
  { barColor: "transparent", backgroundColor: "#535a74", orientationModes: [Ti.UI.PORTRAIT], fullscreen: false, windowSoftInputMode: Ti.UI.Android.SOFT_INPUT_STATE_HIDDEN, title: "PLUX Profile", id: "plux_profile", backButtonTitle: "", navTintColor: "#CE1D1C" });

  $.__views["plux_profile"] && $.addTopLevelView($.__views["plux_profile"]);
  $.__views["__alloyId715"] = Ti.UI.createView(
  { borderWidth: 0, layout: "vertical", id: "__alloyId715" });

  $.__views["plux_profile"].add($.__views["__alloyId715"]);
  if (true) {
    $.__views["__alloyId716"] = Ti.UI.createView(
    { borderWidth: 0, layout: "horizontal", height: 50, width: Ti.UI.FILL, backgroundColor: "#DEDEDE", id: "__alloyId716" });

    $.__views["__alloyId715"].add($.__views["__alloyId716"]);
    $.__views["__alloyId717"] = Ti.UI.createView(
    { borderWidth: 0, left: 0, width: "10%", id: "__alloyId717" });
    ...
    { width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#111111", font: { fontFamily: "Roboto-Regular, arial", fontSize: "16dp" }, text: 'PLUX Profile', textAlign: "center", id: "__alloyId718" });
...
//# sourceMappingURL=file://c:\Users\Danial Haikal\Documents\Appcelerator_Studio_Workspace\plux/build/map/Resources\android\alloy\controllers\plux_profile.js.map