...
function Controller() {
    ...
    $.__views.win.add($.__views.__alloyId328);
    ...
    closeWindow ? $.addListener($.__views.__alloyId329, "click", closeWindow) : __defers["$.__views.__alloyId329!click!closeWindow"] = true;
    ...
    $.__views.__alloyId328.add($.__views.surveyView);
    ...
    $.__views.defaultMsgView.add($.__views.__alloyId330);
