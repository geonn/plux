...
function Controller() {
	...
	$.__views.__alloyId718.add($.__views.moreHealth);
	$.__views.myhealth.rightNavButton = $.__views.__alloyId718;$.__views.main = Ti.UI.createView(
	...
	if (true) {
		...
		{ layout: "horizontal", width: Ti.UI.FILL, height: 50, backgroundColor: "#DEDEDE", id: "__alloyId719" });

		$.__views.main.add($.__views.__alloyId719);
		$.__views.__alloyId720 = Ti.UI.createView(
		{ left: 0, width: "10%", id: "__alloyId720" });
		...
		{ width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'Health Info', textAlign: "center", id: "__alloyId721" });

		$.__views.pageTitle.add($.__views.__alloyId721);
		$.__views.__alloyId722 = Ti.UI.createView(
		{ width: "10%", id: "__alloyId722" });

		$.__views.__alloyId719.add($.__views.__alloyId722);
		$.__views.moreHealth = Ti.UI.createImageView(
		{ id: "moreHealth", width: 30, image: "/images/health_love.png" });

		$.__views.__alloyId722.add($.__views.moreHealth);
	}
	...
	getDataByType ? $.addListener($.__views.bmiWebView, 'load', getDataByType) : __defers['$.__views.bmiWebView!load!getDataByType'] = true;$.__views.__alloyId723 = Ti.UI.createView(
	{ touchEnabled: false, height: 1, left: 10, right: 10, bottom: 0, backgroundColor: "#dfe0e4", width: Ti.UI.FILL, id: "__alloyId723" });

	$.__views.bmiView.add($.__views.__alloyId723);
	$.__views.__alloyId724 = Ti.UI.createView(
	{ touchEnabled: false, height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId724" });

	$.__views.bmiView.add($.__views.__alloyId724);
	$.__views.__alloyId725 = Ti.UI.createLabel(
	{ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#9197a3", text: 'Latest', touchEnabled: false, font: "fontSize: 12", left: 0, id: "__alloyId725" });
	...
	$.__views.__alloyId724.add($.__views.bmiDetailLabel);
