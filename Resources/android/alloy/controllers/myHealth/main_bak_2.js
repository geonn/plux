...
function Controller() {
	...
	$.__views.__alloyId703.add($.__views.moreHealth);
	$.__views.myhealth.rightNavButton = $.__views.__alloyId703;$.__views.main = Ti.UI.createView(
	...
	if (true) {
		...
		{ layout: "horizontal", width: Ti.UI.FILL, height: 50, backgroundColor: "#DEDEDE", id: "__alloyId704" });

		$.__views.main.add($.__views.__alloyId704);
		$.__views.__alloyId705 = Ti.UI.createView(
		{ left: 0, width: "10%", id: "__alloyId705" });

		$.__views.__alloyId704.add($.__views.__alloyId705);
		$.__views.btnBack = Ti.UI.createImageView(
		{ left: 10, id: "btnBack", width: 25, height: 25, image: "/images/btn-back.png" });

		$.__views.__alloyId705.add($.__views.btnBack);
		$.__views.pageTitle = Ti.UI.createView(
		{ id: "pageTitle", width: "80%" });

		$.__views.__alloyId704.add($.__views.pageTitle);
		$.__views.__alloyId706 = Ti.UI.createLabel(
		{ width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'Health Info', textAlign: "center", id: "__alloyId706" });

		$.__views.pageTitle.add($.__views.__alloyId706);
		$.__views.__alloyId707 = Ti.UI.createView(
		{ width: "10%", id: "__alloyId707" });
	...
	getDataByType ? $.addListener($.__views.bmiWebView, 'load', getDataByType) : __defers['$.__views.bmiWebView!load!getDataByType'] = true;$.__views.__alloyId708 = Ti.UI.createView(
	{ touchEnabled: false, height: 1, left: 10, right: 10, bottom: 0, backgroundColor: "#dfe0e4", width: Ti.UI.FILL, id: "__alloyId708" });

	$.__views.bmiView.add($.__views.__alloyId708);
	$.__views.__alloyId709 = Ti.UI.createView(
	{ touchEnabled: false, height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId709" });

	$.__views.bmiView.add($.__views.__alloyId709);
	$.__views.__alloyId710 = Ti.UI.createLabel(
	{ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#9197a3", text: 'Latest', touchEnabled: false, font: "fontSize: 12", left: 0, id: "__alloyId710" });
	...
	$.__views.__alloyId709.add($.__views.bmiDetailLabel);
