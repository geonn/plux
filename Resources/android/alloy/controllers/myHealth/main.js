...
function Controller() {
    ...
    $.__views.__alloyId751.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId751;
    $.__views.__alloyId752 = Ti.UI.createView({
        id: "__alloyId752"
    });
    $.__views.myhealth.add($.__views.__alloyId752);
    ...
    $.__views.__alloyId752.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId753);
    $.__views.main = Ti.UI.createView({
        id: "main",
        layout: "vertical",
        backgroundColor: "#ffffff"
    });
    $.__views.__alloyId752.add($.__views.main);
    ...
    $.__views.__alloyId755.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "80%"
    });
    $.__views.__alloyId754.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId756);
    ...
    $.__views.__alloyId757.add($.__views.moreHealth);
    ...
    $.__views.bmiView.add($.__views.__alloyId758);
    ...
    $.__views.bmiView.add($.__views.__alloyId759);
    ...
    $.__views.__alloyId759.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId761);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId762);
    ...
    $.__views.__alloyId762.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId764);
    ...
    $.__views.heartRateView.add($.__views.__alloyId765);
    ...
    $.__views.__alloyId765.add($.__views.heartRateDetailLabel);
    ...
    $.__views.glucoseView.add($.__views.__alloyId767);
    ...
    $.__views.glucoseView.add($.__views.__alloyId768);
    ...
    $.__views.__alloyId768.add($.__views.glucoseDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId770);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId771);
    ...
    $.__views.__alloyId771.add($.__views.cholestrolDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId773);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId774);
    ...
    $.__views.__alloyId774.add($.__views.bodyTempDetailLabel);
