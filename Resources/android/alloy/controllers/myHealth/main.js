...
function Controller() {
    ...
    $.__views.__alloyId284.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId284;
    $.__views.__alloyId285 = Ti.UI.createView({
        id: "__alloyId285"
    });
    $.__views.myhealth.add($.__views.__alloyId285);
    ...
    $.__views.__alloyId285.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId286);
    $.__views.main = Ti.UI.createView({
        id: "main",
        layout: "vertical",
        backgroundColor: "#ffffff"
    });
    $.__views.__alloyId285.add($.__views.main);
    ...
    $.__views.__alloyId288.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "80%"
    });
    $.__views.__alloyId287.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId289);
    ...
    $.__views.__alloyId290.add($.__views.moreHealth);
    ...
    $.__views.bmiView.add($.__views.__alloyId291);
    ...
    $.__views.bmiView.add($.__views.__alloyId292);
    ...
    $.__views.__alloyId292.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId294);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId295);
    ...
    $.__views.__alloyId295.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId297);
    ...
    $.__views.heartRateView.add($.__views.__alloyId298);
    ...
    $.__views.__alloyId298.add($.__views.heartRateDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId300);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId301);
    ...
    $.__views.__alloyId301.add($.__views.bodyTempDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId303);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId304);
    ...
    $.__views.__alloyId304.add($.__views.cholestrolDetailLabel);
