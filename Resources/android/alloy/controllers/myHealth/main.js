...
function Controller() {
    ...
    $.__views.__alloyId615.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId615;
    $.__views.__alloyId616 = Ti.UI.createView({
        id: "__alloyId616"
    });
    $.__views.myhealth.add($.__views.__alloyId616);
    ...
    $.__views.__alloyId616.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId617);
    $.__views.main = Ti.UI.createView({
        id: "main",
        layout: "vertical",
        backgroundColor: "#ffffff"
    });
    $.__views.__alloyId616.add($.__views.main);
    ...
    $.__views.__alloyId619.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId620);
    ...
    $.__views.__alloyId621.add($.__views.moreHealth);
    ...
    $.__views.bmiView.add($.__views.__alloyId622);
    ...
    $.__views.bmiView.add($.__views.__alloyId623);
    ...
    $.__views.__alloyId623.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId625);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId626);
    ...
    $.__views.__alloyId626.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId628);
    ...
    $.__views.heartRateView.add($.__views.__alloyId629);
    ...
    $.__views.__alloyId629.add($.__views.heartRateDetailLabel);
    ...
    $.__views.glucoseView.add($.__views.__alloyId631);
    ...
    $.__views.glucoseView.add($.__views.__alloyId632);
    ...
    $.__views.__alloyId632.add($.__views.glucoseDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId634);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId635);
    ...
    $.__views.__alloyId635.add($.__views.cholestrolDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId637);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId638);
    ...
    $.__views.__alloyId638.add($.__views.bodyTempDetailLabel);
