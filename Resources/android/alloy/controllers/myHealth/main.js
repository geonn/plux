...
function Controller() {
    ...
    $.__views.__alloyId705.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId705;
    $.__views.__alloyId706 = Ti.UI.createView({
        id: "__alloyId706"
    });
    $.__views.myhealth.add($.__views.__alloyId706);
    ...
    $.__views.__alloyId706.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId707);
    $.__views.main = Ti.UI.createView({
        id: "main",
        layout: "vertical",
        backgroundColor: "#ffffff"
    });
    $.__views.__alloyId706.add($.__views.main);
    ...
    $.__views.__alloyId709.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId710);
    ...
    $.__views.__alloyId711.add($.__views.moreHealth);
    ...
    $.__views.bmiView.add($.__views.__alloyId712);
    ...
    $.__views.bmiView.add($.__views.__alloyId713);
    ...
    $.__views.__alloyId713.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId715);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId716);
    ...
    $.__views.__alloyId716.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId718);
    ...
    $.__views.heartRateView.add($.__views.__alloyId719);
    ...
    $.__views.__alloyId719.add($.__views.heartRateDetailLabel);
    ...
    $.__views.glucoseView.add($.__views.__alloyId721);
    ...
    $.__views.glucoseView.add($.__views.__alloyId722);
    ...
    $.__views.__alloyId722.add($.__views.glucoseDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId724);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId725);
    ...
    $.__views.__alloyId725.add($.__views.cholestrolDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId727);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId728);
    ...
    $.__views.__alloyId728.add($.__views.bodyTempDetailLabel);
