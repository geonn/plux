...
function Controller() {
    ...
    $.__views.__alloyId528.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId528;
    $.__views.__alloyId529 = Ti.UI.createView({
        id: "__alloyId529"
    });
    $.__views.myhealth.add($.__views.__alloyId529);
    ...
    $.__views.__alloyId529.add($.__views.loadingBar);
    ...
    $.__views.__alloyId529.add($.__views.main);
    ...
    $.__views.__alloyId534.add($.__views.moreHealth);
    ...
    $.__views.bmiView.add($.__views.__alloyId535);
    ...
    $.__views.__alloyId536.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId538);
    ...
    $.__views.__alloyId539.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId541);
    ...
    $.__views.__alloyId542.add($.__views.heartRateDetailLabel);
    ...
    $.__views.glucoseView.add($.__views.__alloyId544);
    ...
    $.__views.__alloyId545.add($.__views.glucoseDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId547);
    ...
    $.__views.__alloyId548.add($.__views.cholestrolDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId550);
    ...
    $.__views.__alloyId551.add($.__views.bodyTempDetailLabel);
