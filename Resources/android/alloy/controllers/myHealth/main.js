...
function Controller() {
    ...
    $.__views.__alloyId708.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId708;
    $.__views.__alloyId709 = Ti.UI.createView({
        id: "__alloyId709"
    });
    $.__views.myhealth.add($.__views.__alloyId709);
    ...
    $.__views.__alloyId709.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId710);
    ...
    $.__views.__alloyId714.add($.__views.moreHealth);
    ...
    $.__views.bmiView.add($.__views.__alloyId716);
    ...
    $.__views.__alloyId716.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId719);
    ...
    $.__views.__alloyId719.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId722);
    ...
    $.__views.__alloyId722.add($.__views.heartRateDetailLabel);
    ...
    $.__views.glucoseView.add($.__views.__alloyId725);
    ...
    $.__views.__alloyId725.add($.__views.glucoseDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId728);
    ...
    $.__views.__alloyId728.add($.__views.cholestrolDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId731);
    ...
    $.__views.__alloyId731.add($.__views.bodyTempDetailLabel);
