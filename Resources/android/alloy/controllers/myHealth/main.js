...
function Controller() {
    ...
    $.__views.__alloyId752.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId752;
    $.__views.__alloyId753 = Ti.UI.createView({
        id: "__alloyId753"
    });
    $.__views.myhealth.add($.__views.__alloyId753);
    ...
    $.__views.__alloyId753.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId754);
    $.__views.main = Ti.UI.createView({
        id: "main",
        layout: "vertical",
        backgroundColor: "#ffffff"
    });
    $.__views.__alloyId753.add($.__views.main);
    ...
    $.__views.__alloyId758.add($.__views.moreHealth);
    ...
    $.__views.bmiView.add($.__views.__alloyId760);
    ...
    $.__views.__alloyId760.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId763);
    ...
    $.__views.__alloyId763.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId766);
    ...
    $.__views.__alloyId766.add($.__views.heartRateDetailLabel);
    ...
    $.__views.glucoseView.add($.__views.__alloyId769);
    ...
    $.__views.__alloyId769.add($.__views.glucoseDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId772);
    ...
    $.__views.__alloyId772.add($.__views.cholestrolDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId775);
    ...
    $.__views.__alloyId775.add($.__views.bodyTempDetailLabel);
