...
function Controller() {
    ...
    $.__views.__alloyId279.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId279;
    $.__views.__alloyId280 = Ti.UI.createView({
        id: "__alloyId280"
    });
    $.__views.myhealth.add($.__views.__alloyId280);
    ...
    $.__views.bmiView.add($.__views.__alloyId286);
    ...
    $.__views.bmiView.add($.__views.__alloyId287);
    ...
    $.__views.__alloyId287.add($.__views.bmiDetailLabel);
    ...
    $.__views.__alloyId290.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.__alloyId293.add($.__views.heartRateDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId296);
    ...
    $.__views.__alloyId296.add($.__views.bodyTempDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId298);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId299);
    ...
    $.__views.__alloyId299.add($.__views.cholestrolDetailLabel);
