...
function Controller() {
    ...
    $.__views.__alloyId438.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId438;
    $.__views.__alloyId439 = Ti.UI.createView({
        id: "__alloyId439"
    });
    $.__views.myhealth.add($.__views.__alloyId439);
    ...
    $.__views.__alloyId439.add($.__views.loadingBar);
    ...
    $.__views.__alloyId444.add($.__views.moreHealth);
    ...
    $.__views.bmiView.add($.__views.__alloyId445);
    ...
    $.__views.bmiView.add($.__views.__alloyId446);
    ...
    $.__views.__alloyId446.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId448);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId449);
    ...
    $.__views.__alloyId449.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId451);
    ...
    $.__views.heartRateView.add($.__views.__alloyId452);
    ...
    $.__views.__alloyId452.add($.__views.heartRateDetailLabel);
    ...
    $.__views.glucoseView.add($.__views.__alloyId454);
    ...
    $.__views.glucoseView.add($.__views.__alloyId455);
    ...
    $.__views.__alloyId455.add($.__views.glucoseDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId457);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId458);
    ...
    $.__views.__alloyId458.add($.__views.cholestrolDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId460);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId461);
    ...
    $.__views.__alloyId461.add($.__views.bodyTempDetailLabel);
