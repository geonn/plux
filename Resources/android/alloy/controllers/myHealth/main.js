...
function Controller() {
    ...
    $.__views.myhealth.rightNavButton = $.__views.__alloyId767;
    $.__views.__alloyId768 = Ti.UI.createView({
        id: "__alloyId768"
    });
    $.__views.myhealth.add($.__views.__alloyId768);
    ...
    $.__views.__alloyId768.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId769);
    $.__views.main = Ti.UI.createView({
        id: "main",
        layout: "vertical",
        backgroundColor: "#ffffff"
    });
    $.__views.__alloyId768.add($.__views.main);
    ...
    $.__views.__alloyId773.add($.__views.moreHealth);
    ...
    $.__views.bmiView.add($.__views.__alloyId774);
    ...
    $.__views.bmiView.add($.__views.__alloyId775);
    ...
    $.__views.__alloyId775.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId777);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId778);
    ...
    $.__views.__alloyId778.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId780);
    ...
    $.__views.heartRateView.add($.__views.__alloyId781);
    ...
    $.__views.__alloyId781.add($.__views.heartRateDetailLabel);
    ...
    $.__views.glucoseView.add($.__views.__alloyId783);
    ...
    $.__views.glucoseView.add($.__views.__alloyId784);
    ...
    $.__views.__alloyId784.add($.__views.glucoseDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId786);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId787);
    ...
    $.__views.__alloyId787.add($.__views.cholestrolDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId789);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId790);
    ...
    $.__views.__alloyId790.add($.__views.bodyTempDetailLabel);
