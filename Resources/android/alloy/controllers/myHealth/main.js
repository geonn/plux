...
function Controller() {
    ...
    $.__views.__alloyId455.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId455;
    $.__views.__alloyId456 = Ti.UI.createView({
        id: "__alloyId456"
    });
    $.__views.myhealth.add($.__views.__alloyId456);
    ...
    $.__views.__alloyId456.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId457);
    $.__views.main = Ti.UI.createView({
        id: "main",
        layout: "vertical",
        backgroundColor: "#ffffff"
    });
    $.__views.__alloyId456.add($.__views.main);
    ...
    $.__views.__alloyId459.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "80%"
    });
    $.__views.__alloyId458.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId460);
    ...
    $.__views.__alloyId461.add($.__views.moreHealth);
    ...
    $.__views.bmiView.add($.__views.__alloyId462);
    ...
    $.__views.bmiView.add($.__views.__alloyId463);
    ...
    $.__views.__alloyId463.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId465);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId466);
    ...
    $.__views.__alloyId466.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId468);
    ...
    $.__views.heartRateView.add($.__views.__alloyId469);
    ...
    $.__views.__alloyId469.add($.__views.heartRateDetailLabel);
    ...
    $.__views.glucoseView.add($.__views.__alloyId471);
    ...
    $.__views.glucoseView.add($.__views.__alloyId472);
    ...
    $.__views.__alloyId472.add($.__views.glucoseDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId474);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId475);
    ...
    $.__views.__alloyId475.add($.__views.cholestrolDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId477);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId478);
    ...
    $.__views.__alloyId478.add($.__views.bodyTempDetailLabel);
