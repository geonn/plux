...
function Controller() {
    ...
    $.__views.__alloyId397.add($.__views.moreHealth);
    $.__views.myhealth.rightNavButton = $.__views.__alloyId397;
    $.__views.__alloyId398 = Ti.UI.createView({
        id: "__alloyId398"
    });
    $.__views.myhealth.add($.__views.__alloyId398);
    ...
    $.__views.__alloyId398.add($.__views.loadingBar);
    ...
    $.__views.__alloyId398.add($.__views.main);
    ...
    $.__views.pageTitle.add($.__views.__alloyId402);
    ...
    $.__views.__alloyId403.add($.__views.moreHealth);
    ...
    $.__views.bmiView.add($.__views.__alloyId404);
    ...
    $.__views.bmiView.add($.__views.__alloyId405);
    ...
    $.__views.__alloyId405.add($.__views.bmiDetailLabel);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId407);
    ...
    $.__views.bloodPressureView.add($.__views.__alloyId408);
    ...
    $.__views.__alloyId408.add($.__views.bloodPressureDetailLabel);
    ...
    $.__views.heartRateView.add($.__views.__alloyId410);
    ...
    $.__views.heartRateView.add($.__views.__alloyId411);
    ...
    $.__views.__alloyId411.add($.__views.heartRateDetailLabel);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId413);
    ...
    $.__views.bodyTemperatureView.add($.__views.__alloyId414);
    ...
    $.__views.__alloyId414.add($.__views.bodyTempDetailLabel);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId416);
    ...
    $.__views.cholestrolView.add($.__views.__alloyId417);
    ...
    $.__views.__alloyId417.add($.__views.cholestrolDetailLabel);
