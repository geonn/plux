...
function Controller() {
    ...
    $.__views.__alloyId732.add($.__views.editButton);
    ...
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId732;
    ...
    $.__views.__alloyId734.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "70%"
    });
    $.__views.__alloyId733.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId735);
    ...
    $.__views.__alloyId736.add($.__views.editButton);
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId736.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    var __alloyId737 = [];
    ...
    __alloyId737.push($.__views.tvrFieldDate);
    ...
    $.__views.tvrFieldDate.add($.__views.__alloyId738);
    ...
    $.__views.__alloyId738.add($.__views.date_value);
    ...
    __alloyId737.push($.__views.tvrFieldGender);
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId740);
    ...
    $.__views.__alloyId740.add($.__views.gender_value);
    ...
    __alloyId737.push($.__views.tvrFieldBloodType);
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId742);
    ...
    $.__views.__alloyId742.add($.__views.bloodType_value);
