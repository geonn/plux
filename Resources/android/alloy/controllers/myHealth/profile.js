...
function Controller() {
    ...
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId791;
    ...
    $.__views.__alloyId793.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "70%"
    });
    $.__views.__alloyId792.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId794);
    ...
    $.__views.__alloyId795.add($.__views.editButton);
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId795.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    var __alloyId796 = [];
    ...
    __alloyId796.push($.__views.tvrFieldDate);
    ...
    $.__views.tvrFieldDate.add($.__views.__alloyId797);
    ...
    $.__views.__alloyId797.add($.__views.date_value);
    ...
    __alloyId796.push($.__views.tvrFieldGender);
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId799);
    ...
    $.__views.__alloyId799.add($.__views.gender_value);
    ...
    __alloyId796.push($.__views.tvrFieldBloodType);
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId801);
    ...
    $.__views.__alloyId801.add($.__views.bloodType_value);
