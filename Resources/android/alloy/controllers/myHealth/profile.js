...
function Controller() {
    ...
    $.__views.__alloyId823.add($.__views.editButton);
    ...
    $.__views.__alloyId823.add($.__views.saveButton);
    ...
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId823;
    ...
    $.__views.__alloyId825.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "70%"
    });
    $.__views.__alloyId824.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId826);
    ...
    $.__views.__alloyId827.add($.__views.editButton);
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId827.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    var __alloyId828 = [];
    ...
    __alloyId828.push($.__views.tvrFieldDate);
    ...
    $.__views.tvrFieldDate.add($.__views.__alloyId829);
    ...
    $.__views.__alloyId829.add($.__views.date_value);
    ...
    __alloyId828.push($.__views.tvrFieldGender);
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId831);
    ...
    $.__views.__alloyId831.add($.__views.gender_value);
    ...
    __alloyId828.push($.__views.tvrFieldBloodType);
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId833);
    ...
    $.__views.__alloyId833.add($.__views.bloodType_value);
