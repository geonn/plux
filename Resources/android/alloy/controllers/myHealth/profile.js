...
function Controller() {
    ...
    $.__views.__alloyId237.add($.__views.editButton);
    ...
    $.__views.__alloyId237.add($.__views.saveButton);
    ...
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId237;
    ...
    $.__views.__alloyId241.add($.__views.editButton);
    doEditRecords ? $.__views.editButton.addEventListener("touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.saveButton = Ti.UI.createButton({
        touchEnabled: true,
        id: "saveButton",
    ...
    __alloyId242.push($.__views.tvrFieldDate);
    ...
    $.__views.tvrFieldDate.add($.__views.__alloyId243);
    ...
    $.__views.__alloyId243.add($.__views.date_value);
    $.__views.tvrFieldGender = Ti.UI.createTableViewRow({
        id: "tvrFieldGender",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId242.push($.__views.tvrFieldGender);
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId245);
    ...
    $.__views.__alloyId245.add($.__views.gender_value);
    $.__views.tvrFieldBloodType = Ti.UI.createTableViewRow({
        id: "tvrFieldBloodType",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId242.push($.__views.tvrFieldBloodType);
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId247);
    ...
    $.__views.__alloyId247.add($.__views.bloodType_value);
