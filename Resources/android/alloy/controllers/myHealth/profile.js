...
function Controller() {
    ...
    $.__views.__alloyId790.add($.__views.editButton);
    ...
    $.__views.__alloyId790.add($.__views.saveButton);
    ...
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId790;
    ...
    $.__views.__alloyId794.add($.__views.editButton);
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId794.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    var __alloyId795 = [];
    ...
    __alloyId795.push($.__views.tvrFieldDate);
    ...
    $.__views.tvrFieldDate.add($.__views.__alloyId796);
    ...
    $.__views.__alloyId796.add($.__views.date_value);
    ...
    __alloyId795.push($.__views.tvrFieldGender);
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId798);
    ...
    $.__views.__alloyId798.add($.__views.gender_value);
    ...
    __alloyId795.push($.__views.tvrFieldBloodType);
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId800);
    ...
    $.__views.__alloyId800.add($.__views.bloodType_value);
