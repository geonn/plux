...
function Controller() {
    ...
    $.__views.__alloyId639.add($.__views.editButton);
    ...
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId639;
    ...
    $.__views.__alloyId641.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "70%"
    });
    $.__views.__alloyId640.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId642);
    ...
    $.__views.__alloyId643.add($.__views.editButton);
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    __alloyId644.push($.__views.tvrFieldDate);
    ...
    $.__views.tvrFieldDate.add($.__views.__alloyId645);
    ...
    $.__views.__alloyId645.add($.__views.date_value);
    $.__views.tvrFieldGender = Ti.UI.createTableViewRow({
        id: "tvrFieldGender",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId644.push($.__views.tvrFieldGender);
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId647);
    ...
    $.__views.__alloyId647.add($.__views.gender_value);
    $.__views.tvrFieldBloodType = Ti.UI.createTableViewRow({
        id: "tvrFieldBloodType",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId644.push($.__views.tvrFieldBloodType);
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId649);
    ...
    $.__views.__alloyId649.add($.__views.bloodType_value);
