...
function Controller() {
    ...
    $.__views.__alloyId777.add($.__views.editButton);
    ...
    $.__views.__alloyId777.add($.__views.saveButton);
    ...
    $.__views.healthProfileWin.rightNavButton = $.__views.__alloyId777;
    ...
    $.__views.__alloyId779.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "70%"
    });
    $.__views.__alloyId778.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId780);
    ...
    $.__views.__alloyId781.add($.__views.editButton);
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId781.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    var __alloyId782 = [];
    ...
    __alloyId782.push($.__views.tvrFieldDate);
    ...
    $.__views.tvrFieldDate.add($.__views.__alloyId783);
    ...
    $.__views.__alloyId783.add($.__views.date_value);
    ...
    __alloyId782.push($.__views.tvrFieldGender);
    ...
    $.__views.tvrFieldGender.add($.__views.__alloyId785);
    ...
    $.__views.__alloyId785.add($.__views.gender_value);
    ...
    __alloyId782.push($.__views.tvrFieldBloodType);
    ...
    $.__views.tvrFieldBloodType.add($.__views.__alloyId787);
    ...
    $.__views.__alloyId787.add($.__views.bloodType_value);
