...
function Controller() {
    ...
    $.__views.__alloyId751.add($.__views.saveButton);
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId751;
    ...
    $.__views.__alloyId756.add($.__views.description);
    ...
    $.__views.table.add($.__views.__alloyId757);
    showDatePicker ? $.addListener($.__views.__alloyId757, "click", showDatePicker) : __defers["$.__views.__alloyId757!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId758.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId760);
    $.__views.__alloyId761 = Ti.UI.createView({
        height: Ti.UI.SIZE,
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId761"
    });
    $.__views.table.add($.__views.__alloyId761);
    showTimePicker ? $.addListener($.__views.__alloyId761, "click", showTimePicker) : __defers["$.__views.__alloyId761!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId762.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId765);
    ...
    $.__views.__alloyId765.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId757!click!showDatePicker"] && $.addListener($.__views.__alloyId757, "click", showDatePicker);
    __defers["$.__views.__alloyId761!click!showTimePicker"] && $.addListener($.__views.__alloyId761, "click", showTimePicker);
