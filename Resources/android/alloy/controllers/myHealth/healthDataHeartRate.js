...
<<<<<<< HEAD
    $.__views.__alloyId702.add($.__views.saveButton);
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId702;
=======
    $.__views.__alloyId706.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId706;
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId704.add($.__views.btnBack);
=======
...
<<<<<<< HEAD
    $.__views.__alloyId703.add($.__views.pageTitle);
...
<<<<<<< HEAD
    ...
    $.__views.pageTitle.add($.__views.__alloyId705);
    $.__views.__alloyId706 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId706"
    });
...
<<<<<<< HEAD
    $.__views.__alloyId707.add($.__views.description);
=======
...
<<<<<<< HEAD
    ...
    $.__views.table.add($.__views.__alloyId708);
    showDatePicker ? $.addListener($.__views.__alloyId708, "click", showDatePicker) : __defers["$.__views.__alloyId708!click!showDatePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId709.add($.__views.date_value);
    $.__views.__alloyId711 = Ti.UI.createView({
    ...
    $.__views.table.add($.__views.__alloyId711);
    $.__views.__alloyId712 = Ti.UI.createView({
        height: Ti.UI.SIZE,
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId712"
    ...
    $.__views.table.add($.__views.__alloyId712);
    showTimePicker ? $.addListener($.__views.__alloyId712, "click", showTimePicker) : __defers["$.__views.__alloyId712!click!showTimePicker"] = true;
    $.__views.__alloyId713 = Ti.UI.createView({
        layout: "horizontal",
        height: 45,
        width: "100%",
...
<<<<<<< HEAD
    $.__views.__alloyId713.add($.__views.time_value);
    $.__views.__alloyId715 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
...
<<<<<<< HEAD
    ...
    $.__views.tvrField1.add($.__views.__alloyId716);
...
<<<<<<< HEAD
    $.__views.__alloyId716.add($.__views.field1);
...
>>>>>>> origin/master
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
<<<<<<< HEAD
    __defers["$.__views.__alloyId708!click!showDatePicker"] && $.addListener($.__views.__alloyId708, "click", showDatePicker);
    __defers["$.__views.__alloyId712!click!showTimePicker"] && $.addListener($.__views.__alloyId712, "click", showTimePicker);
=======
