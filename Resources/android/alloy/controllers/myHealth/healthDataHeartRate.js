...
<<<<<<< HEAD
    $.__views.__alloyId726.add($.__views.saveButton);
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId726;
=======
    $.__views.__alloyId724.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId724;
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId728.add($.__views.btnBack);
=======
    $.__views.__alloyId726.add($.__views.btnBack);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId727.add($.__views.pageTitle);
    $.__views.__alloyId729 = Ti.UI.createLabel({
=======
    $.__views.__alloyId725.add($.__views.pageTitle);
...
<<<<<<< HEAD
    ...
    $.__views.pageTitle.add($.__views.__alloyId729);
...
=======
    ...
    $.__views.pageTitle.add($.__views.__alloyId727);
    $.__views.__alloyId728 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId728"
    });
...
<<<<<<< HEAD
    $.__views.__alloyId730.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
...
=======
    $.__views.__alloyId728.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId731.add($.__views.description);
=======
    $.__views.__alloyId729.add($.__views.description);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.table.add($.__views.__alloyId732);
    showDatePicker ? $.addListener($.__views.__alloyId732, "click", showDatePicker) : __defers["$.__views.__alloyId732!click!showDatePicker"] = true;
...
=======
    ...
    $.__views.table.add($.__views.__alloyId730);
    showDatePicker ? $.addListener($.__views.__alloyId730, "click", showDatePicker) : __defers["$.__views.__alloyId730!click!showDatePicker"] = true;
    $.__views.__alloyId731 = Ti.UI.createView({
>>>>>>> origin/master
        layout: "horizontal",
        height: 45,
...
<<<<<<< HEAD
    ...
    $.__views.table.add($.__views.__alloyId735);
    $.__views.__alloyId736 = Ti.UI.createView({
        height: Ti.UI.SIZE,
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId736"
    });
    $.__views.table.add($.__views.__alloyId736);
    showTimePicker ? $.addListener($.__views.__alloyId736, "click", showTimePicker) : __defers["$.__views.__alloyId736!click!showTimePicker"] = true;
...
=======
    ...
    $.__views.table.add($.__views.__alloyId733);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId734, "click", showTimePicker) : __defers["$.__views.__alloyId734!click!showTimePicker"] = true;
    $.__views.__alloyId735 = Ti.UI.createView({
        layout: "horizontal",
        height: 45,
        width: "100%",
...
<<<<<<< HEAD
    $.__views.__alloyId737.add($.__views.time_value);
    ...
    $.__views.table.add($.__views.__alloyId739);
=======
    $.__views.__alloyId735.add($.__views.time_value);
    $.__views.__alloyId737 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
...
<<<<<<< HEAD
    ...
    $.__views.tvrField1.add($.__views.__alloyId740);
...
=======
    ...
    $.__views.tvrField1.add($.__views.__alloyId738);
...
<<<<<<< HEAD
    $.__views.__alloyId740.add($.__views.field1);
    ...
    $.__views.table.add($.__views.__alloyId742);
=======
    $.__views.__alloyId738.add($.__views.field1);
    $.__views.__alloyId740 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
    ...
    $.__views.table.add($.__views.__alloyId740);
>>>>>>> origin/master
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
<<<<<<< HEAD
    __defers["$.__views.__alloyId732!click!showDatePicker"] && $.addListener($.__views.__alloyId732, "click", showDatePicker);
    __defers["$.__views.__alloyId736!click!showTimePicker"] && $.addListener($.__views.__alloyId736, "click", showTimePicker);
=======
    __defers["$.__views.__alloyId730!click!showDatePicker"] && $.addListener($.__views.__alloyId730, "click", showDatePicker);
    __defers["$.__views.__alloyId734!click!showTimePicker"] && $.addListener($.__views.__alloyId734, "click", showTimePicker);
>>>>>>> origin/master
