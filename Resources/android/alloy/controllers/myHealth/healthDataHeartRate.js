...
<<<<<<< HEAD
    $.__views.__alloyId491.add($.__views.saveButton);
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId491;
=======
    $.__views.__alloyId493.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId493;
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId493.add($.__views.btnBack);
=======
...
=======
    $.__views.__alloyId494.add($.__views.pageTitle);
...
<<<<<<< HEAD
    ...
    $.__views.pageTitle.add($.__views.__alloyId494);
    $.__views.__alloyId495 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId495"
    });
...
=======
    ...
    $.__views.pageTitle.add($.__views.__alloyId496);
...
<<<<<<< HEAD
    $.__views.__alloyId495.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId496);
=======
    $.__views.__alloyId497.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId498);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId496.add($.__views.description);
=======
    $.__views.__alloyId498.add($.__views.description);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.table.add($.__views.__alloyId497);
    showDatePicker ? $.addListener($.__views.__alloyId497, "click", showDatePicker) : __defers["$.__views.__alloyId497!click!showDatePicker"] = true;
    $.__views.__alloyId498 = Ti.UI.createView({
=======
    ...
    $.__views.table.add($.__views.__alloyId499);
    showDatePicker ? $.addListener($.__views.__alloyId499, "click", showDatePicker) : __defers["$.__views.__alloyId499!click!showDatePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId498.add($.__views.date_value);
    $.__views.__alloyId500 = Ti.UI.createView({
    ...
    showTimePicker ? $.addListener($.__views.__alloyId501, "click", showTimePicker) : __defers["$.__views.__alloyId501!click!showTimePicker"] = true;
...
=======
    $.__views.__alloyId500.add($.__views.date_value);
    $.__views.__alloyId502 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
    ...
    $.__views.table.add($.__views.__alloyId502);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId503, "click", showTimePicker) : __defers["$.__views.__alloyId503!click!showTimePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId502.add($.__views.time_value);
    $.__views.__alloyId504 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
...
=======
    $.__views.__alloyId504.add($.__views.time_value);
...
<<<<<<< HEAD
    ...
    $.__views.tvrField1.add($.__views.__alloyId505);
...
=======
    ...
    $.__views.tvrField1.add($.__views.__alloyId507);
...
<<<<<<< HEAD
    $.__views.__alloyId505.add($.__views.field1);
    $.__views.__alloyId507 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
...
=======
    $.__views.__alloyId507.add($.__views.field1);
...
>>>>>>> origin/master
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
<<<<<<< HEAD
    __defers["$.__views.__alloyId497!click!showDatePicker"] && $.addListener($.__views.__alloyId497, "click", showDatePicker);
    __defers["$.__views.__alloyId501!click!showTimePicker"] && $.addListener($.__views.__alloyId501, "click", showTimePicker);
=======
    __defers["$.__views.__alloyId499!click!showDatePicker"] && $.addListener($.__views.__alloyId499, "click", showDatePicker);
    __defers["$.__views.__alloyId503!click!showTimePicker"] && $.addListener($.__views.__alloyId503, "click", showTimePicker);
>>>>>>> origin/master
