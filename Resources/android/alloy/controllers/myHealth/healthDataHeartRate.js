...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId727;
    ...
    $.__views.__alloyId732.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId733, "click", showDatePicker) : __defers["$.__views.__alloyId733!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId734.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId737, "click", showTimePicker) : __defers["$.__views.__alloyId737!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId738.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId741);
    ...
    $.__views.__alloyId741.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId733!click!showDatePicker"] && $.addListener($.__views.__alloyId733, "click", showDatePicker);
    __defers["$.__views.__alloyId737!click!showTimePicker"] && $.addListener($.__views.__alloyId737, "click", showTimePicker);
