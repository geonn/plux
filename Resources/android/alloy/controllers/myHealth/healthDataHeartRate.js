...
function Controller() {
    ...
    $.__views.__alloyId242.add($.__views.saveButton);
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId242;
    ...
    $.__views.__alloyId246.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId247.add($.__views.description);
    var __alloyId248 = [];
    $.__views.__alloyId249 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId249"
    });
    __alloyId248.push($.__views.__alloyId249);
    showDatePicker ? $.__views.__alloyId249.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId249!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId250.add($.__views.date_value);
    $.__views.__alloyId252 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId252"
    });
    __alloyId248.push($.__views.__alloyId252);
    showTimePicker ? $.__views.__alloyId252.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId252!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId253.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId248.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId255);
    ...
    $.__views.__alloyId255.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
    __defers["$.__views.__alloyId249!click!showDatePicker"] && $.__views.__alloyId249.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId252!click!showTimePicker"] && $.__views.__alloyId252.addEventListener("click", showTimePicker);
