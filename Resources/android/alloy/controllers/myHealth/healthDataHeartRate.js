...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId710;
    ...
    $.__views.__alloyId711.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId713);
    ...
    $.__views.__alloyId714.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId715.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId716, "click", showDatePicker) : __defers["$.__views.__alloyId716!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId717.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId720, "click", showTimePicker) : __defers["$.__views.__alloyId720!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId721.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId724);
    ...
    $.__views.__alloyId724.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId716!click!showDatePicker"] && $.addListener($.__views.__alloyId716, "click", showDatePicker);
    __defers["$.__views.__alloyId720!click!showTimePicker"] && $.addListener($.__views.__alloyId720, "click", showTimePicker);
