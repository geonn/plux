...
function Controller() {
    ...
    $.__views.__alloyId687.add($.__views.saveButton);
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId687;
    ...
    $.__views.__alloyId689.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId688.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId690);
    ...
    $.__views.__alloyId691.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId692);
    ...
    $.__views.__alloyId692.add($.__views.description);
