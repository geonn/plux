...
function Controller() {
    ...
    $.__views.__alloyId580.add($.__views.saveButton);
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId580;
    ...
    $.__views.main.add($.__views.__alloyId581);
    ...
    $.__views.__alloyId582.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId581.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId583);
    ...
    $.__views.__alloyId584.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId585);
    ...
    $.__views.__alloyId585.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId586, "click", showDatePicker) : __defers["$.__views.__alloyId586!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId587.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId590, "click", showTimePicker) : __defers["$.__views.__alloyId590!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId591.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId594);
    ...
    $.__views.__alloyId594.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId586!click!showDatePicker"] && $.addListener($.__views.__alloyId586, "click", showDatePicker);
    __defers["$.__views.__alloyId590!click!showTimePicker"] && $.addListener($.__views.__alloyId590, "click", showTimePicker);
