...
function Controller() {
    ...
    $.__views.__alloyId723.add($.__views.saveButton);
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId723;
    ...
    $.__views.__alloyId728.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId729, "click", showDatePicker) : __defers["$.__views.__alloyId729!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId730.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId733, "click", showTimePicker) : __defers["$.__views.__alloyId733!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId734.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId737);
    ...
    $.__views.__alloyId737.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId729!click!showDatePicker"] && $.addListener($.__views.__alloyId729, "click", showDatePicker);
    __defers["$.__views.__alloyId733!click!showTimePicker"] && $.addListener($.__views.__alloyId733, "click", showTimePicker);
