...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId417;
    ...
    $.__views.__alloyId418.add($.__views.__alloyId421);
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
        },
    ...
    $.__views.__alloyId422.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId423, "click", showDatePicker) : __defers["$.__views.__alloyId423!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId424.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId427, "click", showTimePicker) : __defers["$.__views.__alloyId427!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId428.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId431);
    ...
    $.__views.__alloyId431.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId423!click!showDatePicker"] && $.addListener($.__views.__alloyId423, "click", showDatePicker);
    __defers["$.__views.__alloyId427!click!showTimePicker"] && $.addListener($.__views.__alloyId427, "click", showTimePicker);
