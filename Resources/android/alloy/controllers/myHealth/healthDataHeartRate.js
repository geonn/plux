...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId419;
    ...
    $.__views.pageTitle.add($.__views.__alloyId422);
    ...
    $.__views.__alloyId424.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId425, "click", showDatePicker) : __defers["$.__views.__alloyId425!click!showDatePicker"] = true;
    ...
    showTimePicker ? $.addListener($.__views.__alloyId429, "click", showTimePicker) : __defers["$.__views.__alloyId429!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId430.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId433);
    ...
    $.__views.__alloyId433.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId425!click!showDatePicker"] && $.addListener($.__views.__alloyId425, "click", showDatePicker);
    __defers["$.__views.__alloyId429!click!showTimePicker"] && $.addListener($.__views.__alloyId429, "click", showTimePicker);
