...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId577;
    ...
    $.__views.main.add($.__views.__alloyId578);
    ...
    $.__views.pageTitle.add($.__views.__alloyId580);
    $.__views.__alloyId581 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId581"
    });
    $.__views.__alloyId578.add($.__views.__alloyId581);
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
        },
    ...
    $.__views.__alloyId581.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId582.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId583, "click", showDatePicker) : __defers["$.__views.__alloyId583!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId584.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId587);
    showTimePicker ? $.addListener($.__views.__alloyId587, "click", showTimePicker) : __defers["$.__views.__alloyId587!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId588.add($.__views.time_value);
    ...
    $.__views.table.add($.__views.__alloyId590);
    ...
    $.__views.tvrField1.add($.__views.__alloyId591);
    ...
    $.__views.__alloyId591.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId583!click!showDatePicker"] && $.addListener($.__views.__alloyId583, "click", showDatePicker);
    __defers["$.__views.__alloyId587!click!showTimePicker"] && $.addListener($.__views.__alloyId587, "click", showTimePicker);
