...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId575;
    ...
    $.__views.__alloyId576.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId578);
    ...
    $.__views.__alloyId579.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId580.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId581, "click", showDatePicker) : __defers["$.__views.__alloyId581!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId582.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId585, "click", showTimePicker) : __defers["$.__views.__alloyId585!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId586.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId589);
    ...
    $.__views.__alloyId589.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId581!click!showDatePicker"] && $.addListener($.__views.__alloyId581, "click", showDatePicker);
    __defers["$.__views.__alloyId585!click!showTimePicker"] && $.addListener($.__views.__alloyId585, "click", showTimePicker);
