...
<<<<<<< HEAD
    $.__views.__alloyId704.add($.__views.saveButton);
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId704;
=======
    $.__views.__alloyId692.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId692;
>>>>>>> origin/master
...
=======
    $.__views.__alloyId696.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId709.add($.__views.description);
=======
    $.__views.__alloyId697.add($.__views.description);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    showDatePicker ? $.addListener($.__views.__alloyId710, "click", showDatePicker) : __defers["$.__views.__alloyId710!click!showDatePicker"] = true;
...
=======
    ...
    showDatePicker ? $.addListener($.__views.__alloyId698, "click", showDatePicker) : __defers["$.__views.__alloyId698!click!showDatePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId711.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId714, "click", showTimePicker) : __defers["$.__views.__alloyId714!click!showTimePicker"] = true;
...
=======
    $.__views.__alloyId699.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId702);
    showTimePicker ? $.addListener($.__views.__alloyId702, "click", showTimePicker) : __defers["$.__views.__alloyId702!click!showTimePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId715.add($.__views.time_value);
...
=======
    $.__views.__alloyId703.add($.__views.time_value);
    $.__views.__alloyId705 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
...
<<<<<<< HEAD
    ...
    $.__views.tvrField1.add($.__views.__alloyId718);
...
=======
    ...
    $.__views.tvrField1.add($.__views.__alloyId706);
    $.__views.__alloyId707 = Ti.UI.createLabel({
>>>>>>> origin/master
        width: "50%",
        height: Titanium.UI.SIZE,
...
<<<<<<< HEAD
    $.__views.__alloyId718.add($.__views.field1);
    ...
    $.__views.table.add($.__views.__alloyId720);
=======
    $.__views.__alloyId706.add($.__views.field1);
    $.__views.__alloyId708 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
...
>>>>>>> origin/master
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
<<<<<<< HEAD
    __defers["$.__views.__alloyId710!click!showDatePicker"] && $.addListener($.__views.__alloyId710, "click", showDatePicker);
    __defers["$.__views.__alloyId714!click!showTimePicker"] && $.addListener($.__views.__alloyId714, "click", showTimePicker);
=======
    __defers["$.__views.__alloyId698!click!showDatePicker"] && $.addListener($.__views.__alloyId698, "click", showDatePicker);
    __defers["$.__views.__alloyId702!click!showTimePicker"] && $.addListener($.__views.__alloyId702, "click", showTimePicker);
>>>>>>> origin/master
