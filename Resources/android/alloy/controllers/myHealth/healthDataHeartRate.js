...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId714;
    ...
    $.__views.__alloyId716.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId715.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId717);
    ...
    $.__views.__alloyId718.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId719.add($.__views.description);
