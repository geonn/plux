...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId715;
    ...
    $.__views.__alloyId720.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId721, "click", showDatePicker) : __defers["$.__views.__alloyId721!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId722.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId725, "click", showTimePicker) : __defers["$.__views.__alloyId725!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId726.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId729);
    ...
    $.__views.__alloyId729.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId721!click!showDatePicker"] && $.addListener($.__views.__alloyId721, "click", showDatePicker);
    __defers["$.__views.__alloyId725!click!showTimePicker"] && $.addListener($.__views.__alloyId725, "click", showTimePicker);
