...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId490;
    ...
    $.__views.main.add($.__views.__alloyId495);
    ...
    $.__views.__alloyId495.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId496, "click", showDatePicker) : __defers["$.__views.__alloyId496!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId497.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId500, "click", showTimePicker) : __defers["$.__views.__alloyId500!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId501.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId504);
    ...
    $.__views.__alloyId504.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId496!click!showDatePicker"] && $.addListener($.__views.__alloyId496, "click", showDatePicker);
    __defers["$.__views.__alloyId500!click!showTimePicker"] && $.addListener($.__views.__alloyId500, "click", showTimePicker);
