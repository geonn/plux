...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId760;
    ...
    $.__views.__alloyId762.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId761.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId763);
    ...
    $.__views.__alloyId764.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId765.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId766, "click", showDatePicker) : __defers["$.__views.__alloyId766!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId767.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId770, "click", showTimePicker) : __defers["$.__views.__alloyId770!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId771.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId774);
    ...
    $.__views.__alloyId774.add($.__views.field1);
    ...
    $.__views.table.add($.__views.__alloyId776);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId766!click!showDatePicker"] && $.addListener($.__views.__alloyId766, "click", showDatePicker);
    __defers["$.__views.__alloyId770!click!showTimePicker"] && $.addListener($.__views.__alloyId770, "click", showTimePicker);
