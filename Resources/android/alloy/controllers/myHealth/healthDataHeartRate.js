...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId728;
    ...
    $.__views.__alloyId730.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId729.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId731);
    ...
    $.__views.__alloyId732.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId733.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId734, "click", showDatePicker) : __defers["$.__views.__alloyId734!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId735.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId738, "click", showTimePicker) : __defers["$.__views.__alloyId738!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId739.add($.__views.time_value);
    ...
    $.__views.table.add($.__views.__alloyId741);
    ...
    $.__views.tvrField1.add($.__views.__alloyId742);
    ...
    $.__views.__alloyId742.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId734!click!showDatePicker"] && $.addListener($.__views.__alloyId734, "click", showDatePicker);
    __defers["$.__views.__alloyId738!click!showTimePicker"] && $.addListener($.__views.__alloyId738, "click", showTimePicker);
