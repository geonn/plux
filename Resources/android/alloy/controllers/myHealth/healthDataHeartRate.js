...
function Controller() {
    ...
    $.__views.healthDHWin.rightNavButton = $.__views.__alloyId359;
    ...
    $.__views.main.add($.__views.__alloyId360);
    ...
    $.__views.__alloyId361.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId360.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId362);
    ...
    $.__views.__alloyId363.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId364);
    ...
    $.__views.__alloyId364.add($.__views.description);
    ...
    $.__views.table.add($.__views.__alloyId365);
    showDatePicker ? $.__views.__alloyId365.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId365!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId366.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId368);
    $.__views.__alloyId369 = Ti.UI.createView({
        height: Ti.UI.SIZE,
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId369"
    });
    $.__views.table.add($.__views.__alloyId369);
    showTimePicker ? $.__views.__alloyId369.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId369!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId370.add($.__views.time_value);
    ...
    $.__views.table.add($.__views.__alloyId372);
    ...
    $.__views.tvrField1.add($.__views.__alloyId373);
    ...
    $.__views.__alloyId373.add($.__views.field1);
    ...
    $.__views.table.add($.__views.__alloyId375);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
    __defers["$.__views.__alloyId365!click!showDatePicker"] && $.__views.__alloyId365.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId369!click!showTimePicker"] && $.__views.__alloyId369.addEventListener("click", showTimePicker);
