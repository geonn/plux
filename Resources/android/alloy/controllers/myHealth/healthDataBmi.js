...
<<<<<<< HEAD
    $.__views.__alloyId186.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId186;
=======
    $.__views.__alloyId196.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId196;
>>>>>>> origin/master
...
=======
    ...
    $.__views.loadingBar.add($.__views.__alloyId197);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId189.add($.__views.btnBack);
=======
...
=======
    $.__views.__alloyId198.add($.__views.pageTitle);
...
<<<<<<< HEAD
    ...
    $.__views.pageTitle.add($.__views.__alloyId190);
...
=======
    ...
    $.__views.pageTitle.add($.__views.__alloyId200);
...
<<<<<<< HEAD
    $.__views.__alloyId191.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
...
<<<<<<< HEAD
    ...
    showDatePicker ? $.__views.__alloyId194.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId194!click!showDatePicker"] = true;
    $.__views.__alloyId195 = Ti.UI.createView({
=======
    $.__views.__alloyId202.add($.__views.description);
    var __alloyId203 = [];
    ...
    showDatePicker ? $.__views.__alloyId204.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId204!click!showDatePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId195.add($.__views.date_value);
    $.__views.__alloyId197 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId197"
    });
    __alloyId193.push($.__views.__alloyId197);
    showTimePicker ? $.__views.__alloyId197.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId197!click!showTimePicker"] = true;
    $.__views.__alloyId198 = Ti.UI.createView({
        layout: "horizontal",
        height: "45",
        width: "100%",
...
=======
    ...
    showTimePicker ? $.__views.__alloyId207.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId207!click!showTimePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId198.add($.__views.time_value);
=======
    $.__views.__alloyId208.add($.__views.time_value);
>>>>>>> origin/master
...
<<<<<<< HEAD
    __alloyId193.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId200);
    $.__views.__alloyId201 = Ti.UI.createLabel({
=======
    __alloyId203.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId210);
...
<<<<<<< HEAD
    $.__views.__alloyId200.add($.__views.field1);
=======
    $.__views.__alloyId210.add($.__views.field1);
>>>>>>> origin/master
...
<<<<<<< HEAD
    __alloyId193.push($.__views.tvrField2);
    $.__views.__alloyId202 = Ti.UI.createView({
        layout: "horizontal",
        height: "55",
        width: "100%",
    ...
    $.__views.tvrField2.add($.__views.__alloyId202);
    $.__views.__alloyId203 = Ti.UI.createLabel({
=======
    __alloyId203.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId212);
...
<<<<<<< HEAD
    $.__views.__alloyId202.add($.__views.field2);
    $.__views.table = Ti.UI.createTableView({
        data: __alloyId193,
=======
    $.__views.__alloyId212.add($.__views.field2);
    $.__views.table = Ti.UI.createTableView({
        data: __alloyId203,
>>>>>>> origin/master
        id: "table",
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
<<<<<<< HEAD
    __defers["$.__views.__alloyId194!click!showDatePicker"] && $.__views.__alloyId194.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId197!click!showTimePicker"] && $.__views.__alloyId197.addEventListener("click", showTimePicker);
=======
    __defers["$.__views.__alloyId204!click!showDatePicker"] && $.__views.__alloyId204.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId207!click!showTimePicker"] && $.__views.__alloyId207.addEventListener("click", showTimePicker);
>>>>>>> origin/master
