...
function Controller() {
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId633;
    ...
    $.__views.loadingBar.add($.__views.__alloyId634);
    ...
    $.__views.main.add($.__views.__alloyId635);
    ...
    $.__views.__alloyId636.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId637);
    $.__views.__alloyId638 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId638"
    });
    $.__views.__alloyId635.add($.__views.__alloyId638);
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
        },
    ...
    $.__views.__alloyId638.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId639.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId641, "click", showDatePicker) : __defers["$.__views.__alloyId641!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId642.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId645);
    showTimePicker ? $.addListener($.__views.__alloyId645, "click", showTimePicker) : __defers["$.__views.__alloyId645!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId646.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId649);
    ...
    $.__views.__alloyId649.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId652);
    ...
    $.__views.__alloyId652.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId641!click!showDatePicker"] && $.addListener($.__views.__alloyId641, "click", showDatePicker);
    __defers["$.__views.__alloyId645!click!showTimePicker"] && $.addListener($.__views.__alloyId645, "click", showTimePicker);
