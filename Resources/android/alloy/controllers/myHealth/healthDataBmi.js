...
<<<<<<< HEAD
    $.__views.__alloyId399.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId399;
=======
    $.__views.__alloyId401.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId401;
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.loadingBar.add($.__views.__alloyId400);
=======
        id: "__alloyId402"
    });
    $.__views.loadingBar.add($.__views.__alloyId402);
>>>>>>> origin/master
...
=======
    ...
    $.__views.main.add($.__views.__alloyId403);
...
=======
    $.__views.__alloyId403.add($.__views.pageTitle);
...
=======
    ...
    $.__views.pageTitle.add($.__views.__alloyId405);
...
=======
    $.__views.__alloyId406.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
...
=======
    $.__views.__alloyId407.add($.__views.description);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.table.add($.__views.__alloyId407);
    showDatePicker ? $.addListener($.__views.__alloyId407, "click", showDatePicker) : __defers["$.__views.__alloyId407!click!showDatePicker"] = true;
...
=======
    ...
    showDatePicker ? $.addListener($.__views.__alloyId409, "click", showDatePicker) : __defers["$.__views.__alloyId409!click!showDatePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId408.add($.__views.date_value);
    $.__views.__alloyId410 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
    ...
    $.__views.table.add($.__views.__alloyId411);
    showTimePicker ? $.addListener($.__views.__alloyId411, "click", showTimePicker) : __defers["$.__views.__alloyId411!click!showTimePicker"] = true;
...
=======
    $.__views.__alloyId410.add($.__views.date_value);
    $.__views.__alloyId412 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
    ...
    showTimePicker ? $.addListener($.__views.__alloyId413, "click", showTimePicker) : __defers["$.__views.__alloyId413!click!showTimePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId412.add($.__views.time_value);
    $.__views.__alloyId414 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
    ...
    $.__views.table.add($.__views.__alloyId414);
=======
    $.__views.__alloyId414.add($.__views.time_value);
...
<<<<<<< HEAD
    ...
    $.__views.tvrField1.add($.__views.__alloyId415);
...
=======
    ...
    $.__views.tvrField1.add($.__views.__alloyId417);
...
<<<<<<< HEAD
    $.__views.__alloyId415.add($.__views.field1);
    $.__views.__alloyId417 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
...
=======
    $.__views.__alloyId417.add($.__views.field1);
...
<<<<<<< HEAD
    ...
    $.__views.tvrField2.add($.__views.__alloyId418);
...
=======
    ...
    $.__views.tvrField2.add($.__views.__alloyId420);
...
<<<<<<< HEAD
    $.__views.__alloyId418.add($.__views.field2);
=======
    $.__views.__alloyId420.add($.__views.field2);
>>>>>>> origin/master
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
<<<<<<< HEAD
    __defers["$.__views.__alloyId407!click!showDatePicker"] && $.addListener($.__views.__alloyId407, "click", showDatePicker);
    __defers["$.__views.__alloyId411!click!showTimePicker"] && $.addListener($.__views.__alloyId411, "click", showTimePicker);
=======
    __defers["$.__views.__alloyId409!click!showDatePicker"] && $.addListener($.__views.__alloyId409, "click", showDatePicker);
    __defers["$.__views.__alloyId413!click!showTimePicker"] && $.addListener($.__views.__alloyId413, "click", showTimePicker);
>>>>>>> origin/master
