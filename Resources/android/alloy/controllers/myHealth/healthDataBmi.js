...
function Controller() {
    ...
    $.__views.__alloyId296.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId296;
    ...
    $.__views.loadingBar.add($.__views.__alloyId297);
    ...
    $.__views.__alloyId299.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId298.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId300);
    $.__views.__alloyId301 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId301"
    });
    $.__views.__alloyId298.add($.__views.__alloyId301);
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
        },
    ...
    $.__views.__alloyId301.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId302.add($.__views.description);
    ...
    $.__views.table.add($.__views.__alloyId303);
    ...
    showDatePicker ? $.__views.__alloyId304.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId304!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId305.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId307);
    ...
    showTimePicker ? $.__views.__alloyId308.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId308!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId309.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId312);
    ...
    $.__views.__alloyId312.add($.__views.field1);
    ...
    $.__views.table.add($.__views.__alloyId314);
    ...
    $.__views.tvrField2.add($.__views.__alloyId315);
    ...
    $.__views.__alloyId315.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
    __defers["$.__views.__alloyId304!click!showDatePicker"] && $.__views.__alloyId304.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId308!click!showTimePicker"] && $.__views.__alloyId308.addEventListener("click", showTimePicker);
