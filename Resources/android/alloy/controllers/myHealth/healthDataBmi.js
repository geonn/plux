...
function Controller() {
    ...
    $.__views.__alloyId409.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId409;
    ...
    $.__views.loadingBar.add($.__views.__alloyId410);
    ...
    $.__views.__alloyId415.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId417, "click", showDatePicker) : __defers["$.__views.__alloyId417!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId418.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId421, "click", showTimePicker) : __defers["$.__views.__alloyId421!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId422.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId425);
    ...
    $.__views.__alloyId425.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId428);
    ...
    $.__views.__alloyId428.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId417!click!showDatePicker"] && $.addListener($.__views.__alloyId417, "click", showDatePicker);
    __defers["$.__views.__alloyId421!click!showTimePicker"] && $.addListener($.__views.__alloyId421, "click", showTimePicker);
