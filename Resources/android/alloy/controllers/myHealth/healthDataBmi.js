...
function Controller() {
    ...
    $.__views.__alloyId634.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId634;
    ...
    $.__views.loadingBar.add($.__views.__alloyId635);
    ...
    $.__views.__alloyId639.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId640);
    ...
    $.__views.__alloyId640.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId642, "click", showDatePicker) : __defers["$.__views.__alloyId642!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId643.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId646, "click", showTimePicker) : __defers["$.__views.__alloyId646!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId647.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId650);
    ...
    $.__views.__alloyId650.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId653);
    ...
    $.__views.__alloyId653.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId642!click!showDatePicker"] && $.addListener($.__views.__alloyId642, "click", showDatePicker);
    __defers["$.__views.__alloyId646!click!showTimePicker"] && $.addListener($.__views.__alloyId646, "click", showTimePicker);
