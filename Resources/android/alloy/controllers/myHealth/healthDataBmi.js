...
function Controller() {
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId587;
    ...
    $.__views.loadingBar.add($.__views.__alloyId588);
    ...
    $.__views.main.add($.__views.__alloyId589);
    ...
    $.__views.__alloyId590.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId589.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId591);
    ...
    $.__views.__alloyId592.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId593);
    ...
    $.__views.__alloyId593.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId595, "click", showDatePicker) : __defers["$.__views.__alloyId595!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId596.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId599, "click", showTimePicker) : __defers["$.__views.__alloyId599!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId600.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId603);
    ...
    $.__views.__alloyId603.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId606);
    ...
    $.__views.__alloyId606.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId595!click!showDatePicker"] && $.addListener($.__views.__alloyId595, "click", showDatePicker);
    __defers["$.__views.__alloyId599!click!showTimePicker"] && $.addListener($.__views.__alloyId599, "click", showTimePicker);
