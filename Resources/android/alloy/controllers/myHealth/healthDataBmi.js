...
function Controller() {
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId590;
    ...
    showDatePicker ? $.addListener($.__views.__alloyId598, "click", showDatePicker) : __defers["$.__views.__alloyId598!click!showDatePicker"] = true;
    ...
    showTimePicker ? $.addListener($.__views.__alloyId602, "click", showTimePicker) : __defers["$.__views.__alloyId602!click!showTimePicker"] = true;
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId598!click!showDatePicker"] && $.addListener($.__views.__alloyId598, "click", showDatePicker);
    __defers["$.__views.__alloyId602!click!showTimePicker"] && $.addListener($.__views.__alloyId602, "click", showTimePicker);
