...
function Controller() {
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId679;
    ...
    $.__views.loadingBar.add($.__views.__alloyId680);
    ...
    $.__views.__alloyId685.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId687, "click", showDatePicker) : __defers["$.__views.__alloyId687!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId688.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId691, "click", showTimePicker) : __defers["$.__views.__alloyId691!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId692.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId695);
    ...
    $.__views.__alloyId695.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId698);
    ...
    $.__views.__alloyId698.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId687!click!showDatePicker"] && $.addListener($.__views.__alloyId687, "click", showDatePicker);
    __defers["$.__views.__alloyId691!click!showTimePicker"] && $.addListener($.__views.__alloyId691, "click", showTimePicker);
