...
function Controller() {
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId499;
    ...
    $.__views.__alloyId504.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId505.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId507, "click", showDatePicker) : __defers["$.__views.__alloyId507!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId508.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId511, "click", showTimePicker) : __defers["$.__views.__alloyId511!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId512.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId515);
    ...
    $.__views.__alloyId515.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId518);
    ...
    $.__views.__alloyId518.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId507!click!showDatePicker"] && $.addListener($.__views.__alloyId507, "click", showDatePicker);
    __defers["$.__views.__alloyId511!click!showTimePicker"] && $.addListener($.__views.__alloyId511, "click", showTimePicker);
