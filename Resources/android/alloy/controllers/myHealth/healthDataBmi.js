...
<<<<<<< HEAD
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId209;
=======
    $.__views.__alloyId211.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId211;
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId212.add($.__views.btnBack);
=======
...
<<<<<<< HEAD
    $.__views.__alloyId211.add($.__views.pageTitle);
...
<<<<<<< HEAD
    ...
    $.__views.pageTitle.add($.__views.__alloyId213);
    $.__views.__alloyId214 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId214"
    });
...
<<<<<<< HEAD
    $.__views.__alloyId214.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
...
=======
    $.__views.__alloyId216.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId215.add($.__views.description);
    var __alloyId216 = [];
    ...
    showDatePicker ? $.__views.__alloyId217.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId217!click!showDatePicker"] = true;
...
=======
    ...
    showDatePicker ? $.__views.__alloyId219.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId219!click!showDatePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId218.add($.__views.date_value);
    $.__views.__alloyId220 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId220"
    });
    __alloyId216.push($.__views.__alloyId220);
    showTimePicker ? $.__views.__alloyId220.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId220!click!showTimePicker"] = true;
...
=======
    $.__views.__alloyId220.add($.__views.date_value);
    $.__views.__alloyId222 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId222"
    });
    __alloyId218.push($.__views.__alloyId222);
...
<<<<<<< HEAD
    $.__views.__alloyId221.add($.__views.time_value);
=======
...
<<<<<<< HEAD
    __alloyId216.push($.__views.tvrField1);
    $.__views.__alloyId223 = Ti.UI.createView({
        layout: "horizontal",
        height: "55",
        width: "100%",
    ...
    $.__views.tvrField1.add($.__views.__alloyId223);
    $.__views.__alloyId224 = Ti.UI.createLabel({
=======
    __alloyId218.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId225);
...
<<<<<<< HEAD
    $.__views.__alloyId223.add($.__views.field1);
=======
    $.__views.__alloyId225.add($.__views.field1);
>>>>>>> origin/master
...
<<<<<<< HEAD
    __alloyId216.push($.__views.tvrField2);
    $.__views.__alloyId225 = Ti.UI.createView({
        layout: "horizontal",
        height: "55",
        width: "100%",
    ...
    $.__views.tvrField2.add($.__views.__alloyId225);
    $.__views.__alloyId226 = Ti.UI.createLabel({
=======
    __alloyId218.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId227);
...
<<<<<<< HEAD
    $.__views.__alloyId225.add($.__views.field2);
    $.__views.table = Ti.UI.createTableView({
        data: __alloyId216,
=======
    $.__views.__alloyId227.add($.__views.field2);
    $.__views.table = Ti.UI.createTableView({
        data: __alloyId218,
>>>>>>> origin/master
        id: "table",
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
<<<<<<< HEAD
    __defers["$.__views.__alloyId217!click!showDatePicker"] && $.__views.__alloyId217.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId220!click!showTimePicker"] && $.__views.__alloyId220.addEventListener("click", showTimePicker);
=======
    __defers["$.__views.__alloyId219!click!showDatePicker"] && $.__views.__alloyId219.addEventListener("click", showDatePicker);
