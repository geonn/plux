...
function Controller() {
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId647;
    ...
    $.__views.__alloyId652.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId653.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId655, "click", showDatePicker) : __defers["$.__views.__alloyId655!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId656.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId659, "click", showTimePicker) : __defers["$.__views.__alloyId659!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId660.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId663);
    ...
    $.__views.__alloyId663.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId666);
    ...
    $.__views.__alloyId666.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId655!click!showDatePicker"] && $.addListener($.__views.__alloyId655, "click", showDatePicker);
    __defers["$.__views.__alloyId659!click!showTimePicker"] && $.addListener($.__views.__alloyId659, "click", showTimePicker);
