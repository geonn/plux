...
function Controller() {
    ...
    $.__views.__alloyId338.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId338;
    ...
    $.__views.loadingBar.add($.__views.__alloyId339);
    ...
    $.__views.__alloyId340.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId342);
    ...
    $.__views.__alloyId343.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId344.add($.__views.description);
    ...
    $.__views.table.add($.__views.__alloyId346);
    showDatePicker ? $.addListener($.__views.__alloyId346, "click", showDatePicker) : __defers["$.__views.__alloyId346!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId347.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId350);
    showTimePicker ? $.addListener($.__views.__alloyId350, "click", showTimePicker) : __defers["$.__views.__alloyId350!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId351.add($.__views.time_value);
    ...
    $.__views.table.add($.__views.__alloyId353);
    ...
    $.__views.tvrField1.add($.__views.__alloyId354);
    ...
    $.__views.__alloyId354.add($.__views.field1);
    ...
    $.__views.table.add($.__views.__alloyId356);
    ...
    $.__views.tvrField2.add($.__views.__alloyId357);
    ...
    $.__views.__alloyId357.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId346!click!showDatePicker"] && $.addListener($.__views.__alloyId346, "click", showDatePicker);
    __defers["$.__views.__alloyId350!click!showTimePicker"] && $.addListener($.__views.__alloyId350, "click", showTimePicker);
