...
function Controller() {
    ...
    $.__views.__alloyId496.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId496;
    ...
    $.__views.loadingBar.add($.__views.__alloyId497);
    ...
    $.__views.__alloyId499.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId498.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId500);
    ...
    $.__views.__alloyId501.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId502);
    ...
    $.__views.__alloyId502.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId504, "click", showDatePicker) : __defers["$.__views.__alloyId504!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId505.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId508, "click", showTimePicker) : __defers["$.__views.__alloyId508!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId509.add($.__views.time_value);
    ...
    $.__views.table.add($.__views.__alloyId511);
    ...
    $.__views.tvrField1.add($.__views.__alloyId512);
    ...
    $.__views.__alloyId512.add($.__views.field1);
    ...
    $.__views.table.add($.__views.__alloyId514);
    ...
    $.__views.tvrField2.add($.__views.__alloyId515);
    ...
    $.__views.__alloyId515.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId504!click!showDatePicker"] && $.addListener($.__views.__alloyId504, "click", showDatePicker);
    __defers["$.__views.__alloyId508!click!showTimePicker"] && $.addListener($.__views.__alloyId508, "click", showTimePicker);
