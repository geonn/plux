...
function Controller() {
    ...
    $.__views.__alloyId588.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId588;
    ...
    $.__views.pageTitle.add($.__views.__alloyId592);
    ...
    $.__views.__alloyId593.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId594);
    ...
    $.__views.__alloyId594.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId596, "click", showDatePicker) : __defers["$.__views.__alloyId596!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId597.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId600, "click", showTimePicker) : __defers["$.__views.__alloyId600!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId601.add($.__views.time_value);
    ...
    $.__views.table.add($.__views.__alloyId603);
    ...
    $.__views.tvrField1.add($.__views.__alloyId604);
    ...
    $.__views.__alloyId604.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId607);
    ...
    $.__views.__alloyId607.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId596!click!showDatePicker"] && $.addListener($.__views.__alloyId596, "click", showDatePicker);
    __defers["$.__views.__alloyId600!click!showTimePicker"] && $.addListener($.__views.__alloyId600, "click", showTimePicker);
