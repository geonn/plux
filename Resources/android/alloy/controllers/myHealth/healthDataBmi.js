...
function Controller() {
    ...
    $.__views.__alloyId641.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId641;
    ...
    $.__views.loadingBar.add($.__views.__alloyId642);
    ...
    $.__views.main.add($.__views.__alloyId643);
    ...
    $.__views.__alloyId643.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId645);
    ...
    $.__views.__alloyId647.add($.__views.description);
    ...
    $.__views.table.add($.__views.__alloyId648);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId649, "click", showDatePicker) : __defers["$.__views.__alloyId649!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId650.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId653, "click", showTimePicker) : __defers["$.__views.__alloyId653!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId654.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId657);
    ...
    $.__views.__alloyId657.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId660);
    ...
    $.__views.__alloyId660.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId649!click!showDatePicker"] && $.addListener($.__views.__alloyId649, "click", showDatePicker);
    __defers["$.__views.__alloyId653!click!showTimePicker"] && $.addListener($.__views.__alloyId653, "click", showTimePicker);
