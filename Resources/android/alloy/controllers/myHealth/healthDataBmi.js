...
<<<<<<< HEAD
    $.__views.__alloyId645.add($.__views.saveButton);
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId645;
=======
    $.__views.__alloyId643.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId643;
>>>>>>> origin/master
...
=======
    ...
    $.__views.loadingBar.add($.__views.__alloyId644);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.main.add($.__views.__alloyId647);
...
<<<<<<< HEAD
    $.__views.__alloyId648.add($.__views.btnBack);
=======
...
<<<<<<< HEAD
    $.__views.__alloyId647.add($.__views.pageTitle);
...
<<<<<<< HEAD
    ...
    $.__views.pageTitle.add($.__views.__alloyId649);
...
<<<<<<< HEAD
    $.__views.__alloyId650.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId651.add($.__views.description);
=======
...
<<<<<<< HEAD
    ...
    $.__views.table.add($.__views.__alloyId652);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId653, "click", showDatePicker) : __defers["$.__views.__alloyId653!click!showDatePicker"] = true;
...
=======
    ...
    $.__views.table.add($.__views.__alloyId651);
    showDatePicker ? $.addListener($.__views.__alloyId651, "click", showDatePicker) : __defers["$.__views.__alloyId651!click!showDatePicker"] = true;
    $.__views.__alloyId652 = Ti.UI.createView({
>>>>>>> origin/master
        layout: "horizontal",
        height: 45,
...
<<<<<<< HEAD
    $.__views.__alloyId654.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId657, "click", showTimePicker) : __defers["$.__views.__alloyId657!click!showTimePicker"] = true;
...
=======
    $.__views.__alloyId652.add($.__views.date_value);
    $.__views.__alloyId654 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
    ...
    $.__views.table.add($.__views.__alloyId655);
    showTimePicker ? $.addListener($.__views.__alloyId655, "click", showTimePicker) : __defers["$.__views.__alloyId655!click!showTimePicker"] = true;
    $.__views.__alloyId656 = Ti.UI.createView({
        layout: "horizontal",
        height: 45,
        width: "100%",
...
<<<<<<< HEAD
    $.__views.__alloyId658.add($.__views.time_value);
...
=======
    $.__views.__alloyId656.add($.__views.time_value);
    $.__views.__alloyId658 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
...
<<<<<<< HEAD
    ...
    $.__views.tvrField1.add($.__views.__alloyId661);
...
=======
    ...
    $.__views.tvrField1.add($.__views.__alloyId659);
...
<<<<<<< HEAD
    $.__views.__alloyId661.add($.__views.field1);
...
=======
    $.__views.__alloyId659.add($.__views.field1);
    $.__views.__alloyId661 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
...
<<<<<<< HEAD
    ...
    $.__views.tvrField2.add($.__views.__alloyId664);
...
=======
    ...
    $.__views.tvrField2.add($.__views.__alloyId662);
...
<<<<<<< HEAD
    $.__views.__alloyId664.add($.__views.field2);
=======
    $.__views.__alloyId662.add($.__views.field2);
>>>>>>> origin/master
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
<<<<<<< HEAD
    __defers["$.__views.__alloyId653!click!showDatePicker"] && $.addListener($.__views.__alloyId653, "click", showDatePicker);
    __defers["$.__views.__alloyId657!click!showTimePicker"] && $.addListener($.__views.__alloyId657, "click", showTimePicker);
=======
    __defers["$.__views.__alloyId651!click!showDatePicker"] && $.addListener($.__views.__alloyId651, "click", showDatePicker);
    __defers["$.__views.__alloyId655!click!showTimePicker"] && $.addListener($.__views.__alloyId655, "click", showTimePicker);
>>>>>>> origin/master
