...
function Controller() {
  ...
  doSaveRecords ? $.addListener($.__views.saveButton, 'touchend', doSaveRecords) : __defers['$.__views.saveButton!touchend!doSaveRecords'] = true;$.__views.healthBmiWin.rightNavButton = $.__views.__alloyId563;$.__views.loadingBar = Ti.UI.createView(
  ...
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#ffffff", top: 5, bottom: 10, text: "Loading", id: "__alloyId564" });

  $.__views.loadingBar.add($.__views.__alloyId564);
  ...
  if (true) {
    ...
    { layout: "horizontal", height: 50, width: "100%", backgroundColor: "#DEDEDE", id: "__alloyId565" });

    $.__views.main.add($.__views.__alloyId565);
    $.__views.__alloyId566 = Ti.UI.createView(
    { left: 0, width: "20%", id: "__alloyId566" });

    $.__views.__alloyId565.add($.__views.__alloyId566);
    $.__views.btnBack = Ti.UI.createImageView(
    { left: 10, id: "btnBack", width: 25, height: 25, image: "/images/btn-back.png" });

    $.__views.__alloyId566.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView(
    { id: "pageTitle", width: "60%" });

    $.__views.__alloyId565.add($.__views.pageTitle);
    $.__views.__alloyId567 = Ti.UI.createLabel(
    { width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'Add Data', textAlign: "center", id: "__alloyId567" });

    $.__views.pageTitle.add($.__views.__alloyId567);
    $.__views.__alloyId568 = Ti.UI.createView(
    { width: "20%", id: "__alloyId568" });
    ...
    $.__views.__alloyId568.add($.__views.saveButton);
  ...
  { layout: "vertical", height: 30, top: 10, id: "__alloyId569" });
  ...
  $.__views.__alloyId569.add($.__views.description);
  ...
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId570" });

  $.__views.table.add($.__views.__alloyId570);
  $.__views.__alloyId571 = Ti.UI.createView(
  { selectedBackgroundColor: "#ffffff", height: Ti.UI.SIZE, id: "__alloyId571" });

  $.__views.table.add($.__views.__alloyId571);
  showDatePicker ? $.addListener($.__views.__alloyId571, 'click', showDatePicker) : __defers['$.__views.__alloyId571!click!showDatePicker'] = true;$.__views.__alloyId572 = Ti.UI.createView(
  { layout: "horizontal", height: 45, width: "100%", textAlign: "right", id: "__alloyId572" });

  $.__views.__alloyId571.add($.__views.__alloyId572);
  $.__views.__alloyId573 = Ti.UI.createLabel(
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "Date", top: 12, id: "__alloyId573" });
  ...
  $.__views.__alloyId572.add($.__views.date_value);
  $.__views.__alloyId574 = Ti.UI.createView(
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId574" });

  $.__views.table.add($.__views.__alloyId574);
  $.__views.__alloyId575 = Ti.UI.createView(
  { selectedBackgroundColor: "#ffffff", height: Ti.UI.SIZE, id: "__alloyId575" });

  $.__views.table.add($.__views.__alloyId575);
  showTimePicker ? $.addListener($.__views.__alloyId575, 'click', showTimePicker) : __defers['$.__views.__alloyId575!click!showTimePicker'] = true;$.__views.__alloyId576 = Ti.UI.createView(
  { layout: "horizontal", height: 45, width: "100%", id: "__alloyId576" });

  $.__views.__alloyId575.add($.__views.__alloyId576);
  $.__views.__alloyId577 = Ti.UI.createLabel(
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "Time", top: 12, id: "__alloyId577" });
  ...
  $.__views.__alloyId576.add($.__views.time_value);
  $.__views.__alloyId578 = Ti.UI.createView(
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId578" });

  $.__views.table.add($.__views.__alloyId578);
  ...
  { layout: "horizontal", height: 45, width: "100%", id: "__alloyId579" });

  $.__views.tvrField1.add($.__views.__alloyId579);
  $.__views.__alloyId580 = Ti.UI.createLabel(
  { width: "50%", height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "KG", top: 12, id: "__alloyId580" });
  ...
  $.__views.__alloyId579.add($.__views.field1);
  $.__views.__alloyId581 = Ti.UI.createView(
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId581" });

  $.__views.table.add($.__views.__alloyId581);
  ...
  { layout: "horizontal", height: 45, width: "100%", id: "__alloyId582" });

  $.__views.tvrField2.add($.__views.__alloyId582);
  $.__views.__alloyId583 = Ti.UI.createLabel(
  { width: "50%", height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "Height(cm)", top: 12, id: "__alloyId583" });
  ...
  $.__views.__alloyId582.add($.__views.field2);
  ...
  __defers['$.__views.__alloyId571!click!showDatePicker'] && $.addListener($.__views.__alloyId571, 'click', showDatePicker);__defers['$.__views.__alloyId575!click!showTimePicker'] && $.addListener($.__views.__alloyId575, 'click', showTimePicker);__defers['$.__views.datePicker!change!changeDate'] && $.addListener($.__views.datePicker, 'change', changeDate);__defers['$.__views.timePicker!change!changeTime'] && $.addListener($.__views.timePicker, 'change', changeTime);
