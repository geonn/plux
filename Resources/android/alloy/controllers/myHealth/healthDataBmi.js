...
function Controller() {
    ...
    $.__views.healthBmiWin.rightNavButton = $.__views.__alloyId670;
    ...
    $.__views.loadingBar.add($.__views.__alloyId671);
    ...
    $.__views.__alloyId675.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId676.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId678, "click", showDatePicker) : __defers["$.__views.__alloyId678!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId679.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId682, "click", showTimePicker) : __defers["$.__views.__alloyId682!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId683.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId686);
    ...
    $.__views.__alloyId686.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId689);
    ...
    $.__views.__alloyId689.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId678!click!showDatePicker"] && $.addListener($.__views.__alloyId678, "click", showDatePicker);
    __defers["$.__views.__alloyId682!click!showTimePicker"] && $.addListener($.__views.__alloyId682, "click", showTimePicker);
