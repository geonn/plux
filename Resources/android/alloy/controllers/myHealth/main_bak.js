...
function Controller() {
	...
	$.__views.__alloyId677.add($.__views.moreHealth);
	$.__views.myhealth.rightNavButton = $.__views.__alloyId677;$.__views.__alloyId678 = Ti.UI.createView(
	{ id: "__alloyId678" });

	$.__views.myhealth.add($.__views.__alloyId678);
	$.__views.loadingBar = Ti.UI.createView(
	{ layout: "vertical", id: "loadingBar", height: 120, width: 120, borderRadius: 15, backgroundColor: "#2E2E2E" });

	$.__views.__alloyId678.add($.__views.loadingBar);
	$.__views.activityIndicator = Ti.UI.createActivityIndicator(
	{ top: 10, left: 30, width: 60, id: "activityIndicator" });

	$.__views.loadingBar.add($.__views.activityIndicator);
	$.__views.__alloyId679 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#ffffff", top: 5, bottom: 10, text: "Loading", id: "__alloyId679" });

	$.__views.loadingBar.add($.__views.__alloyId679);
	$.__views.main = Ti.UI.createView(
	{ id: "main", layout: "vertical", backgroundColor: "#ffffff" });

	$.__views.__alloyId678.add($.__views.main);
	if (true) {
		$.__views.__alloyId680 = Ti.UI.createView(
		{ layout: "horizontal", height: 50, width: "100%", backgroundColor: "#DEDEDE", id: "__alloyId680" });
	...
	{ height: 1, left: 10, right: 10, bottom: 0, backgroundColor: "#dfe0e4", width: Ti.UI.FILL, id: "__alloyId684" });

	$.__views.bmiView.add($.__views.__alloyId684);
	$.__views.__alloyId685 = Ti.UI.createView(
	{ height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId685" });

	$.__views.bmiView.add($.__views.__alloyId685);
	$.__views.__alloyId686 = Ti.UI.createLabel(
	{ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#9197a3", text: 'Latest', font: "fontSize: 12", left: 0, id: "__alloyId686" });
	...
	$.__views.__alloyId685.add($.__views.bmiDetailLabel);
	...
	{ height: 1, left: 10, right: 10, bottom: 0, backgroundColor: "#dfe0e4", width: Ti.UI.FILL, id: "__alloyId687" });

	$.__views.bloodPressureView.add($.__views.__alloyId687);
	$.__views.__alloyId688 = Ti.UI.createView(
	{ height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId688" });

	$.__views.bloodPressureView.add($.__views.__alloyId688);
	$.__views.__alloyId689 = Ti.UI.createLabel(
	{ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#9197a3", text: 'Latest', font: "fontSize: 12", left: 0, id: "__alloyId689" });
	...
	$.__views.__alloyId688.add($.__views.bloodPressureDetailLabel);
	...
	{ height: 1, left: 10, right: 10, bottom: 0, backgroundColor: "#dfe0e4", width: Ti.UI.FILL, id: "__alloyId690" });

	$.__views.heartRateView.add($.__views.__alloyId690);
	$.__views.__alloyId691 = Ti.UI.createView(
	{ height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId691" });

	$.__views.heartRateView.add($.__views.__alloyId691);
	$.__views.__alloyId692 = Ti.UI.createLabel(
	{ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#9197a3", text: 'Latest', font: "fontSize: 12", left: 0, id: "__alloyId692" });
	...
	$.__views.__alloyId691.add($.__views.heartRateDetailLabel);
	...
	{ height: 1, left: 10, right: 10, bottom: 0, backgroundColor: "#dfe0e4", width: Ti.UI.FILL, id: "__alloyId693" });

	$.__views.glucoseView.add($.__views.__alloyId693);
	$.__views.__alloyId694 = Ti.UI.createView(
	{ height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId694" });

	$.__views.glucoseView.add($.__views.__alloyId694);
	$.__views.__alloyId695 = Ti.UI.createLabel(
	{ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#9197a3", text: 'Latest', font: "fontSize: 12", left: 0, id: "__alloyId695" });
	...
	$.__views.__alloyId694.add($.__views.glucoseDetailLabel);
	...
	{ height: 1, left: 10, right: 10, bottom: 0, backgroundColor: "#dfe0e4", width: Ti.UI.FILL, id: "__alloyId696" });

	$.__views.cholestrolView.add($.__views.__alloyId696);
	$.__views.__alloyId697 = Ti.UI.createView(
	{ height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId697" });

	$.__views.cholestrolView.add($.__views.__alloyId697);
	$.__views.__alloyId698 = Ti.UI.createLabel(
	{ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#9197a3", text: 'Latest', font: "fontSize: 12", left: 0, id: "__alloyId698" });
	...
	$.__views.__alloyId697.add($.__views.cholestrolDetailLabel);
	...
	$.__views.bodyTemperatureView.add($.__views.__alloyId699);
	$.__views.__alloyId700 = Ti.UI.createView(
	{ height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId700" });

	$.__views.bodyTemperatureView.add($.__views.__alloyId700);
	...
	$.__views.__alloyId700.add($.__views.bodyTempDetailLabel);
