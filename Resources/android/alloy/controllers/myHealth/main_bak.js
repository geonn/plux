...
function Controller() {
	...
	$.__views.myhealth.rightNavButton = $.__views.__alloyId690;$.__views.__alloyId691 = Ti.UI.createView(
	{ id: "__alloyId691" });

	$.__views.myhealth.add($.__views.__alloyId691);
	$.__views.loadingBar = Ti.UI.createView(
	{ layout: "vertical", id: "loadingBar", height: 120, width: 120, borderRadius: 15, backgroundColor: "#2E2E2E" });

	$.__views.__alloyId691.add($.__views.loadingBar);
	$.__views.activityIndicator = Ti.UI.createActivityIndicator(
	{ top: 10, left: 30, width: 60, id: "activityIndicator" });

	$.__views.loadingBar.add($.__views.activityIndicator);
	$.__views.__alloyId692 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#ffffff", top: 5, bottom: 10, text: "Loading", id: "__alloyId692" });

	$.__views.loadingBar.add($.__views.__alloyId692);
	$.__views.main = Ti.UI.createView(
	{ id: "main", layout: "vertical", backgroundColor: "#ffffff" });

	$.__views.__alloyId691.add($.__views.main);
	if (true) {
		$.__views.__alloyId693 = Ti.UI.createView(
		{ layout: "horizontal", height: 50, width: "100%", backgroundColor: "#DEDEDE", id: "__alloyId693" });

		$.__views.main.add($.__views.__alloyId693);
		$.__views.__alloyId694 = Ti.UI.createView(
		{ left: 0, width: "10%", id: "__alloyId694" });
		...
		{ width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'Health Info', textAlign: "center", id: "__alloyId695" });

		$.__views.pageTitle.add($.__views.__alloyId695);
		$.__views.__alloyId696 = Ti.UI.createView(
		{ width: "10%", id: "__alloyId696" });

		$.__views.__alloyId693.add($.__views.__alloyId696);
		$.__views.moreHealth = Ti.UI.createImageView(
		{ id: "moreHealth", width: 30, image: "/images/health_love.png" });

		$.__views.__alloyId696.add($.__views.moreHealth);
	}
	...
	{ height: 1, left: 10, right: 10, bottom: 0, backgroundColor: "#dfe0e4", width: Ti.UI.FILL, id: "__alloyId697" });

	$.__views.bmiView.add($.__views.__alloyId697);
	$.__views.__alloyId698 = Ti.UI.createView(
	{ height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId698" });

	$.__views.bmiView.add($.__views.__alloyId698);
	$.__views.__alloyId699 = Ti.UI.createLabel(
	{ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#9197a3", text: 'Latest', font: "fontSize: 12", left: 0, id: "__alloyId699" });
	...
	$.__views.__alloyId698.add($.__views.bmiDetailLabel);
	...
	{ height: 1, left: 10, right: 10, bottom: 0, backgroundColor: "#dfe0e4", width: Ti.UI.FILL, id: "__alloyId700" });

	$.__views.bloodPressureView.add($.__views.__alloyId700);
	$.__views.__alloyId701 = Ti.UI.createView(
	{ height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId701" });

	$.__views.bloodPressureView.add($.__views.__alloyId701);
	$.__views.__alloyId702 = Ti.UI.createLabel(
	{ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#9197a3", text: 'Latest', font: "fontSize: 12", left: 0, id: "__alloyId702" });
	...
	$.__views.__alloyId701.add($.__views.bloodPressureDetailLabel);
	...
	{ height: 1, left: 10, right: 10, bottom: 0, backgroundColor: "#dfe0e4", width: Ti.UI.FILL, id: "__alloyId703" });

	$.__views.heartRateView.add($.__views.__alloyId703);
	$.__views.__alloyId704 = Ti.UI.createView(
	{ height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId704" });

	$.__views.heartRateView.add($.__views.__alloyId704);
	$.__views.__alloyId705 = Ti.UI.createLabel(
	{ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#9197a3", text: 'Latest', font: "fontSize: 12", left: 0, id: "__alloyId705" });
	...
	$.__views.__alloyId704.add($.__views.heartRateDetailLabel);
	...
	{ height: 1, left: 10, right: 10, bottom: 0, backgroundColor: "#dfe0e4", width: Ti.UI.FILL, id: "__alloyId706" });

	$.__views.glucoseView.add($.__views.__alloyId706);
	$.__views.__alloyId707 = Ti.UI.createView(
	{ height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId707" });

	$.__views.glucoseView.add($.__views.__alloyId707);
	$.__views.__alloyId708 = Ti.UI.createLabel(
	{ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#9197a3", text: 'Latest', font: "fontSize: 12", left: 0, id: "__alloyId708" });
	...
	$.__views.__alloyId707.add($.__views.glucoseDetailLabel);
	...
	{ height: 1, left: 10, right: 10, bottom: 0, backgroundColor: "#dfe0e4", width: Ti.UI.FILL, id: "__alloyId709" });

	$.__views.cholestrolView.add($.__views.__alloyId709);
	$.__views.__alloyId710 = Ti.UI.createView(
	{ height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId710" });

	$.__views.cholestrolView.add($.__views.__alloyId710);
	$.__views.__alloyId711 = Ti.UI.createLabel(
	{ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#9197a3", text: 'Latest', font: "fontSize: 12", left: 0, id: "__alloyId711" });
	...
	$.__views.__alloyId710.add($.__views.cholestrolDetailLabel);
	...
	{ height: 1, left: 10, right: 10, bottom: 0, backgroundColor: "#dfe0e4", width: Ti.UI.FILL, id: "__alloyId712" });

	$.__views.bodyTemperatureView.add($.__views.__alloyId712);
	$.__views.__alloyId713 = Ti.UI.createView(
	{ height: Ti.UI.SIZE, left: 10, right: 10, top: 10, bottom: 10, id: "__alloyId713" });

	$.__views.bodyTemperatureView.add($.__views.__alloyId713);
	$.__views.__alloyId714 = Ti.UI.createLabel(
	{ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#9197a3", text: 'Latest', font: "fontSize: 12", left: 0, id: "__alloyId714" });
	...
	$.__views.__alloyId713.add($.__views.bodyTempDetailLabel);
