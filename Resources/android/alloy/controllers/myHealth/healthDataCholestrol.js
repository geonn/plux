...
function Controller() {
    ...
    $.__views.__alloyId719.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId719;
    ...
    $.__views.loadingBar.add($.__views.__alloyId720);
    ...
    $.__views.__alloyId722.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId721.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId723);
    ...
    $.__views.__alloyId725.add($.__views.description);
    ...
    $.__views.table.add($.__views.__alloyId726);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId727, "click", showDatePicker) : __defers["$.__views.__alloyId727!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId728.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId731, "click", showTimePicker) : __defers["$.__views.__alloyId731!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId732.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId735);
    ...
    $.__views.__alloyId735.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId738);
    ...
    $.__views.__alloyId738.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId727!click!showDatePicker"] && $.addListener($.__views.__alloyId727, "click", showDatePicker);
    __defers["$.__views.__alloyId731!click!showTimePicker"] && $.addListener($.__views.__alloyId731, "click", showTimePicker);
