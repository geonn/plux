...
function Controller() {
    ...
    $.__views.__alloyId376.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId376;
    ...
    $.__views.main.add($.__views.__alloyId378);
    ...
    $.__views.__alloyId379.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId378.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId380);
    ...
    $.__views.__alloyId381.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId382);
    ...
    $.__views.__alloyId382.add($.__views.description);
    ...
    $.__views.table.add($.__views.__alloyId383);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId384, "click", showDatePicker) : __defers["$.__views.__alloyId384!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId385.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId388, "click", showTimePicker) : __defers["$.__views.__alloyId388!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId389.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId392);
    ...
    $.__views.__alloyId392.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId395);
    ...
    $.__views.__alloyId395.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId384!click!showDatePicker"] && $.addListener($.__views.__alloyId384, "click", showDatePicker);
    __defers["$.__views.__alloyId388!click!showTimePicker"] && $.addListener($.__views.__alloyId388, "click", showTimePicker);
