...
function Controller() {
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId378;
    ...
    $.__views.loadingBar.add($.__views.__alloyId379);
    ...
    $.__views.__alloyId380.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId382);
    ...
    $.__views.__alloyId383.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId384.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId386, "click", showDatePicker) : __defers["$.__views.__alloyId386!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId387.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId390, "click", showTimePicker) : __defers["$.__views.__alloyId390!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId391.add($.__views.time_value);
    ...
    $.__views.table.add($.__views.__alloyId393);
    ...
    $.__views.tvrField1.add($.__views.__alloyId394);
    ...
    $.__views.__alloyId394.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId397);
    ...
    $.__views.__alloyId397.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId386!click!showDatePicker"] && $.addListener($.__views.__alloyId386, "click", showDatePicker);
    __defers["$.__views.__alloyId390!click!showTimePicker"] && $.addListener($.__views.__alloyId390, "click", showTimePicker);
