...
function Controller() {
    ...
    $.__views.__alloyId359.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId359;
    ...
    $.__views.loadingBar.add($.__views.__alloyId360);
    ...
    $.__views.main.add($.__views.__alloyId361);
    ...
    $.__views.__alloyId364.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId365);
    ...
    $.__views.__alloyId365.add($.__views.description);
    ...
    $.__views.table.add($.__views.__alloyId366);
    $.__views.__alloyId367 = Ti.UI.createView({
        height: Ti.UI.SIZE,
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId367"
    });
    $.__views.table.add($.__views.__alloyId367);
    showDatePicker ? $.addListener($.__views.__alloyId367, "click", showDatePicker) : __defers["$.__views.__alloyId367!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId368.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId370);
    $.__views.__alloyId371 = Ti.UI.createView({
        height: Ti.UI.SIZE,
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId371"
    });
    $.__views.table.add($.__views.__alloyId371);
    showTimePicker ? $.addListener($.__views.__alloyId371, "click", showTimePicker) : __defers["$.__views.__alloyId371!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId372.add($.__views.time_value);
    ...
    $.__views.table.add($.__views.__alloyId374);
    ...
    $.__views.tvrField1.add($.__views.__alloyId375);
    ...
    $.__views.__alloyId375.add($.__views.field1);
    ...
    $.__views.table.add($.__views.__alloyId377);
    ...
    $.__views.tvrField2.add($.__views.__alloyId378);
    ...
    $.__views.__alloyId378.add($.__views.field2);
    ...
    $.__views.table.add($.__views.__alloyId380);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId367!click!showDatePicker"] && $.addListener($.__views.__alloyId367, "click", showDatePicker);
    __defers["$.__views.__alloyId371!click!showTimePicker"] && $.addListener($.__views.__alloyId371, "click", showTimePicker);
