...
function Controller() {
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId710;
    ...
    $.__views.loadingBar.add($.__views.__alloyId711);
    ...
    $.__views.__alloyId713.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId714);
    ...
    $.__views.__alloyId715.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId716.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId718, "click", showDatePicker) : __defers["$.__views.__alloyId718!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId719.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId722, "click", showTimePicker) : __defers["$.__views.__alloyId722!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId723.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId726);
    ...
    $.__views.__alloyId726.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId729);
    ...
    $.__views.__alloyId729.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId718!click!showDatePicker"] && $.addListener($.__views.__alloyId718, "click", showDatePicker);
    __defers["$.__views.__alloyId722!click!showTimePicker"] && $.addListener($.__views.__alloyId722, "click", showTimePicker);
