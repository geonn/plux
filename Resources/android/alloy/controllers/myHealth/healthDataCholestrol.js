...
function Controller() {
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId715;
    ...
    $.__views.loadingBar.add($.__views.__alloyId716);
    ...
    $.__views.__alloyId720.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId721.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId723, "click", showDatePicker) : __defers["$.__views.__alloyId723!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId724.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId727, "click", showTimePicker) : __defers["$.__views.__alloyId727!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId728.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId731);
    ...
    $.__views.__alloyId731.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId734);
    ...
    $.__views.__alloyId734.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId723!click!showDatePicker"] && $.addListener($.__views.__alloyId723, "click", showDatePicker);
    __defers["$.__views.__alloyId727!click!showTimePicker"] && $.addListener($.__views.__alloyId727, "click", showTimePicker);
