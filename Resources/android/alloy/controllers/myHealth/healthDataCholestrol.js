...
function Controller() {
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId682;
    ...
    $.__views.loadingBar.add($.__views.__alloyId683);
    ...
    $.__views.main.add($.__views.__alloyId684);
    ...
    $.__views.__alloyId685.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId684.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId686);
    ...
    $.__views.__alloyId688.add($.__views.description);
    ...
    $.__views.tvrField2.add($.__views.__alloyId701);
    ...
    $.__views.__alloyId701.add($.__views.field2);
