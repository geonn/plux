...
function Controller() {
    ...
    $.__views.__alloyId673.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId673;
    ...
    $.__views.loadingBar.add($.__views.__alloyId674);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId681, "click", showDatePicker) : __defers["$.__views.__alloyId681!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId682.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId685, "click", showTimePicker) : __defers["$.__views.__alloyId685!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId686.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId689);
    ...
    $.__views.__alloyId689.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId692);
    ...
    $.__views.__alloyId692.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId681!click!showDatePicker"] && $.addListener($.__views.__alloyId681, "click", showDatePicker);
    __defers["$.__views.__alloyId685!click!showTimePicker"] && $.addListener($.__views.__alloyId685, "click", showTimePicker);
