...
function Controller() {
    ...
    $.__views.__alloyId689.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId689;
    ...
    $.__views.loadingBar.add($.__views.__alloyId690);
    ...
    $.__views.__alloyId695.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId697, "click", showDatePicker) : __defers["$.__views.__alloyId697!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId698.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId701, "click", showTimePicker) : __defers["$.__views.__alloyId701!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId702.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId705);
    ...
    $.__views.__alloyId705.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId708);
    ...
    $.__views.__alloyId708.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId697!click!showDatePicker"] && $.addListener($.__views.__alloyId697, "click", showDatePicker);
    __defers["$.__views.__alloyId701!click!showTimePicker"] && $.addListener($.__views.__alloyId701, "click", showTimePicker);
