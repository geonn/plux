...
function Controller() {
    ...
    $.__views.__alloyId223.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId223;
    ...
    $.__views.__alloyId225.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId227);
    ...
    $.__views.__alloyId228.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    showDatePicker ? $.__views.__alloyId231.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId231!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId232.add($.__views.date_value);
    $.__views.__alloyId234 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId234"
    });
    __alloyId230.push($.__views.__alloyId234);
    showTimePicker ? $.__views.__alloyId234.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId234!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId235.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId230.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId237);
    ...
    $.__views.__alloyId237.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId230.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId239);
    ...
    $.__views.__alloyId239.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
    __defers["$.__views.__alloyId231!click!showDatePicker"] && $.__views.__alloyId231.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId234!click!showTimePicker"] && $.__views.__alloyId234.addEventListener("click", showTimePicker);
