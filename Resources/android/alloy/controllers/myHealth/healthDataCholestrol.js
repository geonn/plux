...
function Controller() {
  ...
  $.__views.__alloyId590.add($.__views.saveButton);
  doSaveRecords ? $.addListener($.__views.saveButton, 'touchend', doSaveRecords) : __defers['$.__views.saveButton!touchend!doSaveRecords'] = true;$.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId590;$.__views.loadingBar = Ti.UI.createView(
  ...
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#ffffff", top: 5, bottom: 10, text: "Loading", id: "__alloyId591" });
  ...
  if (true) {
    ...
    { layout: "horizontal", height: 50, width: "100%", backgroundColor: "#DEDEDE", id: "__alloyId592" });

    $.__views.main.add($.__views.__alloyId592);
    $.__views.__alloyId593 = Ti.UI.createView(
    { left: 0, width: "20%", id: "__alloyId593" });
    ...
    { width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'Add Data', textAlign: "center", id: "__alloyId594" });

    $.__views.pageTitle.add($.__views.__alloyId594);
    $.__views.__alloyId595 = Ti.UI.createView(
    { width: "20%", id: "__alloyId595" });
    ...
    $.__views.__alloyId595.add($.__views.saveButton);
  ...
  { layout: "vertical", height: 30, top: 10, id: "__alloyId596" });
  ...
  $.__views.__alloyId596.add($.__views.description);
  ...
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId597" });

  $.__views.table.add($.__views.__alloyId597);
  $.__views.__alloyId598 = Ti.UI.createView(
  { height: Ti.UI.SIZE, selectedBackgroundColor: "#ffffff", id: "__alloyId598" });

  $.__views.table.add($.__views.__alloyId598);
  showDatePicker ? $.addListener($.__views.__alloyId598, 'click', showDatePicker) : __defers['$.__views.__alloyId598!click!showDatePicker'] = true;$.__views.__alloyId599 = Ti.UI.createView(
  { layout: "horizontal", height: 45, width: "100%", textAlign: "right", id: "__alloyId599" });

  $.__views.__alloyId598.add($.__views.__alloyId599);
  $.__views.__alloyId600 = Ti.UI.createLabel(
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "Date", top: 12, id: "__alloyId600" });
  ...
  $.__views.__alloyId599.add($.__views.date_value);
  $.__views.__alloyId601 = Ti.UI.createView(
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId601" });

  $.__views.table.add($.__views.__alloyId601);
  $.__views.__alloyId602 = Ti.UI.createView(
  { height: Ti.UI.SIZE, selectedBackgroundColor: "#ffffff", id: "__alloyId602" });

  $.__views.table.add($.__views.__alloyId602);
  showTimePicker ? $.addListener($.__views.__alloyId602, 'click', showTimePicker) : __defers['$.__views.__alloyId602!click!showTimePicker'] = true;$.__views.__alloyId603 = Ti.UI.createView(
  { layout: "horizontal", height: 45, width: "100%", id: "__alloyId603" });

  $.__views.__alloyId602.add($.__views.__alloyId603);
  $.__views.__alloyId604 = Ti.UI.createLabel(
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "Time", top: 12, id: "__alloyId604" });
  ...
  $.__views.__alloyId603.add($.__views.time_value);
  $.__views.__alloyId605 = Ti.UI.createView(
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId605" });
  ...
  { layout: "horizontal", height: 55, width: "100%", id: "__alloyId606" });

  $.__views.tvrField1.add($.__views.__alloyId606);
  $.__views.__alloyId607 = Ti.UI.createLabel(
  { width: "50%", height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "HDL(mg/dL)", top: 12, id: "__alloyId607" });
  ...
  $.__views.__alloyId606.add($.__views.field1);
  $.__views.__alloyId608 = Ti.UI.createView(
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId608" });
  ...
  { layout: "horizontal", height: 55, width: "100%", id: "__alloyId609" });

  $.__views.tvrField2.add($.__views.__alloyId609);
  $.__views.__alloyId610 = Ti.UI.createLabel(
  { width: "50%", height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "LDL(mg/dL)", top: 12, id: "__alloyId610" });
  ...
  $.__views.__alloyId609.add($.__views.field2);
  $.__views.__alloyId611 = Ti.UI.createView(
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId611" });
  ...
  __defers['$.__views.__alloyId598!click!showDatePicker'] && $.addListener($.__views.__alloyId598, 'click', showDatePicker);__defers['$.__views.__alloyId602!click!showTimePicker'] && $.addListener($.__views.__alloyId602, 'click', showTimePicker);__defers['$.__views.datePicker!change!changeDate'] && $.addListener($.__views.datePicker, 'change', changeDate);__defers['$.__views.timePicker!change!changeTime'] && $.addListener($.__views.timePicker, 'change', changeTime);
