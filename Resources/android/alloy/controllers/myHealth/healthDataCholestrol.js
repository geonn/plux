...
function Controller() {
    ...
    $.__views.__alloyId318.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId318;
    ...
    $.__views.__alloyId320.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId322);
    ...
    $.__views.__alloyId324.add($.__views.description);
    var __alloyId325 = [];
    $.__views.__alloyId326 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId326"
    });
    __alloyId325.push($.__views.__alloyId326);
    showDatePicker ? $.__views.__alloyId326.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId326!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId327.add($.__views.date_value);
    $.__views.__alloyId329 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId329"
    });
    __alloyId325.push($.__views.__alloyId329);
    showTimePicker ? $.__views.__alloyId329.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId329!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId330.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId325.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId332);
    ...
    $.__views.__alloyId332.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId325.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId334);
    ...
    $.__views.__alloyId334.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
    __defers["$.__views.__alloyId326!click!showDatePicker"] && $.__views.__alloyId326.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId329!click!showTimePicker"] && $.__views.__alloyId329.addEventListener("click", showTimePicker);
