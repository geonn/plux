...
function Controller() {
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId674;
    ...
    $.__views.__alloyId679.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId680.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId682, "click", showDatePicker) : __defers["$.__views.__alloyId682!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId683.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId686, "click", showTimePicker) : __defers["$.__views.__alloyId686!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId687.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId690);
    ...
    $.__views.__alloyId690.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId693);
    ...
    $.__views.__alloyId693.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId682!click!showDatePicker"] && $.addListener($.__views.__alloyId682, "click", showDatePicker);
    __defers["$.__views.__alloyId686!click!showTimePicker"] && $.addListener($.__views.__alloyId686, "click", showTimePicker);
