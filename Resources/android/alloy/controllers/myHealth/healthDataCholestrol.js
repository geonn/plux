...
function Controller() {
    ...
    $.__views.__alloyId449.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId449;
    ...
    $.__views.__alloyId452.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId453);
    ...
    $.__views.__alloyId454.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId455.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId457, "click", showDatePicker) : __defers["$.__views.__alloyId457!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId458.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId461, "click", showTimePicker) : __defers["$.__views.__alloyId461!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId462.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId465);
    ...
    $.__views.__alloyId465.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId468);
    ...
    $.__views.__alloyId468.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId457!click!showDatePicker"] && $.addListener($.__views.__alloyId457, "click", showDatePicker);
    __defers["$.__views.__alloyId461!click!showTimePicker"] && $.addListener($.__views.__alloyId461, "click", showTimePicker);
