...
function Controller() {
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId681;
    ...
    $.__views.loadingBar.add($.__views.__alloyId682);
    ...
    $.__views.__alloyId684.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId683.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId685);
    $.__views.__alloyId686 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId686"
    });
    $.__views.__alloyId683.add($.__views.__alloyId686);
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
        },
    ...
    $.__views.__alloyId686.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId687.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId689, "click", showDatePicker) : __defers["$.__views.__alloyId689!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId690.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId693, "click", showTimePicker) : __defers["$.__views.__alloyId693!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId694.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId697);
    ...
    $.__views.__alloyId697.add($.__views.field1);
    ...
    $.__views.table.add($.__views.__alloyId699);
    ...
    $.__views.tvrField2.add($.__views.__alloyId700);
    ...
    $.__views.__alloyId700.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId689!click!showDatePicker"] && $.addListener($.__views.__alloyId689, "click", showDatePicker);
    __defers["$.__views.__alloyId693!click!showTimePicker"] && $.addListener($.__views.__alloyId693, "click", showTimePicker);
