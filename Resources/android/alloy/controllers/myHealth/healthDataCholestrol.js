...
function Controller() {
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId630;
    ...
    $.__views.loadingBar.add($.__views.__alloyId631);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId638, "click", showDatePicker) : __defers["$.__views.__alloyId638!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId639.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId642, "click", showTimePicker) : __defers["$.__views.__alloyId642!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId643.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId646);
    ...
    $.__views.__alloyId646.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId649);
    ...
    $.__views.__alloyId649.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId638!click!showDatePicker"] && $.addListener($.__views.__alloyId638, "click", showDatePicker);
    __defers["$.__views.__alloyId642!click!showTimePicker"] && $.addListener($.__views.__alloyId642, "click", showTimePicker);
