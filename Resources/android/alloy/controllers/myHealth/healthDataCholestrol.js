...
function Controller() {
    ...
    $.__views.__alloyId629.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId629;
    ...
    $.__views.loadingBar.add($.__views.__alloyId630);
    ...
    $.__views.__alloyId632.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId633);
    $.__views.__alloyId634 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId634"
    });
    $.__views.__alloyId631.add($.__views.__alloyId634);
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
        },
    ...
    $.__views.__alloyId635.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId637, "click", showDatePicker) : __defers["$.__views.__alloyId637!click!showDatePicker"] = true;
    ...
    showTimePicker ? $.addListener($.__views.__alloyId641, "click", showTimePicker) : __defers["$.__views.__alloyId641!click!showTimePicker"] = true;
    ...
    $.__views.tvrField2.add($.__views.__alloyId648);
    ...
    $.__views.__alloyId648.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId637!click!showDatePicker"] && $.addListener($.__views.__alloyId637, "click", showDatePicker);
    __defers["$.__views.__alloyId641!click!showTimePicker"] && $.addListener($.__views.__alloyId641, "click", showTimePicker);
