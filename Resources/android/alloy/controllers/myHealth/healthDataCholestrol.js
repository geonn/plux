...
function Controller() {
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId628;
    ...
    $.__views.loadingBar.add($.__views.__alloyId629);
    ...
    $.__views.main.add($.__views.__alloyId630);
    ...
    $.__views.__alloyId631.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId630.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId632);
    ...
    $.__views.__alloyId634.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId636, "click", showDatePicker) : __defers["$.__views.__alloyId636!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId637.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId640, "click", showTimePicker) : __defers["$.__views.__alloyId640!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId641.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId644);
    ...
    $.__views.__alloyId644.add($.__views.field1);
    ...
    $.__views.table.add($.__views.__alloyId646);
    ...
    $.__views.tvrField2.add($.__views.__alloyId647);
    ...
    $.__views.__alloyId647.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId636!click!showDatePicker"] && $.addListener($.__views.__alloyId636, "click", showDatePicker);
    __defers["$.__views.__alloyId640!click!showTimePicker"] && $.addListener($.__views.__alloyId640, "click", showTimePicker);
