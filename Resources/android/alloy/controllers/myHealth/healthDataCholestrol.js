...
function Controller() {
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId539;
    ...
    $.__views.loadingBar.add($.__views.__alloyId540);
    ...
    $.__views.main.add($.__views.__alloyId541);
    ...
    $.__views.__alloyId542.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId541.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId543);
    ...
    $.__views.__alloyId545.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId547, "click", showDatePicker) : __defers["$.__views.__alloyId547!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId548.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId551, "click", showTimePicker) : __defers["$.__views.__alloyId551!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId552.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId555);
    ...
    $.__views.__alloyId555.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId558);
    ...
    $.__views.__alloyId558.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId547!click!showDatePicker"] && $.addListener($.__views.__alloyId547, "click", showDatePicker);
    __defers["$.__views.__alloyId551!click!showTimePicker"] && $.addListener($.__views.__alloyId551, "click", showTimePicker);
