...
function Controller() {
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId228;
    ...
    $.__views.pageTitle.add($.__views.__alloyId232);
    ...
    $.__views.__alloyId233.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId234.add($.__views.description);
    var __alloyId235 = [];
    ...
    showDatePicker ? $.__views.__alloyId236.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId236!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId237.add($.__views.date_value);
    $.__views.__alloyId239 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId239"
    });
    __alloyId235.push($.__views.__alloyId239);
    showTimePicker ? $.__views.__alloyId239.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId239!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId240.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId235.push($.__views.tvrField1);
    ...
    __alloyId235.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId244);
    ...
    $.__views.__alloyId244.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
    __defers["$.__views.__alloyId236!click!showDatePicker"] && $.__views.__alloyId236.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId239!click!showTimePicker"] && $.__views.__alloyId239.addEventListener("click", showTimePicker);
