...
<<<<<<< HEAD
    $.__views.__alloyId439.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId439;
=======
    $.__views.__alloyId441.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId441;
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.loadingBar.add($.__views.__alloyId440);
=======
        id: "__alloyId442"
    });
    $.__views.loadingBar.add($.__views.__alloyId442);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.pageTitle.add($.__views.__alloyId443);
    $.__views.__alloyId444 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId444"
    });
...
=======
    ...
    $.__views.pageTitle.add($.__views.__alloyId445);
...
<<<<<<< HEAD
    $.__views.__alloyId444.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
...
=======
    $.__views.__alloyId446.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId445.add($.__views.description);
=======
    $.__views.__alloyId447.add($.__views.description);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    showDatePicker ? $.addListener($.__views.__alloyId447, "click", showDatePicker) : __defers["$.__views.__alloyId447!click!showDatePicker"] = true;
...
=======
    ...
    $.__views.table.add($.__views.__alloyId449);
    showDatePicker ? $.addListener($.__views.__alloyId449, "click", showDatePicker) : __defers["$.__views.__alloyId449!click!showDatePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId448.add($.__views.date_value);
    $.__views.__alloyId450 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
    ...
    showTimePicker ? $.addListener($.__views.__alloyId451, "click", showTimePicker) : __defers["$.__views.__alloyId451!click!showTimePicker"] = true;
...
=======
    $.__views.__alloyId450.add($.__views.date_value);
    $.__views.__alloyId452 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
    ...
    showTimePicker ? $.addListener($.__views.__alloyId453, "click", showTimePicker) : __defers["$.__views.__alloyId453!click!showTimePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId452.add($.__views.time_value);
    $.__views.__alloyId454 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
    ...
    $.__views.table.add($.__views.__alloyId454);
=======
    $.__views.__alloyId454.add($.__views.time_value);
...
<<<<<<< HEAD
    ...
    $.__views.tvrField1.add($.__views.__alloyId455);
...
=======
    ...
    $.__views.tvrField1.add($.__views.__alloyId457);
...
<<<<<<< HEAD
    $.__views.__alloyId455.add($.__views.field1);
    $.__views.__alloyId457 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
...
=======
    $.__views.__alloyId457.add($.__views.field1);
...
<<<<<<< HEAD
    ...
    $.__views.tvrField2.add($.__views.__alloyId458);
...
=======
    ...
    $.__views.tvrField2.add($.__views.__alloyId460);
...
<<<<<<< HEAD
    $.__views.__alloyId458.add($.__views.field2);
    $.__views.__alloyId460 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
...
=======
    $.__views.__alloyId460.add($.__views.field2);
...
>>>>>>> origin/master
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
<<<<<<< HEAD
    __defers["$.__views.__alloyId447!click!showDatePicker"] && $.addListener($.__views.__alloyId447, "click", showDatePicker);
    __defers["$.__views.__alloyId451!click!showTimePicker"] && $.addListener($.__views.__alloyId451, "click", showTimePicker);
=======
    __defers["$.__views.__alloyId449!click!showDatePicker"] && $.addListener($.__views.__alloyId449, "click", showDatePicker);
    __defers["$.__views.__alloyId453!click!showTimePicker"] && $.addListener($.__views.__alloyId453, "click", showTimePicker);
>>>>>>> origin/master
