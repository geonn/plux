...
function Controller() {
    ...
    $.__views.__alloyId118.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId118;
    ...
    $.__views.__alloyId123.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId124.add($.__views.description);
    var __alloyId125 = [];
    ...
    showDatePicker ? $.__views.__alloyId126.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId126!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId127.add($.__views.date_value);
    $.__views.__alloyId129 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId129"
    });
    __alloyId125.push($.__views.__alloyId129);
    showTimePicker ? $.__views.__alloyId129.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId129!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId130.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId125.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId132);
    ...
    $.__views.__alloyId132.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId125.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId134);
    ...
    $.__views.__alloyId134.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
    __defers["$.__views.__alloyId126!click!showDatePicker"] && $.__views.__alloyId126.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId129!click!showTimePicker"] && $.__views.__alloyId129.addEventListener("click", showTimePicker);
