...
function Controller() {
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId669;
    ...
    $.__views.loadingBar.add($.__views.__alloyId670);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId677, "click", showDatePicker) : __defers["$.__views.__alloyId677!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId678.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId681, "click", showTimePicker) : __defers["$.__views.__alloyId681!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId682.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId685);
    ...
    $.__views.__alloyId685.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId688);
    ...
    $.__views.__alloyId688.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId677!click!showDatePicker"] && $.addListener($.__views.__alloyId677, "click", showDatePicker);
    __defers["$.__views.__alloyId681!click!showTimePicker"] && $.addListener($.__views.__alloyId681, "click", showTimePicker);
