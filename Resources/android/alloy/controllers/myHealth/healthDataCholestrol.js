...
<<<<<<< HEAD
    $.__views.__alloyId661.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId661;
=======
    $.__views.__alloyId665.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId665;
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.loadingBar.add($.__views.__alloyId662);
=======
        bottom: 10,
        text: "Loading",
        id: "__alloyId666"
...
<<<<<<< HEAD
    $.__views.__alloyId664.add($.__views.btnBack);
=======
...
<<<<<<< HEAD
    $.__views.__alloyId663.add($.__views.pageTitle);
...
<<<<<<< HEAD
    ...
    $.__views.pageTitle.add($.__views.__alloyId665);
...
<<<<<<< HEAD
    $.__views.__alloyId666.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.__alloyId667 = Ti.UI.createView({
        layout: "vertical",
        height: 30,
...
<<<<<<< HEAD
    $.__views.__alloyId667.add($.__views.description);
=======
    $.__views.__alloyId671.add($.__views.description);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.table.add($.__views.__alloyId668);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId669, "click", showDatePicker) : __defers["$.__views.__alloyId669!click!showDatePicker"] = true;
    $.__views.__alloyId670 = Ti.UI.createView({
=======
    ...
    showDatePicker ? $.addListener($.__views.__alloyId673, "click", showDatePicker) : __defers["$.__views.__alloyId673!click!showDatePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId670.add($.__views.date_value);
    $.__views.__alloyId672 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
    ...
    $.__views.table.add($.__views.__alloyId673);
    showTimePicker ? $.addListener($.__views.__alloyId673, "click", showTimePicker) : __defers["$.__views.__alloyId673!click!showTimePicker"] = true;
    $.__views.__alloyId674 = Ti.UI.createView({
        layout: "horizontal",
        height: 45,
        width: "100%",
    ...
    $.__views.__alloyId675 = Ti.UI.createLabel({
=======
    $.__views.__alloyId674.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId677, "click", showTimePicker) : __defers["$.__views.__alloyId677!click!showTimePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId674.add($.__views.time_value);
    $.__views.__alloyId676 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
    ...
    $.__views.table.add($.__views.__alloyId676);
=======
    $.__views.__alloyId678.add($.__views.time_value);
...
<<<<<<< HEAD
    ...
    $.__views.tvrField1.add($.__views.__alloyId677);
...
=======
    ...
    $.__views.tvrField1.add($.__views.__alloyId681);
...
<<<<<<< HEAD
    $.__views.__alloyId677.add($.__views.field1);
...
=======
    $.__views.__alloyId681.add($.__views.field1);
...
<<<<<<< HEAD
    ...
    $.__views.tvrField2.add($.__views.__alloyId680);
...
=======
    ...
    $.__views.tvrField2.add($.__views.__alloyId684);
...
<<<<<<< HEAD
    $.__views.__alloyId680.add($.__views.field2);
    ...
    $.__views.table.add($.__views.__alloyId682);
=======
    $.__views.__alloyId684.add($.__views.field2);
...
>>>>>>> origin/master
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
<<<<<<< HEAD
    __defers["$.__views.__alloyId669!click!showDatePicker"] && $.addListener($.__views.__alloyId669, "click", showDatePicker);
    __defers["$.__views.__alloyId673!click!showTimePicker"] && $.addListener($.__views.__alloyId673, "click", showTimePicker);
=======
    __defers["$.__views.__alloyId673!click!showDatePicker"] && $.addListener($.__views.__alloyId673, "click", showDatePicker);
    __defers["$.__views.__alloyId677!click!showTimePicker"] && $.addListener($.__views.__alloyId677, "click", showTimePicker);
>>>>>>> origin/master
