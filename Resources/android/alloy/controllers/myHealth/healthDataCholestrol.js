...
function Controller() {
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId687;
    ...
    $.__views.loadingBar.add($.__views.__alloyId688);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId695, "click", showDatePicker) : __defers["$.__views.__alloyId695!click!showDatePicker"] = true;
    ...
    showTimePicker ? $.addListener($.__views.__alloyId699, "click", showTimePicker) : __defers["$.__views.__alloyId699!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId700.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId703);
    ...
    $.__views.__alloyId703.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId706);
    ...
    $.__views.__alloyId706.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId695!click!showDatePicker"] && $.addListener($.__views.__alloyId695, "click", showDatePicker);
    __defers["$.__views.__alloyId699!click!showTimePicker"] && $.addListener($.__views.__alloyId699, "click", showTimePicker);
