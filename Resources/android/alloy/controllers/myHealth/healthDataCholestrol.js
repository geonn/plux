...
function Controller() {
  ...
  $.__views.__alloyId605.add($.__views.saveButton);
  doSaveRecords ? $.addListener($.__views.saveButton, 'touchend', doSaveRecords) : __defers['$.__views.saveButton!touchend!doSaveRecords'] = true;$.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId605;$.__views.loadingBar = Ti.UI.createView(
  ...
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#ffffff", top: 5, bottom: 10, text: "Loading", id: "__alloyId606" });

  $.__views.loadingBar.add($.__views.__alloyId606);
  ...
  if (true) {
    ...
    { layout: "horizontal", height: 50, width: "100%", backgroundColor: "#DEDEDE", id: "__alloyId607" });

    $.__views.main.add($.__views.__alloyId607);
    $.__views.__alloyId608 = Ti.UI.createView(
    { left: 0, width: "20%", id: "__alloyId608" });
    ...
    { width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'Add Data', textAlign: "center", id: "__alloyId609" });

    $.__views.pageTitle.add($.__views.__alloyId609);
    $.__views.__alloyId610 = Ti.UI.createView(
    { width: "20%", id: "__alloyId610" });

    $.__views.__alloyId607.add($.__views.__alloyId610);
    $.__views.saveButton = Ti.UI.createButton(
    { font: { fontSize: "10dp" }, color: "#000", touchEnabled: false, id: "saveButton", title: "Save", right: 0 });

    $.__views.__alloyId610.add($.__views.saveButton);
  ...
  { layout: "vertical", height: 30, top: 10, id: "__alloyId611" });

  $.__views.main.add($.__views.__alloyId611);
  ...
  $.__views.__alloyId611.add($.__views.description);
  ...
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId612" });

  $.__views.table.add($.__views.__alloyId612);
  $.__views.__alloyId613 = Ti.UI.createView(
  { height: Ti.UI.SIZE, selectedBackgroundColor: "#ffffff", id: "__alloyId613" });

  $.__views.table.add($.__views.__alloyId613);
  showDatePicker ? $.addListener($.__views.__alloyId613, 'click', showDatePicker) : __defers['$.__views.__alloyId613!click!showDatePicker'] = true;$.__views.__alloyId614 = Ti.UI.createView(
  { layout: "horizontal", height: 45, width: "100%", textAlign: "right", id: "__alloyId614" });

  $.__views.__alloyId613.add($.__views.__alloyId614);
  $.__views.__alloyId615 = Ti.UI.createLabel(
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "Date", top: 12, id: "__alloyId615" });
  ...
  $.__views.__alloyId614.add($.__views.date_value);
  $.__views.__alloyId616 = Ti.UI.createView(
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId616" });

  $.__views.table.add($.__views.__alloyId616);
  $.__views.__alloyId617 = Ti.UI.createView(
  { height: Ti.UI.SIZE, selectedBackgroundColor: "#ffffff", id: "__alloyId617" });

  $.__views.table.add($.__views.__alloyId617);
  showTimePicker ? $.addListener($.__views.__alloyId617, 'click', showTimePicker) : __defers['$.__views.__alloyId617!click!showTimePicker'] = true;$.__views.__alloyId618 = Ti.UI.createView(
  { layout: "horizontal", height: 45, width: "100%", id: "__alloyId618" });

  $.__views.__alloyId617.add($.__views.__alloyId618);
  $.__views.__alloyId619 = Ti.UI.createLabel(
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "Time", top: 12, id: "__alloyId619" });
  ...
  $.__views.__alloyId618.add($.__views.time_value);
  $.__views.__alloyId620 = Ti.UI.createView(
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId620" });

  $.__views.table.add($.__views.__alloyId620);
  ...
  { layout: "horizontal", height: 55, width: "100%", id: "__alloyId621" });

  $.__views.tvrField1.add($.__views.__alloyId621);
  $.__views.__alloyId622 = Ti.UI.createLabel(
  { width: "50%", height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "HDL(mg/dL)", top: 12, id: "__alloyId622" });
  ...
  $.__views.__alloyId621.add($.__views.field1);
  $.__views.__alloyId623 = Ti.UI.createView(
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId623" });
  ...
  { layout: "horizontal", height: 55, width: "100%", id: "__alloyId624" });

  $.__views.tvrField2.add($.__views.__alloyId624);
  $.__views.__alloyId625 = Ti.UI.createLabel(
  { width: "50%", height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "LDL(mg/dL)", top: 12, id: "__alloyId625" });
  ...
  $.__views.__alloyId624.add($.__views.field2);
  $.__views.__alloyId626 = Ti.UI.createView(
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId626" });
  ...
  __defers['$.__views.__alloyId613!click!showDatePicker'] && $.addListener($.__views.__alloyId613, 'click', showDatePicker);__defers['$.__views.__alloyId617!click!showTimePicker'] && $.addListener($.__views.__alloyId617, 'click', showTimePicker);__defers['$.__views.datePicker!change!changeDate'] && $.addListener($.__views.datePicker, 'change', changeDate);__defers['$.__views.timePicker!change!changeTime'] && $.addListener($.__views.timePicker, 'change', changeTime);
