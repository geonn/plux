...
function Controller() {
    ...
    $.__views.__alloyId536.add($.__views.saveButton);
    ...
    $.__views.healthCholestrolWin.rightNavButton = $.__views.__alloyId536;
    ...
    $.__views.loadingBar.add($.__views.__alloyId537);
    ...
    $.__views.main.add($.__views.__alloyId538);
    ...
    $.__views.__alloyId539.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId538.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId540);
    ...
    $.__views.__alloyId541.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId542);
    ...
    $.__views.__alloyId542.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId544, "click", showDatePicker) : __defers["$.__views.__alloyId544!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId545.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId547);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId548, "click", showTimePicker) : __defers["$.__views.__alloyId548!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId549.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId552);
    ...
    $.__views.__alloyId552.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId555);
    ...
    $.__views.__alloyId555.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId544!click!showDatePicker"] && $.addListener($.__views.__alloyId544, "click", showDatePicker);
    __defers["$.__views.__alloyId548!click!showTimePicker"] && $.addListener($.__views.__alloyId548, "click", showTimePicker);
