...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId663;
    ...
    $.__views.__alloyId668.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId670, "click", showDatePicker) : __defers["$.__views.__alloyId670!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId671.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId674, "click", showTimePicker) : __defers["$.__views.__alloyId674!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId675.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId678);
    ...
    $.__views.__alloyId678.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId670!click!showDatePicker"] && $.addListener($.__views.__alloyId670, "click", showDatePicker);
    __defers["$.__views.__alloyId674!click!showTimePicker"] && $.addListener($.__views.__alloyId674, "click", showTimePicker);
