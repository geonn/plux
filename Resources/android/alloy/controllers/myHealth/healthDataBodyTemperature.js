...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId694;
    ...
    $.__views.__alloyId699.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId701, "click", showDatePicker) : __defers["$.__views.__alloyId701!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId702.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId705, "click", showTimePicker) : __defers["$.__views.__alloyId705!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId706.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId709);
    ...
    $.__views.__alloyId709.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId701!click!showDatePicker"] && $.addListener($.__views.__alloyId701, "click", showDatePicker);
    __defers["$.__views.__alloyId705!click!showTimePicker"] && $.addListener($.__views.__alloyId705, "click", showTimePicker);
