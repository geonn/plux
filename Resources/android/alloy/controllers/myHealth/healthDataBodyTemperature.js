...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId611;
    ...
    $.__views.__alloyId615.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId616.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId618, "click", showDatePicker) : __defers["$.__views.__alloyId618!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId619.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId622, "click", showTimePicker) : __defers["$.__views.__alloyId622!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId623.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId626);
    ...
    $.__views.__alloyId626.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId618!click!showDatePicker"] && $.addListener($.__views.__alloyId618, "click", showDatePicker);
    __defers["$.__views.__alloyId622!click!showTimePicker"] && $.addListener($.__views.__alloyId622, "click", showTimePicker);
