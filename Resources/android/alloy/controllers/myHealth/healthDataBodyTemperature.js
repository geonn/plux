...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId692;
    ...
    showDatePicker ? $.addListener($.__views.__alloyId699, "click", showDatePicker) : __defers["$.__views.__alloyId699!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId700.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId703, "click", showTimePicker) : __defers["$.__views.__alloyId703!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId704.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId707);
    ...
    $.__views.__alloyId707.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId699!click!showDatePicker"] && $.addListener($.__views.__alloyId699, "click", showDatePicker);
    __defers["$.__views.__alloyId703!click!showTimePicker"] && $.addListener($.__views.__alloyId703, "click", showTimePicker);
