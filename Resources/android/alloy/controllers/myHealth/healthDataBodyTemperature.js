...
function Controller() {
    ...
    $.__views.__alloyId697.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId697;
    ...
    $.__views.__alloyId698.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId700);
    ...
    $.__views.__alloyId702.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId704, "click", showDatePicker) : __defers["$.__views.__alloyId704!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId705.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId708, "click", showTimePicker) : __defers["$.__views.__alloyId708!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId709.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId712);
    ...
    $.__views.__alloyId712.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId704!click!showDatePicker"] && $.addListener($.__views.__alloyId704, "click", showDatePicker);
    __defers["$.__views.__alloyId708!click!showTimePicker"] && $.addListener($.__views.__alloyId708, "click", showTimePicker);
