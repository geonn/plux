...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId516;
    ...
    showDatePicker ? $.addListener($.__views.__alloyId523, "click", showDatePicker) : __defers["$.__views.__alloyId523!click!showDatePicker"] = true;
    ...
    showTimePicker ? $.addListener($.__views.__alloyId527, "click", showTimePicker) : __defers["$.__views.__alloyId527!click!showTimePicker"] = true;
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId523!click!showDatePicker"] && $.addListener($.__views.__alloyId523, "click", showDatePicker);
    __defers["$.__views.__alloyId527!click!showTimePicker"] && $.addListener($.__views.__alloyId527, "click", showTimePicker);
