...
function Controller() {
    ...
    $.__views.__alloyId609.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId609;
    ...
    $.__views.main.add($.__views.__alloyId610);
    ...
    $.__views.pageTitle.add($.__views.__alloyId612);
    ...
    $.__views.__alloyId614.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId616, "click", showDatePicker) : __defers["$.__views.__alloyId616!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId617.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId620, "click", showTimePicker) : __defers["$.__views.__alloyId620!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId621.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId624);
    ...
    $.__views.__alloyId624.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId616!click!showDatePicker"] && $.addListener($.__views.__alloyId616, "click", showDatePicker);
    __defers["$.__views.__alloyId620!click!showTimePicker"] && $.addListener($.__views.__alloyId620, "click", showTimePicker);
