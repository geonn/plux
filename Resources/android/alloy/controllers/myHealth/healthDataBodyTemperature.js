...
function Controller() {
    ...
    $.__views.__alloyId431.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId431;
    ...
    $.__views.main.add($.__views.__alloyId432);
    ...
    $.__views.__alloyId433.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId434);
    ...
    $.__views.__alloyId435.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId436);
    ...
    $.__views.__alloyId436.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId438, "click", showDatePicker) : __defers["$.__views.__alloyId438!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId439.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId442, "click", showTimePicker) : __defers["$.__views.__alloyId442!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId443.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId446);
    ...
    $.__views.__alloyId446.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId438!click!showDatePicker"] && $.addListener($.__views.__alloyId438, "click", showDatePicker);
    __defers["$.__views.__alloyId442!click!showTimePicker"] && $.addListener($.__views.__alloyId442, "click", showTimePicker);
