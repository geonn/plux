...
function Controller() {
    ...
    $.__views.__alloyId358.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId358;
    ...
    $.__views.main.add($.__views.__alloyId359);
    ...
    $.__views.__alloyId362.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId363);
    ...
    $.__views.__alloyId363.add($.__views.description);
    ...
    $.__views.table.add($.__views.__alloyId364);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId365, "click", showDatePicker) : __defers["$.__views.__alloyId365!click!showDatePicker"] = true;
    ...
    showTimePicker ? $.addListener($.__views.__alloyId369, "click", showTimePicker) : __defers["$.__views.__alloyId369!click!showTimePicker"] = true;
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId365!click!showDatePicker"] && $.addListener($.__views.__alloyId365, "click", showDatePicker);
    __defers["$.__views.__alloyId369!click!showTimePicker"] && $.addListener($.__views.__alloyId369, "click", showTimePicker);
