...
function Controller() {
  ...
  $.__views.__alloyId587.add($.__views.saveButton);
  doSaveRecords ? $.addListener($.__views.saveButton, 'touchend', doSaveRecords) : __defers['$.__views.saveButton!touchend!doSaveRecords'] = true;$.__views.healthDBPWin.rightNavButton = $.__views.__alloyId587;$.__views.main = Ti.UI.createView(
  ...
  if (true) {
    ...
    { layout: "horizontal", height: 50, width: "100%", backgroundColor: "#DEDEDE", id: "__alloyId588" });

    $.__views.main.add($.__views.__alloyId588);
    $.__views.__alloyId589 = Ti.UI.createView(
    { left: 0, width: "20%", id: "__alloyId589" });

    $.__views.__alloyId588.add($.__views.__alloyId589);
    $.__views.btnBack = Ti.UI.createImageView(
    { left: 10, id: "btnBack", width: 25, height: 25, image: "/images/btn-back.png" });

    $.__views.__alloyId589.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView(
    { id: "pageTitle", width: "60%" });

    $.__views.__alloyId588.add($.__views.pageTitle);
    $.__views.__alloyId590 = Ti.UI.createLabel(
    { width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'Add Data', textAlign: "center", id: "__alloyId590" });

    $.__views.pageTitle.add($.__views.__alloyId590);
    $.__views.__alloyId591 = Ti.UI.createView(
    { width: "20%", id: "__alloyId591" });
    ...
    $.__views.__alloyId591.add($.__views.saveButton);
  ...
  { layout: "vertical", height: 30, top: 10, id: "__alloyId592" });
  ...
  $.__views.__alloyId592.add($.__views.description);
  ...
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId593" });

  $.__views.table.add($.__views.__alloyId593);
  $.__views.__alloyId594 = Ti.UI.createView(
  { height: Ti.UI.SIZE, selectedBackgroundColor: "#ffffff", id: "__alloyId594" });

  $.__views.table.add($.__views.__alloyId594);
  showDatePicker ? $.addListener($.__views.__alloyId594, 'click', showDatePicker) : __defers['$.__views.__alloyId594!click!showDatePicker'] = true;$.__views.__alloyId595 = Ti.UI.createView(
  { layout: "horizontal", height: 45, width: "100%", textAlign: "right", id: "__alloyId595" });

  $.__views.__alloyId594.add($.__views.__alloyId595);
  $.__views.__alloyId596 = Ti.UI.createLabel(
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "Date", top: 12, id: "__alloyId596" });
  ...
  $.__views.__alloyId595.add($.__views.date_value);
  ...
  showTimePicker ? $.addListener($.__views.__alloyId598, 'click', showTimePicker) : __defers['$.__views.__alloyId598!click!showTimePicker'] = true;$.__views.__alloyId599 = Ti.UI.createView(
  { layout: "horizontal", height: 45, width: "100%", id: "__alloyId599" });

  $.__views.__alloyId598.add($.__views.__alloyId599);
  $.__views.__alloyId600 = Ti.UI.createLabel(
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "Time", top: 12, id: "__alloyId600" });
  ...
  $.__views.__alloyId599.add($.__views.time_value);
  ...
  { layout: "horizontal", height: 55, width: "100%", id: "__alloyId602" });

  $.__views.tvrField1.add($.__views.__alloyId602);
  $.__views.__alloyId603 = Ti.UI.createLabel(
  { width: "50%", height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "C", top: 12, id: "__alloyId603" });
  ...
  $.__views.__alloyId602.add($.__views.field1);
  ...
  __defers['$.__views.__alloyId594!click!showDatePicker'] && $.addListener($.__views.__alloyId594, 'click', showDatePicker);__defers['$.__views.__alloyId598!click!showTimePicker'] && $.addListener($.__views.__alloyId598, 'click', showTimePicker);__defers['$.__views.datePicker!change!changeDate'] && $.addListener($.__views.datePicker, 'change', changeDate);__defers['$.__views.timePicker!change!changeTime'] && $.addListener($.__views.timePicker, 'change', changeTime);
