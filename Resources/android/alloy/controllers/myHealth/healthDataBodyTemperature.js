...
function Controller() {
    ...
    $.__views.__alloyId521.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId521;
    ...
    $.__views.__alloyId525.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId526.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId528, "click", showDatePicker) : __defers["$.__views.__alloyId528!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId529.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId531);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId532, "click", showTimePicker) : __defers["$.__views.__alloyId532!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId533.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId536);
    ...
    $.__views.__alloyId536.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId528!click!showDatePicker"] && $.addListener($.__views.__alloyId528, "click", showDatePicker);
    __defers["$.__views.__alloyId532!click!showTimePicker"] && $.addListener($.__views.__alloyId532, "click", showTimePicker);
