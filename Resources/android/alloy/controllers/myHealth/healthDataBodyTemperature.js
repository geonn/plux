...
<<<<<<< HEAD
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId228;
=======
    $.__views.__alloyId230.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId230;
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId229.add($.__views.pageTitle);
...
<<<<<<< HEAD
    ...
    $.__views.pageTitle.add($.__views.__alloyId231);
    $.__views.__alloyId232 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId232"
    });
...
<<<<<<< HEAD
    $.__views.__alloyId233.add($.__views.description);
    var __alloyId234 = [];
    ...
    showDatePicker ? $.__views.__alloyId235.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId235!click!showDatePicker"] = true;
...
<<<<<<< HEAD
    $.__views.__alloyId236.add($.__views.date_value);
    $.__views.__alloyId238 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId238"
    });
    __alloyId234.push($.__views.__alloyId238);
...
<<<<<<< HEAD
    __alloyId234.push($.__views.tvrField1);
    $.__views.__alloyId241 = Ti.UI.createView({
        layout: "horizontal",
        height: "55",
        width: "100%",
...
>>>>>>> origin/master
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
<<<<<<< HEAD
    __defers["$.__views.__alloyId235!click!showDatePicker"] && $.__views.__alloyId235.addEventListener("click", showDatePicker);
