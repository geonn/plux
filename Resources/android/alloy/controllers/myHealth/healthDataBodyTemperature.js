...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId610;
    ...
    $.__views.__alloyId612.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId611.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId613);
    $.__views.__alloyId614 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId614"
    });
    $.__views.__alloyId611.add($.__views.__alloyId614);
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
        },
    ...
    $.__views.__alloyId614.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId615);
    ...
    $.__views.__alloyId615.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId617, "click", showDatePicker) : __defers["$.__views.__alloyId617!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId618.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId621, "click", showTimePicker) : __defers["$.__views.__alloyId621!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId622.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId625);
    ...
    $.__views.__alloyId625.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId617!click!showDatePicker"] && $.addListener($.__views.__alloyId617, "click", showDatePicker);
    __defers["$.__views.__alloyId621!click!showTimePicker"] && $.addListener($.__views.__alloyId621, "click", showTimePicker);
