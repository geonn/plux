...
function Controller() {
    ...
    $.__views.__alloyId241.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId241;
    ...
    $.__views.__alloyId245.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId246.add($.__views.description);
    var __alloyId247 = [];
    $.__views.__alloyId248 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId248"
    });
    __alloyId247.push($.__views.__alloyId248);
    showDatePicker ? $.__views.__alloyId248.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId248!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId249.add($.__views.date_value);
    $.__views.__alloyId251 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId251"
    });
    __alloyId247.push($.__views.__alloyId251);
    showTimePicker ? $.__views.__alloyId251.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId251!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId252.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId247.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId254);
    ...
    $.__views.__alloyId254.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
    __defers["$.__views.__alloyId248!click!showDatePicker"] && $.__views.__alloyId248.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId251!click!showTimePicker"] && $.__views.__alloyId251.addEventListener("click", showTimePicker);
