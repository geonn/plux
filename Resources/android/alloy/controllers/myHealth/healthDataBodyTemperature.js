...
function Controller() {
    ...
    $.__views.__alloyId512.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId512;
    ...
    $.__views.__alloyId517.add($.__views.description);
    ...
    $.__views.table.add($.__views.__alloyId518);
    $.__views.__alloyId519 = Ti.UI.createView({
        height: Ti.UI.SIZE,
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId519"
    });
    $.__views.table.add($.__views.__alloyId519);
    showDatePicker ? $.addListener($.__views.__alloyId519, "click", showDatePicker) : __defers["$.__views.__alloyId519!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId520.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId523, "click", showTimePicker) : __defers["$.__views.__alloyId523!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId524.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId527);
    ...
    $.__views.__alloyId527.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId519!click!showDatePicker"] && $.addListener($.__views.__alloyId519, "click", showDatePicker);
    __defers["$.__views.__alloyId523!click!showTimePicker"] && $.addListener($.__views.__alloyId523, "click", showTimePicker);
