...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId302;
    ...
    showDatePicker ? $.__views.__alloyId309.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId309!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId310.add($.__views.date_value);
    $.__views.__alloyId312 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId312"
    });
    __alloyId308.push($.__views.__alloyId312);
    showTimePicker ? $.__views.__alloyId312.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId312!click!showTimePicker"] = true;
    ...
    __alloyId308.push($.__views.tvrField1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
    __defers["$.__views.__alloyId309!click!showDatePicker"] && $.__views.__alloyId309.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId312!click!showTimePicker"] && $.__views.__alloyId312.addEventListener("click", showTimePicker);
