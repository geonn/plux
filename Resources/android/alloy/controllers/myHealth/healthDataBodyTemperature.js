...
function Controller() {
    ...
    $.__views.__alloyId192.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId192;
    ...
    $.__views.__alloyId197.add($.__views.description);
    var __alloyId198 = [];
    ...
    showDatePicker ? $.__views.__alloyId199.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId199!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId200.add($.__views.date_value);
    $.__views.__alloyId202 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId202"
    });
    __alloyId198.push($.__views.__alloyId202);
    showTimePicker ? $.__views.__alloyId202.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId202!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId203.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId198.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId205);
    ...
    $.__views.__alloyId205.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
    __defers["$.__views.__alloyId199!click!showDatePicker"] && $.__views.__alloyId199.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId202!click!showTimePicker"] && $.__views.__alloyId202.addEventListener("click", showTimePicker);
