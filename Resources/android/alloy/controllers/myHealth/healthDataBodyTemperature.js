...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId341;
    ...
    $.__views.__alloyId343.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId344);
    ...
    $.__views.__alloyId345.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId346.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId348, "click", showDatePicker) : __defers["$.__views.__alloyId348!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId349.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId352, "click", showTimePicker) : __defers["$.__views.__alloyId352!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId353.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId356);
    ...
    $.__views.__alloyId356.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId348!click!showDatePicker"] && $.addListener($.__views.__alloyId348, "click", showDatePicker);
    __defers["$.__views.__alloyId352!click!showTimePicker"] && $.addListener($.__views.__alloyId352, "click", showTimePicker);
