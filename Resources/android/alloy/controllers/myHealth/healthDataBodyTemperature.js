...
<<<<<<< HEAD
    $.__views.__alloyId667.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId667;
=======
    $.__views.__alloyId665.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId665;
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.main.add($.__views.__alloyId668);
...
=======
    ...
    $.__views.main.add($.__views.__alloyId666);
    $.__views.__alloyId667 = Ti.UI.createView({
        left: 0,
        width: "20%",
        id: "__alloyId667"
...
<<<<<<< HEAD
    $.__views.__alloyId669.add($.__views.btnBack);
=======
    $.__views.__alloyId667.add($.__views.btnBack);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId668.add($.__views.pageTitle);
    $.__views.__alloyId670 = Ti.UI.createLabel({
=======
    $.__views.__alloyId666.add($.__views.pageTitle);
...
<<<<<<< HEAD
    ...
    $.__views.pageTitle.add($.__views.__alloyId670);
...
=======
    ...
    $.__views.pageTitle.add($.__views.__alloyId668);
    $.__views.__alloyId669 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId669"
    });
...
<<<<<<< HEAD
    $.__views.__alloyId671.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
...
=======
    $.__views.__alloyId669.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId670);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId672.add($.__views.description);
=======
    $.__views.__alloyId670.add($.__views.description);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.table.add($.__views.__alloyId673);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId674, "click", showDatePicker) : __defers["$.__views.__alloyId674!click!showDatePicker"] = true;
...
=======
    ...
    showDatePicker ? $.addListener($.__views.__alloyId672, "click", showDatePicker) : __defers["$.__views.__alloyId672!click!showDatePicker"] = true;
    $.__views.__alloyId673 = Ti.UI.createView({
>>>>>>> origin/master
        layout: "horizontal",
        height: 45,
...
<<<<<<< HEAD
    $.__views.__alloyId675.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId677);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId678, "click", showTimePicker) : __defers["$.__views.__alloyId678!click!showTimePicker"] = true;
...
=======
    $.__views.__alloyId673.add($.__views.date_value);
    $.__views.__alloyId675 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
    ...
    showTimePicker ? $.addListener($.__views.__alloyId676, "click", showTimePicker) : __defers["$.__views.__alloyId676!click!showTimePicker"] = true;
    $.__views.__alloyId677 = Ti.UI.createView({
        layout: "horizontal",
        height: 45,
        width: "100%",
...
<<<<<<< HEAD
    $.__views.__alloyId679.add($.__views.time_value);
...
=======
    $.__views.__alloyId677.add($.__views.time_value);
    $.__views.__alloyId679 = Ti.UI.createView({
        width: Titanium.UI.FILL,
        height: 1,
        backgroundColor: "#F6F6F6",
...
<<<<<<< HEAD
    ...
    $.__views.tvrField1.add($.__views.__alloyId682);
...
=======
    ...
    $.__views.tvrField1.add($.__views.__alloyId680);
...
<<<<<<< HEAD
    $.__views.__alloyId682.add($.__views.field1);
=======
    $.__views.__alloyId680.add($.__views.field1);
>>>>>>> origin/master
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
<<<<<<< HEAD
    __defers["$.__views.__alloyId674!click!showDatePicker"] && $.addListener($.__views.__alloyId674, "click", showDatePicker);
    __defers["$.__views.__alloyId678!click!showTimePicker"] && $.addListener($.__views.__alloyId678, "click", showTimePicker);
=======
    __defers["$.__views.__alloyId672!click!showDatePicker"] && $.addListener($.__views.__alloyId672, "click", showDatePicker);
    __defers["$.__views.__alloyId676!click!showTimePicker"] && $.addListener($.__views.__alloyId676, "click", showTimePicker);
>>>>>>> origin/master
