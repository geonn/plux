...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId318;
    ...
    $.__views.__alloyId319.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId321);
    ...
    $.__views.__alloyId322.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId323);
    ...
    $.__views.__alloyId323.add($.__views.description);
    ...
    showDatePicker ? $.__views.__alloyId325.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId325!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId326.add($.__views.date_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId333);
    ...
    $.__views.__alloyId333.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
    __defers["$.__views.__alloyId325!click!showDatePicker"] && $.__views.__alloyId325.addEventListener("click", showDatePicker);
