...
function Controller() {
    ...
    $.__views.__alloyId207.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId207;
    ...
    $.__views.__alloyId212.add($.__views.description);
    var __alloyId213 = [];
    ...
    showDatePicker ? $.__views.__alloyId214.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId214!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId215.add($.__views.date_value);
    $.__views.__alloyId217 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId217"
    });
    __alloyId213.push($.__views.__alloyId217);
    showTimePicker ? $.__views.__alloyId217.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId217!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId218.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId213.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId220);
    ...
    $.__views.__alloyId220.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
    __defers["$.__views.__alloyId214!click!showDatePicker"] && $.__views.__alloyId214.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId217!click!showTimePicker"] && $.__views.__alloyId217.addEventListener("click", showTimePicker);
