...
function Controller() {
    ...
    $.__views.__alloyId789.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId789;
    $.__views.__alloyId790 = Ti.UI.createView({
        id: "__alloyId790"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId790);
    ...
    $.__views.__alloyId790.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId791);
    ...
    $.__views.__alloyId790.add($.__views.main);
    ...
    $.__views.__alloyId795.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
