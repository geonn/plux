...
<<<<<<< HEAD
    $.__views.__alloyId733.add($.__views.editButton);
=======
    $.__views.__alloyId721.add($.__views.editButton);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId733.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId733;
    $.__views.__alloyId734 = Ti.UI.createView({
        id: "__alloyId734"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId734);
=======
    $.__views.__alloyId721.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId721;
    $.__views.__alloyId722 = Ti.UI.createView({
        id: "__alloyId722"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId722);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId734.add($.__views.loadingBar);
=======
    $.__views.__alloyId722.add($.__views.loadingBar);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.loadingBar.add($.__views.__alloyId735);
=======
        id: "__alloyId723"
    });
...
<<<<<<< HEAD
    $.__views.__alloyId734.add($.__views.main);
    $.__views.__alloyId736 = Ti.UI.createView({
=======
    $.__views.__alloyId722.add($.__views.main);
...
<<<<<<< HEAD
    $.__views.__alloyId739.add($.__views.editButton);
=======
...
<<<<<<< HEAD
    $.__views.__alloyId739.add($.__views.doneButton);
=======
    $.__views.__alloyId727.add($.__views.doneButton);
>>>>>>> origin/master
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
