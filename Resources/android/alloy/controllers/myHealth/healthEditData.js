...
=======
    $.__views.__alloyId786.add($.__views.editButton);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId787.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId787;
    $.__views.__alloyId788 = Ti.UI.createView({
        id: "__alloyId788"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId788);
=======
    $.__views.__alloyId786.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId786;
    $.__views.__alloyId787 = Ti.UI.createView({
        id: "__alloyId787"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId787);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId788.add($.__views.loadingBar);
=======
    $.__views.__alloyId787.add($.__views.loadingBar);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.loadingBar.add($.__views.__alloyId789);
=======
        id: "__alloyId788"
    });
    $.__views.loadingBar.add($.__views.__alloyId788);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId788.add($.__views.main);
    $.__views.__alloyId790 = Ti.UI.createView({
=======
    $.__views.__alloyId787.add($.__views.main);
...
=======
    $.__views.__alloyId790.add($.__views.btnBack);
>>>>>>> origin/master
...
=======
    $.__views.__alloyId789.add($.__views.pageTitle);
...
=======
    ...
    $.__views.pageTitle.add($.__views.__alloyId791);
...
=======
    $.__views.__alloyId792.add($.__views.editButton);
>>>>>>> origin/master
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.doneButton = Ti.UI.createButton({
        font: {
...
<<<<<<< HEAD
    $.__views.__alloyId793.add($.__views.doneButton);
=======
    $.__views.__alloyId792.add($.__views.doneButton);
>>>>>>> origin/master
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
