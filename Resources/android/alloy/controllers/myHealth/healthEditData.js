...
function Controller() {
    ...
    $.__views.__alloyId259.add($.__views.editButton);
    ...
    $.__views.__alloyId259.add($.__views.doneButton);
    doDone ? $.__views.doneButton.addEventListener("touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId259;
    $.__views.__alloyId260 = Ti.UI.createView({
        id: "__alloyId260"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId260);
    ...
    $.__views.__alloyId265.add($.__views.editButton);
    doEditRecords ? $.__views.editButton.addEventListener("touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.doneButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId265.add($.__views.doneButton);
    doDone ? $.__views.doneButton.addEventListener("touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
