...
function Controller() {
    ...
    $.__views.__alloyId389.add($.__views.editButton);
    ...
    $.__views.__alloyId389.add($.__views.doneButton);
    doDone ? $.__views.doneButton.addEventListener("touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId389;
    $.__views.__alloyId390 = Ti.UI.createView({
        id: "__alloyId390"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId390);
    ...
    $.__views.__alloyId390.add($.__views.loadingBar);
    ...
    $.__views.__alloyId395.add($.__views.editButton);
    doEditRecords ? $.__views.editButton.addEventListener("touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.doneButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId395.add($.__views.doneButton);
    doDone ? $.__views.doneButton.addEventListener("touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
