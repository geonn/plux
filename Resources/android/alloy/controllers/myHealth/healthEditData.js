...
<<<<<<< HEAD
    $.__views.__alloyId510.add($.__views.editButton);
=======
    $.__views.__alloyId512.add($.__views.editButton);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId510.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId510;
    $.__views.__alloyId511 = Ti.UI.createView({
        id: "__alloyId511"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId511);
=======
    $.__views.__alloyId512.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId512;
    $.__views.__alloyId513 = Ti.UI.createView({
        id: "__alloyId513"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId513);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId511.add($.__views.loadingBar);
=======
    $.__views.__alloyId513.add($.__views.loadingBar);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.loadingBar.add($.__views.__alloyId512);
=======
        id: "__alloyId514"
    });
...
<<<<<<< HEAD
    $.__views.__alloyId511.add($.__views.main);
    $.__views.__alloyId513 = Ti.UI.createView({
=======
    $.__views.__alloyId513.add($.__views.main);
...
<<<<<<< HEAD
    $.__views.__alloyId516.add($.__views.editButton);
=======
    $.__views.__alloyId518.add($.__views.editButton);
>>>>>>> origin/master
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.doneButton = Ti.UI.createButton({
        font: {
...
<<<<<<< HEAD
    $.__views.__alloyId516.add($.__views.doneButton);
=======
    $.__views.__alloyId518.add($.__views.doneButton);
>>>>>>> origin/master
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
