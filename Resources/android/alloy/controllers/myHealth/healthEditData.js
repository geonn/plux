...
function Controller() {
    ...
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId759;
    $.__views.__alloyId760 = Ti.UI.createView({
        id: "__alloyId760"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId760);
    ...
    $.__views.__alloyId765.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
