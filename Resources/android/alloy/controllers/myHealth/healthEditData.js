...
function Controller() {
    ...
    $.__views.__alloyId782.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId782;
    $.__views.__alloyId783 = Ti.UI.createView({
        id: "__alloyId783"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId783);
    ...
    $.__views.__alloyId783.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId784);
    ...
    $.__views.__alloyId783.add($.__views.main);
    ...
    $.__views.__alloyId786.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId785.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId787);
    ...
    $.__views.__alloyId788.add($.__views.editButton);
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.doneButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId788.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
