...
function Controller() {
    ...
    $.__views.__alloyId610.add($.__views.editButton);
    ...
    $.__views.__alloyId610.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId610;
    $.__views.__alloyId611 = Ti.UI.createView({
        id: "__alloyId611"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId611);
    ...
    $.__views.__alloyId611.add($.__views.loadingBar);
    ...
    $.__views.__alloyId611.add($.__views.main);
    ...
    $.__views.__alloyId616.add($.__views.editButton);
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.doneButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId616.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
