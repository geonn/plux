...
function Controller() {
    ...
    $.__views.__alloyId430.add($.__views.editButton);
    ...
    $.__views.__alloyId430.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId430;
    $.__views.__alloyId431 = Ti.UI.createView({
        id: "__alloyId431"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId431);
    ...
    $.__views.__alloyId431.add($.__views.loadingBar);
    ...
    $.__views.__alloyId431.add($.__views.main);
    ...
    $.__views.__alloyId436.add($.__views.editButton);
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.doneButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId436.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
