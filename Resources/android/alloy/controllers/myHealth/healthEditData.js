...
function Controller() {
    ...
    $.__views.__alloyId756.add($.__views.editButton);
    ...
    $.__views.__alloyId756.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId756;
    $.__views.__alloyId757 = Ti.UI.createView({
        id: "__alloyId757"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId757);
    ...
    $.__views.__alloyId757.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId758);
    ...
    $.__views.__alloyId757.add($.__views.main);
    ...
    $.__views.__alloyId762.add($.__views.editButton);
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.doneButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId762.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
