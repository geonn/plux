...
function Controller() {
    ...
    $.__views.__alloyId447.add($.__views.editButton);
    ...
    $.__views.__alloyId447.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId447;
    $.__views.__alloyId448 = Ti.UI.createView({
        id: "__alloyId448"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId448);
    ...
    $.__views.__alloyId448.add($.__views.loadingBar);
    ...
    $.__views.__alloyId448.add($.__views.main);
    ...
    $.__views.__alloyId450.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId452);
    $.__views.__alloyId453 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId453"
    });
    $.__views.__alloyId450.add($.__views.__alloyId453);
    $.__views.editButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
        },
    ...
    $.__views.__alloyId453.add($.__views.editButton);
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.doneButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId453.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
