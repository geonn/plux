...
function Controller() {
    ...
    $.__views.__alloyId780.add($.__views.editButton);
    ...
    $.__views.__alloyId780.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId780;
    $.__views.__alloyId781 = Ti.UI.createView({
        id: "__alloyId781"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId781);
    ...
    $.__views.__alloyId781.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId782);
    ...
    $.__views.__alloyId784.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId783.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId785);
