...
function Controller() {
    ...
    $.__views.__alloyId601.add($.__views.editButton);
    ...
    $.__views.__alloyId601.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId601;
    $.__views.__alloyId602 = Ti.UI.createView({
        id: "__alloyId602"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId602);
    ...
    $.__views.__alloyId602.add($.__views.loadingBar);
    ...
    $.__views.__alloyId602.add($.__views.main);
    ...
    $.__views.main.add($.__views.__alloyId604);
    ...
    $.__views.__alloyId604.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId606);
    ...
    $.__views.__alloyId607.add($.__views.editButton);
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.doneButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId607.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
