...
function Controller() {
    ...
    $.__views.__alloyId744.add($.__views.editButton);
    ...
    $.__views.__alloyId744.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId744;
    $.__views.__alloyId745 = Ti.UI.createView({
        id: "__alloyId745"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId745);
    ...
    $.__views.__alloyId745.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId746);
    ...
    $.__views.__alloyId745.add($.__views.main);
    ...
    $.__views.__alloyId747.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId749);
    ...
    $.__views.__alloyId750.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
