...
function Controller() {
    ...
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId757;
    $.__views.__alloyId758 = Ti.UI.createView({
        id: "__alloyId758"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId758);
    ...
    $.__views.__alloyId758.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId759);
    ...
    $.__views.__alloyId758.add($.__views.main);
    ...
    $.__views.__alloyId763.add($.__views.editButton);
    doEditRecords ? $.addListener($.__views.editButton, "touchend", doEditRecords) : __defers["$.__views.editButton!touchend!doEditRecords"] = true;
    $.__views.doneButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
    ...
    $.__views.__alloyId763.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
