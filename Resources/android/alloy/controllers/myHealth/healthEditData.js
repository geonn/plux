...
function Controller() {
    ...
    $.__views.__alloyId366.add($.__views.editButton);
    ...
    $.__views.__alloyId366.add($.__views.doneButton);
    doDone ? $.__views.doneButton.addEventListener("touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId366;
    $.__views.__alloyId367 = Ti.UI.createView({
        id: "__alloyId367"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId367);
    ...
    $.__views.__alloyId367.add($.__views.loadingBar);
    ...
    $.__views.__alloyId367.add($.__views.main);
    ...
    $.__views.main.add($.__views.__alloyId369);
    ...
    $.__views.pageTitle.add($.__views.__alloyId371);
    ...
    $.__views.__alloyId372.add($.__views.doneButton);
    doDone ? $.__views.doneButton.addEventListener("touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
