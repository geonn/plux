...
=======
    $.__views.__alloyId753.add($.__views.editButton);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId755.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId755;
    $.__views.__alloyId756 = Ti.UI.createView({
        id: "__alloyId756"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId756);
=======
    $.__views.__alloyId753.add($.__views.doneButton);
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId753;
    $.__views.__alloyId754 = Ti.UI.createView({
        id: "__alloyId754"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId754);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId756.add($.__views.loadingBar);
=======
    $.__views.__alloyId754.add($.__views.loadingBar);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.loadingBar.add($.__views.__alloyId757);
=======
        id: "__alloyId755"
    });
    $.__views.loadingBar.add($.__views.__alloyId755);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId761.add($.__views.editButton);
=======
...
<<<<<<< HEAD
    $.__views.__alloyId761.add($.__views.doneButton);
=======
    $.__views.__alloyId759.add($.__views.doneButton);
>>>>>>> origin/master
    doDone ? $.addListener($.__views.doneButton, "touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
