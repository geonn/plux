...
function Controller() {
    ...
    $.__views.__alloyId305.add($.__views.editButton);
    ...
    $.__views.__alloyId305.add($.__views.doneButton);
    doDone ? $.__views.doneButton.addEventListener("touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
    $.__views.healthEditWindow.rightNavButton = $.__views.__alloyId305;
    $.__views.__alloyId306 = Ti.UI.createView({
        id: "__alloyId306"
    });
    $.__views.healthEditWindow.add($.__views.__alloyId306);
    ...
    $.__views.loadingBar.add($.__views.__alloyId307);
    ...
    $.__views.__alloyId311.add($.__views.doneButton);
    doDone ? $.__views.doneButton.addEventListener("touchend", doDone) : __defers["$.__views.doneButton!touchend!doDone"] = true;
