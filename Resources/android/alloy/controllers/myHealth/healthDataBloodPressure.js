...
function Controller() {
    ...
    $.__views.__alloyId658.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId658;
    ...
    $.__views.main.add($.__views.__alloyId659);
    ...
    $.__views.__alloyId660.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId659.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId661);
    $.__views.__alloyId662 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId662"
    });
    $.__views.__alloyId659.add($.__views.__alloyId662);
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
        },
    ...
    $.__views.__alloyId662.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId663.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId665, "click", showDatePicker) : __defers["$.__views.__alloyId665!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId666.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId669, "click", showTimePicker) : __defers["$.__views.__alloyId669!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId670.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId673);
    ...
    $.__views.__alloyId673.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId676);
    ...
    $.__views.__alloyId676.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId665!click!showDatePicker"] && $.addListener($.__views.__alloyId665, "click", showDatePicker);
    __defers["$.__views.__alloyId669!click!showTimePicker"] && $.addListener($.__views.__alloyId669, "click", showTimePicker);
