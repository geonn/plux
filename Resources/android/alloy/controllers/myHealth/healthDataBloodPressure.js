...
function Controller() {
    ...
    $.__views.__alloyId298.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId298;
    ...
    $.__views.__alloyId302.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId303.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId305, "click", showDatePicker) : __defers["$.__views.__alloyId305!click!showDatePicker"] = true;
    ...
    showTimePicker ? $.addListener($.__views.__alloyId309, "click", showTimePicker) : __defers["$.__views.__alloyId309!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId310.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId313);
    ...
    $.__views.__alloyId313.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId316);
    ...
    $.__views.__alloyId316.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId305!click!showDatePicker"] && $.addListener($.__views.__alloyId305, "click", showDatePicker);
    __defers["$.__views.__alloyId309!click!showTimePicker"] && $.addListener($.__views.__alloyId309, "click", showTimePicker);
