...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId158;
    ...
    $.__views.__alloyId160.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId159.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId161);
    ...
    $.__views.__alloyId162.add($.__views.saveButton);
    doSaveRecords ? $.__views.saveButton.addEventListener("touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId163.add($.__views.description);
    var __alloyId164 = [];
    ...
    showDatePicker ? $.__views.__alloyId165.addEventListener("click", showDatePicker) : __defers["$.__views.__alloyId165!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId166.add($.__views.date_value);
    $.__views.__alloyId168 = Ti.UI.createTableViewRow({
        selectedBackgroundColor: "#ffffff",
        id: "__alloyId168"
    });
    __alloyId164.push($.__views.__alloyId168);
    showTimePicker ? $.__views.__alloyId168.addEventListener("click", showTimePicker) : __defers["$.__views.__alloyId168!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId169.add($.__views.time_value);
    $.__views.tvrField1 = Ti.UI.createTableViewRow({
        id: "tvrField1",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId164.push($.__views.tvrField1);
    ...
    $.__views.tvrField1.add($.__views.__alloyId171);
    ...
    $.__views.__alloyId171.add($.__views.field1);
    $.__views.tvrField2 = Ti.UI.createTableViewRow({
        id: "tvrField2",
        selectedBackgroundColor: "#ffffff"
    });
    __alloyId164.push($.__views.tvrField2);
    ...
    $.__views.tvrField2.add($.__views.__alloyId173);
    ...
    $.__views.__alloyId173.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.__views.saveButton.addEventListener("touchend", doSaveRecords);
    __defers["$.__views.__alloyId165!click!showDatePicker"] && $.__views.__alloyId165.addEventListener("click", showDatePicker);
    __defers["$.__views.__alloyId168!click!showTimePicker"] && $.__views.__alloyId168.addEventListener("click", showTimePicker);
