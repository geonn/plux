...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId613;
    ...
    showDatePicker ? $.addListener($.__views.__alloyId620, "click", showDatePicker) : __defers["$.__views.__alloyId620!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId621.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId624, "click", showTimePicker) : __defers["$.__views.__alloyId624!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId625.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId628);
    ...
    $.__views.__alloyId628.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId631);
    ...
    $.__views.__alloyId631.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId620!click!showDatePicker"] && $.addListener($.__views.__alloyId620, "click", showDatePicker);
    __defers["$.__views.__alloyId624!click!showTimePicker"] && $.addListener($.__views.__alloyId624, "click", showTimePicker);
