...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId608;
    ...
    $.__views.__alloyId610.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId609.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId611);
    ...
    $.__views.__alloyId612.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId613.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId615, "click", showDatePicker) : __defers["$.__views.__alloyId615!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId616.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId619, "click", showTimePicker) : __defers["$.__views.__alloyId619!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId620.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId623);
    ...
    $.__views.__alloyId623.add($.__views.field1);
    ...
    $.__views.table.add($.__views.__alloyId625);
    ...
    $.__views.tvrField2.add($.__views.__alloyId626);
    ...
    $.__views.__alloyId626.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId615!click!showDatePicker"] && $.addListener($.__views.__alloyId615, "click", showDatePicker);
    __defers["$.__views.__alloyId619!click!showTimePicker"] && $.addListener($.__views.__alloyId619, "click", showTimePicker);
