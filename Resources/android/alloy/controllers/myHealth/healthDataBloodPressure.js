...
function Controller() {
    ...
    $.__views.__alloyId478.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId478;
    ...
    $.__views.main.add($.__views.__alloyId479);
    ...
    $.__views.__alloyId483.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId485, "click", showDatePicker) : __defers["$.__views.__alloyId485!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId486.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId489, "click", showTimePicker) : __defers["$.__views.__alloyId489!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId490.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId493);
    ...
    $.__views.__alloyId493.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId496);
    ...
    $.__views.__alloyId496.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId485!click!showDatePicker"] && $.addListener($.__views.__alloyId485, "click", showDatePicker);
    __defers["$.__views.__alloyId489!click!showTimePicker"] && $.addListener($.__views.__alloyId489, "click", showTimePicker);
