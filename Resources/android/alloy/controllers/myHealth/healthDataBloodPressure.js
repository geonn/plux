...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId649;
    ...
    $.__views.__alloyId653.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId654);
    ...
    $.__views.__alloyId654.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId656, "click", showDatePicker) : __defers["$.__views.__alloyId656!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId657.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId660, "click", showTimePicker) : __defers["$.__views.__alloyId660!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId661.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId664);
    ...
    $.__views.__alloyId664.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId667);
    ...
    $.__views.__alloyId667.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId656!click!showDatePicker"] && $.addListener($.__views.__alloyId656, "click", showDatePicker);
    __defers["$.__views.__alloyId660!click!showTimePicker"] && $.addListener($.__views.__alloyId660, "click", showTimePicker);
