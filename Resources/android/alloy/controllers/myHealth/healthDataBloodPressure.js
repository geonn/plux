...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId654;
    ...
    $.__views.__alloyId656.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId655.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId657);
    $.__views.__alloyId658 = Ti.UI.createView({
        width: "20%",
        id: "__alloyId658"
    });
    $.__views.__alloyId655.add($.__views.__alloyId658);
    $.__views.saveButton = Ti.UI.createButton({
        font: {
            fontSize: "10dp"
        },
    ...
    $.__views.__alloyId659.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId661, "click", showDatePicker) : __defers["$.__views.__alloyId661!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId662.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId665, "click", showTimePicker) : __defers["$.__views.__alloyId665!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId666.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId669);
    ...
    $.__views.__alloyId669.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId672);
    ...
    $.__views.__alloyId672.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId661!click!showDatePicker"] && $.addListener($.__views.__alloyId661, "click", showDatePicker);
    __defers["$.__views.__alloyId665!click!showTimePicker"] && $.addListener($.__views.__alloyId665, "click", showTimePicker);
