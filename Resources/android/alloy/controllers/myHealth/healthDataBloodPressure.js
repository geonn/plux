...
function Controller() {
    ...
    $.__views.__alloyId388.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId388;
    ...
    $.__views.main.add($.__views.__alloyId389);
    ...
    $.__views.__alloyId390.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId389.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId391);
    ...
    $.__views.__alloyId392.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId393.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId395, "click", showDatePicker) : __defers["$.__views.__alloyId395!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId396.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId399, "click", showTimePicker) : __defers["$.__views.__alloyId399!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId400.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId403);
    ...
    $.__views.__alloyId403.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId406);
    ...
    $.__views.__alloyId406.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId395!click!showDatePicker"] && $.addListener($.__views.__alloyId395, "click", showDatePicker);
    __defers["$.__views.__alloyId399!click!showTimePicker"] && $.addListener($.__views.__alloyId399, "click", showTimePicker);
