...
function Controller() {
    ...
    $.__views.__alloyId620.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId620;
    ...
    $.__views.__alloyId624.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId625.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId627, "click", showDatePicker) : __defers["$.__views.__alloyId627!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId628.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId630);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId631, "click", showTimePicker) : __defers["$.__views.__alloyId631!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId632.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId635);
    ...
    $.__views.__alloyId635.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId638);
    ...
    $.__views.__alloyId638.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId627!click!showDatePicker"] && $.addListener($.__views.__alloyId627, "click", showDatePicker);
    __defers["$.__views.__alloyId631!click!showTimePicker"] && $.addListener($.__views.__alloyId631, "click", showTimePicker);
