...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId475;
    ...
    showDatePicker ? $.addListener($.__views.__alloyId482, "click", showDatePicker) : __defers["$.__views.__alloyId482!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId483.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId486, "click", showTimePicker) : __defers["$.__views.__alloyId486!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId487.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId490);
    ...
    $.__views.__alloyId490.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId493);
    ...
    $.__views.__alloyId493.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId482!click!showDatePicker"] && $.addListener($.__views.__alloyId482, "click", showDatePicker);
    __defers["$.__views.__alloyId486!click!showTimePicker"] && $.addListener($.__views.__alloyId486, "click", showTimePicker);
