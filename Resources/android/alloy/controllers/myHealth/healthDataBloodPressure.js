...
function Controller() {
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId568;
    ...
    $.__views.__alloyId569.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId571);
    ...
    $.__views.__alloyId573.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId575, "click", showDatePicker) : __defers["$.__views.__alloyId575!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId576.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId579, "click", showTimePicker) : __defers["$.__views.__alloyId579!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId580.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId583);
    ...
    $.__views.__alloyId583.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId586);
    ...
    $.__views.__alloyId586.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId575!click!showDatePicker"] && $.addListener($.__views.__alloyId575, "click", showDatePicker);
    __defers["$.__views.__alloyId579!click!showTimePicker"] && $.addListener($.__views.__alloyId579, "click", showTimePicker);
