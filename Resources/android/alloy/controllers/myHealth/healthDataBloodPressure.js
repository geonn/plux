...
function Controller() {
    ...
    $.__views.__alloyId569.add($.__views.saveButton);
    ...
    $.__views.healthDBPWin.rightNavButton = $.__views.__alloyId569;
    ...
    $.__views.main.add($.__views.__alloyId570);
    ...
    $.__views.__alloyId571.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId572);
    ...
    $.__views.__alloyId573.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId574);
    ...
    $.__views.__alloyId574.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId576, "click", showDatePicker) : __defers["$.__views.__alloyId576!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId577.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId580, "click", showTimePicker) : __defers["$.__views.__alloyId580!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId581.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId584);
    ...
    $.__views.__alloyId584.add($.__views.field1);
    ...
    $.__views.tvrField2.add($.__views.__alloyId587);
    ...
    $.__views.__alloyId587.add($.__views.field2);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId576!click!showDatePicker"] && $.addListener($.__views.__alloyId576, "click", showDatePicker);
    __defers["$.__views.__alloyId580!click!showTimePicker"] && $.addListener($.__views.__alloyId580, "click", showTimePicker);
