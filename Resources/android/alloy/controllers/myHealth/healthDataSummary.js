...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId686);
    ...
    $.__views.__alloyId686.add($.__views.main);
    ...
    __alloyId690.push(__alloyId693);
    var __alloyId694 = {
        font: {
            fontSize: "12dp"
        },
    ...
    __alloyId690.push(__alloyId694);
    ...
    __alloyId695.push($.__views.__alloyId696);
    editData ? $.addListener($.__views.__alloyId696, "click", editData) : __defers["$.__views.__alloyId696!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId696!click!editData"] && $.addListener($.__views.__alloyId696, "click", editData);
    _.extend($, exports);
}
