...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId291);
    ...
    $.__views.__alloyId291.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId292);
    ...
    $.__views.__alloyId291.add($.__views.main);
    ...
    addData ? $.__views.__alloyId302.addEventListener("click", addData) : __defers["$.__views.__alloyId302!click!addData"] = true;
    ...
    __alloyId301.push($.__views.__alloyId303);
    editData ? $.__views.__alloyId303.addEventListener("click", editData) : __defers["$.__views.__alloyId303!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId302!click!addData"] && $.__views.__alloyId302.addEventListener("click", addData);
    __defers["$.__views.__alloyId303!click!editData"] && $.__views.__alloyId303.addEventListener("click", editData);
    _.extend($, exports);
}
