...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId417);
    ...
    $.__views.__alloyId417.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId418);
    ...
    $.__views.__alloyId419.add($.__views.pageTitle);
    ...
    __alloyId422.push(__alloyId425);
    var __alloyId426 = {
        font: {
            fontSize: "12dp"
        },
    ...
    __alloyId427.push($.__views.__alloyId428);
    editData ? $.addListener($.__views.__alloyId428, "click", editData) : __defers["$.__views.__alloyId428!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId428!click!editData"] && $.addListener($.__views.__alloyId428, "click", editData);
    _.extend($, exports);
}
