...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId777);
    ...
    $.__views.__alloyId777.add($.__views.main);
    ...
    __alloyId781.push(__alloyId784);
    var __alloyId785 = {
        font: {
            fontSize: "12dp"
        },
    ...
    __alloyId781.push(__alloyId785);
    ...
    __alloyId786.push($.__views.addHealthData);
    ...
    __alloyId786.push($.__views.__alloyId787);
    editData ? $.addListener($.__views.__alloyId787, "click", editData) : __defers["$.__views.__alloyId787!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId787!click!editData"] && $.addListener($.__views.__alloyId787, "click", editData);
    _.extend($, exports);
}
