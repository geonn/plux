...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId434);
    ...
    $.__views.__alloyId434.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId435);
    ...
    $.__views.__alloyId434.add($.__views.main);
    ...
    __alloyId439.push(__alloyId442);
    var __alloyId443 = {
        font: {
            fontSize: "12dp"
        },
    ...
    __alloyId439.push(__alloyId443);
    ...
    __alloyId444.push($.__views.__alloyId445);
    editData ? $.addListener($.__views.__alloyId445, "click", editData) : __defers["$.__views.__alloyId445!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId445!click!editData"] && $.addListener($.__views.__alloyId445, "click", editData);
    _.extend($, exports);
}
