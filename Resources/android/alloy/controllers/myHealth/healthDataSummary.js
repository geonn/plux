...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId594);
    ...
    $.__views.__alloyId594.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId595);
    ...
    $.__views.__alloyId594.add($.__views.main);
    ...
    $.__views.pageTitle.add($.__views.__alloyId598);
    var __alloyId599 = [];
    var __alloyId602 = {
        font: {
            fontSize: "12dp"
    ...
    __alloyId599.push(__alloyId602);
    var __alloyId603 = {
        font: {
            fontSize: "12dp"
        },
    ...
    __alloyId599.push(__alloyId603);
    ...
    __alloyId604.push($.__views.__alloyId605);
    editData ? $.addListener($.__views.__alloyId605, "click", editData) : __defers["$.__views.__alloyId605!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId605!click!editData"] && $.addListener($.__views.__alloyId605, "click", editData);
    _.extend($, exports);
}
