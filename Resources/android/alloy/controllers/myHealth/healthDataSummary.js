...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId245);
    ...
    $.__views.__alloyId245.add($.__views.loadingBar);
    ...
    $.__views.__alloyId247.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId249);
    var __alloyId250 = [];
    var __alloyId253 = {
        title: "Month"
    };
    __alloyId250.push(__alloyId253);
    var __alloyId254 = {
        title: "Year"
    };
    __alloyId250.push(__alloyId254);
    ...
    __alloyId255.push($.__views.__alloyId256);
    addData ? $.__views.__alloyId256.addEventListener("click", addData) : __defers["$.__views.__alloyId256!click!addData"] = true;
    ...
    editData ? $.__views.__alloyId257.addEventListener("click", editData) : __defers["$.__views.__alloyId257!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId256!click!addData"] && $.__views.__alloyId256.addEventListener("click", addData);
    __defers["$.__views.__alloyId257!click!editData"] && $.__views.__alloyId257.addEventListener("click", editData);
    _.extend($, exports);
}
