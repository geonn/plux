...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId773);
    ...
    $.__views.__alloyId773.add($.__views.main);
    ...
    __alloyId777.push(__alloyId780);
    var __alloyId781 = {
        font: {
            fontSize: "12dp"
        },
    ...
    __alloyId782.push($.__views.addHealthData);
    ...
    __alloyId782.push($.__views.__alloyId783);
    editData ? $.addListener($.__views.__alloyId783, "click", editData) : __defers["$.__views.__alloyId783!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId783!click!editData"] && $.addListener($.__views.__alloyId783, "click", editData);
    _.extend($, exports);
}
