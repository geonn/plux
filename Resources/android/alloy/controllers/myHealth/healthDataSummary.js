...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId768);
    ...
    $.__views.__alloyId770.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "80%"
    });
    $.__views.__alloyId769.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId771);
    var __alloyId772 = [];
    var __alloyId775 = {
        font: {
            fontSize: "12dp"
    ...
    __alloyId772.push(__alloyId775);
    var __alloyId776 = {
        font: {
            fontSize: "12dp"
        },
    ...
    __alloyId777.push($.__views.__alloyId778);
    editData ? $.addListener($.__views.__alloyId778, "click", editData) : __defers["$.__views.__alloyId778!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId778!click!editData"] && $.addListener($.__views.__alloyId778, "click", editData);
    _.extend($, exports);
}
