...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId352);
    ...
    $.__views.__alloyId352.add($.__views.loadingBar);
    ...
    $.__views.__alloyId352.add($.__views.main);
    ...
    __alloyId357.push(__alloyId360);
    var __alloyId361 = {
        font: {
            fontSize: "12dp"
        },
    ...
    __alloyId357.push(__alloyId361);
    ...
    __alloyId362.push($.__views.__alloyId363);
    addData ? $.__views.__alloyId363.addEventListener("click", addData) : __defers["$.__views.__alloyId363!click!addData"] = true;
    ...
    __alloyId362.push($.__views.__alloyId364);
    editData ? $.__views.__alloyId364.addEventListener("click", editData) : __defers["$.__views.__alloyId364!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId363!click!addData"] && $.__views.__alloyId363.addEventListener("click", addData);
    __defers["$.__views.__alloyId364!click!editData"] && $.__views.__alloyId364.addEventListener("click", editData);
    _.extend($, exports);
}
