...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId731);
    ...
    $.__views.__alloyId731.add($.__views.main);
    ...
    __alloyId735.push(__alloyId738);
    var __alloyId739 = {
        font: {
            fontSize: "12dp"
        },
    ...
    __alloyId735.push(__alloyId739);
    ...
    __alloyId740.push($.__views.__alloyId741);
    editData ? $.addListener($.__views.__alloyId741, "click", editData) : __defers["$.__views.__alloyId741!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId741!click!editData"] && $.addListener($.__views.__alloyId741, "click", editData);
    _.extend($, exports);
}
