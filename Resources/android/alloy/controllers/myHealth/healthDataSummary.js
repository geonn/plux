...
function Controller() {
    ...
    $.__views.dashboard.add($.__views.__alloyId507);
    ...
    $.__views.__alloyId507.add($.__views.loadingBar);
    ...
    $.__views.__alloyId507.add($.__views.main);
    ...
    __alloyId512.push(__alloyId515);
    var __alloyId516 = {
        font: {
            fontSize: "12dp"
        },
    ...
    __alloyId512.push(__alloyId516);
    ...
    __alloyId517.push($.__views.__alloyId518);
    editData ? $.addListener($.__views.__alloyId518, "click", editData) : __defers["$.__views.__alloyId518!click!editData"] = true;
    ...
    __defers["$.__views.__alloyId518!click!editData"] && $.addListener($.__views.__alloyId518, "click", editData);
    _.extend($, exports);
}
