...
function Controller() {
    ...
    $.__views.__alloyId562.add($.__views.saveButton);
    ...
    $.__views.healthBGWin.rightNavButton = $.__views.__alloyId562;
    ...
    $.__views.main.add($.__views.__alloyId563);
    ...
    $.__views.__alloyId564.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId563.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId565);
    ...
    $.__views.__alloyId567.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId568, "click", showDatePicker) : __defers["$.__views.__alloyId568!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId569.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId572, "click", showTimePicker) : __defers["$.__views.__alloyId572!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId573.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId576);
    ...
    $.__views.__alloyId576.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId568!click!showDatePicker"] && $.addListener($.__views.__alloyId568, "click", showDatePicker);
    __defers["$.__views.__alloyId572!click!showTimePicker"] && $.addListener($.__views.__alloyId572, "click", showTimePicker);
