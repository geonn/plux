...
function Controller() {
    ...
    $.__views.healthBGWin.rightNavButton = $.__views.__alloyId709;
    ...
    $.__views.__alloyId713.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId714.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId715, "click", showDatePicker) : __defers["$.__views.__alloyId715!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId716.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId719, "click", showTimePicker) : __defers["$.__views.__alloyId719!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId720.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId723);
    ...
    $.__views.__alloyId723.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId715!click!showDatePicker"] && $.addListener($.__views.__alloyId715, "click", showDatePicker);
    __defers["$.__views.__alloyId719!click!showTimePicker"] && $.addListener($.__views.__alloyId719, "click", showTimePicker);
