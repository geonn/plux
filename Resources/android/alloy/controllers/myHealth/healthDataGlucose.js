...
function Controller() {
    ...
    $.__views.healthBGWin.rightNavButton = $.__views.__alloyId742;
    ...
    $.__views.pageTitle.add($.__views.__alloyId745);
    ...
    $.__views.__alloyId746.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId747.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId748, "click", showDatePicker) : __defers["$.__views.__alloyId748!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId749.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId752, "click", showTimePicker) : __defers["$.__views.__alloyId752!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId753.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId756);
    ...
    $.__views.__alloyId756.add($.__views.field1);
    ...
    $.__views.table.add($.__views.__alloyId758);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId748!click!showDatePicker"] && $.addListener($.__views.__alloyId748, "click", showDatePicker);
    __defers["$.__views.__alloyId752!click!showTimePicker"] && $.addListener($.__views.__alloyId752, "click", showTimePicker);
