...
function Controller() {
    ...
    $.__views.healthBGWin.rightNavButton = $.__views.__alloyId559;
    ...
    showDatePicker ? $.addListener($.__views.__alloyId565, "click", showDatePicker) : __defers["$.__views.__alloyId565!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId566.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId569, "click", showTimePicker) : __defers["$.__views.__alloyId569!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId570.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId573);
    ...
    $.__views.__alloyId573.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId565!click!showDatePicker"] && $.addListener($.__views.__alloyId565, "click", showDatePicker);
    __defers["$.__views.__alloyId569!click!showTimePicker"] && $.addListener($.__views.__alloyId569, "click", showTimePicker);
