...
function Controller() {
    ...
    $.__views.__alloyId705.add($.__views.saveButton);
    ...
    $.__views.healthBGWin.rightNavButton = $.__views.__alloyId705;
    ...
    $.__views.__alloyId706.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId708);
    ...
    $.__views.__alloyId709.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId710.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId711, "click", showDatePicker) : __defers["$.__views.__alloyId711!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId712.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId715, "click", showTimePicker) : __defers["$.__views.__alloyId715!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId716.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId719);
    ...
    $.__views.__alloyId719.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId711!click!showDatePicker"] && $.addListener($.__views.__alloyId711, "click", showDatePicker);
    __defers["$.__views.__alloyId715!click!showTimePicker"] && $.addListener($.__views.__alloyId715, "click", showTimePicker);
