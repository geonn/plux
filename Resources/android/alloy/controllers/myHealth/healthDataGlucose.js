...
function Controller() {
    ...
    $.__views.healthBGWin.rightNavButton = $.__views.__alloyId399;
    ...
    $.__views.__alloyId403.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId404.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId405, "click", showDatePicker) : __defers["$.__views.__alloyId405!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId406.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId409, "click", showTimePicker) : __defers["$.__views.__alloyId409!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId410.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId413);
    ...
    $.__views.__alloyId413.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId405!click!showDatePicker"] && $.addListener($.__views.__alloyId405, "click", showDatePicker);
    __defers["$.__views.__alloyId409!click!showTimePicker"] && $.addListener($.__views.__alloyId409, "click", showTimePicker);
