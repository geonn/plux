...
function Controller() {
    ...
    $.__views.__alloyId733.add($.__views.saveButton);
    ...
    $.__views.healthBGWin.rightNavButton = $.__views.__alloyId733;
    ...
    $.__views.__alloyId735.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId736);
    ...
    $.__views.__alloyId737.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId738.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId739, "click", showDatePicker) : __defers["$.__views.__alloyId739!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId740.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId743, "click", showTimePicker) : __defers["$.__views.__alloyId743!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId744.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId747);
    ...
    $.__views.__alloyId747.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId739!click!showDatePicker"] && $.addListener($.__views.__alloyId739, "click", showDatePicker);
    __defers["$.__views.__alloyId743!click!showTimePicker"] && $.addListener($.__views.__alloyId743, "click", showTimePicker);
