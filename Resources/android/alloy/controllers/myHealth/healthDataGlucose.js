...
function Controller() {
    ...
    $.__views.healthBGWin.rightNavButton = $.__views.__alloyId401;
    ...
    $.__views.pageTitle.add($.__views.__alloyId404);
    ...
    $.__views.__alloyId405.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId406.add($.__views.description);
