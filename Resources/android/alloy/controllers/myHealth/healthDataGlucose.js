...
function Controller() {
    ...
    $.__views.healthBGWin.rightNavButton = $.__views.__alloyId696;
    ...
    $.__views.__alloyId698.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId697.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId699);
    ...
    $.__views.__alloyId700.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId701.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId702, "click", showDatePicker) : __defers["$.__views.__alloyId702!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId703.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId706, "click", showTimePicker) : __defers["$.__views.__alloyId706!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId707.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId710);
    ...
    $.__views.__alloyId710.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId702!click!showDatePicker"] && $.addListener($.__views.__alloyId702, "click", showDatePicker);
    __defers["$.__views.__alloyId706!click!showTimePicker"] && $.addListener($.__views.__alloyId706, "click", showTimePicker);
