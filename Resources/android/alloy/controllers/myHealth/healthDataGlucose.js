...
function Controller() {
    ...
    $.__views.__alloyId738.add($.__views.saveButton);
    ...
    $.__views.healthBGWin.rightNavButton = $.__views.__alloyId738;
    ...
    $.__views.__alloyId740.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId739.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId741);
    ...
    $.__views.__alloyId742.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.__alloyId743.add($.__views.description);
    ...
    $.__views.table.add($.__views.__alloyId744);
    showDatePicker ? $.addListener($.__views.__alloyId744, "click", showDatePicker) : __defers["$.__views.__alloyId744!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId745.add($.__views.date_value);
    ...
    $.__views.table.add($.__views.__alloyId747);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId748, "click", showTimePicker) : __defers["$.__views.__alloyId748!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId749.add($.__views.time_value);
    ...
    $.__views.table.add($.__views.__alloyId751);
    ...
    $.__views.tvrField1.add($.__views.__alloyId752);
    ...
    $.__views.__alloyId752.add($.__views.field1);
    ...
    $.__views.table.add($.__views.__alloyId754);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId744!click!showDatePicker"] && $.addListener($.__views.__alloyId744, "click", showDatePicker);
    __defers["$.__views.__alloyId748!click!showTimePicker"] && $.addListener($.__views.__alloyId748, "click", showTimePicker);
