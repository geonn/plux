...
function Controller() {
  ...
  { backgroundColor: "#ffffff", orientationModes: [Ti.UI.PORTRAIT], fullscreen: false, windowSoftInputMode: Ti.UI.Android.SOFT_INPUT_STATE_HIDDEN, title: "Add Data", backButtonTitle: "", id: "healthBGWin", navTintColor: "#CE1D1C" });
  ...
  doSaveRecords ? $.addListener($.__views.saveButton, 'touchend', doSaveRecords) : __defers['$.__views.saveButton!touchend!doSaveRecords'] = true;$.__views.healthBGWin.rightNavButton = $.__views.__alloyId628;$.__views.main = Ti.UI.createView(
  ...
  if (true) {
    ...
    { layout: "horizontal", height: 50, width: "100%", backgroundColor: "#DEDEDE", id: "__alloyId629" });

    $.__views.main.add($.__views.__alloyId629);
    $.__views.__alloyId630 = Ti.UI.createView(
    { left: 0, width: "20%", id: "__alloyId630" });
    ...
    { width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'Add Data', textAlign: "center", id: "__alloyId631" });

    $.__views.pageTitle.add($.__views.__alloyId631);
    $.__views.__alloyId632 = Ti.UI.createView(
    { width: "20%", id: "__alloyId632" });
    ...
    $.__views.__alloyId632.add($.__views.saveButton);
  ...
  { layout: "vertical", height: 30, top: 10, id: "__alloyId633" });

  $.__views.main.add($.__views.__alloyId633);
  ...
  $.__views.__alloyId633.add($.__views.description);
  ...
  { height: Ti.UI.SIZE, selectedBackgroundColor: "#ffffff", id: "__alloyId634" });

  $.__views.table.add($.__views.__alloyId634);
  showDatePicker ? $.addListener($.__views.__alloyId634, 'click', showDatePicker) : __defers['$.__views.__alloyId634!click!showDatePicker'] = true;$.__views.__alloyId635 = Ti.UI.createView(
  { layout: "horizontal", height: 45, width: "100%", textAlign: "right", id: "__alloyId635" });

  $.__views.__alloyId634.add($.__views.__alloyId635);
  $.__views.__alloyId636 = Ti.UI.createLabel(
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "Date", top: 12, id: "__alloyId636" });
  ...
  $.__views.__alloyId635.add($.__views.date_value);
  $.__views.__alloyId637 = Ti.UI.createView(
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId637" });

  $.__views.table.add($.__views.__alloyId637);
  $.__views.__alloyId638 = Ti.UI.createView(
  { height: Ti.UI.SIZE, selectedBackgroundColor: "#ffffff", id: "__alloyId638" });

  $.__views.table.add($.__views.__alloyId638);
  showTimePicker ? $.addListener($.__views.__alloyId638, 'click', showTimePicker) : __defers['$.__views.__alloyId638!click!showTimePicker'] = true;$.__views.__alloyId639 = Ti.UI.createView(
  { layout: "horizontal", height: 45, width: "100%", id: "__alloyId639" });

  $.__views.__alloyId638.add($.__views.__alloyId639);
  $.__views.__alloyId640 = Ti.UI.createLabel(
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "Time", top: 12, id: "__alloyId640" });
  ...
  $.__views.__alloyId639.add($.__views.time_value);
  $.__views.__alloyId641 = Ti.UI.createView(
  { width: Titanium.UI.FILL, height: 1, backgroundColor: "#F6F6F6", id: "__alloyId641" });
  ...
  { layout: "horizontal", height: 55, width: "100%", id: "__alloyId642" });

  $.__views.tvrField1.add($.__views.__alloyId642);
  $.__views.__alloyId643 = Ti.UI.createLabel(
  { width: "50%", height: Titanium.UI.SIZE, color: "#A8A8A8", left: 20, font: { fontSize: "16dp" }, text: "Blood Glucose (mmol/L)", top: 12, id: "__alloyId643" });
  ...
  $.__views.__alloyId642.add($.__views.field1);
  ...
  __defers['$.__views.__alloyId634!click!showDatePicker'] && $.addListener($.__views.__alloyId634, 'click', showDatePicker);__defers['$.__views.__alloyId638!click!showTimePicker'] && $.addListener($.__views.__alloyId638, 'click', showTimePicker);__defers['$.__views.datePicker!change!changeDate'] && $.addListener($.__views.datePicker, 'change', changeDate);__defers['$.__views.timePicker!change!changeTime'] && $.addListener($.__views.timePicker, 'change', changeTime);
