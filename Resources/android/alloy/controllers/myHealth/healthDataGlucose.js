...
function Controller() {
    ...
    $.__views.healthBGWin.rightNavButton = $.__views.__alloyId653;
    ...
    $.__views.__alloyId655.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId654.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId656);
    ...
    $.__views.__alloyId657.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId658);
    ...
    $.__views.__alloyId658.add($.__views.description);
