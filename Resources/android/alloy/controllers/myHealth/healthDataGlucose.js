...
function Controller() {
    ...
    $.__views.__alloyId472.add($.__views.saveButton);
    ...
    $.__views.healthBGWin.rightNavButton = $.__views.__alloyId472;
    ...
    $.__views.__alloyId474.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId473.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId475);
    ...
    $.__views.__alloyId476.add($.__views.saveButton);
    doSaveRecords ? $.addListener($.__views.saveButton, "touchend", doSaveRecords) : __defers["$.__views.saveButton!touchend!doSaveRecords"] = true;
    ...
    $.__views.main.add($.__views.__alloyId477);
    ...
    $.__views.__alloyId477.add($.__views.description);
    ...
    showDatePicker ? $.addListener($.__views.__alloyId478, "click", showDatePicker) : __defers["$.__views.__alloyId478!click!showDatePicker"] = true;
    ...
    $.__views.__alloyId479.add($.__views.date_value);
    ...
    showTimePicker ? $.addListener($.__views.__alloyId482, "click", showTimePicker) : __defers["$.__views.__alloyId482!click!showTimePicker"] = true;
    ...
    $.__views.__alloyId483.add($.__views.time_value);
    ...
    $.__views.tvrField1.add($.__views.__alloyId486);
    ...
    $.__views.__alloyId486.add($.__views.field1);
    ...
    __defers["$.__views.saveButton!touchend!doSaveRecords"] && $.addListener($.__views.saveButton, "touchend", doSaveRecords);
    __defers["$.__views.__alloyId478!click!showDatePicker"] && $.addListener($.__views.__alloyId478, "click", showDatePicker);
    __defers["$.__views.__alloyId482!click!showTimePicker"] && $.addListener($.__views.__alloyId482, "click", showTimePicker);
