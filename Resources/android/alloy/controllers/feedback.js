...
function Controller() {
  ...
  if (true) {
    ...
    { layout: "horizontal", height: 50, width: Ti.UI.FILL, backgroundColor: "#DEDEDE", id: "__alloyId420" });

    $.__views.main.add($.__views.__alloyId420);
    $.__views.__alloyId421 = Ti.UI.createView(
    { left: 0, width: "10%", id: "__alloyId421" });

    $.__views.__alloyId420.add($.__views.__alloyId421);
    $.__views.btnBack = Ti.UI.createImageView(
    { left: 10, id: "btnBack", width: 25, height: 25, image: "/images/btn-back.png" });

    $.__views.__alloyId421.add($.__views.btnBack);
    $.__views.__alloyId422 = Ti.UI.createView(
    { width: "90%", id: "__alloyId422" });
  ...
  { width: Ti.UI.FILL, height: Titanium.UI.SIZE, color: "#606060", top: 10, left: 10, right: 10, bottom: 10, font: { fontSize: 14 }, text: "Please complete this form and submit to us.", id: "__alloyId423" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId424" });

  $.__views.tvrName.add($.__views.__alloyId424);
  $.__views.__alloyId425 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Name", top: 12, id: "__alloyId425" });
  ...
  $.__views.__alloyId424.add($.__views.name);
  $.__views.__alloyId426 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId426" });

  $.__views.table.add($.__views.__alloyId426);
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId427" });

  $.__views.tvrEmail.add($.__views.__alloyId427);
  $.__views.__alloyId428 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Email", top: 12, id: "__alloyId428" });
  ...
  $.__views.__alloyId427.add($.__views.email);
  $.__views.__alloyId429 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId429" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId430" });

  $.__views.tvrMobile.add($.__views.__alloyId430);
  $.__views.__alloyId431 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Mobile No.", top: 12, id: "__alloyId431" });
  ...
  $.__views.__alloyId430.add($.__views.mobile);
  $.__views.__alloyId432 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId432" });
  ...
  { layout: "vertical", width: Ti.UI.FILL, height: 250, textAlign: "right", id: "__alloyId433" });

  $.__views.tvrComment.add($.__views.__alloyId433);
  $.__views.__alloyId434 = Ti.UI.createLabel(
  { width: "100%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Comment", top: 12, id: "__alloyId434" });
  ...
  $.__views.__alloyId433.add($.__views.comment);
  $.__views.__alloyId435 = Ti.UI.createView(
  { width: Ti.UI.FILL, height: Ti.UI.SIZE, top: 10, id: "__alloyId435" });
  ...
  $.__views.__alloyId435.add($.__views.saveBtn);
