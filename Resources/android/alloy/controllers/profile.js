...
function Controller() {
    ...
    $.__views.myProfile.add($.__views.__alloyId199);
    ...
    $.__views.__alloyId199.add($.__views.scrollboard);
    ...
    $.__views.scrollboard.add($.__views.__alloyId203);
    ...
    navProfile ? $.addListener($.__views.__alloyId205, "click", navProfile) : __defers["$.__views.__alloyId205!click!navProfile"] = true;
    ...
    __defers["$.__views.__alloyId205!click!navProfile"] && $.addListener($.__views.__alloyId205, "click", navProfile);
    _.extend($, exports);
}
