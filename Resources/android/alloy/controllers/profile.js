...
function Controller() {
    ...
    $.__views.myProfile.add($.__views.__alloyId261);
    ...
    $.__views.__alloyId263.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "90%"
    });
    $.__views.__alloyId262.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId264);
    ...
    $.__views.__alloyId261.add($.__views.scrollboard);
    ...
    $.__views.scrollboard.add($.__views.__alloyId265);
    ...
    navProfile ? $.addListener($.__views.__alloyId266, "click", navProfile) : __defers["$.__views.__alloyId266!click!navProfile"] = true;
    ...
    __defers["$.__views.__alloyId266!click!navProfile"] && $.addListener($.__views.__alloyId266, "click", navProfile);
