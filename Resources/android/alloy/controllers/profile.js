...
function Controller() {
    ...
    $.__views.myProfile.add($.__views.__alloyId269);
    ...
    $.__views.__alloyId269.add($.__views.scrollboard);
    ...
    $.__views.scrollboard.add($.__views.__alloyId273);
    ...
    navProfile ? $.addListener($.__views.__alloyId275, "click", navProfile) : __defers["$.__views.__alloyId275!click!navProfile"] = true;
    ...
    __defers["$.__views.__alloyId275!click!navProfile"] && $.addListener($.__views.__alloyId275, "click", navProfile);
    _.extend($, exports);
}
