...
function Controller() {
    ...
    $.__views.myProfile.add($.__views.__alloyId236);
    ...
    $.__views.__alloyId238.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "90%"
    });
    $.__views.__alloyId237.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId239);
    ...
    $.__views.__alloyId236.add($.__views.description);
    ...
    $.__views.__alloyId236.add($.__views.scrollboard);
    ...
    $.__views.scrollboard.add($.__views.__alloyId240);
    ...
    navProfile ? $.addListener($.__views.__alloyId241, "click", navProfile) : __defers["$.__views.__alloyId241!click!navProfile"] = true;
    ...
    navProfile ? $.addListener($.__views.__alloyId242, "click", navProfile) : __defers["$.__views.__alloyId242!click!navProfile"] = true;
    ...
    __defers["$.__views.__alloyId241!click!navProfile"] && $.addListener($.__views.__alloyId241, "click", navProfile);
    __defers["$.__views.__alloyId242!click!navProfile"] && $.addListener($.__views.__alloyId242, "click", navProfile);
    _.extend($, exports);
}
