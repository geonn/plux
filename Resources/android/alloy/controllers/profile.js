...
<<<<<<< HEAD
    ...
    $.__views.myProfile.add($.__views.__alloyId262);
...
=======
    ...
    $.__views.myProfile.add($.__views.__alloyId263);
...
<<<<<<< HEAD
    ...
    $.__views.pageTitle.add($.__views.__alloyId265);
=======
        id: "__alloyId266"
    });
...
<<<<<<< HEAD
    $.__views.__alloyId262.add($.__views.description);
=======
...
<<<<<<< HEAD
    $.__views.__alloyId262.add($.__views.scrollboard);
    ...
    $.__views.scrollboard.add($.__views.__alloyId266);
    $.__views.__alloyId267 = Ti.UI.createImageView({
=======
    $.__views.__alloyId263.add($.__views.scrollboard);
    ...
    $.__views.scrollboard.add($.__views.__alloyId267);
...
<<<<<<< HEAD
    ...
    navProfile ? $.addListener($.__views.__alloyId267, "click", navProfile) : __defers["$.__views.__alloyId267!click!navProfile"] = true;
    $.__views.__alloyId268 = Ti.UI.createImageView({
=======
        id: "__alloyId268"
    });
    $.__views.__alloyId267.add($.__views.__alloyId268);
    navProfile ? $.addListener($.__views.__alloyId268, "click", navProfile) : __defers["$.__views.__alloyId268!click!navProfile"] = true;
...
<<<<<<< HEAD
    __defers["$.__views.__alloyId267!click!navProfile"] && $.addListener($.__views.__alloyId267, "click", navProfile);
    __defers["$.__views.__alloyId268!click!navProfile"] && $.addListener($.__views.__alloyId268, "click", navProfile);
=======
    __defers["$.__views.__alloyId268!click!navProfile"] && $.addListener($.__views.__alloyId268, "click", navProfile);
