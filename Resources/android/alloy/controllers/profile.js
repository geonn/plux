...
function Controller() {
  ...
  { borderWidth: 0, layout: "vertical", height: "100%", id: "__alloyId745" });

  $.__views["myProfile"].add($.__views["__alloyId745"]);
  if (true) {
    $.__views["__alloyId746"] = Ti.UI.createView(
    { borderWidth: 0, layout: "horizontal", height: 50, width: Ti.UI.FILL, backgroundColor: "#DEDEDE", id: "__alloyId746" });
    ...
    { width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#111111", font: { fontFamily: "Roboto-Regular, arial", fontSize: "16dp" }, text: 'My Profile', textAlign: "center", id: "__alloyId748" });
  ...
  $.__views["__alloyId745"].add($.__views["scrollboard"]);
  $.__views["__alloyId749"] = Ti.UI.createView(
  { borderWidth: 0, layout: "horizontal", width: 293, top: 20, id: "__alloyId749" });

  $.__views["scrollboard"].add($.__views["__alloyId749"]);
  ...
  $.__views["__alloyId749"].add($.__views["plux_logo"]);
  ...
  $.__views["__alloyId749"].add($.__views["asp_logo"]);
...
//# sourceMappingURL=file:///Users/yikonnlau/Documents/Appcelerator_Studio_Workspace/plux/build/map/Resources/android/alloy/controllers/profile.js.map