...
function Controller() {
    ...
    $.__views.myProfile.add($.__views.__alloyId268);
    ...
    $.__views.__alloyId270.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "90%"
    });
    $.__views.__alloyId269.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId271);
    ...
    $.__views.__alloyId268.add($.__views.scrollboard);
    ...
    $.__views.scrollboard.add($.__views.__alloyId272);
    ...
    navProfile ? $.addListener($.__views.__alloyId273, "click", navProfile) : __defers["$.__views.__alloyId273!click!navProfile"] = true;
    ...
    navProfile ? $.addListener($.__views.__alloyId274, "click", navProfile) : __defers["$.__views.__alloyId274!click!navProfile"] = true;
    ...
    __defers["$.__views.__alloyId273!click!navProfile"] && $.addListener($.__views.__alloyId273, "click", navProfile);
    __defers["$.__views.__alloyId274!click!navProfile"] && $.addListener($.__views.__alloyId274, "click", navProfile);
    _.extend($, exports);
}
