...
function Controller() {
    ...
    $.__views.hraDetailsWin.add($.__views.__alloyId58);
    ...
    $.__views.__alloyId59.add($.__views.pageTitle);
    ...
    $.__views.__alloyId61.add($.__views.input_box);
    $.__views.description = Ti.UI.createView({
        id: "description",
        height: Ti.UI.SIZE
    });
    $.__views.__alloyId61.add($.__views.description);
    ...
    $.__views.__alloyId58.add($.__views.picker);
