...
function Controller() {
    ...
    $.__views.__alloyId332.add($.__views.addbox_title);
    ...
    closeBox ? $.addListener($.__views.__alloyId333, "click", closeBox) : __defers["$.__views.__alloyId333!click!closeBox"] = true;
    ...
    $.__views.addbox.add($.__views.__alloyId334);
    addRecord ? $.addListener($.__views.__alloyId334, "click", addRecord) : __defers["$.__views.__alloyId334!click!addRecord"] = true;
    ...
    $.__views.__alloyId335.add($.__views.profile_data);
    ...
    $.__views.__alloyId338.add($.__views.fullname);
    $.__views.__alloyId339 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.SIZE,
        id: "__alloyId339"
    });
    $.__views.__alloyId335.add($.__views.__alloyId339);
    ...
    $.__views.__alloyId339.add($.__views.email);
    $.__views.__alloyId340 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.SIZE,
        id: "__alloyId340"
    });
    $.__views.__alloyId335.add($.__views.__alloyId340);
    ...
    $.__views.__alloyId340.add($.__views.last_login);
    ...
    $.__views.__alloyId335.add($.__views.__alloyId341);
    ...
    openBox ? $.addListener($.__views.__alloyId343, "click", openBox) : __defers["$.__views.__alloyId343!click!openBox"] = true;
    ...
    $.__views.__alloyId335.add($.__views.my_health);
    $.__views.__alloyId344 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.SIZE,
        id: "__alloyId344"
    });
    $.__views.my_health.add($.__views.__alloyId344);
    ...
    $.__views.__alloyId345.add($.__views.firstTab);
    ...
    $.__views.firstTab.add($.__views.__alloyId346);
    ...
    $.__views.__alloyId345.add($.__views.secondTab);
    ...
    $.__views.secondTab.add($.__views.__alloyId348);
    switchListing ? $.addListener($.__views.__alloyId348, "click", switchListing) : __defers["$.__views.__alloyId348!click!switchListing"] = true;
    ...
    __defers["$.__views.__alloyId333!click!closeBox"] && $.addListener($.__views.__alloyId333, "click", closeBox);
    __defers["$.__views.__alloyId334!click!addRecord"] && $.addListener($.__views.__alloyId334, "click", addRecord);
    __defers["$.__views.__alloyId343!click!openBox"] && $.addListener($.__views.__alloyId343, "click", openBox);
    ...
    __defers["$.__views.__alloyId348!click!switchListing"] && $.addListener($.__views.__alloyId348, "click", switchListing);
    _.extend($, exports);
}
