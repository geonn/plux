...
function Controller() {
    ...
    $.__views.__alloyId73.add($.__views.estimate);
    ...
    $.__views.__alloyId72.add($.__views.chatroom);
    ...
    $.__views.inner_area.add($.__views.__alloyId74);
    getPreviousData ? $.addListener($.__views.__alloyId74, "click", getPreviousData) : __defers["$.__views.__alloyId74!click!getPreviousData"] = true;
    ...
    $.__views.__alloyId75.add($.__views.message);
    ...
    SendMessage ? $.addListener($.__views.__alloyId76, "click", SendMessage) : __defers["$.__views.__alloyId76!click!SendMessage"] = true;
    ...
    __defers["$.__views.__alloyId74!click!getPreviousData"] && $.addListener($.__views.__alloyId74, "click", getPreviousData);
    __defers["$.__views.__alloyId76!click!SendMessage"] && $.addListener($.__views.__alloyId76, "click", SendMessage);
    _.extend($, exports);
}
