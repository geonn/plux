...
function Controller() {
    ...
    $.__views.__alloyId117.add($.__views.btnBack);
    ...
    $.__views.__alloyId118.add($.__views.pageTitle);
    ...
    $.__views.__alloyId120.add($.__views.estimate);
    ...
    $.__views.__alloyId119.add($.__views.chatroom);
    ...
    $.__views.inner_area.add($.__views.__alloyId121);
    getPreviousData ? $.addListener($.__views.__alloyId121, "click", getPreviousData) : __defers["$.__views.__alloyId121!click!getPreviousData"] = true;
    ...
    $.__views.__alloyId122.add($.__views.message);
    ...
    SendMessage ? $.addListener($.__views.__alloyId123, "click", SendMessage) : __defers["$.__views.__alloyId123!click!SendMessage"] = true;
    ...
    __defers["$.__views.__alloyId121!click!getPreviousData"] && $.addListener($.__views.__alloyId121, "click", getPreviousData);
    __defers["$.__views.__alloyId123!click!SendMessage"] && $.addListener($.__views.__alloyId123, "click", SendMessage);
    _.extend($, exports);
}
