...
function Controller() {
  ...
  $.__views.win = Ti.UI.createWindow({ backgroundColor: "#ffffff", orientationModes: [Ti.UI.PORTRAIT], fullscreen: false, windowSoftInputMode: Ti.UI.Android.SOFT_INPUT_STATE_HIDDEN, title: "Ask Me - Helpline", id: "win", backButtonTitle: "", navTintColor: "#CE1D1C" });
  $.__views.win && $.addTopLevelView($.__views.win);
  $.__views.__alloyId402 = Ti.UI.createView({ layout: "vertical", width: Ti.UI.FILL, height: Ti.UI.FILL, id: "__alloyId402" });
  $.__views.win.add($.__views.__alloyId402);
  if (true) {
    $.__views.__alloyId403 = Ti.UI.createView({ layout: "horizontal", height: 50, width: Ti.UI.FILL, backgroundColor: "#DEDEDE", id: "__alloyId403" });
    $.__views.__alloyId402.add($.__views.__alloyId403);
    $.__views.__alloyId404 = Ti.UI.createView({ left: 0, width: "20%", id: "__alloyId404" });
    ...
    closeWindow ? $.addListener($.__views.btnBack, 'click', closeWindow) : __defers['$.__views.btnBack!click!closeWindow'] = true;$.__views.__alloyId405 = Ti.UI.createView({ width: "60%", id: "__alloyId405" });
    $.__views.__alloyId403.add($.__views.__alloyId405);
    $.__views.pageTitle = Ti.UI.createLabel({ width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'Ask Me - Helpline', id: "pageTitle", textAlign: "center" });
    $.__views.__alloyId405.add($.__views.pageTitle);
  }
  $.__views.__alloyId406 = Ti.UI.createScrollView({ width: Ti.UI.FILL, height: Ti.UI.FILL, contentHeight: Ti.UI.FILL, contentWidth: Ti.UI.FILL, id: "__alloyId406" });
  $.__views.__alloyId402.add($.__views.__alloyId406);
  $.__views.__alloyId407 = Ti.UI.createView({ height: Ti.UI.SIZE, borderColor: "#dfe0e4", backgroundColor: "#ffffff", borderRadius: "5", zIndex: 10, width: "80%", id: "__alloyId407" });
  $.__views.__alloyId406.add($.__views.__alloyId407);
  $.__views.estimate = Ti.UI.createLabel({ width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#f63d3d", top: 10, left: 10, right: 10, bottom: 10, font: { fontSize: 14 }, id: "estimate" });
  $.__views.__alloyId407.add($.__views.estimate);
  $.__views.chatroom = Ti.UI.createScrollView({ width: Ti.UI.FILL, height: Ti.UI.FILL, id: "chatroom", backgroundRepeat: true, backgroundImage: "/images/grey-patern-bg.png", bottom: 50, contentHeight: Ti.UI.SIZE, contentWidth: Ti.UI.FILL });
  $.__views.__alloyId406.add($.__views.chatroom);
  $.__views.inner_area = Ti.UI.createView({ layout: "vertical", width: Ti.UI.FILL, height: Ti.UI.SIZE, id: "inner_area", bottom: 20 });
  $.__views.chatroom.add($.__views.inner_area);
  $.__views.__alloyId408 = Ti.UI.createLabel({ width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#606060", top: 10, left: 10, right: 10, bottom: 10, borderColor: "#dfe0e4", backgroundColor: "#FFFFFF", font: { fontSize: 14 }, text: 'More', m_id: "no", textAlign: "center", id: "__alloyId408" });
  $.__views.inner_area.add($.__views.__alloyId408);
  getPreviousData ? $.addListener($.__views.__alloyId408, 'click', getPreviousData) : __defers['$.__views.__alloyId408!click!getPreviousData'] = true;$.__views.bottom_bar = Ti.UI.createView({ width: Ti.UI.FILL, height: 50, backgroundColor: "white", bottom: 0, id: "bottom_bar" });
  $.__views.__alloyId406.add($.__views.bottom_bar);
  $.__views.message_bar = Ti.UI.createTextField({ verticalAlign: Titanium.UI.TEXT_VERTICAL_ALIGNMENT_CENTER, height: 40, font: "fontSize: 40", color: "#222222", borderWidth: "1px", borderStyle: Titanium.UI.INPUT_BORDERSTYLE_ROUNDED, width: Ti.UI.FILL, backgroundColor: "#ffffff", top: 4, left: 5, right: 50, bottom: 4, id: "message_bar", borderColor: "#ccc" });
  $.__views.bottom_bar.add($.__views.message_bar);
  switchIcon ? $.addListener($.__views.message_bar, 'change', switchIcon) : __defers['$.__views.message_bar!change!switchIcon'] = true;$.__views.action_btn = Ti.UI.createView({ width: Ti.UI.SIZE, height: Ti.UI.SIZE, id: "action_btn", right: 0 });
  $.__views.bottom_bar.add($.__views.action_btn);
  $.__views.enter_icon = Ti.UI.createImageView({ id: "enter_icon", backgroundColor: "#ffffff", image: "/images/icons/icon_enter.png", top: 10, bottom: 10, zIndex: 3, right: -50, height: 30, width: 30 });
  ...
  __defers['$.__views.__alloyId408!click!getPreviousData'] && $.addListener($.__views.__alloyId408, 'click', getPreviousData);__defers['$.__views.message_bar!change!switchIcon'] && $.addListener($.__views.message_bar, 'change', switchIcon);__defers['$.__views.enter_icon!click!SendMessage'] && $.addListener($.__views.enter_icon, 'click', SendMessage);
