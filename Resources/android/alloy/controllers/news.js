...
function Controller() {
  ...
  if (true) {
    ...
    { borderWidth: 0, layout: "horizontal", height: 50, width: Ti.UI.FILL, backgroundColor: "#DEDEDE", id: "__alloyId666" });

    $.__views["main"].add($.__views["__alloyId666"]);
    $.__views["__alloyId667"] = Ti.UI.createView(
    { borderWidth: 0, left: 0, width: "20%", id: "__alloyId667" });
    ...
    { borderWidth: 0, width: "60%", id: "__alloyId668" });
  ...
  __alloyId670.push($.__views["myContentView"]);
  ...
  $.__views["__alloyId669"] = Ti.UI.createScrollableView(
  { views: __alloyId670, showPagingControl: false, id: "__alloyId669" });
