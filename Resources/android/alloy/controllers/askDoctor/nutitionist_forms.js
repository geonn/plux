...
function Controller() {
  ...
  { borderWidth: 0, layout: "vertical", width: Ti.UI.FILL, height: Ti.UI.FILL, id: "__alloyId117" });

  $.__views["win"].add($.__views["__alloyId117"]);
  if (true) {
    $.__views["__alloyId118"] = Ti.UI.createView(
    { borderWidth: 0, layout: "horizontal", height: 50, width: Ti.UI.FILL, id: "__alloyId118" });

    $.__views["__alloyId117"].add($.__views["__alloyId118"]);
    $.__views["__alloyId119"] = Ti.UI.createView(
    { borderWidth: 0, left: 0, width: "20%", id: "__alloyId119" });

    $.__views["__alloyId118"].add($.__views["__alloyId119"]);
    $.__views["__alloyId120"] = Ti.UI.createImageView(
    { left: 10, width: 25, height: 25, image: "/images/btn-back.png", id: "__alloyId120" });

    $.__views["__alloyId119"].add($.__views["__alloyId120"]);
    closeWindow ? $.addListener($.__views["__alloyId120"], 'click', closeWindow) : __defers['$.__views["__alloyId120"]!click!closeWindow'] = true;$.__views["__alloyId121"] = Ti.UI.createView(
    { borderWidth: 0, width: "60%", id: "__alloyId121" });
    ...
    $.__views["__alloyId121"].add($.__views["pageTitle"]);
  }
  $.__views["__alloyId122"] = Ti.UI.createScrollView(
  { layout: "vertical", width: Ti.UI.FILL, height: Ti.UI.FILL, contentHeight: Ti.UI.SIZE, contentWidth: Ti.UI.FILL, id: "__alloyId122" });

  $.__views["__alloyId117"].add($.__views["__alloyId122"]);
  $.__views["__alloyId123"] = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#fff", font: { fontFamily: "Roboto-Regular, arial", fontSize: 16 }, top: 10, bottom: 10, textAlign: "center", text: L('pleasefillin_nutritionist'), id: "__alloyId123" });
  ...
  $.__views["__alloyId122"].add($.__views["forms"]);
  ...
  { borderWidth: 0, height: Ti.UI.SIZE, width: "50%", right: 1, gender: L('male'), backgroundColor: "#ffffff", id: "__alloyId124" });

  $.__views["gender_view"].add($.__views["__alloyId124"]);
  genderSelect ? $.addListener($.__views["__alloyId124"], 'click', genderSelect) : __defers['$.__views["__alloyId124"]!click!genderSelect'] = true;$.__views["__alloyId125"] = Ti.UI.createLabel(
  { width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#111111", font: { fontFamily: "Roboto-Regular, arial", fontSize: 16 }, top: 10, left: 10, right: 10, bottom: 10, touchEnabled: false, textAlign: "center", text: L('male'), id: "__alloyId125" });

  $.__views["__alloyId124"].add($.__views["__alloyId125"]);
  $.__views["__alloyId126"] = Ti.UI.createView(
  { borderWidth: 0, width: Ti.UI.FILL, height: Ti.UI.SIZE, right: 10, backgroundColor: "#ffffff", gender: L('female'), id: "__alloyId126" });

  $.__views["gender_view"].add($.__views["__alloyId126"]);
  genderSelect ? $.addListener($.__views["__alloyId126"], 'click', genderSelect) : __defers['$.__views["__alloyId126"]!click!genderSelect'] = true;$.__views["__alloyId127"] = Ti.UI.createLabel(
  { width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#111111", font: { fontFamily: "Roboto-Regular, arial", fontSize: 16 }, top: 10, left: 10, right: 10, bottom: 10, touchEnabled: false, textAlign: "center", text: L('female'), id: "__alloyId127" });
  ...
  popout ? $.addListener($.__views["Ethnic"], 'click', popout) : __defers['$.__views["Ethnic"]!click!popout'] = true;loadComboBoxLocal ? $.addListener($.__views["Ethnic"], 'postlayout', loadComboBoxLocal) : __defers['$.__views["Ethnic"]!postlayout!loadComboBoxLocal'] = true;$.__views["__alloyId128"] = Ti.UI.createLabel(
  { width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "Roboto-Regular, arial", fontSize: 14 }, touchEnabled: false, left: 10, text: L('Ethnic'), id: "__alloyId128" });

  $.__views["Ethnic"].add($.__views["__alloyId128"]);
  ...
  { width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "Roboto-Regular, arial", fontSize: 14 }, touchEnabled: false, left: 10, text: L('any_medical_condition'), id: "__alloyId129" });

  $.__views["any_medical_condition"].add($.__views["__alloyId129"]);
  $.__views["__alloyId130"] = Ti.UI.createTextField(
  { borderStyle: Ti.UI.INPUT_BORDERSTYLE_NONE, padding: { left: 10, right: 10, bottom: 5, top: 5 }, width: Ti.UI.FILL, height: 40, font: { fontSize: 14 }, color: "#000000", hintTextColor: "#000", backgroundColor: "#ffffff", borderRadius: "5", left: 10, right: 10, bottom: 10, borderWidth: 0, hintText: L('if_other'), newline: 1, required: 0, value: "", id: "__alloyId130" });

  $.__views["forms"].add($.__views["__alloyId130"]);
  ...
  popout ? $.addListener($.__views["find_your_diet_intake"], 'click', popout) : __defers['$.__views["find_your_diet_intake"]!click!popout'] = true;loadComboBoxLocal ? $.addListener($.__views["find_your_diet_intake"], 'postlayout', loadComboBoxLocal) : __defers['$.__views["find_your_diet_intake"]!postlayout!loadComboBoxLocal'] = true;$.__views["__alloyId131"] = Ti.UI.createLabel(
  { width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "Roboto-Regular, arial", fontSize: 14 }, touchEnabled: false, left: 10, text: L('find_your_diet_intake'), id: "__alloyId131" });

  $.__views["find_your_diet_intake"].add($.__views["__alloyId131"]);
  ...
  popout ? $.addListener($.__views["glass_of_plain_water"], 'click', popout) : __defers['$.__views["glass_of_plain_water"]!click!popout'] = true;loadComboBoxLocal ? $.addListener($.__views["glass_of_plain_water"], 'postlayout', loadComboBoxLocal) : __defers['$.__views["glass_of_plain_water"]!postlayout!loadComboBoxLocal'] = true;$.__views["__alloyId132"] = Ti.UI.createLabel(
  { width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "Roboto-Regular, arial", fontSize: 14 }, touchEnabled: false, left: 10, text: L('glass_of_plain_water'), id: "__alloyId132" });

  $.__views["glass_of_plain_water"].add($.__views["__alloyId132"]);
  $.__views["__alloyId133"] = Ti.UI.createTextField(
  { borderStyle: Ti.UI.INPUT_BORDERSTYLE_NONE, padding: { left: 10, right: 10, bottom: 5, top: 5 }, width: Ti.UI.FILL, height: 40, font: { fontSize: 14 }, color: "#000000", hintTextColor: "#000", backgroundColor: "#ffffff", borderRadius: "5", left: 10, right: 10, bottom: 10, borderWidth: 0, hintText: L('if_other'), newline: 1, required: 0, value: "", id: "__alloyId133" });

  $.__views["forms"].add($.__views["__alloyId133"]);
  ...
  { width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "Roboto-Regular, arial", fontSize: 14 }, touchEnabled: false, left: 10, text: L('servings_of_fruits'), id: "__alloyId134" });

  $.__views["servings_of_fruits"].add($.__views["__alloyId134"]);
  $.__views["__alloyId135"] = Ti.UI.createTextField(
  { borderStyle: Ti.UI.INPUT_BORDERSTYLE_NONE, padding: { left: 10, right: 10, bottom: 5, top: 5 }, width: Ti.UI.FILL, height: 40, font: { fontSize: 14 }, color: "#000000", hintTextColor: "#000", backgroundColor: "#ffffff", borderRadius: "5", left: 10, right: 10, bottom: 10, borderWidth: 0, hintText: L('if_other'), newline: 1, required: 0, value: "", id: "__alloyId135" });

  $.__views["forms"].add($.__views["__alloyId135"]);
  ...
  popout ? $.addListener($.__views["often_oder_food"], 'click', popout) : __defers['$.__views["often_oder_food"]!click!popout'] = true;loadComboBoxLocal ? $.addListener($.__views["often_oder_food"], 'postlayout', loadComboBoxLocal) : __defers['$.__views["often_oder_food"]!postlayout!loadComboBoxLocal'] = true;$.__views["__alloyId136"] = Ti.UI.createLabel(
  { width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "Roboto-Regular, arial", fontSize: 14 }, touchEnabled: false, left: 10, text: L('often_oder_food'), id: "__alloyId136" });

  $.__views["often_oder_food"].add($.__views["__alloyId136"]);
  ...
  popout ? $.addListener($.__views["your_target"], 'click', popout) : __defers['$.__views["your_target"]!click!popout'] = true;loadComboBoxLocal ? $.addListener($.__views["your_target"], 'postlayout', loadComboBoxLocal) : __defers['$.__views["your_target"]!postlayout!loadComboBoxLocal'] = true;$.__views["__alloyId138"] = Ti.UI.createLabel(
  { width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#000000", font: { fontFamily: "Roboto-Regular, arial", fontSize: 14 }, touchEnabled: false, left: 10, text: L('your_target'), id: "__alloyId138" });

  $.__views["your_target"].add($.__views["__alloyId138"]);
  $.__views["yes_please_state"] = Ti.UI.createTextField(
  { borderStyle: Ti.UI.INPUT_BORDERSTYLE_NONE, padding: { left: 10, right: 10, bottom: 5, top: 5 }, width: Ti.UI.FILL, height: 40, font: { fontSize: 14 }, color: "#000000", hintTextColor: "#000", backgroundColor: "#ffffff", borderRadius: "5", left: 10, right: 10, bottom: 10, borderWidth: 0, hintText: L('if_other'), newline: 1, id: "yes_please_state", required: 0, value: "" });
...
//# sourceMappingURL=file:///Users/yikonnlau/Documents/Appcelerator_Studio_Workspace/plux/build/map/Resources/android/alloy/controllers/askDoctor/nutitionist_forms.js.map