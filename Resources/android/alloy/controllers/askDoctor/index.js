...
function Controller() {
    ...
    closeWindow ? $.addListener($.__views.__alloyId416, "click", closeWindow) : __defers["$.__views.__alloyId416!click!closeWindow"] = true;
    ...
    $.__views.__alloyId420.add($.__views.sub_back);
    ...
    $.__views.__alloyId420.add($.__views.sub_title);
    ...
    __alloyId422.push($.__views._specialty_list.getViewEx({
        recurse: true
    }));
    $.__views._doctor_list = Alloy.createController("askDoctor/_doctor_list", {
        id: "_doctor_list"
    });
    __alloyId422.push($.__views._doctor_list.getViewEx({
        recurse: true
    }));
    ...
    $.__views.__alloyId413.add($.__views.inner_box);
    ...
    __defers["$.__views.__alloyId416!click!closeWindow"] && $.addListener($.__views.__alloyId416, "click", closeWindow);
    _.extend($, exports);
}
