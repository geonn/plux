...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId382);
    ...
    $.__views.__alloyId384.add($.__views.patient_name);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId386);
    ...
    $.__views.__alloyId388.add($.__views.patient_email);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId390);
    ...
    $.__views.__alloyId392.add($.__views.appointment_datetime);
    ...
    $.__views.__alloyId397.add($.__views.appointment_clinic);
    ...
    $.__views.__alloyId402.add($.__views.specialty);
    ...
    $.__views.__alloyId405.add($.__views.remarkTextArea);
    ...
    saveRecord ? $.addListener($.__views.__alloyId409, "click", saveRecord) : __defers["$.__views.__alloyId409!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId409!click!saveRecord"] && $.addListener($.__views.__alloyId409, "click", saveRecord);
    _.extend($, exports);
}
