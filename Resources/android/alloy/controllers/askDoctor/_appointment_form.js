...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId348);
    ...
    $.__views.__alloyId350.add($.__views.patient_name);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId352);
    ...
    $.__views.__alloyId354.add($.__views.patient_email);
    ...
    $.__views.aView.add($.__views.__alloyId355);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId356);
    ...
    $.__views.__alloyId358.add($.__views.appointment_datetime);
    ...
    $.__views.aView.add($.__views.__alloyId359);
    ...
    $.__views.__alloyId363.add($.__views.appointment_clinic);
    ...
    $.__views.__alloyId368.add($.__views.specialty);
    ...
    $.__views.__alloyId371.add($.__views.remarkTextArea);
    ...
    $.__views.__alloyId375 = Ti.UI.createButton({
    ...
    saveRecord ? $.addListener($.__views.__alloyId375, "click", saveRecord) : __defers["$.__views.__alloyId375!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId375!click!saveRecord"] && $.addListener($.__views.__alloyId375, "click", saveRecord);
    _.extend($, exports);
}
