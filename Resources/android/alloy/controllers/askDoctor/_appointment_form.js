...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId364);
    ...
    $.__views.__alloyId366.add($.__views.patient_name);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId368);
    ...
    $.__views.__alloyId370.add($.__views.patient_email);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId372);
    ...
    $.__views.__alloyId374.add($.__views.appointment_datetime);
    ...
    $.__views.__alloyId379.add($.__views.appointment_clinic);
    ...
    $.__views.__alloyId384.add($.__views.specialty);
    ...
    $.__views.__alloyId387.add($.__views.remarkTextArea);
    ...
    saveRecord ? $.addListener($.__views.__alloyId391, "click", saveRecord) : __defers["$.__views.__alloyId391!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId391!click!saveRecord"] && $.addListener($.__views.__alloyId391, "click", saveRecord);
    _.extend($, exports);
}
