...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId368);
    ...
    $.__views.__alloyId370.add($.__views.patient_name);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId372);
    ...
    $.__views.__alloyId374.add($.__views.patient_email);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId376);
    ...
    $.__views.__alloyId378.add($.__views.appointment_datetime);
    ...
    $.__views.__alloyId383.add($.__views.appointment_clinic);
    ...
    $.__views.__alloyId388.add($.__views.specialty);
    ...
    $.__views.__alloyId391.add($.__views.remarkTextArea);
    ...
    $.__views.__alloyId395 = Ti.UI.createButton({
    ...
    saveRecord ? $.addListener($.__views.__alloyId395, "click", saveRecord) : __defers["$.__views.__alloyId395!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId395!click!saveRecord"] && $.addListener($.__views.__alloyId395, "click", saveRecord);
    _.extend($, exports);
}
