...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId397);
    ...
    $.__views.__alloyId399.add($.__views.patient_name);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId401);
    ...
    $.__views.__alloyId403.add($.__views.patient_email);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId405);
    ...
    $.__views.__alloyId407.add($.__views.appointment_datetime);
    ...
    $.__views.__alloyId412.add($.__views.appointment_clinic);
    ...
    $.__views.__alloyId417.add($.__views.specialty);
    ...
    $.__views.__alloyId420.add($.__views.remarkTextArea);
    ...
    $.__views.__alloyId424 = Ti.UI.createButton({
    ...
    saveRecord ? $.addListener($.__views.__alloyId424, "click", saveRecord) : __defers["$.__views.__alloyId424!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId424!click!saveRecord"] && $.addListener($.__views.__alloyId424, "click", saveRecord);
    _.extend($, exports);
}
