...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId347);
    ...
    $.__views.__alloyId349.add($.__views.patient_name);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId351);
    ...
    $.__views.__alloyId353.add($.__views.patient_email);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId355);
    ...
    $.__views.__alloyId357.add($.__views.appointment_datetime);
    ...
    $.__views.__alloyId362.add($.__views.appointment_clinic);
    ...
    $.__views.__alloyId367.add($.__views.specialty);
    ...
    $.__views.__alloyId370.add($.__views.remarkTextArea);
    ...
    saveRecord ? $.addListener($.__views.__alloyId374, "click", saveRecord) : __defers["$.__views.__alloyId374!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId374!click!saveRecord"] && $.addListener($.__views.__alloyId374, "click", saveRecord);
    _.extend($, exports);
}
