...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId384);
    ...
    $.__views.__alloyId386.add($.__views.patient_name);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId388);
    ...
    $.__views.__alloyId390.add($.__views.patient_email);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId392);
    ...
    $.__views.__alloyId394.add($.__views.appointment_datetime);
    ...
    $.__views.__alloyId399.add($.__views.appointment_clinic);
    ...
    $.__views.__alloyId404.add($.__views.specialty);
    ...
    $.__views.__alloyId407.add($.__views.remarkTextArea);
    ...
    $.__views.__alloyId411 = Ti.UI.createButton({
    ...
    saveRecord ? $.addListener($.__views.__alloyId411, "click", saveRecord) : __defers["$.__views.__alloyId411!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId411!click!saveRecord"] && $.addListener($.__views.__alloyId411, "click", saveRecord);
    _.extend($, exports);
}
