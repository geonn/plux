...
<<<<<<< HEAD
    $.__views.__alloyId429 = Ti.UI.createScrollView({
=======
    $.__views.__alloyId449 = Ti.UI.createScrollView({
>>>>>>> origin/master
        width: Ti.UI.FILL,
        height: Ti.UI.FILL,
...
<<<<<<< HEAD
    ...
    $.__views.inner_box.add($.__views.__alloyId429);
=======
        id: "__alloyId449"
    });
    $.__views.inner_box.add($.__views.__alloyId449);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId429.add($.__views.timeslot);
=======
    $.__views.__alloyId449.add($.__views.timeslot);
>>>>>>> origin/master
