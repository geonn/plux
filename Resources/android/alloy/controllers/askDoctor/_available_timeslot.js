...
function Controller() {
    ...
    function render_available_timeslot() {
        ...
        while (working_hour_end > working_hour_begin + timeblock) {
...
<<<<<<< HEAD
    $.__views.__alloyId403 = Ti.UI.createScrollView({
=======
    $.__views.__alloyId391 = Ti.UI.createScrollView({
>>>>>>> origin/master
        width: Ti.UI.FILL,
        height: Ti.UI.FILL,
...
<<<<<<< HEAD
    ...
    $.__views.inner_box.add($.__views.__alloyId403);
=======
        id: "__alloyId391"
    });
    $.__views.inner_box.add($.__views.__alloyId391);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId403.add($.__views.timeslot);
=======
    $.__views.__alloyId391.add($.__views.timeslot);
>>>>>>> origin/master
