...
function Controller() {
  ...
  { width: Ti.UI.FILL, height: Ti.UI.FILL, contentWidth: Ti.UI.FILL, disableBounce: true, contentHeight: Ti.UI.SIZE, backgroundColor: "#d7d7d7", id: "__alloyId179" });

  $.__views.inner_box.add($.__views.__alloyId179);
  $.__views.timeslot = Ti.UI.createView(
  { layout: "horizontal", width: Ti.UI.FILL, height: Ti.UI.SIZE, left: 1, top: 1, id: "timeslot" });

  $.__views.__alloyId179.add($.__views.timeslot);
