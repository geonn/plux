...
function Controller() {
  ...
  { width: Ti.UI.FILL, height: Ti.UI.FILL, contentWidth: Ti.UI.FILL, disableBounce: true, contentHeight: Ti.UI.SIZE, backgroundColor: "#d7d7d7", id: "__alloyId191" });

  $.__views.inner_box.add($.__views.__alloyId191);
  ...
  $.__views.__alloyId191.add($.__views.timeslot);
