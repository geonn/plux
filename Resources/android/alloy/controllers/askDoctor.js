...
function Controller() {
    ...
    $.__views.aView.add($.__views.__alloyId59);
    ...
    $.__views.__alloyId61.add($.__views.pageTitle);
    ...
    navFindDoctor ? $.addListener($.__views.__alloyId63, "click", navFindDoctor) : __defers["$.__views.__alloyId63!click!navFindDoctor"] = true;
    ...
    __defers["$.__views.__alloyId63!click!navFindDoctor"] && $.addListener($.__views.__alloyId63, "click", navFindDoctor);
    _.extend($, exports);
}
