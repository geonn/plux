...
function Controller() {
    ...
    $.__views.aView.add($.__views.__alloyId106);
    ...
    navFindDoctor ? $.addListener($.__views.__alloyId110, "click", navFindDoctor) : __defers["$.__views.__alloyId110!click!navFindDoctor"] = true;
    ...
    __defers["$.__views.__alloyId110!click!navFindDoctor"] && $.addListener($.__views.__alloyId110, "click", navFindDoctor);
    _.extend($, exports);
}
