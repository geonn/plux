...
function Controller() {
    ...
    newRecord ? $.addListener($.__views.__alloyId197, "click", newRecord) : __defers["$.__views.__alloyId197!click!newRecord"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId196;
    ...
    $.__views.__alloyId198.add($.__views.aView);
    ...
    $.__views.__alloyId202.add($.__views.newRecord);
    ...
    __defers["$.__views.__alloyId197!click!newRecord"] && $.addListener($.__views.__alloyId197, "click", newRecord);
