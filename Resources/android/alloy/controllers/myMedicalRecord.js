...
function Controller() {
  ...
  { left: 10, width: 25, height: 20, image: "/images/add.png", id: "__alloyId726" });

  $.__views.__alloyId725.add($.__views.__alloyId726);
  newRecord ? $.addListener($.__views.__alloyId726, 'click', newRecord) : __defers['$.__views.__alloyId726!click!newRecord'] = true;$.__views.win.rightNavButton = $.__views.__alloyId725;$.__views.__alloyId727 = Ti.UI.createView(
  { id: "__alloyId727" });

  $.__views.win.add($.__views.__alloyId727);
  $.__views.aView = Ti.UI.createView(
  { id: "aView", height: Ti.UI.SIZE, top: 0, layout: "vertical" });

  $.__views.__alloyId727.add($.__views.aView);
  if (true) {
    $.__views.__alloyId728 = Ti.UI.createView(
    { layout: "horizontal", height: 50, width: Ti.UI.FILL, backgroundColor: "#DEDEDE", id: "__alloyId728" });

    $.__views.aView.add($.__views.__alloyId728);
    $.__views.__alloyId729 = Ti.UI.createView(
    { left: 0, width: "20%", id: "__alloyId729" });
    ...
    $.__views.__alloyId730.add($.__views.pageTitle);
    $.__views.__alloyId731 = Ti.UI.createView(
    { left: 0, width: "20%", id: "__alloyId731" });
    ...
    $.__views.__alloyId731.add($.__views.newRecord);
  ...
  __defers['$.__views.__alloyId726!click!newRecord'] && $.addListener($.__views.__alloyId726, 'click', newRecord);if (true) {
