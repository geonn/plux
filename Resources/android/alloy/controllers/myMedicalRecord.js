...
function Controller() {
    ...
    $.__views.__alloyId169.add($.__views.newRecord);
    $.__views.myMedicalRecord.rightNavButton = $.__views.__alloyId169;
    $.__views.__alloyId170 = Ti.UI.createView({
        id: "__alloyId170"
    });
    $.__views.myMedicalRecord.add($.__views.__alloyId170);
    ...
    $.__views.__alloyId170.add($.__views.aView);
    ...
    $.__views.aView.add($.__views.__alloyId171);
    ...
    $.__views.__alloyId173.add($.__views.pageTitle);
    ...
    $.__views.__alloyId174.add($.__views.newRecord);
