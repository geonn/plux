...
function Controller() {
    ...
    newRecord ? $.addListener($.__views.__alloyId200, "click", newRecord) : __defers["$.__views.__alloyId200!click!newRecord"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId199;
    ...
    $.__views.aView.add($.__views.__alloyId202);
    ...
    $.__views.__alloyId203.add($.__views.btnBack);
    ...
    $.__views.__alloyId204.add($.__views.pageTitle);
    ...
    $.__views.__alloyId205.add($.__views.newRecord);
    ...
    __defers["$.__views.__alloyId200!click!newRecord"] && $.addListener($.__views.__alloyId200, "click", newRecord);
