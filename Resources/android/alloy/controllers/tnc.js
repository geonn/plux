...
function Controller() {
	...
	{ layout: "vertical", id: "__alloyId829" });

	$.__views.win.add($.__views.__alloyId829);
	$.__views.__alloyId830 = Ti.UI.createView(
	{ layout: "horizontal", height: 50, width: "100%", backgroundColor: "#DEDEDE", id: "__alloyId830" });

	$.__views.__alloyId829.add($.__views.__alloyId830);
	$.__views.__alloyId831 = Ti.UI.createView(
	{ left: 0, width: "10%", id: "__alloyId831" });

	$.__views.__alloyId830.add($.__views.__alloyId831);
	$.__views.btnBack = Ti.UI.createImageView(
	{ left: 10, id: "btnBack", width: 25, height: 25, image: "/images/btn-back.png" });

	$.__views.__alloyId831.add($.__views.btnBack);
	$.__views.pageTitle = Ti.UI.createView(
	{ id: "pageTitle", width: Ti.UI.FILL });

	$.__views.__alloyId830.add($.__views.pageTitle);
	$.__views.__alloyId832 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'ASP Healthcare Terms of Service', textAlign: "center", id: "__alloyId832" });

	$.__views.pageTitle.add($.__views.__alloyId832);
	$.__views.main = Ti.UI.createScrollView(
	{ id: "main", layout: "vertical", height: "100%", contentHeight: Ti.UI.SIZE });

	$.__views.__alloyId829.add($.__views.main);
	$.__views.__alloyId833 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#404040", font: { fontSize: "16", fontWeight: "bold" }, left: "10", right: "10", text: '1.    Welcome to ASP HEALTHCARE!', bottom: 5, id: "__alloyId833" });

	$.__views.main.add($.__views.__alloyId833);
	$.__views.__alloyId834 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#6E6E6E", font: { fontSize: "14" }, left: "10", textAlign: "left", right: "10", text: 'Thanks for your interest in our ASP Healthcare (the “Services”)!', bottom: 3, id: "__alloyId834" });

	$.__views.main.add($.__views.__alloyId834);
	$.__views.__alloyId835 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#6E6E6E", font: { fontSize: "14" }, left: "10", textAlign: "left", right: "10", text: 'By using our Services, you agree to these terms (the “ Terms”).', bottom: 3, id: "__alloyId835" });

	$.__views.main.add($.__views.__alloyId835);
	$.__views.__alloyId836 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#6E6E6E", font: { fontSize: "14" }, left: "10", textAlign: "left", right: "10", text: 'As used in the Agreement, “you” means the individual or entity using the Services (and/or any individual, entity or successor entity, agency or network acting on your behalf), “we,” “us” or “ASP” means ASP Healthcare, and the “parties” means you and ASP.', bottom: 5, id: "__alloyId836" });

	$.__views.main.add($.__views.__alloyId836);
	$.__views.__alloyId837 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#404040", font: { fontSize: "16", fontWeight: "bold" }, left: "10", right: "10", text: '2. Access to the Services; ASP Accounts', bottom: 5, id: "__alloyId837" });

	$.__views.main.add($.__views.__alloyId837);
	$.__views.__alloyId838 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#6E6E6E", font: { fontSize: "14" }, left: "10", textAlign: "left", right: "10", text: 'Your use of the Services is subject to your creation and our approval of a ASP account (an “Account”). We have the right to refuse or limit your access to the Services. By enrolling in ASP, you permit us to serve, as applicable, (i) advertisements and other content (“Ads”), (ii) notifications, and (iii) related promotions and other links to your mobile applications, media players, mobile content, and/or other properties approved by ASP (each individually a “Property”). In addition, you grant ASP the right to access, index and cache the Properties, or any portion thereof, including by automated means.', bottom: 3, id: "__alloyId838" });

	$.__views.main.add($.__views.__alloyId838);
	$.__views.__alloyId839 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#404040", font: { fontSize: "16", fontWeight: "bold" }, left: "10", right: "10", text: '3. Changes to our Services; Changes to the Agreement', bottom: 5, id: "__alloyId839" });

	$.__views.main.add($.__views.__alloyId839);
	$.__views.__alloyId840 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#6E6E6E", font: { fontSize: "14" }, left: "10", textAlign: "left", right: "10", text: 'We are constantly changing and improving our Services. We may modify the Agreement at any time. We’ll post any modifications to the ASP Terms on this page.', bottom: 3, id: "__alloyId840" });

	$.__views.main.add($.__views.__alloyId840);
	$.__views.__alloyId841 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#404040", font: { fontSize: "16", fontWeight: "bold" }, left: "10", right: "10", text: '4. Privacy', bottom: 5, id: "__alloyId841" });

	$.__views.main.add($.__views.__alloyId841);
	$.__views.__alloyId842 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#6E6E6E", font: { fontSize: "14" }, left: "10", textAlign: "left", right: "10", text: 'Our privacy policy how we treat your personal data and protect your privacy when you use our Services. By using our Services, you agree that ASP can use such medical data in accordance with our privacy policy. We will ensure that at all times you use the Services, the Properties have a clearly labeled and easily accessible privacy policy that provides end users with clear and comprehensive information about cookies, device-specific information, location information and other information stored on, accessed on, or collected from end users’ devices in connection with the Services, including, as applicable, information about end users’ options for cookie management.  We will use commercially reasonable efforts to ensure that an end user gives consent to the storing and accessing of cookies, device-specific information, location information or other information on the end user\'s device in connection with the Services where such consent is required by law.', bottom: 3, id: "__alloyId842" });

	$.__views.main.add($.__views.__alloyId842);
	$.__views.__alloyId843 = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#6E6E6E", font: { fontSize: "14" }, left: "10", textAlign: "left", right: "10", text: 'By downloading or using the app, these terms will automatically apply to you – you should make sure therefore that you read them carefully before using the app. We are offering you this app to use for your own personal use without cost, but you should be aware that you cannot send it on to anyone else, and you’re not allowed to copy, or modify the app, any part of the app, or our trademarks in any way. You’re not allowed to attempt to extract the source code of the app, and you also shouldn’t try to translate the app into other languages, or make derivative versions. The app itself, and all the trade marks, copyright, database rights and other intellectual property rights related to it, still belong to ASP Healthcare.', bottom: 3, id: "__alloyId843" });

	$.__views.main.add($.__views.__alloyId843);
