...
function Controller() {
    ...
    $.__views.__alloyId71.add($.__views.pageTitle);
    ...
    $.__views.__alloyId72.add($.__views.saveRecord);
    ...
    $.__views.__alloyId68.add($.__views.titleRecord);
    ...
    $.__views.__alloyId68.add($.__views.aView);
    ...
    $.__views.aView.add($.__views.__alloyId76);
    ...
    $.__views.__alloyId77.add($.__views.attachment);
    ...
    showCategory ? $.addListener($.__views.__alloyId78, "click", showCategory) : __defers["$.__views.__alloyId78!click!showCategory"] = true;
    ...
    $.__views.__alloyId79.add($.__views.addLbl);
    ...
    deleteRecord ? $.addListener($.__views.__alloyId81, "click", deleteRecord) : __defers["$.__views.__alloyId81!click!deleteRecord"] = true;
    ...
    $.__views.__alloyId82.add($.__views.lastUpdated);
    ...
    __defers["$.__views.__alloyId78!click!showCategory"] && $.addListener($.__views.__alloyId78, "click", showCategory);
    __defers["$.__views.__alloyId81!click!deleteRecord"] && $.addListener($.__views.__alloyId81, "click", deleteRecord);
    _.extend($, exports);
}
