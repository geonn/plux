...
function Controller() {
    ...
    $.__views.editRecWin.add($.__views.__alloyId92);
    ...
    $.__views.__alloyId96.add($.__views.saveRecord);
    ...
    $.__views.__alloyId92.add($.__views.titleRecord);
    ...
    $.__views.__alloyId92.add($.__views.aView);
    ...
    $.__views.aView.add($.__views.__alloyId98);
    ...
    $.__views.aView.add($.__views.__alloyId99);
    ...
    $.__views.aView.add($.__views.__alloyId100);
    ...
    $.__views.editRecWin.add($.__views.__alloyId101);
    ...
    $.__views.__alloyId101.add($.__views.attachment);
    ...
    showCategory ? $.addListener($.__views.__alloyId102, "click", showCategory) : __defers["$.__views.__alloyId102!click!showCategory"] = true;
    ...
    $.__views.__alloyId103.add($.__views.addLbl);
    ...
    $.__views.editRecWin.add($.__views.__alloyId104);
    ...
    deleteRecord ? $.addListener($.__views.__alloyId105, "click", deleteRecord) : __defers["$.__views.__alloyId105!click!deleteRecord"] = true;
    ...
    $.__views.__alloyId106.add($.__views.lastUpdated);
    ...
    __defers["$.__views.__alloyId102!click!showCategory"] && $.addListener($.__views.__alloyId102, "click", showCategory);
    __defers["$.__views.__alloyId105!click!deleteRecord"] && $.addListener($.__views.__alloyId105, "click", deleteRecord);
    _.extend($, exports);
}
