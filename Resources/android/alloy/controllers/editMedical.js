...
function Controller() {
    ...
    $.__views.__alloyId92.add($.__views.saveRecord);
    ...
    $.__views.__alloyId88.add($.__views.titleRecord);
    ...
    $.__views.editRecWin.add($.__views.__alloyId97);
    ...
    $.__views.__alloyId97.add($.__views.attachment);
    ...
    showCategory ? $.addListener($.__views.__alloyId98, "click", showCategory) : __defers["$.__views.__alloyId98!click!showCategory"] = true;
    ...
    $.__views.__alloyId99.add($.__views.addLbl);
    ...
    $.__views.editRecWin.add($.__views.__alloyId100);
    ...
    deleteRecord ? $.addListener($.__views.__alloyId101, "click", deleteRecord) : __defers["$.__views.__alloyId101!click!deleteRecord"] = true;
    ...
    $.__views.__alloyId102.add($.__views.lastUpdated);
    ...
    __defers["$.__views.__alloyId98!click!showCategory"] && $.addListener($.__views.__alloyId98, "click", showCategory);
    __defers["$.__views.__alloyId101!click!deleteRecord"] && $.addListener($.__views.__alloyId101, "click", deleteRecord);
    _.extend($, exports);
}
