...
function Controller() {
    ...
    $.__views.__alloyId35.add($.__views.saveRecord);
    $.__views.editRecWin.rightNavButton = $.__views.__alloyId35;
    $.__views.__alloyId36 = Ti.UI.createView({
        layout: "vertical",
        bottom: "90",
        id: "__alloyId36"
    });
    $.__views.editRecWin.add($.__views.__alloyId36);
    ...
    $.__views.__alloyId40.add($.__views.saveRecord);
    ...
    $.__views.__alloyId36.add($.__views.titleRecord);
    ...
    $.__views.__alloyId36.add($.__views.aView);
    ...
    $.__views.aView.add($.__views.__alloyId43);
    ...
    $.__views.aView.add($.__views.__alloyId44);
    ...
    $.__views.editRecWin.add($.__views.__alloyId45);
    ...
    showCategory ? $.addListener($.__views.__alloyId46, "click", showCategory) : __defers["$.__views.__alloyId46!click!showCategory"] = true;
    ...
    $.__views.editRecWin.add($.__views.__alloyId48);
    ...
    deleteRecord ? $.addListener($.__views.__alloyId49, "click", deleteRecord) : __defers["$.__views.__alloyId49!click!deleteRecord"] = true;
    ...
    __defers["$.__views.__alloyId46!click!showCategory"] && $.addListener($.__views.__alloyId46, "click", showCategory);
    __defers["$.__views.__alloyId49!click!deleteRecord"] && $.addListener($.__views.__alloyId49, "click", deleteRecord);
    _.extend($, exports);
}
