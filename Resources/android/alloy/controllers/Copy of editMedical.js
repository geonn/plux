...
function Controller() {
	...
	{ layout: "vertical", bottom: 90, id: "__alloyId1" });

	$.__views.editRecWin.add($.__views.__alloyId1);
	if (true) {
		$.__views.__alloyId2 = Ti.UI.createView(
		{ layout: "horizontal", height: 50, width: Ti.UI.FILL, backgroundColor: "#DEDEDE", id: "__alloyId2" });

		$.__views.__alloyId1.add($.__views.__alloyId2);
		$.__views.__alloyId3 = Ti.UI.createView(
		{ left: 0, width: "20%", id: "__alloyId3" });
	...
	{ height: 1, width: "100%", backgroundColor: "#CE1D1C", id: "__alloyId6" });
	...
	{ width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14, fontWeight: "bold" }, text: 'Clinic/Hospital/Specialist', left: 10, top: 10, textAlign: Ti.UI.TEXT_ALIGNMENT_LEFT, id: "__alloyId7" });
	...
	{ width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14, fontWeight: "bold" }, text: 'Treatment', left: 10, top: 10, textAlign: Ti.UI.TEXT_ALIGNMENT_LEFT, id: "__alloyId8" });
	...
	{ width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14, fontWeight: "bold" }, text: 'Procedures', left: 10, top: 10, textAlign: Ti.UI.TEXT_ALIGNMENT_LEFT, id: "__alloyId9" });
	...
	{ bottom: 40, height: Ti.UI.SIZE, layout: "horizontal", width: "100%", id: "__alloyId10" });
	...
	{ width: "auto", height: Ti.UI.SIZE, id: "__alloyId11" });
	...
	{ backgroundColor: "#CE1D1C", height: 50, width: Ti.UI.FILL, right: 0, id: "__alloyId12" });
	...
	{ height: 40, layout: "horizontal", bottom: 0, width: "100%", backgroundColor: "#EEEEEE", id: "__alloyId13" });

	$.__views.editRecWin.add($.__views.__alloyId13);
	$.__views.__alloyId14 = Ti.UI.createButton(
	{ backgroundImage: "/images/btn-remove.png", textAlign: "left", left: 15, width: 30, height: 30, id: "__alloyId14" });
	...
	{ width: "auto", height: Ti.UI.FILL, id: "__alloyId15" });

	$.__views.__alloyId13.add($.__views.__alloyId15);
	$.__views.lastUpdated = Ti.UI.createLabel(
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#606060", id: "lastUpdated", textAlign: "right", right: 10 });
