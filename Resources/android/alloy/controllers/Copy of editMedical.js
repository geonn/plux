...
function Controller() {
    ...
    $.__views.editRecWin.add($.__views.__alloyId77);
    ...
    $.__views.__alloyId79.add($.__views.btnBack);
    ...
    $.__views.__alloyId80.add($.__views.pageTitle);
    ...
    $.__views.__alloyId81.add($.__views.saveRecord);
    ...
    $.__views.__alloyId77.add($.__views.titleRecord);
    ...
    $.__views.__alloyId77.add($.__views.aView);
    ...
    $.__views.editRecWin.add($.__views.__alloyId86);
    ...
    $.__views.__alloyId86.add($.__views.attachment);
    ...
    showCategory ? $.addListener($.__views.__alloyId87, "click", showCategory) : __defers["$.__views.__alloyId87!click!showCategory"] = true;
    ...
    $.__views.__alloyId88.add($.__views.addLbl);
    ...
    $.__views.editRecWin.add($.__views.__alloyId89);
    ...
    deleteRecord ? $.addListener($.__views.__alloyId90, "click", deleteRecord) : __defers["$.__views.__alloyId90!click!deleteRecord"] = true;
    ...
    $.__views.__alloyId91.add($.__views.lastUpdated);
    exports.destroy = function() {};
    _.extend($, $.__views);
    __defers["$.__views.__alloyId87!click!showCategory"] && $.addListener($.__views.__alloyId87, "click", showCategory);
    __defers["$.__views.__alloyId90!click!deleteRecord"] && $.addListener($.__views.__alloyId90, "click", deleteRecord);
    _.extend($, exports);
}
