...
function Controller() {
    ...
    $.__views.win_map.add($.__views.__alloyId602);
    ...
    $.__views.__alloyId603.add($.__views.btnBack);
    ...
    $.__views.__alloyId602.add($.__views.__alloyId605);
    $.__views.btnList = Ti.UI.createImageView({
        right: 10,
        id: "btnList",
        width: 25,
    ...
    $.__views.__alloyId605.add($.__views.btnList);
