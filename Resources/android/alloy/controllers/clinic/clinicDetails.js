...
function Controller() {
    ...
    $.__views.__alloyId552.add($.__views.btnBack);
    ...
    $.__views.__alloyId551.add($.__views.__alloyId555);
    ...
    $.__views.__alloyId555.add($.__views.btnDirection);
    ...
    $.__views.__alloyId556 = Ti.UI.createScrollView({
        layout: "vertical",
        scrollType: "vertical",
        backgroundColor: "#ffffff",
        height: Ti.UI.FILL,
    ...
    direction2here ? $.addListener($.__views.__alloyId559, "click", direction2here) : __defers["$.__views.__alloyId559!click!direction2here"] = true;
    ...
    $.__views.__alloyId558.add($.__views.__alloyId562);
    ...
    clickToCall ? $.addListener($.__views.__alloyId563, "click", clickToCall) : __defers["$.__views.__alloyId563!click!clickToCall"] = true;
    ...
    $.__views.__alloyId558.add($.__views.__alloyId566);
    ...
    $.__views.__alloyId558.add($.__views.add2contact);
    ...
    $.__views.add2contact.add($.__views.__alloyId567);
    ...
    $.__views.add2contact.add($.__views.__alloyId568);
    ...
    $.__views.__alloyId557.add($.__views.clinicDetailsView);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId569);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId570);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId571);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId572);
    ...
    __defers["$.__views.__alloyId559!click!direction2here"] && $.addListener($.__views.__alloyId559, "click", direction2here);
    __defers["$.__views.__alloyId563!click!clickToCall"] && $.addListener($.__views.__alloyId563, "click", clickToCall);
