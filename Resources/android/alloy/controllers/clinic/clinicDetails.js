...
function Controller() {
    ...
    $.__views.__alloyId564.add($.__views.__alloyId568);
    ...
    $.__views.__alloyId568.add($.__views.btnDirection);
    ...
    $.__views.__alloyId569 = Ti.UI.createScrollView({
        layout: "vertical",
        scrollType: "vertical",
        backgroundColor: "#ffffff",
        height: Ti.UI.FILL,
    ...
    direction2here ? $.addListener($.__views.__alloyId572, "click", direction2here) : __defers["$.__views.__alloyId572!click!direction2here"] = true;
    ...
    clickToCall ? $.addListener($.__views.__alloyId576, "click", clickToCall) : __defers["$.__views.__alloyId576!click!clickToCall"] = true;
    ...
    $.__views.__alloyId571.add($.__views.__alloyId579);
    ...
    $.__views.__alloyId571.add($.__views.add2contact);
    ...
    $.__views.add2contact.add($.__views.__alloyId581);
    ...
    $.__views.__alloyId570.add($.__views.clinicDetailsView);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId585);
    ...
    __defers["$.__views.__alloyId572!click!direction2here"] && $.addListener($.__views.__alloyId572, "click", direction2here);
    __defers["$.__views.__alloyId576!click!clickToCall"] && $.addListener($.__views.__alloyId576, "click", clickToCall);
