...
function Controller() {
    ...
    $.__views.__alloyId583.add($.__views.btnDirection);
    ...
    $.__views.__alloyId584 = Ti.UI.createScrollView({
        layout: "vertical",
        scrollType: "vertical",
        backgroundColor: "#ffffff",
        height: Ti.UI.FILL,
    ...
    $.__views.main.add($.__views.__alloyId584);
    ...
    direction2here ? $.addListener($.__views.__alloyId587, "click", direction2here) : __defers["$.__views.__alloyId587!click!direction2here"] = true;
    ...
    $.__views.__alloyId586.add($.__views.__alloyId590);
    ...
    $.__views.__alloyId586.add($.__views.__alloyId591);
    clickToCall ? $.addListener($.__views.__alloyId591, "click", clickToCall) : __defers["$.__views.__alloyId591!click!clickToCall"] = true;
    $.__views.__alloyId592 = Ti.UI.createImageView({
    ...
    $.__views.__alloyId586.add($.__views.__alloyId594);
    ...
    $.__views.__alloyId586.add($.__views.add2contact);
    ...
    $.__views.add2contact.add($.__views.__alloyId595);
    ...
    $.__views.add2contact.add($.__views.__alloyId596);
    ...
    $.__views.__alloyId585.add($.__views.clinicDetailsView);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId597);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId598);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId599);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId600);
    ...
    __defers["$.__views.__alloyId587!click!direction2here"] && $.addListener($.__views.__alloyId587, "click", direction2here);
    __defers["$.__views.__alloyId591!click!clickToCall"] && $.addListener($.__views.__alloyId591, "click", clickToCall);
