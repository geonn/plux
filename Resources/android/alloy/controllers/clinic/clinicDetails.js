...
function Controller() {
    ...
    $.__views.__alloyId588.add($.__views.btnDirection);
    ...
    $.__views.__alloyId589 = Ti.UI.createScrollView({
        layout: "vertical",
        scrollType: "vertical",
        backgroundColor: "#ffffff",
        height: Ti.UI.FILL,
    ...
    direction2here ? $.addListener($.__views.__alloyId592, "click", direction2here) : __defers["$.__views.__alloyId592!click!direction2here"] = true;
    ...
    $.__views.__alloyId591.add($.__views.__alloyId596);
    clickToCall ? $.addListener($.__views.__alloyId596, "click", clickToCall) : __defers["$.__views.__alloyId596!click!clickToCall"] = true;
    ...
    $.__views.__alloyId591.add($.__views.__alloyId599);
    ...
    $.__views.__alloyId591.add($.__views.add2contact);
    ...
    $.__views.add2contact.add($.__views.__alloyId600);
    ...
    $.__views.add2contact.add($.__views.__alloyId601);
    ...
    $.__views.__alloyId590.add($.__views.clinicDetailsView);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId602);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId603);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId604);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId605);
    ...
    __defers["$.__views.__alloyId592!click!direction2here"] && $.addListener($.__views.__alloyId592, "click", direction2here);
    __defers["$.__views.__alloyId596!click!clickToCall"] && $.addListener($.__views.__alloyId596, "click", clickToCall);
