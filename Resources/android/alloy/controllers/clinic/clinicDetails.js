...
function Controller() {
    ...
    $.__views.main.add($.__views.__alloyId333);
    ...
    $.__views.__alloyId334.add($.__views.clinicMap);
    ...
    direction2here ? $.addListener($.__views.__alloyId336, "click", direction2here) : __defers["$.__views.__alloyId336!click!direction2here"] = true;
    ...
    clickToCall ? $.addListener($.__views.__alloyId340, "click", clickToCall) : __defers["$.__views.__alloyId340!click!clickToCall"] = true;
    ...
    $.__views.__alloyId335.add($.__views.__alloyId343);
    ...
    $.__views.__alloyId335.add($.__views.add2contact);
    ...
    $.__views.add2contact.add($.__views.__alloyId344);
    ...
    $.__views.__alloyId334.add($.__views.clinicDetails);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId346);
    ...
    __defers["$.__views.__alloyId336!click!direction2here"] && $.addListener($.__views.__alloyId336, "click", direction2here);
    __defers["$.__views.__alloyId340!click!clickToCall"] && $.addListener($.__views.__alloyId340, "click", clickToCall);
