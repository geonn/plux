...
function Controller() {
    ...
    $.__views.main.add($.__views.__alloyId417);
    ...
    $.__views.__alloyId418.add($.__views.btnBack);
    ...
    $.__views.__alloyId417.add($.__views.__alloyId421);
    ...
    $.__views.__alloyId421.add($.__views.btnDirection);
    $.__views.__alloyId422 = Ti.UI.createScrollView({
        layout: "vertical",
        scrollType: "vertical",
        backgroundColor: "#ffffff",
        height: Ti.UI.FILL,
    ...
    $.__views.__alloyId423.add($.__views.clinicMap);
    ...
    direction2here ? $.addListener($.__views.__alloyId425, "click", direction2here) : __defers["$.__views.__alloyId425!click!direction2here"] = true;
    ...
    $.__views.__alloyId424.add($.__views.__alloyId429);
    clickToCall ? $.addListener($.__views.__alloyId429, "click", clickToCall) : __defers["$.__views.__alloyId429!click!clickToCall"] = true;
    ...
    $.__views.__alloyId424.add($.__views.__alloyId432);
    ...
    $.__views.__alloyId424.add($.__views.add2contact);
    ...
    $.__views.add2contact.add($.__views.__alloyId433);
    ...
    $.__views.add2contact.add($.__views.__alloyId434);
    ...
    $.__views.__alloyId423.add($.__views.clinicDetails);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId435);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId436);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId437);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId438);
    ...
    __defers["$.__views.__alloyId425!click!direction2here"] && $.addListener($.__views.__alloyId425, "click", direction2here);
    __defers["$.__views.__alloyId429!click!clickToCall"] && $.addListener($.__views.__alloyId429, "click", clickToCall);
