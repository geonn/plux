...
function Controller() {
    ...
    $.__views.__alloyId551.add($.__views.btnDirection);
    ...
    $.__views.__alloyId552 = Ti.UI.createScrollView({
        layout: "vertical",
        scrollType: "vertical",
        backgroundColor: "#ffffff",
        height: Ti.UI.FILL,
    ...
    direction2here ? $.addListener($.__views.__alloyId555, "click", direction2here) : __defers["$.__views.__alloyId555!click!direction2here"] = true;
    ...
    $.__views.__alloyId554.add($.__views.__alloyId559);
    clickToCall ? $.addListener($.__views.__alloyId559, "click", clickToCall) : __defers["$.__views.__alloyId559!click!clickToCall"] = true;
    ...
    $.__views.__alloyId554.add($.__views.__alloyId562);
    ...
    $.__views.__alloyId554.add($.__views.add2contact);
    ...
    $.__views.add2contact.add($.__views.__alloyId563);
    ...
    $.__views.add2contact.add($.__views.__alloyId564);
    ...
    $.__views.__alloyId553.add($.__views.clinicDetailsView);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId567);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId568);
    ...
    __defers["$.__views.__alloyId555!click!direction2here"] && $.addListener($.__views.__alloyId555, "click", direction2here);
    __defers["$.__views.__alloyId559!click!clickToCall"] && $.addListener($.__views.__alloyId559, "click", clickToCall);
