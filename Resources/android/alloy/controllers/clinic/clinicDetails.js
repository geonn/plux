...
function Controller() {
    ...
    $.__views.__alloyId418.add($.__views.btnDirection);
    $.__views.__alloyId419 = Ti.UI.createScrollView({
        layout: "vertical",
        scrollType: "vertical",
        backgroundColor: "#ffffff",
        height: Ti.UI.FILL,
    ...
    $.__views.__alloyId420.add($.__views.clinicMap);
    ...
    direction2here ? $.addListener($.__views.__alloyId422, "click", direction2here) : __defers["$.__views.__alloyId422!click!direction2here"] = true;
    ...
    $.__views.__alloyId421.add($.__views.__alloyId425);
    ...
    $.__views.__alloyId421.add($.__views.__alloyId426);
    clickToCall ? $.addListener($.__views.__alloyId426, "click", clickToCall) : __defers["$.__views.__alloyId426!click!clickToCall"] = true;
    ...
    $.__views.__alloyId421.add($.__views.__alloyId429);
    ...
    $.__views.__alloyId421.add($.__views.add2contact);
    ...
    $.__views.add2contact.add($.__views.__alloyId430);
    ...
    $.__views.add2contact.add($.__views.__alloyId431);
    ...
    $.__views.__alloyId420.add($.__views.clinicDetails);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId432);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId433);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId434);
    ...
    __defers["$.__views.__alloyId422!click!direction2here"] && $.addListener($.__views.__alloyId422, "click", direction2here);
    __defers["$.__views.__alloyId426!click!clickToCall"] && $.addListener($.__views.__alloyId426, "click", clickToCall);
