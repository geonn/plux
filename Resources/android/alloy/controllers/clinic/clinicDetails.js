...
function Controller() {
    ...
    $.__views.__alloyId585.add($.__views.btnDirection);
    ...
    $.__views.__alloyId586 = Ti.UI.createScrollView({
        layout: "vertical",
        scrollType: "vertical",
        backgroundColor: "#ffffff",
        height: Ti.UI.FILL,
    ...
    direction2here ? $.addListener($.__views.__alloyId589, "click", direction2here) : __defers["$.__views.__alloyId589!click!direction2here"] = true;
    ...
    clickToCall ? $.addListener($.__views.__alloyId593, "click", clickToCall) : __defers["$.__views.__alloyId593!click!clickToCall"] = true;
    ...
    $.__views.__alloyId588.add($.__views.add2contact);
    ...
    $.__views.add2contact.add($.__views.__alloyId597);
    ...
    $.__views.add2contact.add($.__views.__alloyId598);
    ...
    $.__views.__alloyId587.add($.__views.clinicDetailsView);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId601);
    ...
    __defers["$.__views.__alloyId589!click!direction2here"] && $.addListener($.__views.__alloyId589, "click", direction2here);
    __defers["$.__views.__alloyId593!click!clickToCall"] && $.addListener($.__views.__alloyId593, "click", clickToCall);
