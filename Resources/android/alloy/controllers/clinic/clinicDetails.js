...
function Controller() {
    ...
    $.__views.__alloyId556.add($.__views.btnDirection);
    ...
    $.__views.main.add($.__views.__alloyId557);
    ...
    direction2here ? $.addListener($.__views.__alloyId560, "click", direction2here) : __defers["$.__views.__alloyId560!click!direction2here"] = true;
    ...
    clickToCall ? $.addListener($.__views.__alloyId564, "click", clickToCall) : __defers["$.__views.__alloyId564!click!clickToCall"] = true;
    ...
    $.__views.__alloyId559.add($.__views.__alloyId567);
    ...
    $.__views.__alloyId559.add($.__views.add2contact);
    ...
    $.__views.__alloyId558.add($.__views.clinicDetailsView);
    ...
    __defers["$.__views.__alloyId560!click!direction2here"] && $.addListener($.__views.__alloyId560, "click", direction2here);
    __defers["$.__views.__alloyId564!click!clickToCall"] && $.addListener($.__views.__alloyId564, "click", clickToCall);
