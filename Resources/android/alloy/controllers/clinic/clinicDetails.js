...
function Controller() {
    ...
    $.__views.__alloyId264.add($.__views.clinicMap);
    ...
    clickToCall ? $.addListener($.__views.__alloyId270, "click", clickToCall) : __defers["$.__views.__alloyId270!click!clickToCall"] = true;
    ...
    $.__views.__alloyId265.add($.__views.__alloyId273);
    ...
    $.__views.__alloyId265.add($.__views.add2contact);
    ...
    $.__views.add2contact.add($.__views.__alloyId274);
    ...
    $.__views.add2contact.add($.__views.__alloyId275);
    ...
    $.__views.__alloyId264.add($.__views.clinicDetails);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId278);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId279);
    ...
    __defers["$.__views.__alloyId270!click!clickToCall"] && $.addListener($.__views.__alloyId270, "click", clickToCall);
