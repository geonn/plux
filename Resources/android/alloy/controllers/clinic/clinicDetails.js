...
function Controller() {
    ...
    $.__views.__alloyId512.add($.__views.btnDirection);
    $.__views.__alloyId513 = Ti.UI.createScrollView({
        layout: "vertical",
        scrollType: "vertical",
        backgroundColor: "#ffffff",
        height: Ti.UI.FILL,
    ...
    $.__views.__alloyId514.add($.__views.clinicMap);
    ...
    direction2here ? $.addListener($.__views.__alloyId516, "click", direction2here) : __defers["$.__views.__alloyId516!click!direction2here"] = true;
    ...
    clickToCall ? $.addListener($.__views.__alloyId520, "click", clickToCall) : __defers["$.__views.__alloyId520!click!clickToCall"] = true;
    ...
    $.__views.__alloyId515.add($.__views.__alloyId523);
    ...
    $.__views.__alloyId515.add($.__views.add2contact);
    ...
    $.__views.add2contact.add($.__views.__alloyId524);
    ...
    $.__views.add2contact.add($.__views.__alloyId525);
    ...
    $.__views.__alloyId514.add($.__views.clinicDetailsView);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId528);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId529);
    ...
    __defers["$.__views.__alloyId516!click!direction2here"] && $.addListener($.__views.__alloyId516, "click", direction2here);
    __defers["$.__views.__alloyId520!click!clickToCall"] && $.addListener($.__views.__alloyId520, "click", clickToCall);
