...
function Controller() {
    ...
    $.__views.__alloyId564.add($.__views.btnDirection);
    ...
    $.__views.__alloyId565 = Ti.UI.createScrollView({
        layout: "vertical",
        scrollType: "vertical",
        backgroundColor: "#ffffff",
        height: Ti.UI.FILL,
    ...
    direction2here ? $.addListener($.__views.__alloyId568, "click", direction2here) : __defers["$.__views.__alloyId568!click!direction2here"] = true;
    ...
    $.__views.__alloyId567.add($.__views.__alloyId571);
    ...
    clickToCall ? $.addListener($.__views.__alloyId572, "click", clickToCall) : __defers["$.__views.__alloyId572!click!clickToCall"] = true;
    ...
    $.__views.__alloyId567.add($.__views.__alloyId575);
    ...
    $.__views.__alloyId567.add($.__views.add2contact);
    ...
    $.__views.add2contact.add($.__views.__alloyId576);
    ...
    $.__views.__alloyId566.add($.__views.clinicDetailsView);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId578);
    ...
    __defers["$.__views.__alloyId568!click!direction2here"] && $.addListener($.__views.__alloyId568, "click", direction2here);
    __defers["$.__views.__alloyId572!click!clickToCall"] && $.addListener($.__views.__alloyId572, "click", clickToCall);
