...
function Controller() {
    ...
    $.__views.main.add($.__views.__alloyId533);
    ...
    $.__views.__alloyId534.add($.__views.btnBack);
    ...
    $.__views.__alloyId537.add($.__views.btnDirection);
    ...
    $.__views.__alloyId538 = Ti.UI.createScrollView({
        layout: "vertical",
        scrollType: "vertical",
        backgroundColor: "#ffffff",
        height: Ti.UI.FILL,
    ...
    direction2here ? $.addListener($.__views.__alloyId541, "click", direction2here) : __defers["$.__views.__alloyId541!click!direction2here"] = true;
    ...
    clickToCall ? $.addListener($.__views.__alloyId545, "click", clickToCall) : __defers["$.__views.__alloyId545!click!clickToCall"] = true;
    ...
    $.__views.__alloyId540.add($.__views.__alloyId548);
    ...
    $.__views.add2contact.add($.__views.__alloyId549);
    ...
    $.__views.add2contact.add($.__views.__alloyId550);
    ...
    $.__views.__alloyId539.add($.__views.clinicDetailsView);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId551);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId552);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId553);
    ...
    $.__views.clinicDetailsView.add($.__views.__alloyId554);
    ...
    __defers["$.__views.__alloyId541!click!direction2here"] && $.addListener($.__views.__alloyId541, "click", direction2here);
    __defers["$.__views.__alloyId545!click!clickToCall"] && $.addListener($.__views.__alloyId545, "click", clickToCall);
