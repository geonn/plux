...
function Controller() {
    ...
    $.__views.__alloyId168 = Ti.UI.createScrollView({
        layout: "vertical",
    ...
    $.__views.__alloyId169.add($.__views.clinicName);
    ...
    $.__views.__alloyId169.add($.__views.clinicAddress);
    ...
    $.__views.__alloyId169.add($.__views.clinicLocation);
    ...
    $.__views.__alloyId169.add($.__views.clinicTel);
    ...
    $.__views.__alloyId169.add($.__views.clinicOper);
    ...
    direction2here ? $.__views.__alloyId176.addEventListener("click", direction2here) : __defers["$.__views.__alloyId176!click!direction2here"] = true;
    ...
    clickToCall ? $.__views.__alloyId177.addEventListener("click", clickToCall) : __defers["$.__views.__alloyId177!click!clickToCall"] = true;
    ...
    __alloyId175.push($.__views.add2contact);
    ...
    $.__views.__alloyId168.add($.__views.healthTableData);
    ...
    __defers["$.__views.__alloyId176!click!direction2here"] && $.__views.__alloyId176.addEventListener("click", direction2here);
    __defers["$.__views.__alloyId177!click!clickToCall"] && $.__views.__alloyId177.addEventListener("click", clickToCall);
