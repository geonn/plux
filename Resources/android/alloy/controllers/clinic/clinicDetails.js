...
function Controller() {
    ...
    $.__views.__alloyId261 = Ti.UI.createScrollView({
        layout: "vertical",
        backgroundColor: "#ffffff",
        height: Ti.UI.FILL,
        width: Ti.UI.FILL,
    ...
    $.__views.__alloyId262.add($.__views.clinicMap);
    ...
    direction2here ? $.addListener($.__views.__alloyId264, "click", direction2here) : __defers["$.__views.__alloyId264!click!direction2here"] = true;
    ...
    clickToCall ? $.addListener($.__views.__alloyId268, "click", clickToCall) : __defers["$.__views.__alloyId268!click!clickToCall"] = true;
    ...
    $.__views.__alloyId263.add($.__views.add2contact);
    ...
    $.__views.add2contact.add($.__views.__alloyId272);
    ...
    $.__views.add2contact.add($.__views.__alloyId273);
    ...
    $.__views.__alloyId262.add($.__views.clinicDetails);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId274);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId275);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId276);
    ...
    $.__views.clinicDetails.add($.__views.__alloyId277);
    ...
    __defers["$.__views.__alloyId264!click!direction2here"] && $.addListener($.__views.__alloyId264, "click", direction2here);
    __defers["$.__views.__alloyId268!click!clickToCall"] && $.addListener($.__views.__alloyId268, "click", clickToCall);
