...
function Controller() {
    ...
    $.__views.win.rightNavButton = $.__views.__alloyId568;
    ...
    $.__views.__alloyId571.add($.__views.pageTitle);
    ...
    $.__views.__alloyId573.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId573.add($.__views.btnSearch);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId574);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId575, "click", showTypeSelection) : __defers["$.__views.__alloyId575!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId575.add($.__views.clinicTypeSelection);
    ...
    $.__views.__alloyId574.add($.__views.__alloyId577);
    ...
    showLocationSelection ? $.addListener($.__views.__alloyId578, "click", showLocationSelection) : __defers["$.__views.__alloyId578!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId578.add($.__views.clinicLocationSelection);
    ...
    __defers["$.__views.__alloyId575!click!showTypeSelection"] && $.addListener($.__views.__alloyId575, "click", showTypeSelection);
    __defers["$.__views.__alloyId578!click!showLocationSelection"] && $.addListener($.__views.__alloyId578, "click", showLocationSelection);
    _.extend($, exports);
}
