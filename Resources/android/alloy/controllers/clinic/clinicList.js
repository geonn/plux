...
function Controller() {
    ...
    $.__views.__alloyId440.add($.__views.btnMap);
    ...
    $.__views.__alloyId440.add($.__views.btnSearch);
    $.__views.clinicList.rightNavButton = $.__views.__alloyId440;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId442);
    ...
    $.__views.__alloyId446.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: "25",
        height: "25",
    ...
    $.__views.__alloyId446.add($.__views.btnSearch);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId447);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId448, "click", showTypeSelection) : __defers["$.__views.__alloyId448!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId448.add($.__views.clinicTypeSelection);
    ...
    showLocationSelection ? $.addListener($.__views.__alloyId451, "click", showLocationSelection) : __defers["$.__views.__alloyId451!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId451.add($.__views.clinicLocationSelection);
    $.__views.__alloyId452 = Ti.UI.createImageView({
        right: "10",
        width: "15",
        height: "15",
        image: "/images/btn-down.png",
    ...
    $.__views.panelListTbl.add($.__views.__alloyId453);
    ...
    __defers["$.__views.__alloyId448!click!showTypeSelection"] && $.addListener($.__views.__alloyId448, "click", showTypeSelection);
    __defers["$.__views.__alloyId451!click!showLocationSelection"] && $.addListener($.__views.__alloyId451, "click", showLocationSelection);
    _.extend($, exports);
}
