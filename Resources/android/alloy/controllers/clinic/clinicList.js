...
function Controller() {
    ...
    $.__views.__alloyId597.add($.__views.btnMap);
    ...
    $.__views.__alloyId597.add($.__views.btnSearch);
    $.__views.win.rightNavButton = $.__views.__alloyId597;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId598);
    ...
    $.__views.__alloyId599.add($.__views.btnBack);
    ...
    $.__views.__alloyId598.add($.__views.__alloyId601);
    ...
    $.__views.__alloyId602.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId602.add($.__views.btnSearch);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId604, "click", showTypeSelection) : __defers["$.__views.__alloyId604!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId604.add($.__views.clinicTypeSelection);
    $.__views.__alloyId605 = Ti.UI.createImageView({
        right: 10,
        width: 15,
        height: 15,
    ...
    $.__views.__alloyId603.add($.__views.__alloyId607);
    showLocationSelection ? $.addListener($.__views.__alloyId607, "click", showLocationSelection) : __defers["$.__views.__alloyId607!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId607.add($.__views.clinicLocationSelection);
    $.__views.__alloyId608 = Ti.UI.createImageView({
        right: 10,
        width: 15,
        height: 15,
        image: "/images/btn-down.png",
    ...
    $.__views.panelListTbl.add($.__views.__alloyId609);
    ...
    __defers["$.__views.__alloyId604!click!showTypeSelection"] && $.addListener($.__views.__alloyId604, "click", showTypeSelection);
    __defers["$.__views.__alloyId607!click!showLocationSelection"] && $.addListener($.__views.__alloyId607, "click", showLocationSelection);
    _.extend($, exports);
}
