...
function Controller() {
    ...
    $.__views.__alloyId607.add($.__views.btnMap);
    ...
    $.__views.__alloyId607.add($.__views.btnSearch);
    $.__views.win.rightNavButton = $.__views.__alloyId607;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId608);
    ...
    $.__views.__alloyId612.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId612.add($.__views.btnSearch);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId614, "click", showTypeSelection) : __defers["$.__views.__alloyId614!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId614.add($.__views.clinicTypeSelection);
    ...
    $.__views.__alloyId613.add($.__views.__alloyId617);
    showLocationSelection ? $.addListener($.__views.__alloyId617, "click", showLocationSelection) : __defers["$.__views.__alloyId617!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId617.add($.__views.clinicLocationSelection);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId619);
    ...
    __defers["$.__views.__alloyId614!click!showTypeSelection"] && $.addListener($.__views.__alloyId614, "click", showTypeSelection);
    __defers["$.__views.__alloyId617!click!showLocationSelection"] && $.addListener($.__views.__alloyId617, "click", showLocationSelection);
    _.extend($, exports);
}
