...
function Controller() {
    ...
    $.__views.__alloyId531.add($.__views.btnMap);
    ...
    $.__views.__alloyId531.add($.__views.btnSearch);
    $.__views.clinicList.rightNavButton = $.__views.__alloyId531;
    ...
    $.__views.loadingBar.add($.__views.__alloyId532);
    ...
    $.__views.__alloyId535.add($.__views.pageTitle);
    ...
    $.__views.__alloyId537.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId537.add($.__views.btnSearch);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId538);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId539, "click", showTypeSelection) : __defers["$.__views.__alloyId539!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId539.add($.__views.clinicTypeSelection);
    ...
    $.__views.__alloyId538.add($.__views.__alloyId542);
    showLocationSelection ? $.addListener($.__views.__alloyId542, "click", showLocationSelection) : __defers["$.__views.__alloyId542!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId542.add($.__views.clinicLocationSelection);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId544);
    ...
    __defers["$.__views.__alloyId539!click!showTypeSelection"] && $.addListener($.__views.__alloyId539, "click", showTypeSelection);
    __defers["$.__views.__alloyId542!click!showLocationSelection"] && $.addListener($.__views.__alloyId542, "click", showLocationSelection);
    _.extend($, exports);
}
