...
function Controller() {
    ...
    $.__views.win.rightNavButton = $.__views.__alloyId599;
    ...
    $.__views.__alloyId601.add($.__views.btnBack);
    ...
    $.__views.__alloyId602.add($.__views.pageTitle);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId606, "click", showTypeSelection) : __defers["$.__views.__alloyId606!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId606.add($.__views.clinicTypeSelection);
    ...
    $.__views.__alloyId605.add($.__views.__alloyId609);
    showLocationSelection ? $.addListener($.__views.__alloyId609, "click", showLocationSelection) : __defers["$.__views.__alloyId609!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId609.add($.__views.clinicLocationSelection);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId611);
    ...
    __defers["$.__views.__alloyId606!click!showTypeSelection"] && $.addListener($.__views.__alloyId606, "click", showTypeSelection);
    __defers["$.__views.__alloyId609!click!showLocationSelection"] && $.addListener($.__views.__alloyId609, "click", showLocationSelection);
    _.extend($, exports);
}
