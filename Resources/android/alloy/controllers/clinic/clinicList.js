...
function Controller() {
    ...
    $.__views.__alloyId556.add($.__views.btnMap);
    ...
    $.__views.__alloyId556.add($.__views.btnSearch);
    $.__views.win.rightNavButton = $.__views.__alloyId556;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId557);
    ...
    $.__views.__alloyId558.add($.__views.btnBack);
    ...
    $.__views.__alloyId561.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId561.add($.__views.btnSearch);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId562);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId563, "click", showTypeSelection) : __defers["$.__views.__alloyId563!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId563.add($.__views.clinicTypeSelection);
    ...
    showLocationSelection ? $.addListener($.__views.__alloyId566, "click", showLocationSelection) : __defers["$.__views.__alloyId566!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId566.add($.__views.clinicLocationSelection);
    ...
    __defers["$.__views.__alloyId563!click!showTypeSelection"] && $.addListener($.__views.__alloyId563, "click", showTypeSelection);
    __defers["$.__views.__alloyId566!click!showLocationSelection"] && $.addListener($.__views.__alloyId566, "click", showLocationSelection);
    _.extend($, exports);
}
