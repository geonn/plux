...
function Controller() {
    ...
    $.__views.__alloyId528.add($.__views.btnMap);
    ...
    $.__views.__alloyId528.add($.__views.btnSearch);
    $.__views.clinicList.rightNavButton = $.__views.__alloyId528;
    ...
    $.__views.loadingBar.add($.__views.__alloyId529);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId530);
    ...
    $.__views.__alloyId534.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId534.add($.__views.btnSearch);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId535);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId536, "click", showTypeSelection) : __defers["$.__views.__alloyId536!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId536.add($.__views.clinicTypeSelection);
    ...
    $.__views.__alloyId535.add($.__views.__alloyId539);
    showLocationSelection ? $.addListener($.__views.__alloyId539, "click", showLocationSelection) : __defers["$.__views.__alloyId539!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId539.add($.__views.clinicLocationSelection);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId541);
    ...
    __defers["$.__views.__alloyId536!click!showTypeSelection"] && $.addListener($.__views.__alloyId536, "click", showTypeSelection);
    __defers["$.__views.__alloyId539!click!showLocationSelection"] && $.addListener($.__views.__alloyId539, "click", showLocationSelection);
    _.extend($, exports);
}
