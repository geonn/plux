...
function Controller() {
    ...
    $.__views.__alloyId574.add($.__views.btnMap);
    ...
    $.__views.__alloyId574.add($.__views.btnSearch);
    $.__views.win.rightNavButton = $.__views.__alloyId574;
    ...
    $.__views.__alloyId576.add($.__views.btnBack);
    ...
    $.__views.__alloyId577.add($.__views.pageTitle);
    ...
    $.__views.__alloyId579.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId579.add($.__views.btnSearch);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId580);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId581, "click", showTypeSelection) : __defers["$.__views.__alloyId581!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId581.add($.__views.clinicTypeSelection);
    ...
    $.__views.__alloyId580.add($.__views.__alloyId584);
    showLocationSelection ? $.addListener($.__views.__alloyId584, "click", showLocationSelection) : __defers["$.__views.__alloyId584!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId584.add($.__views.clinicLocationSelection);
    $.__views.__alloyId585 = Ti.UI.createImageView({
        right: 10,
        width: 15,
        height: 15,
        image: "/images/btn-down.png",
    ...
    __defers["$.__views.__alloyId581!click!showTypeSelection"] && $.addListener($.__views.__alloyId581, "click", showTypeSelection);
    __defers["$.__views.__alloyId584!click!showLocationSelection"] && $.addListener($.__views.__alloyId584, "click", showLocationSelection);
    _.extend($, exports);
}
