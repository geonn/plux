...
function Controller() {
    ...
    $.__views.__alloyId594.add($.__views.btnMap);
    ...
    $.__views.__alloyId594.add($.__views.btnSearch);
    $.__views.win.rightNavButton = $.__views.__alloyId594;
    ...
    $.__views.__alloyId596.add($.__views.btnBack);
    ...
    $.__views.__alloyId597.add($.__views.pageTitle);
    $.__views.__alloyId598 = Ti.UI.createView({
        right: 0,
        width: "20%",
        id: "__alloyId598"
    });
    $.__views.__alloyId595.add($.__views.__alloyId598);
    ...
    $.__views.__alloyId599.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId599.add($.__views.btnSearch);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId600);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId601, "click", showTypeSelection) : __defers["$.__views.__alloyId601!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId601.add($.__views.clinicTypeSelection);
    ...
    showLocationSelection ? $.addListener($.__views.__alloyId604, "click", showLocationSelection) : __defers["$.__views.__alloyId604!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId604.add($.__views.clinicLocationSelection);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId606);
    ...
    __defers["$.__views.__alloyId601!click!showTypeSelection"] && $.addListener($.__views.__alloyId601, "click", showTypeSelection);
    __defers["$.__views.__alloyId604!click!showLocationSelection"] && $.addListener($.__views.__alloyId604, "click", showLocationSelection);
    _.extend($, exports);
}
