...
function Controller() {
    ...
    $.__views.__alloyId351.add($.__views.btnMap);
    ...
    $.__views.__alloyId351.add($.__views.btnSearch);
    $.__views.clinicList.rightNavButton = $.__views.__alloyId351;
    ...
    $.__views.__alloyId356.add($.__views.btnSearch);
    $.__views.btnSearch = Ti.UI.createImageView({
        right: "10",
        id: "btnSearch",
        width: "25",
    ...
    $.__views.panelListTbl.add($.__views.__alloyId357);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId358, "click", showTypeSelection) : __defers["$.__views.__alloyId358!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId358.add($.__views.clinicTypeSelection);
    ...
    showLocationSelection ? $.addListener($.__views.__alloyId361, "click", showLocationSelection) : __defers["$.__views.__alloyId361!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId361.add($.__views.clinicLocationSelection);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId363);
    ...
    __defers["$.__views.__alloyId358!click!showTypeSelection"] && $.addListener($.__views.__alloyId358, "click", showTypeSelection);
    __defers["$.__views.__alloyId361!click!showLocationSelection"] && $.addListener($.__views.__alloyId361, "click", showLocationSelection);
    _.extend($, exports);
}
