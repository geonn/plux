...
function Controller() {
    ...
    $.__views.__alloyId583.add($.__views.btnMap);
    ...
    $.__views.__alloyId583.add($.__views.btnSearch);
    $.__views.clinicList.rightNavButton = $.__views.__alloyId583;
    ...
    $.__views.loadingBar.add($.__views.__alloyId584);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId585);
    ...
    $.__views.__alloyId587.add($.__views.pageTitle);
    ...
    $.__views.__alloyId589.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId589.add($.__views.btnSearch);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId590);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId591, "click", showTypeSelection) : __defers["$.__views.__alloyId591!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId591.add($.__views.clinicTypeSelection);
    ...
    $.__views.__alloyId590.add($.__views.__alloyId593);
    $.__views.__alloyId594 = Ti.UI.createView({
        width: "49%",
        height: Ti.UI.SIZE,
        id: "__alloyId594"
    });
    $.__views.__alloyId590.add($.__views.__alloyId594);
    showLocationSelection ? $.addListener($.__views.__alloyId594, "click", showLocationSelection) : __defers["$.__views.__alloyId594!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId594.add($.__views.clinicLocationSelection);
    ...
    __defers["$.__views.__alloyId591!click!showTypeSelection"] && $.addListener($.__views.__alloyId591, "click", showTypeSelection);
    __defers["$.__views.__alloyId594!click!showLocationSelection"] && $.addListener($.__views.__alloyId594, "click", showLocationSelection);
    _.extend($, exports);
}
