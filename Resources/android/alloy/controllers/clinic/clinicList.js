...
function Controller() {
    ...
    $.__views.panelListTbl.add($.__views.__alloyId282);
    ...
    $.__views.__alloyId285.add($.__views.btnSearch);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId286);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId287, "click", showTypeSelection) : __defers["$.__views.__alloyId287!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId287.add($.__views.clinicTypeSelection);
    ...
    $.__views.__alloyId286.add($.__views.__alloyId290);
    showLocationSelection ? $.addListener($.__views.__alloyId290, "click", showLocationSelection) : __defers["$.__views.__alloyId290!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId290.add($.__views.clinicLocationSelection);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId292);
    ...
    __defers["$.__views.__alloyId287!click!showTypeSelection"] && $.addListener($.__views.__alloyId287, "click", showTypeSelection);
    __defers["$.__views.__alloyId290!click!showLocationSelection"] && $.addListener($.__views.__alloyId290, "click", showLocationSelection);
    _.extend($, exports);
}
