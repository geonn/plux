...
function Controller() {
    ...
    $.__views.__alloyId587.add($.__views.btnMap);
    ...
    $.__views.__alloyId587.add($.__views.btnSearch);
    $.__views.clinicList.rightNavButton = $.__views.__alloyId587;
    ...
    $.__views.__alloyId593.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId593.add($.__views.btnSearch);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId595, "click", showTypeSelection) : __defers["$.__views.__alloyId595!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId595.add($.__views.clinicTypeSelection);
    ...
    showLocationSelection ? $.addListener($.__views.__alloyId598, "click", showLocationSelection) : __defers["$.__views.__alloyId598!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId598.add($.__views.clinicLocationSelection);
    ...
    __defers["$.__views.__alloyId595!click!showTypeSelection"] && $.addListener($.__views.__alloyId595, "click", showTypeSelection);
    __defers["$.__views.__alloyId598!click!showLocationSelection"] && $.addListener($.__views.__alloyId598, "click", showLocationSelection);
    _.extend($, exports);
}
