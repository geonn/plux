...
function Controller() {
    ...
    $.__views.clinicList.rightNavButton = $.__views.__alloyId437;
    ...
    $.__views.loadingBar.add($.__views.__alloyId438);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId439);
    ...
    $.__views.__alloyId443.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: "25",
        height: "25",
    ...
    $.__views.__alloyId443.add($.__views.btnSearch);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId445, "click", showTypeSelection) : __defers["$.__views.__alloyId445!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId445.add($.__views.clinicTypeSelection);
    ...
    $.__views.__alloyId444.add($.__views.__alloyId448);
    showLocationSelection ? $.addListener($.__views.__alloyId448, "click", showLocationSelection) : __defers["$.__views.__alloyId448!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId448.add($.__views.clinicLocationSelection);
    $.__views.__alloyId449 = Ti.UI.createImageView({
        right: "10",
        width: "15",
        height: "15",
        image: "/images/btn-down.png",
    ...
    $.__views.panelListTbl.add($.__views.__alloyId450);
    ...
    __defers["$.__views.__alloyId445!click!showTypeSelection"] && $.addListener($.__views.__alloyId445, "click", showTypeSelection);
    __defers["$.__views.__alloyId448!click!showLocationSelection"] && $.addListener($.__views.__alloyId448, "click", showLocationSelection);
    _.extend($, exports);
}
