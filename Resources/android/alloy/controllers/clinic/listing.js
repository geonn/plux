...
function Controller() {
    ...
    doRefresh ? $.addListener($.__views.__alloyId558, "click", doRefresh) : __defers["$.__views.__alloyId558!click!doRefresh"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId558;
    ...
    doRefresh ? $.addListener($.__views.__alloyId563, "click", doRefresh) : __defers["$.__views.__alloyId563!click!doRefresh"] = true;
    ...
    __defers["$.__views.__alloyId558!click!doRefresh"] && $.addListener($.__views.__alloyId558, "click", doRefresh);
    __defers["$.__views.__alloyId563!click!doRefresh"] && $.addListener($.__views.__alloyId563, "click", doRefresh);
    _.extend($, exports);
}
