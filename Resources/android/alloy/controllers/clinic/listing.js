...
function Controller() {
    ...
    doRefresh ? $.addListener($.__views.__alloyId466, "click", doRefresh) : __defers["$.__views.__alloyId466!click!doRefresh"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId466;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId467);
    ...
    $.__views.__alloyId469.add($.__views.pageTitle);
    $.__views.__alloyId470 = Ti.UI.createView({
        right: "0",
        width: "20%",
        id: "__alloyId470"
    });
    $.__views.__alloyId467.add($.__views.__alloyId470);
    ...
    doRefresh ? $.addListener($.__views.__alloyId471, "click", doRefresh) : __defers["$.__views.__alloyId471!click!doRefresh"] = true;
    ...
    $.__views.loadingBar.add($.__views.__alloyId472);
    ...
    __defers["$.__views.__alloyId466!click!doRefresh"] && $.addListener($.__views.__alloyId466, "click", doRefresh);
    __defers["$.__views.__alloyId471!click!doRefresh"] && $.addListener($.__views.__alloyId471, "click", doRefresh);
    _.extend($, exports);
}
