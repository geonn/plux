...
function Controller() {
    ...
    $.__views.win.rightNavButton = $.__views.__alloyId650;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId651);
    ...
    doRefresh ? $.addListener($.__views.__alloyId655, "click", doRefresh) : __defers["$.__views.__alloyId655!click!doRefresh"] = true;
    ...
    $.__views.loadingBar.add($.__views.__alloyId656);
    ...
    __defers["$.__views.__alloyId655!click!doRefresh"] && $.addListener($.__views.__alloyId655, "click", doRefresh);
    _.extend($, exports);
}
