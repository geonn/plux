...
function Controller() {
    ...
    doRefresh ? $.addListener($.__views.__alloyId306, "click", doRefresh) : __defers["$.__views.__alloyId306!click!doRefresh"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId306;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId307);
    ...
    doRefresh ? $.addListener($.__views.__alloyId311, "click", doRefresh) : __defers["$.__views.__alloyId311!click!doRefresh"] = true;
    ...
    __defers["$.__views.__alloyId306!click!doRefresh"] && $.addListener($.__views.__alloyId306, "click", doRefresh);
    __defers["$.__views.__alloyId311!click!doRefresh"] && $.addListener($.__views.__alloyId311, "click", doRefresh);
    _.extend($, exports);
}
