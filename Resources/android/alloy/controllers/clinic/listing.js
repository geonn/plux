...
function Controller() {
    ...
    doRefresh ? $.addListener($.__views.__alloyId611, "click", doRefresh) : __defers["$.__views.__alloyId611!click!doRefresh"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId611;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId612);
    ...
    doRefresh ? $.addListener($.__views.__alloyId616, "click", doRefresh) : __defers["$.__views.__alloyId616!click!doRefresh"] = true;
    ...
    __defers["$.__views.__alloyId611!click!doRefresh"] && $.addListener($.__views.__alloyId611, "click", doRefresh);
    __defers["$.__views.__alloyId616!click!doRefresh"] && $.addListener($.__views.__alloyId616, "click", doRefresh);
    _.extend($, exports);
}
