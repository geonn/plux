...
function Controller() {
    ...
    $.__views.__alloyId637 = Ti.UI.createImageView({
        right: 10,
        width: 25,
        height: 25,
    ...
    doRefresh ? $.addListener($.__views.__alloyId637, "click", doRefresh) : __defers["$.__views.__alloyId637!click!doRefresh"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId637;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId638);
    ...
    $.__views.__alloyId639.add($.__views.btnBack);
    ...
    $.__views.__alloyId638.add($.__views.__alloyId641);
    ...
    __defers["$.__views.__alloyId637!click!doRefresh"] && $.addListener($.__views.__alloyId637, "click", doRefresh);
