...
function Controller() {
    ...
    doRefresh ? $.addListener($.__views.__alloyId645, "click", doRefresh) : __defers["$.__views.__alloyId645!click!doRefresh"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId645;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId646);
    ...
    doRefresh ? $.addListener($.__views.__alloyId650, "click", doRefresh) : __defers["$.__views.__alloyId650!click!doRefresh"] = true;
    ...
    $.__views.loadingBar.add($.__views.__alloyId651);
    ...
    __defers["$.__views.__alloyId645!click!doRefresh"] && $.addListener($.__views.__alloyId645, "click", doRefresh);
    __defers["$.__views.__alloyId650!click!doRefresh"] && $.addListener($.__views.__alloyId650, "click", doRefresh);
    _.extend($, exports);
}
