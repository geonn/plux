...
function Controller() {
    ...
    doRefresh ? $.addListener($.__views.__alloyId557, "click", doRefresh) : __defers["$.__views.__alloyId557!click!doRefresh"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId557;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId558);
    ...
    doRefresh ? $.addListener($.__views.__alloyId562, "click", doRefresh) : __defers["$.__views.__alloyId562!click!doRefresh"] = true;
    ...
    __defers["$.__views.__alloyId557!click!doRefresh"] && $.addListener($.__views.__alloyId557, "click", doRefresh);
    __defers["$.__views.__alloyId562!click!doRefresh"] && $.addListener($.__views.__alloyId562, "click", doRefresh);
    _.extend($, exports);
}
