...
function Controller() {
    ...
    doRefresh ? $.addListener($.__views.__alloyId379, "click", doRefresh) : __defers["$.__views.__alloyId379!click!doRefresh"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId379;
    ...
    doRefresh ? $.addListener($.__views.__alloyId384, "click", doRefresh) : __defers["$.__views.__alloyId384!click!doRefresh"] = true;
    ...
    __defers["$.__views.__alloyId379!click!doRefresh"] && $.addListener($.__views.__alloyId379, "click", doRefresh);
    __defers["$.__views.__alloyId384!click!doRefresh"] && $.addListener($.__views.__alloyId384, "click", doRefresh);
    _.extend($, exports);
}
