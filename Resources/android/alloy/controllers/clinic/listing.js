...
<<<<<<< HEAD:Resources/iphone/alloy/controllers/clinic/listing.js
...
=======
    $.__views.__alloyId289 = Ti.UI.createLabel({
        ...
        right: "10",
        id: "__alloyId289"
>>>>>>> origin/master:Resources/android/alloy/controllers/clinic/listing.js
    });
    doRefresh ? $.addListener($.__views.__alloyId289, "click", doRefresh) : __defers["$.__views.__alloyId289!click!doRefresh"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId289;
    ...
    doRefresh ? $.addListener($.__views.__alloyId294, "click", doRefresh) : __defers["$.__views.__alloyId294!click!doRefresh"] = true;
    ...
    __defers["$.__views.__alloyId289!click!doRefresh"] && $.addListener($.__views.__alloyId289, "click", doRefresh);
    __defers["$.__views.__alloyId294!click!doRefresh"] && $.addListener($.__views.__alloyId294, "click", doRefresh);
    _.extend($, exports);
}
