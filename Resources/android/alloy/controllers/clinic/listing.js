...
function Controller() {
    ...
    $.__views.win.rightNavButton = $.__views.__alloyId616;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId617);
    ...
    $.__views.__alloyId618.add($.__views.btnBack);
    ...
    doRefresh ? $.addListener($.__views.__alloyId621, "click", doRefresh) : __defers["$.__views.__alloyId621!click!doRefresh"] = true;
    ...
    __defers["$.__views.__alloyId621!click!doRefresh"] && $.addListener($.__views.__alloyId621, "click", doRefresh);
    _.extend($, exports);
}
