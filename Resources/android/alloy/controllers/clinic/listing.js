...
function Controller() {
    ...
    doRefresh ? $.addListener($.__views.__alloyId469, "click", doRefresh) : __defers["$.__views.__alloyId469!click!doRefresh"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId469;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId470);
    ...
    $.__views.__alloyId472.add($.__views.pageTitle);
    ...
    doRefresh ? $.addListener($.__views.__alloyId474, "click", doRefresh) : __defers["$.__views.__alloyId474!click!doRefresh"] = true;
    ...
    __defers["$.__views.__alloyId469!click!doRefresh"] && $.addListener($.__views.__alloyId469, "click", doRefresh);
    __defers["$.__views.__alloyId474!click!doRefresh"] && $.addListener($.__views.__alloyId474, "click", doRefresh);
    _.extend($, exports);
}
