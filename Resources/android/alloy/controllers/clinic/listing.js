...
function Controller() {
    ...
    doRefresh ? $.addListener($.__views.__alloyId308, "click", doRefresh) : __defers["$.__views.__alloyId308!click!doRefresh"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId308;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId309);
    ...
    doRefresh ? $.addListener($.__views.__alloyId313, "click", doRefresh) : __defers["$.__views.__alloyId313!click!doRefresh"] = true;
    ...
    $.__views.loadingBar.add($.__views.__alloyId314);
    ...
    __defers["$.__views.__alloyId308!click!doRefresh"] && $.addListener($.__views.__alloyId308, "click", doRefresh);
    __defers["$.__views.__alloyId313!click!doRefresh"] && $.addListener($.__views.__alloyId313, "click", doRefresh);
    _.extend($, exports);
}
