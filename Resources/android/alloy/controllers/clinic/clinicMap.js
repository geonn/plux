...
function Controller() {
	...
	{ height: Ti.UI.FILL, width: Ti.UI.FILL, layout: "vertical", id: "__alloyId387" });

	$.__views.panelMapWin.add($.__views.__alloyId387);
	if (true) {
		$.__views.__alloyId388 = Ti.UI.createView(
		{ layout: "horizontal", height: 50, width: "100%", backgroundColor: "#DEDEDE", id: "__alloyId388" });

		$.__views.__alloyId387.add($.__views.__alloyId388);
		$.__views.__alloyId389 = Ti.UI.createView(
		{ left: 0, width: "10%", id: "__alloyId389" });
		...
		{ width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'Clinic Map', textAlign: "center", id: "__alloyId390" });
