...
function Controller() {
	...
	{ layout: "horizontal", right: 5, id: "__alloyId367" });
	...
	$.__views.clinicList.rightNavButton = $.__views.__alloyId367;$.__views.loadingBar = Ti.UI.createView(
	...
	{ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#ffffff", top: 5, bottom: 10, text: "Loading", id: "__alloyId368" });
	...
	if (true) {
		...
		{ layout: "horizontal", height: 50, width: Ti.UI.FILL, backgroundColor: "#DEDEDE", id: "__alloyId369" });

		$.__views.panelListTbl.add($.__views.__alloyId369);
		$.__views.__alloyId370 = Ti.UI.createView(
		{ left: 0, width: "20%", id: "__alloyId370" });
	...
	{ height: 50, layout: "horizontal", width: Ti.UI.FILL, id: "__alloyId374" });

	$.__views.panelListTbl.add($.__views.__alloyId374);
	$.__views.__alloyId375 = Ti.UI.createView(
	{ width: "50%", height: Ti.UI.SIZE, id: "__alloyId375" });

	$.__views.__alloyId374.add($.__views.__alloyId375);
	showTypeSelection ? $.addListener($.__views.__alloyId375, 'click', showTypeSelection) : __defers['$.__views.__alloyId375!click!showTypeSelection'] = true;$.__views.clinicTypeSelection = Ti.UI.createLabel(
	...
	{ right: 10, width: 15, height: 15, image: "/images/btn-down.png", id: "__alloyId376" });

	$.__views.__alloyId375.add($.__views.__alloyId376);
	$.__views.__alloyId377 = Ti.UI.createView(
	{ width: 1, height: 50, backgroundColor: "#9E9E9E", id: "__alloyId377" });

	$.__views.__alloyId374.add($.__views.__alloyId377);
	$.__views.__alloyId378 = Ti.UI.createView(
	{ width: "49%", height: Ti.UI.SIZE, id: "__alloyId378" });

	$.__views.__alloyId374.add($.__views.__alloyId378);
	showLocationSelection ? $.addListener($.__views.__alloyId378, 'click', showLocationSelection) : __defers['$.__views.__alloyId378!click!showLocationSelection'] = true;$.__views.clinicLocationSelection = Ti.UI.createLabel(
	...
	{ right: 10, width: 15, height: 15, image: "/images/btn-down.png", id: "__alloyId379" });

	$.__views.__alloyId378.add($.__views.__alloyId379);
	$.__views.__alloyId380 = Ti.UI.createView(
	{ width: Ti.UI.FILL, height: 1, backgroundColor: "#9E9E9E", id: "__alloyId380" });
