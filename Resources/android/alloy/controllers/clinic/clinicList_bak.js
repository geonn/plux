...
function Controller() {
    ...
    $.__views.__alloyId621.add($.__views.btnMap);
    ...
    $.__views.__alloyId621.add($.__views.btnSearch);
    $.__views.clinicList.rightNavButton = $.__views.__alloyId621;
    ...
    $.__views.__alloyId627.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId627.add($.__views.btnSearch);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId628);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId629, "click", showTypeSelection) : __defers["$.__views.__alloyId629!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId629.add($.__views.clinicTypeSelection);
    ...
    showLocationSelection ? $.addListener($.__views.__alloyId632, "click", showLocationSelection) : __defers["$.__views.__alloyId632!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId632.add($.__views.clinicLocationSelection);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId634);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId629!click!showTypeSelection"] && $.addListener($.__views.__alloyId629, "click", showTypeSelection);
    __defers["$.__views.__alloyId632!click!showLocationSelection"] && $.addListener($.__views.__alloyId632, "click", showLocationSelection);
    _.extend($, exports);
}
