...
function Controller() {
    ...
    $.__views.__alloyId618.add($.__views.btnMap);
    ...
    $.__views.__alloyId618.add($.__views.btnSearch);
    $.__views.clinicList.rightNavButton = $.__views.__alloyId618;
    ...
    $.__views.__alloyId621.add($.__views.btnBack);
    ...
    $.__views.__alloyId624.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId624.add($.__views.btnSearch);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId625);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId626, "click", showTypeSelection) : __defers["$.__views.__alloyId626!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId626.add($.__views.clinicTypeSelection);
    ...
    $.__views.__alloyId625.add($.__views.__alloyId629);
    showLocationSelection ? $.addListener($.__views.__alloyId629, "click", showLocationSelection) : __defers["$.__views.__alloyId629!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId629.add($.__views.clinicLocationSelection);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId631);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId626!click!showTypeSelection"] && $.addListener($.__views.__alloyId626, "click", showTypeSelection);
    __defers["$.__views.__alloyId629!click!showLocationSelection"] && $.addListener($.__views.__alloyId629, "click", showLocationSelection);
    _.extend($, exports);
}
