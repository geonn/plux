...
function Controller() {
    ...
    $.__views.__alloyId611.add($.__views.btnMap);
    ...
    $.__views.__alloyId611.add($.__views.btnSearch);
    $.__views.clinicList.rightNavButton = $.__views.__alloyId611;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId613);
    ...
    $.__views.__alloyId615.add($.__views.pageTitle);
    ...
    $.__views.__alloyId617.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId617.add($.__views.btnSearch);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId619, "click", showTypeSelection) : __defers["$.__views.__alloyId619!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId619.add($.__views.clinicTypeSelection);
    ...
    showLocationSelection ? $.addListener($.__views.__alloyId622, "click", showLocationSelection) : __defers["$.__views.__alloyId622!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId622.add($.__views.clinicLocationSelection);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId624);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId619!click!showTypeSelection"] && $.addListener($.__views.__alloyId619, "click", showTypeSelection);
    __defers["$.__views.__alloyId622!click!showLocationSelection"] && $.addListener($.__views.__alloyId622, "click", showLocationSelection);
    _.extend($, exports);
}
