...
function Controller() {
    ...
    $.__views.clinicList.rightNavButton = $.__views.__alloyId588;
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId596, "click", showTypeSelection) : __defers["$.__views.__alloyId596!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId596.add($.__views.clinicTypeSelection);
    ...
    $.__views.__alloyId595.add($.__views.__alloyId599);
    showLocationSelection ? $.addListener($.__views.__alloyId599, "click", showLocationSelection) : __defers["$.__views.__alloyId599!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId599.add($.__views.clinicLocationSelection);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId601);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId596!click!showTypeSelection"] && $.addListener($.__views.__alloyId596, "click", showTypeSelection);
    __defers["$.__views.__alloyId599!click!showLocationSelection"] && $.addListener($.__views.__alloyId599, "click", showLocationSelection);
    _.extend($, exports);
}
