...
function Controller() {
    ...
    $.__views.__alloyId608.add($.__views.btnMap);
    ...
    $.__views.__alloyId608.add($.__views.btnSearch);
    $.__views.clinicList.rightNavButton = $.__views.__alloyId608;
    ...
    $.__views.loadingBar.add($.__views.__alloyId609);
    ...
    $.__views.__alloyId614.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId614.add($.__views.btnSearch);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId616, "click", showTypeSelection) : __defers["$.__views.__alloyId616!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId616.add($.__views.clinicTypeSelection);
    $.__views.__alloyId617 = Ti.UI.createImageView({
        right: 10,
        width: 15,
        height: 15,
    ...
    showLocationSelection ? $.addListener($.__views.__alloyId619, "click", showLocationSelection) : __defers["$.__views.__alloyId619!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId619.add($.__views.clinicLocationSelection);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId621);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId616!click!showTypeSelection"] && $.addListener($.__views.__alloyId616, "click", showTypeSelection);
    __defers["$.__views.__alloyId619!click!showLocationSelection"] && $.addListener($.__views.__alloyId619, "click", showLocationSelection);
    _.extend($, exports);
}
