...
function Controller() {
    ...
    $.__views.__alloyId616.add($.__views.btnMap);
    ...
    $.__views.__alloyId616.add($.__views.btnSearch);
    $.__views.clinicList.rightNavButton = $.__views.__alloyId616;
    ...
    $.__views.panelListTbl.add($.__views.__alloyId618);
    ...
    $.__views.__alloyId620.add($.__views.pageTitle);
    ...
    $.__views.__alloyId622.add($.__views.btnMap);
    $.__views.btnSearch = Ti.UI.createImageView({
        id: "btnSearch",
        width: 25,
        height: 25,
    ...
    $.__views.__alloyId622.add($.__views.btnSearch);
    ...
    $.__views.panelListTbl.add($.__views.__alloyId623);
    ...
    showTypeSelection ? $.addListener($.__views.__alloyId624, "click", showTypeSelection) : __defers["$.__views.__alloyId624!click!showTypeSelection"] = true;
    ...
    $.__views.__alloyId624.add($.__views.clinicTypeSelection);
    ...
    $.__views.__alloyId623.add($.__views.__alloyId627);
    showLocationSelection ? $.addListener($.__views.__alloyId627, "click", showLocationSelection) : __defers["$.__views.__alloyId627!click!showLocationSelection"] = true;
    ...
    $.__views.__alloyId627.add($.__views.clinicLocationSelection);
    $.__views.__alloyId628 = Ti.UI.createImageView({
        right: 10,
        width: 15,
        height: 15,
        image: "/images/btn-down.png",
    ...
    $.__views.panelListTbl.add($.__views.__alloyId629);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId624!click!showTypeSelection"] && $.addListener($.__views.__alloyId624, "click", showTypeSelection);
    __defers["$.__views.__alloyId627!click!showLocationSelection"] && $.addListener($.__views.__alloyId627, "click", showLocationSelection);
    _.extend($, exports);
}
