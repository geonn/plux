...
function Controller() {
  ...
  if (true) {
    ...
    { layout: "horizontal", height: 50, width: Ti.UI.FILL, backgroundColor: "#DEDEDE", id: "__alloyId391" });

    $.__views.win_map.add($.__views.__alloyId391);
    $.__views.__alloyId392 = Ti.UI.createView(
    { left: 0, width: "20%", id: "__alloyId392" });
  ...
  { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#ffffff", top: 5, bottom: 10, text: "Loading", id: "__alloyId394" });
