...
function Controller() {
    ...
    $.__views.__alloyId349.add($.__views.addbox_title);
    ...
    closeBox ? $.addListener($.__views.__alloyId350, "click", closeBox) : __defers["$.__views.__alloyId350!click!closeBox"] = true;
    ...
    $.__views.addbox.add($.__views.__alloyId351);
    addRecord ? $.addListener($.__views.__alloyId351, "click", addRecord) : __defers["$.__views.__alloyId351!click!addRecord"] = true;
    ...
    $.__views.win.add($.__views.__alloyId352);
    ...
    $.__views.__alloyId352.add($.__views.profile_data);
    ...
    openBox ? $.addListener($.__views.__alloyId357, "click", openBox) : __defers["$.__views.__alloyId357!click!openBox"] = true;
    ...
    $.__views.__alloyId352.add($.__views.my_health);
    $.__views.__alloyId358 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.SIZE,
        id: "__alloyId358"
    });
    $.__views.my_health.add($.__views.__alloyId358);
    ...
    $.__views.__alloyId359.add($.__views.firstTab);
    ...
    $.__views.firstTab.add($.__views.__alloyId360);
    ...
    $.__views.__alloyId359.add($.__views.secondTab);
    ...
    $.__views.secondTab.add($.__views.__alloyId362);
    switchListing ? $.addListener($.__views.__alloyId362, "click", switchListing) : __defers["$.__views.__alloyId362!click!switchListing"] = true;
    ...
    init();
    __defers["$.__views.__alloyId350!click!closeBox"] && $.addListener($.__views.__alloyId350, "click", closeBox);
    __defers["$.__views.__alloyId351!click!addRecord"] && $.addListener($.__views.__alloyId351, "click", addRecord);
    __defers["$.__views.__alloyId357!click!openBox"] && $.addListener($.__views.__alloyId357, "click", openBox);
    ...
    __defers["$.__views.__alloyId362!click!switchListing"] && $.addListener($.__views.__alloyId362, "click", switchListing);
    _.extend($, exports);
}
