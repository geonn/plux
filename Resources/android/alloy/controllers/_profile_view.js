...
function Controller() {
    ...
    $.__views.addbox.add($.__views.__alloyId33);
    ...
    $.__views.__alloyId33.add($.__views.addbox_title);
    ...
    closeBox ? $.addListener($.__views.__alloyId34, "click", closeBox) : __defers["$.__views.__alloyId34!click!closeBox"] = true;
    ...
    $.__views.addbox.add($.__views.__alloyId35);
    addRecord ? $.addListener($.__views.__alloyId35, "click", addRecord) : __defers["$.__views.__alloyId35!click!addRecord"] = true;
    ...
    $.__views.__alloyId36.add($.__views.profile_data);
    ...
    openBox ? $.addListener($.__views.__alloyId41, "click", openBox) : __defers["$.__views.__alloyId41!click!openBox"] = true;
    ...
    $.__views.__alloyId36.add($.__views.my_health);
    $.__views.__alloyId42 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.SIZE,
        id: "__alloyId42"
    });
    $.__views.my_health.add($.__views.__alloyId42);
    ...
    $.__views.__alloyId43.add($.__views.firstTab);
    ...
    $.__views.firstTab.add($.__views.__alloyId44);
    switchListing ? $.addListener($.__views.__alloyId44, "click", switchListing) : __defers["$.__views.__alloyId44!click!switchListing"] = true;
    ...
    $.__views.__alloyId43.add($.__views.secondTab);
    ...
    $.__views.secondTab.add($.__views.__alloyId46);
    switchListing ? $.addListener($.__views.__alloyId46, "click", switchListing) : __defers["$.__views.__alloyId46!click!switchListing"] = true;
    ...
    init();
    __defers["$.__views.__alloyId34!click!closeBox"] && $.addListener($.__views.__alloyId34, "click", closeBox);
    __defers["$.__views.__alloyId35!click!addRecord"] && $.addListener($.__views.__alloyId35, "click", addRecord);
    __defers["$.__views.__alloyId41!click!openBox"] && $.addListener($.__views.__alloyId41, "click", openBox);
    __defers["$.__views.firstTab!click!switchListing"] && $.addListener($.__views.firstTab, "click", switchListing);
    __defers["$.__views.__alloyId44!click!switchListing"] && $.addListener($.__views.__alloyId44, "click", switchListing);
    __defers["$.__views.secondTab!click!switchListing"] && $.addListener($.__views.secondTab, "click", switchListing);
    __defers["$.__views.__alloyId46!click!switchListing"] && $.addListener($.__views.__alloyId46, "click", switchListing);
    _.extend($, exports);
}
