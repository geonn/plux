...
function Controller() {
    ...
    $.__views.__alloyId403.add($.__views.name);
    ...
    $.__views.__alloyId403.add($.__views.more);
    ...
    for (var i = 0; i < args.data.length; i++) {
        ...
        if (args.data[i].entidvbal < 99999) {
            ...
            view_container.add("SANTECH" == corpcode && "MATERNITY" == args.data[i].benefittype ? generate_description("Limit: ", args.data[i].entidvbal, "T&C Apply") : "SANTECH" == corpcode && "EXECUTIVE HEALTH SCREENING" == args.data[i].benefittype ? generate_description("Limit: ", args.data[i].entidvbal, "As Charge") : "9999" == args.data[i].entidv ? generate_description("Limit: ", args.data[i].entidvbal, "Unlimited") : generate_description("Limit: RM ", args.data[i].entidvbal, args.data[i].entidv));
        }
