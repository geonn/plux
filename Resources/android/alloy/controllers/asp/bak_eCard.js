...
function Controller() {
    ...
    $.__views.eCardWin.add($.__views.__alloyId336);
    ...
    $.__views.__alloyId336.add($.__views.mainContainer);
    ...
    $.__views.loadingBar.add($.__views.__alloyId340);
    ...
    $.__views.unverified.add($.__views.__alloyId341);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId342, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId342!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId343, "touchend", checkStatus) : __defers["$.__views.__alloyId343!touchend!checkStatus"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    __defers["$.__views.__alloyId342!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId342, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId343!touchend!checkStatus"] && $.addListener($.__views.__alloyId343, "touchend", checkStatus);
    _.extend($, exports);
}
