...
function Controller() {
    ...
    $.__views.eCardWin.add($.__views.__alloyId245);
    ...
    $.__views.__alloyId245.add($.__views.mainContainer);
    ...
    $.__views.unverified.add($.__views.__alloyId250);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId251, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId251!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId252, "touchend", checkStatus) : __defers["$.__views.__alloyId252!touchend!checkStatus"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    __defers["$.__views.__alloyId251!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId251, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId252!touchend!checkStatus"] && $.addListener($.__views.__alloyId252, "touchend", checkStatus);
    _.extend($, exports);
}
