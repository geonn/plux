...
function Controller() {
    ...
    $.__views.eCardWin.add($.__views.__alloyId342);
    ...
    $.__views.__alloyId343.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId345);
    $.__views.mainContainer = Ti.UI.createView({
        id: "mainContainer",
        height: Ti.UI.SIZE,
        width: Ti.UI.FILL
    });
    $.__views.__alloyId342.add($.__views.mainContainer);
    ...
    $.__views.loadingBar.add($.__views.__alloyId346);
    ...
    $.__views.unverified.add($.__views.__alloyId347);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId348, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId348!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId349, "touchend", checkStatus) : __defers["$.__views.__alloyId349!touchend!checkStatus"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    __defers["$.__views.__alloyId348!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId348, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId349!touchend!checkStatus"] && $.addListener($.__views.__alloyId349, "touchend", checkStatus);
    _.extend($, exports);
}
