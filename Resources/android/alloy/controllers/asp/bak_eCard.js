...
function Controller() {
    ...
    $.__views.eCardWin.add($.__views.__alloyId346);
    ...
    $.__views.__alloyId348.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId349);
    $.__views.mainContainer = Ti.UI.createView({
        id: "mainContainer",
        height: Ti.UI.SIZE,
        width: Ti.UI.FILL
    });
    $.__views.__alloyId346.add($.__views.mainContainer);
    ...
    $.__views.unverified.add($.__views.__alloyId351);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId352, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId352!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId353 = Ti.UI.createButton({
        borderRadius: 5,
    ...
    checkStatus ? $.addListener($.__views.__alloyId353, "touchend", checkStatus) : __defers["$.__views.__alloyId353!touchend!checkStatus"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    __defers["$.__views.__alloyId352!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId352, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId353!touchend!checkStatus"] && $.addListener($.__views.__alloyId353, "touchend", checkStatus);
    _.extend($, exports);
}
