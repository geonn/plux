...
function Controller() {
    ...
    $.__views.eCardWin.add($.__views.__alloyId240);
    ...
    $.__views.__alloyId240.add($.__views.mainContainer);
    ...
    $.__views.unverified.add($.__views.__alloyId245);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId246, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId246!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId247, "touchend", checkStatus) : __defers["$.__views.__alloyId247!touchend!checkStatus"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    __defers["$.__views.__alloyId246!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId246, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId247!touchend!checkStatus"] && $.addListener($.__views.__alloyId247, "touchend", checkStatus);
    _.extend($, exports);
}
