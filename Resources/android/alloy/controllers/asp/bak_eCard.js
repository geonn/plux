...
function Controller() {
    ...
    $.__views.eCardWin.add($.__views.__alloyId331);
    ...
    $.__views.__alloyId331.add($.__views.mainContainer);
    ...
    $.__views.loadingBar.add($.__views.__alloyId335);
    ...
    $.__views.unverified.add($.__views.__alloyId336);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId337, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId337!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId338, "touchend", checkStatus) : __defers["$.__views.__alloyId338!touchend!checkStatus"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    __defers["$.__views.__alloyId337!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId337, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId338!touchend!checkStatus"] && $.addListener($.__views.__alloyId338, "touchend", checkStatus);
    _.extend($, exports);
}
