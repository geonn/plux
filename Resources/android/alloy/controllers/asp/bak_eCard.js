...
function Controller() {
    ...
    $.__views.eCardWin.add($.__views.__alloyId244);
    ...
    $.__views.__alloyId246.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: Ti.UI.FILL
    });
    $.__views.__alloyId245.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId247);
    $.__views.mainContainer = Ti.UI.createView({
        id: "mainContainer",
        height: Ti.UI.SIZE,
        width: Ti.UI.FILL
    });
    $.__views.__alloyId244.add($.__views.mainContainer);
    ...
    $.__views.unverified.add($.__views.__alloyId249);
