...
function Controller() {
    ...
    $.__views.eCardWin.add($.__views.__alloyId316);
    ...
    $.__views.__alloyId318.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: Ti.UI.FILL
    });
    $.__views.__alloyId317.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId319);
    $.__views.mainContainer = Ti.UI.createView({
        id: "mainContainer",
        height: Ti.UI.SIZE,
        width: Ti.UI.FILL
    });
    $.__views.__alloyId316.add($.__views.mainContainer);
    ...
    $.__views.unverified.add($.__views.__alloyId321);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId322, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId322!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId323, "touchend", checkStatus) : __defers["$.__views.__alloyId323!touchend!checkStatus"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    __defers["$.__views.__alloyId322!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId322, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId323!touchend!checkStatus"] && $.addListener($.__views.__alloyId323, "touchend", checkStatus);
    _.extend($, exports);
}
