...
function Controller() {
    ...
    $.__views.asp_profile.add($.__views.__alloyId151);
    ...
    $.__views.__alloyId152.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId154);
    ...
    $.__views.__alloyId155.add($.__views.profileContainer);
    var __alloyId156 = [];
    ...
    $.__views.profileContainer.add($.__views.__alloyId157);
    changePassword ? $.__views.__alloyId157.addEventListener("touchend", changePassword) : __defers["$.__views.__alloyId157!touchend!changePassword"] = true;
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId155.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId160);
    ...
    __defers["$.__views.__alloyId157!touchend!changePassword"] && $.__views.__alloyId157.addEventListener("touchend", changePassword);
