...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId491);
    ...
    $.__views.asp_profile.add($.__views.__alloyId492);
    ...
    $.__views.__alloyId496.add($.__views.profileContainer);
    var __alloyId497 = [];
    ...
    $.__views.profileContainer.add($.__views.__alloyId498);
    changePassword ? $.addListener($.__views.__alloyId498, "touchend", changePassword) : __defers["$.__views.__alloyId498!touchend!changePassword"] = true;
    ...
    __defers["$.__views.__alloyId498!touchend!changePassword"] && $.addListener($.__views.__alloyId498, "touchend", changePassword);
