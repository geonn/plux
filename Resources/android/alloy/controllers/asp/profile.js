...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId539);
    ...
    $.__views.__alloyId541.add($.__views.moreBtn);
    $.__views.asp_profile.rightNavButton = $.__views.__alloyId541;
    ...
    $.__views.asp_profile.add($.__views.__alloyId542);
    ...
    $.__views.__alloyId546.add($.__views.moreBtn);
    ...
    $.__views.__alloyId547.add($.__views.profileContainer);
    var __alloyId548 = [];
    ...
    $.__views.__alloyId547.add($.__views.verifyContainer);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId550, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId550!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId551, "touchend", checkStatus) : __defers["$.__views.__alloyId551!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId550!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId550, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId551!touchend!checkStatus"] && $.addListener($.__views.__alloyId551, "touchend", checkStatus);
    _.extend($, exports);
}
