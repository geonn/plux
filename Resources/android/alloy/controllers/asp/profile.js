...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId516);
    ...
    $.__views.asp_profile.add($.__views.__alloyId517);
    ...
    $.__views.__alloyId521.add($.__views.profileContainer);
    var __alloyId522 = [];
    ...
    $.__views.__alloyId523 = Ti.UI.createButton({
        borderRadius: 5,
    ...
    $.__views.profileContainer.add($.__views.__alloyId523);
    changePassword ? $.addListener($.__views.__alloyId523, "touchend", changePassword) : __defers["$.__views.__alloyId523!touchend!changePassword"] = true;
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: false,
        layout: "vertical"
    });
    $.__views.__alloyId521.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId524);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId525);
    resendVerificationEmail ? $.addListener($.__views.__alloyId525, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId525!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId526 = Ti.UI.createButton({
        borderRadius: 5,
        backgroundColor: "#7B7B7B",
        title: "Refresh",
        width: "70%",
    ...
    checkStatus ? $.addListener($.__views.__alloyId526, "touchend", checkStatus) : __defers["$.__views.__alloyId526!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId523!touchend!changePassword"] && $.addListener($.__views.__alloyId523, "touchend", changePassword);
    __defers["$.__views.__alloyId525!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId525, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId526!touchend!checkStatus"] && $.addListener($.__views.__alloyId526, "touchend", checkStatus);
    _.extend($, exports);
}
