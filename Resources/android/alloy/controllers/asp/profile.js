...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId399);
    ...
    $.__views.asp_profile.add($.__views.__alloyId400);
    ...
    $.__views.__alloyId404.add($.__views.profileContainer);
    var __alloyId405 = [];
    ...
    $.__views.profileContainer.add($.__views.__alloyId406);
    changePassword ? $.addListener($.__views.__alloyId406, "touchend", changePassword) : __defers["$.__views.__alloyId406!touchend!changePassword"] = true;
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId404.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId407);
    ...
    $.__views.__alloyId408 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId408);
    resendVerificationEmail ? $.addListener($.__views.__alloyId408, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId408!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId409 = Ti.UI.createButton({
        borderRadius: "5",
        backgroundColor: "#7B7B7B",
        title: "Refresh",
        width: "70%",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId409);
    checkStatus ? $.addListener($.__views.__alloyId409, "touchend", checkStatus) : __defers["$.__views.__alloyId409!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId406!touchend!changePassword"] && $.addListener($.__views.__alloyId406, "touchend", changePassword);
    __defers["$.__views.__alloyId408!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId408, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId409!touchend!checkStatus"] && $.addListener($.__views.__alloyId409, "touchend", checkStatus);
    _.extend($, exports);
}
