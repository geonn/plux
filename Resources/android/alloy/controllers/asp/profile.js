...
function Controller() {
    ...
    function checkStatus() {
        ...
        "undefined" != typeof asp_email && "" != asp_email ? loadPage() : common.createAlert("Error", "Please login your ASP account", function(e) {
            $.win.close();
        });
    }
    ...
    $.__views.loadingBar.add($.__views.__alloyId550);
    ...
    $.__views.__alloyId552.add($.__views.moreBtn);
    $.__views.asp_profile.rightNavButton = $.__views.__alloyId552;
    ...
    $.__views.asp_profile.add($.__views.__alloyId553);
    ...
    $.__views.__alloyId554.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId556);
    ...
    $.__views.__alloyId558.add($.__views.profileContainer);
    var __alloyId559 = [];
    ...
    $.__views.__alloyId558.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId560);
    ...
    $.__views.__alloyId561 = Ti.UI.createButton({
        borderRadius: 5,
    ...
    $.__views.verifyContainer.add($.__views.__alloyId561);
    resendVerificationEmail ? $.addListener($.__views.__alloyId561, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId561!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId562 = Ti.UI.createButton({
        borderRadius: 5,
    ...
    checkStatus ? $.addListener($.__views.__alloyId562, "touchend", checkStatus) : __defers["$.__views.__alloyId562!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId561!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId561, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId562!touchend!checkStatus"] && $.addListener($.__views.__alloyId562, "touchend", checkStatus);
    _.extend($, exports);
}
