...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId489);
    ...
    $.__views.asp_profile.add($.__views.__alloyId490);
    ...
    $.__views.pageTitle.add($.__views.__alloyId493);
    ...
    $.__views.__alloyId494.add($.__views.profileContainer);
    var __alloyId495 = [];
    ...
    $.__views.profileContainer.add($.__views.__alloyId496);
    changePassword ? $.addListener($.__views.__alloyId496, "touchend", changePassword) : __defers["$.__views.__alloyId496!touchend!changePassword"] = true;
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: false,
        layout: "vertical"
    });
    $.__views.__alloyId494.add($.__views.verifyContainer);
    ...
    __defers["$.__views.__alloyId496!touchend!changePassword"] && $.addListener($.__views.__alloyId496, "touchend", changePassword);
