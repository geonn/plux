...
function Controller() {
    ...
    $.__views.asp_profile.add($.__views.__alloyId208);
    ...
    $.__views.__alloyId212.add($.__views.profileContainer);
    var __alloyId213 = [];
    ...
    $.__views.profileContainer.add($.__views.__alloyId214);
    changePassword ? $.__views.__alloyId214.addEventListener("touchend", changePassword) : __defers["$.__views.__alloyId214!touchend!changePassword"] = true;
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId212.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId215);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId216);
    resendVerificationEmail ? $.__views.__alloyId216.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId216!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId217);
    checkStatus ? $.__views.__alloyId217.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId217!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId214!touchend!changePassword"] && $.__views.__alloyId214.addEventListener("touchend", changePassword);
    __defers["$.__views.__alloyId216!touchend!resendVerificationEmail"] && $.__views.__alloyId216.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId217!touchend!checkStatus"] && $.__views.__alloyId217.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
