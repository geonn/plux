...
function Controller() {
    ...
    $.__views.asp_profile.add($.__views.__alloyId237);
    ...
    $.__views.__alloyId239.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId240);
    ...
    $.__views.__alloyId241.add($.__views.profileContainer);
    var __alloyId242 = [];
    ...
    $.__views.__alloyId243 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    $.__views.profileContainer.add($.__views.__alloyId243);
    changePassword ? $.addListener($.__views.__alloyId243, "touchend", changePassword) : __defers["$.__views.__alloyId243!touchend!changePassword"] = true;
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId241.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId244);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId245);
    resendVerificationEmail ? $.addListener($.__views.__alloyId245, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId245!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId246 = Ti.UI.createButton({
        borderRadius: "5",
        backgroundColor: "#7B7B7B",
        title: "Refresh",
        width: "70%",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId246);
    checkStatus ? $.addListener($.__views.__alloyId246, "touchend", checkStatus) : __defers["$.__views.__alloyId246!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId243!touchend!changePassword"] && $.addListener($.__views.__alloyId243, "touchend", changePassword);
    __defers["$.__views.__alloyId245!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId245, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId246!touchend!checkStatus"] && $.addListener($.__views.__alloyId246, "touchend", checkStatus);
    _.extend($, exports);
}
