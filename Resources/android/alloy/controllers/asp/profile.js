...
function Controller() {
    ...
    $.__views.__alloyId537.add($.__views.moreBtn);
    $.__views.asp_profile.rightNavButton = $.__views.__alloyId537;
    ...
    $.__views.asp_profile.add($.__views.__alloyId538);
    ...
    $.__views.__alloyId542.add($.__views.moreBtn);
    $.__views.__alloyId543 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.FILL,
        id: "__alloyId543"
    });
    $.__views.__alloyId538.add($.__views.__alloyId543);
    $.__views.profileContainer = Ti.UI.createView({
        layout: "vertical",
        id: "profileContainer",
        visible: false
    });
    $.__views.__alloyId543.add($.__views.profileContainer);
    var __alloyId544 = [];
    ...
    $.__views.__alloyId543.add($.__views.verifyContainer);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId546, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId546!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId547, "touchend", checkStatus) : __defers["$.__views.__alloyId547!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId546!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId546, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId547!touchend!checkStatus"] && $.addListener($.__views.__alloyId547, "touchend", checkStatus);
    _.extend($, exports);
}
