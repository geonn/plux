...
=======
    ...
    $.__views.loadingBar.add($.__views.__alloyId536);
...
<<<<<<< HEAD
    $.__views.__alloyId540.add($.__views.moreBtn);
    $.__views.asp_profile.rightNavButton = $.__views.__alloyId540;
    ...
    $.__views.asp_profile.add($.__views.__alloyId541);
    $.__views.__alloyId542 = Ti.UI.createView({
=======
    $.__views.__alloyId538.add($.__views.moreBtn);
    $.__views.asp_profile.rightNavButton = $.__views.__alloyId538;
    ...
    $.__views.asp_profile.add($.__views.__alloyId539);
    $.__views.__alloyId540 = Ti.UI.createView({
>>>>>>> origin/master
        layout: "horizontal",
        height: 50,
...
<<<<<<< HEAD
    $.__views.__alloyId543.add($.__views.btnBack);
=======
    $.__views.__alloyId541.add($.__views.btnBack);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId542.add($.__views.pageTitle);
    $.__views.__alloyId544 = Ti.UI.createLabel({
=======
    $.__views.__alloyId540.add($.__views.pageTitle);
...
<<<<<<< HEAD
    ...
    $.__views.pageTitle.add($.__views.__alloyId544);
...
=======
    ...
    $.__views.pageTitle.add($.__views.__alloyId542);
    $.__views.__alloyId543 = Ti.UI.createView({
        width: "10%",
        id: "__alloyId543"
    });
...
<<<<<<< HEAD
    $.__views.__alloyId545.add($.__views.moreBtn);
    $.__views.__alloyId546 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.FILL,
        id: "__alloyId546"
    });
    $.__views.__alloyId541.add($.__views.__alloyId546);
=======
    $.__views.__alloyId543.add($.__views.moreBtn);
    $.__views.__alloyId544 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.FILL,
        id: "__alloyId544"
    });
    $.__views.__alloyId539.add($.__views.__alloyId544);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId546.add($.__views.profileContainer);
    var __alloyId547 = [];
    $.__views.main = Ti.UI.createScrollableView({
        views: __alloyId547,
=======
    $.__views.__alloyId544.add($.__views.profileContainer);
    var __alloyId545 = [];
    $.__views.main = Ti.UI.createScrollableView({
        views: __alloyId545,
>>>>>>> origin/master
...
=======
    $.__views.__alloyId544.add($.__views.verifyContainer);
...
=======
    ...
    $.__views.verifyContainer.add($.__views.__alloyId546);
>>>>>>> origin/master
...
=======
    $.__views.__alloyId547 = Ti.UI.createButton({
>>>>>>> origin/master
        borderRadius: 5,
...
=======
    ...
    $.__views.verifyContainer.add($.__views.__alloyId547);
    resendVerificationEmail ? $.addListener($.__views.__alloyId547, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId547!touchend!resendVerificationEmail"] = true;
...
=======
    ...
    $.__views.verifyContainer.add($.__views.__alloyId548);
    checkStatus ? $.addListener($.__views.__alloyId548, "touchend", checkStatus) : __defers["$.__views.__alloyId548!touchend!checkStatus"] = true;
>>>>>>> origin/master
...
=======
    __defers["$.__views.__alloyId547!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId547, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId548!touchend!checkStatus"] && $.addListener($.__views.__alloyId548, "touchend", checkStatus);
>>>>>>> origin/master
    _.extend($, exports);
}
