...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId239);
    ...
    $.__views.asp_profile.add($.__views.__alloyId240);
    ...
    $.__views.__alloyId244.add($.__views.profileContainer);
    var __alloyId245 = [];
    ...
    $.__views.profileContainer.add($.__views.__alloyId246);
    changePassword ? $.addListener($.__views.__alloyId246, "touchend", changePassword) : __defers["$.__views.__alloyId246!touchend!changePassword"] = true;
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId244.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId247);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId248);
    resendVerificationEmail ? $.addListener($.__views.__alloyId248, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId248!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId249, "touchend", checkStatus) : __defers["$.__views.__alloyId249!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId246!touchend!changePassword"] && $.addListener($.__views.__alloyId246, "touchend", changePassword);
    __defers["$.__views.__alloyId248!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId248, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId249!touchend!checkStatus"] && $.addListener($.__views.__alloyId249, "touchend", checkStatus);
    _.extend($, exports);
}
