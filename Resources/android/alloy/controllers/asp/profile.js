...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId488);
    ...
    $.__views.asp_profile.add($.__views.__alloyId489);
    ...
    $.__views.__alloyId490.add($.__views.pageTitle);
    ...
    $.__views.__alloyId493.add($.__views.profileContainer);
    var __alloyId494 = [];
    ...
    $.__views.profileContainer.add($.__views.__alloyId495);
    changePassword ? $.addListener($.__views.__alloyId495, "touchend", changePassword) : __defers["$.__views.__alloyId495!touchend!changePassword"] = true;
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: false,
        layout: "vertical"
    });
    $.__views.__alloyId493.add($.__views.verifyContainer);
    $.__views.__alloyId496 = Ti.UI.createImageView({
        width: "40%",
        borderRadius: 10,
        height: Ti.UI.SIZE,
    ...
    $.__views.verifyContainer.add($.__views.__alloyId496);
    ...
    __defers["$.__views.__alloyId495!touchend!changePassword"] && $.addListener($.__views.__alloyId495, "touchend", changePassword);
