...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId558);
    ...
    $.__views.__alloyId560.add($.__views.moreBtn);
    $.__views.asp_profile.rightNavButton = $.__views.__alloyId560;
    ...
    $.__views.asp_profile.add($.__views.__alloyId561);
    ...
    $.__views.__alloyId563.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "80%"
    });
    $.__views.__alloyId562.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId564);
    ...
    $.__views.__alloyId565.add($.__views.moreBtn);
    ...
    $.__views.__alloyId566.add($.__views.profileContainer);
    var __alloyId567 = [];
    ...
    $.__views.__alloyId566.add($.__views.verifyContainer);
    $.__views.__alloyId568 = Ti.UI.createImageView({
        width: "40%",
        borderRadius: 10,
        height: Ti.UI.SIZE,
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId569, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId569!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId570 = Ti.UI.createButton({
        borderRadius: 5,
    ...
    $.__views.verifyContainer.add($.__views.__alloyId570);
    checkStatus ? $.addListener($.__views.__alloyId570, "touchend", checkStatus) : __defers["$.__views.__alloyId570!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId569!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId569, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId570!touchend!checkStatus"] && $.addListener($.__views.__alloyId570, "touchend", checkStatus);
    _.extend($, exports);
}
