...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId508);
    ...
    $.__views.__alloyId510.add($.__views.moreBtn);
    $.__views.asp_profile.rightNavButton = $.__views.__alloyId510;
    ...
    $.__views.asp_profile.add($.__views.__alloyId511);
    ...
    $.__views.__alloyId515.add($.__views.moreBtn);
    ...
    $.__views.__alloyId516.add($.__views.profileContainer);
    var __alloyId517 = [];
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId519, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId519!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId520, "touchend", checkStatus) : __defers["$.__views.__alloyId520!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId519!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId519, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId520!touchend!checkStatus"] && $.addListener($.__views.__alloyId520, "touchend", checkStatus);
    _.extend($, exports);
}
