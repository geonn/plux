...
function Controller() {
    ...
    $.__views.asp_profile.add($.__views.__alloyId491);
    ...
    $.__views.__alloyId491.add($.__views.__alloyId495);
    $.__views.profileContainer = Ti.UI.createView({
        layout: "vertical",
        id: "profileContainer",
        visible: false
    });
    $.__views.__alloyId495.add($.__views.profileContainer);
    var __alloyId496 = [];
    ...
    $.__views.profileContainer.add($.__views.__alloyId497);
    changePassword ? $.addListener($.__views.__alloyId497, "touchend", changePassword) : __defers["$.__views.__alloyId497!touchend!changePassword"] = true;
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: false,
        layout: "vertical"
    });
    $.__views.__alloyId495.add($.__views.verifyContainer);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId499, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId499!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId500, "touchend", checkStatus) : __defers["$.__views.__alloyId500!touchend!checkStatus"] = true;
