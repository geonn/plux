...
function Controller() {
    ...
    $.__views.asp_profile.add($.__views.__alloyId525);
    ...
    $.__views.__alloyId529.add($.__views.profileContainer);
    var __alloyId530 = [];
    ...
    $.__views.profileContainer.add($.__views.__alloyId531);
    changePassword ? $.addListener($.__views.__alloyId531, "touchend", changePassword) : __defers["$.__views.__alloyId531!touchend!changePassword"] = true;
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId533, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId533!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId534 = Ti.UI.createButton({
        borderRadius: 5,
        backgroundColor: "#7B7B7B",
        title: "Refresh",
        width: "70%",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId534);
    checkStatus ? $.addListener($.__views.__alloyId534, "touchend", checkStatus) : __defers["$.__views.__alloyId534!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId531!touchend!changePassword"] && $.addListener($.__views.__alloyId531, "touchend", changePassword);
    __defers["$.__views.__alloyId533!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId533, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId534!touchend!checkStatus"] && $.addListener($.__views.__alloyId534, "touchend", checkStatus);
    _.extend($, exports);
}
