...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId396);
    ...
    $.__views.asp_profile.add($.__views.__alloyId397);
    ...
    $.__views.pageTitle.add($.__views.__alloyId400);
    ...
    $.__views.__alloyId401.add($.__views.profileContainer);
    var __alloyId402 = [];
    ...
    $.__views.profileContainer.add($.__views.__alloyId403);
    changePassword ? $.addListener($.__views.__alloyId403, "touchend", changePassword) : __defers["$.__views.__alloyId403!touchend!changePassword"] = true;
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId401.add($.__views.verifyContainer);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId405, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId405!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId406);
    checkStatus ? $.addListener($.__views.__alloyId406, "touchend", checkStatus) : __defers["$.__views.__alloyId406!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId403!touchend!changePassword"] && $.addListener($.__views.__alloyId403, "touchend", changePassword);
    __defers["$.__views.__alloyId405!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId405, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId406!touchend!checkStatus"] && $.addListener($.__views.__alloyId406, "touchend", checkStatus);
    _.extend($, exports);
}
