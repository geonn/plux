...
function Controller() {
    ...
    $.__views.asp_profile.add($.__views.__alloyId150);
    ...
    $.__views.__alloyId152.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "90%"
    });
    $.__views.__alloyId151.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId153);
    ...
    $.__views.__alloyId154.add($.__views.profileContainer);
    var __alloyId155 = [];
    ...
    $.__views.profileContainer.add($.__views.__alloyId156);
    changePassword ? $.__views.__alloyId156.addEventListener("touchend", changePassword) : __defers["$.__views.__alloyId156!touchend!changePassword"] = true;
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId154.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId157);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId158);
    resendVerificationEmail ? $.__views.__alloyId158.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId158!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId159);
    checkStatus ? $.__views.__alloyId159.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId159!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId156!touchend!changePassword"] && $.__views.__alloyId156.addEventListener("touchend", changePassword);
    __defers["$.__views.__alloyId158!touchend!resendVerificationEmail"] && $.__views.__alloyId158.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId159!touchend!checkStatus"] && $.__views.__alloyId159.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
