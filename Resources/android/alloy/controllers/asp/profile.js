...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId311);
    ...
    $.__views.asp_profile.add($.__views.__alloyId312);
    ...
    $.__views.__alloyId313.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId315);
    $.__views.__alloyId316 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.FILL,
        id: "__alloyId316"
    });
    $.__views.__alloyId312.add($.__views.__alloyId316);
    $.__views.profileContainer = Ti.UI.createView({
        layout: "vertical",
        id: "profileContainer",
        visible: "false"
    });
    $.__views.__alloyId316.add($.__views.profileContainer);
    var __alloyId317 = [];
    ...
    $.__views.profileContainer.add($.__views.__alloyId318);
    changePassword ? $.addListener($.__views.__alloyId318, "touchend", changePassword) : __defers["$.__views.__alloyId318!touchend!changePassword"] = true;
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId316.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId319);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId320, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId320!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId321, "touchend", checkStatus) : __defers["$.__views.__alloyId321!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId318!touchend!changePassword"] && $.addListener($.__views.__alloyId318, "touchend", changePassword);
    __defers["$.__views.__alloyId320!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId320, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId321!touchend!checkStatus"] && $.addListener($.__views.__alloyId321, "touchend", checkStatus);
    _.extend($, exports);
}
