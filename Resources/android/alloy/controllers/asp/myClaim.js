...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId214;
    ...
    $.__views.loadingBar.add($.__views.__alloyId215);
    ...
    $.__views.myClaim.add($.__views.__alloyId216);
    ...
    $.__views.__alloyId218.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId219);
    ...
    $.__views.__alloyId220.add($.__views.claimContainer);
    ...
    $.__views.__alloyId220.add($.__views.verifyContainer);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId222, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId222!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId223, "touchend", checkStatus) : __defers["$.__views.__alloyId223!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId222!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId222, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId223!touchend!checkStatus"] && $.addListener($.__views.__alloyId223, "touchend", checkStatus);
    _.extend($, exports);
}
