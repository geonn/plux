...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId366;
    ...
    $.__views.myClaim.add($.__views.__alloyId367);
    ...
    $.__views.__alloyId371.add($.__views.claimContainer);
    ...
    $.__views.__alloyId371.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId372);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId373);
    resendVerificationEmail ? $.addListener($.__views.__alloyId373, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId373!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId374 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId374);
    checkStatus ? $.addListener($.__views.__alloyId374, "touchend", checkStatus) : __defers["$.__views.__alloyId374!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId373!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId373, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId374!touchend!checkStatus"] && $.addListener($.__views.__alloyId374, "touchend", checkStatus);
    _.extend($, exports);
}
