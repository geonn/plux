...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId532;
    ...
    $.__views.myClaim.add($.__views.__alloyId534);
    ...
    $.__views.__alloyId536.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId537);
    $.__views.__alloyId538 = Ti.UI.createView({
        height: Ti.UI.FILL,
        width: Ti.UI.FILL,
        id: "__alloyId538"
    });
    $.__views.__alloyId534.add($.__views.__alloyId538);
    ...
    $.__views.__alloyId538.add($.__views.claimContainer);
    ...
    $.__views.__alloyId538.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId540);
    resendVerificationEmail ? $.addListener($.__views.__alloyId540, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId540!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId541);
    checkStatus ? $.addListener($.__views.__alloyId541, "touchend", checkStatus) : __defers["$.__views.__alloyId541!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId540!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId540, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId541!touchend!checkStatus"] && $.addListener($.__views.__alloyId541, "touchend", checkStatus);
    _.extend($, exports);
}
