...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId466;
    ...
    $.__views.myClaim.add($.__views.__alloyId467);
    ...
    $.__views.pageTitle.add($.__views.__alloyId470);
    $.__views.__alloyId471 = Ti.UI.createView({
        height: Ti.UI.FILL,
        width: Ti.UI.FILL,
        id: "__alloyId471"
    });
    $.__views.__alloyId467.add($.__views.__alloyId471);
    ...
    $.__views.__alloyId471.add($.__views.claimContainer);
    ...
    $.__views.__alloyId471.add($.__views.verifyContainer);
    $.__views.__alloyId472 = Ti.UI.createImageView({
        width: "40%",
        borderRadius: 10,
        height: Ti.UI.SIZE,
    ...
    $.__views.verifyContainer.add($.__views.__alloyId472);
    ...
    $.__views.__alloyId473 = Ti.UI.createButton({
        borderRadius: 5,
        backgroundColor: "#CE1D1C",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId473);
    resendVerificationEmail ? $.addListener($.__views.__alloyId473, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId473!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId474);
    checkStatus ? $.addListener($.__views.__alloyId474, "touchend", checkStatus) : __defers["$.__views.__alloyId474!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId473!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId473, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId474!touchend!checkStatus"] && $.addListener($.__views.__alloyId474, "touchend", checkStatus);
    _.extend($, exports);
}
