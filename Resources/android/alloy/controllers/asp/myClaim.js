...
function Controller() {
    ...
    $.__views.verifyContainer.add($.__views.__alloyId508);
    ...
    $.__views.__alloyId509 = Ti.UI.createButton({
        borderRadius: 5,
        backgroundColor: "#CE1D1C",
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId509, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId509!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId510, "touchend", checkStatus) : __defers["$.__views.__alloyId510!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId509!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId509, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId510!touchend!checkStatus"] && $.addListener($.__views.__alloyId510, "touchend", checkStatus);
    _.extend($, exports);
}
