...
function Controller() {
    ...
    $.__views.myClaim.add($.__views.__alloyId371);
    ...
    $.__views.__alloyId375.add($.__views.claimContainer);
    ...
    $.__views.__alloyId375.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId376);
    ...
    $.__views.__alloyId377 = Ti.UI.createButton({
        borderRadius: "5",
        backgroundColor: "#CE1D1C",
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId377, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId377!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId378, "touchend", checkStatus) : __defers["$.__views.__alloyId378!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId377!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId377, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId378!touchend!checkStatus"] && $.addListener($.__views.__alloyId378, "touchend", checkStatus);
    _.extend($, exports);
}
