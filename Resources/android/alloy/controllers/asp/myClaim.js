...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId370;
    ...
    $.__views.loadingBar.add($.__views.__alloyId371);
    ...
    $.__views.myClaim.add($.__views.__alloyId372);
    ...
    $.__views.__alloyId374.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "90%"
    });
    $.__views.__alloyId373.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId375);
    ...
    $.__views.__alloyId376.add($.__views.claimContainer);
    ...
    $.__views.__alloyId376.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId377);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId378);
    resendVerificationEmail ? $.addListener($.__views.__alloyId378, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId378!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId379 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId379);
    checkStatus ? $.addListener($.__views.__alloyId379, "touchend", checkStatus) : __defers["$.__views.__alloyId379!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId378!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId378, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId379!touchend!checkStatus"] && $.addListener($.__views.__alloyId379, "touchend", checkStatus);
    _.extend($, exports);
}
