...
function Controller() {
    ...
    $.__views.myClaim.add($.__views.__alloyId483);
    ...
    $.__views.__alloyId485.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "90%"
    });
    $.__views.__alloyId484.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId486);
    $.__views.__alloyId487 = Ti.UI.createView({
        height: Ti.UI.FILL,
        width: Ti.UI.FILL,
        id: "__alloyId487"
    });
    $.__views.__alloyId483.add($.__views.__alloyId487);
    ...
    $.__views.__alloyId487.add($.__views.claimContainer);
    ...
    $.__views.__alloyId487.add($.__views.verifyContainer);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId489, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId489!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId490, "touchend", checkStatus) : __defers["$.__views.__alloyId490!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId489!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId489, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId490!touchend!checkStatus"] && $.addListener($.__views.__alloyId490, "touchend", checkStatus);
    _.extend($, exports);
}
