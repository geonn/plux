...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId465;
    ...
    $.__views.myClaim.add($.__views.__alloyId466);
    ...
    $.__views.__alloyId468.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId469);
    ...
    $.__views.__alloyId470.add($.__views.claimContainer);
    ...
    $.__views.__alloyId470.add($.__views.verifyContainer);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId472, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId472!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId473, "touchend", checkStatus) : __defers["$.__views.__alloyId473!touchend!checkStatus"] = true;
