...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId373;
    ...
    $.__views.loadingBar.add($.__views.__alloyId374);
    ...
    $.__views.myClaim.add($.__views.__alloyId375);
    ...
    $.__views.__alloyId377.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "90%"
    });
    $.__views.__alloyId376.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId378);
    ...
    $.__views.__alloyId379.add($.__views.claimContainer);
    ...
    $.__views.__alloyId379.add($.__views.verifyContainer);
    $.__views.__alloyId380 = Ti.UI.createImageView({
        width: "40%",
        borderRadius: "10",
        height: Ti.UI.SIZE,
    ...
    $.__views.verifyContainer.add($.__views.__alloyId380);
    ...
    $.__views.__alloyId381 = Ti.UI.createButton({
        borderRadius: "5",
        backgroundColor: "#CE1D1C",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId381);
    resendVerificationEmail ? $.addListener($.__views.__alloyId381, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId381!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId382 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId382);
    checkStatus ? $.addListener($.__views.__alloyId382, "touchend", checkStatus) : __defers["$.__views.__alloyId382!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId381!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId381, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId382!touchend!checkStatus"] && $.addListener($.__views.__alloyId382, "touchend", checkStatus);
    _.extend($, exports);
}
