...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId286;
    ...
    $.__views.myClaim.add($.__views.__alloyId288);
    ...
    $.__views.__alloyId290.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "90%"
    });
    $.__views.__alloyId289.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId291);
    ...
    $.__views.__alloyId292.add($.__views.claimContainer);
    ...
    $.__views.__alloyId292.add($.__views.verifyContainer);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId294, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId294!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId295 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    checkStatus ? $.addListener($.__views.__alloyId295, "touchend", checkStatus) : __defers["$.__views.__alloyId295!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId294!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId294, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId295!touchend!checkStatus"] && $.addListener($.__views.__alloyId295, "touchend", checkStatus);
    _.extend($, exports);
}
