...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId191;
    ...
    $.__views.myClaim.add($.__views.__alloyId193);
    ...
    $.__views.__alloyId197.add($.__views.claimContainer);
    ...
    $.__views.__alloyId197.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId198);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId199);
    resendVerificationEmail ? $.__views.__alloyId199.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId199!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId200);
    checkStatus ? $.__views.__alloyId200.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId200!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId199!touchend!resendVerificationEmail"] && $.__views.__alloyId199.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId200!touchend!checkStatus"] && $.__views.__alloyId200.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
