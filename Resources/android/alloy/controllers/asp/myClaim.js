...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId185;
    ...
    $.__views.myClaim.add($.__views.__alloyId187);
    ...
    $.__views.__alloyId191.add($.__views.claimContainer);
    ...
    $.__views.__alloyId191.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId192);
    ...
    resendVerificationEmail ? $.__views.__alloyId193.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId193!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.__views.__alloyId194.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId194!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId193!touchend!resendVerificationEmail"] && $.__views.__alloyId193.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId194!touchend!checkStatus"] && $.__views.__alloyId194.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
