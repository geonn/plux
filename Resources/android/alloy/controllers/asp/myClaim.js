...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId217;
    ...
    $.__views.loadingBar.add($.__views.__alloyId218);
    ...
    $.__views.myClaim.add($.__views.__alloyId219);
    ...
    $.__views.__alloyId223.add($.__views.claimContainer);
    ...
    $.__views.__alloyId223.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId224);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId225);
    resendVerificationEmail ? $.addListener($.__views.__alloyId225, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId225!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId226 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    checkStatus ? $.addListener($.__views.__alloyId226, "touchend", checkStatus) : __defers["$.__views.__alloyId226!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId225!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId225, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId226!touchend!checkStatus"] && $.addListener($.__views.__alloyId226, "touchend", checkStatus);
    _.extend($, exports);
}
