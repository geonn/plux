...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId219;
    ...
    $.__views.myClaim.add($.__views.__alloyId221);
    ...
    $.__views.__alloyId222.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId224);
    ...
    $.__views.__alloyId225.add($.__views.claimContainer);
    ...
    $.__views.__alloyId225.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId226);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId227);
    resendVerificationEmail ? $.addListener($.__views.__alloyId227, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId227!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId228);
    checkStatus ? $.addListener($.__views.__alloyId228, "touchend", checkStatus) : __defers["$.__views.__alloyId228!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId227!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId227, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId228!touchend!checkStatus"] && $.addListener($.__views.__alloyId228, "touchend", checkStatus);
    _.extend($, exports);
}
