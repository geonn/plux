...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId498;
    ...
    $.__views.loadingBar.add($.__views.__alloyId499);
    ...
    $.__views.myClaim.add($.__views.__alloyId500);
    ...
    $.__views.__alloyId504.add($.__views.claimContainer);
    ...
    $.__views.__alloyId504.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId505);
    ...
    $.__views.__alloyId506 = Ti.UI.createButton({
        borderRadius: 5,
        backgroundColor: "#CE1D1C",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId506);
    resendVerificationEmail ? $.addListener($.__views.__alloyId506, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId506!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId507);
    checkStatus ? $.addListener($.__views.__alloyId507, "touchend", checkStatus) : __defers["$.__views.__alloyId507!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId506!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId506, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId507!touchend!checkStatus"] && $.addListener($.__views.__alloyId507, "touchend", checkStatus);
    _.extend($, exports);
}
