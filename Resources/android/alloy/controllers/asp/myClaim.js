...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId463;
    ...
    $.__views.myClaim.add($.__views.__alloyId464);
    ...
    $.__views.__alloyId464.add($.__views.__alloyId468);
    ...
    $.__views.__alloyId468.add($.__views.claimContainer);
    ...
    $.__views.__alloyId468.add($.__views.verifyContainer);
    $.__views.__alloyId469 = Ti.UI.createImageView({
        width: "40%",
        borderRadius: 10,
        height: Ti.UI.SIZE,
    ...
    $.__views.verifyContainer.add($.__views.__alloyId469);
    ...
    $.__views.__alloyId470 = Ti.UI.createButton({
        borderRadius: 5,
        backgroundColor: "#CE1D1C",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId470);
    resendVerificationEmail ? $.addListener($.__views.__alloyId470, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId470!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId471 = Ti.UI.createButton({
        borderRadius: 5,
    ...
    $.__views.verifyContainer.add($.__views.__alloyId471);
    checkStatus ? $.addListener($.__views.__alloyId471, "touchend", checkStatus) : __defers["$.__views.__alloyId471!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId470!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId470, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId471!touchend!checkStatus"] && $.addListener($.__views.__alloyId471, "touchend", checkStatus);
    _.extend($, exports);
}
