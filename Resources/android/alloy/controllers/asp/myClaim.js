...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId285;
    ...
    $.__views.myClaim.add($.__views.__alloyId287);
    ...
    $.__views.__alloyId291.add($.__views.claimContainer);
    ...
    $.__views.__alloyId291.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId292);
    ...
    $.__views.__alloyId293 = Ti.UI.createButton({
        borderRadius: "5",
        backgroundColor: "#CE1D1C",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId293);
    resendVerificationEmail ? $.addListener($.__views.__alloyId293, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId293!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId294 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId294);
    checkStatus ? $.addListener($.__views.__alloyId294, "touchend", checkStatus) : __defers["$.__views.__alloyId294!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId293!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId293, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId294!touchend!checkStatus"] && $.addListener($.__views.__alloyId294, "touchend", checkStatus);
    _.extend($, exports);
}
