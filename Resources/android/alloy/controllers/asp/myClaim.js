...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId464;
    ...
    $.__views.myClaim.add($.__views.__alloyId465);
    ...
    $.__views.pageTitle.add($.__views.__alloyId468);
    $.__views.__alloyId469 = Ti.UI.createView({
        height: Ti.UI.FILL,
        width: Ti.UI.FILL,
        id: "__alloyId469"
    });
    $.__views.__alloyId465.add($.__views.__alloyId469);
    ...
    $.__views.__alloyId469.add($.__views.claimContainer);
    ...
    $.__views.__alloyId469.add($.__views.verifyContainer);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId471, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId471!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId472 = Ti.UI.createButton({
        borderRadius: 5,
    ...
    checkStatus ? $.addListener($.__views.__alloyId472, "touchend", checkStatus) : __defers["$.__views.__alloyId472!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId471!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId471, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId472!touchend!checkStatus"] && $.addListener($.__views.__alloyId472, "touchend", checkStatus);
    _.extend($, exports);
}
