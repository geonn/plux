...
function Controller() {
    ...
    $.__views.__alloyId458.add($.__views.btnBack);
    ...
    $.__views.__alloyId459.add($.__views.pageTitle);
    ...
    openReceipt ? $.addListener($.__views.__alloyId460, "click", openReceipt) : __defers["$.__views.__alloyId460!click!openReceipt"] = true;
    ...
    $.__views.__alloyId460.add($.__views.recepit);
    ...
    __defers["$.__views.__alloyId460!click!openReceipt"] && $.addListener($.__views.__alloyId460, "click", openReceipt);
    _.extend($, exports);
}
