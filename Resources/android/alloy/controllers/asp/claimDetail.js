...
function Controller() {
    ...
    lightBox ? $.addListener($.__views.__alloyId415, "click", lightBox) : __defers["$.__views.__alloyId415!click!lightBox"] = true;
    ...
    __defers["$.__views.__alloyId415!click!lightBox"] && $.addListener($.__views.__alloyId415, "click", lightBox);
    _.extend($, exports);
}
