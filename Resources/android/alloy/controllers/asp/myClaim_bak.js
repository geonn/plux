...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId297;
    ...
    $.__views.loadingBar.add($.__views.__alloyId298);
    ...
    $.__views.myClaim.add($.__views.__alloyId299);
    ...
    $.__views.__alloyId303.add($.__views.claimContainer);
    ...
    $.__views.__alloyId304.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId303.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId305);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId306);
    resendVerificationEmail ? $.addListener($.__views.__alloyId306, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId306!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId307);
    checkStatus ? $.addListener($.__views.__alloyId307, "touchend", checkStatus) : __defers["$.__views.__alloyId307!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId306!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId306, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId307!touchend!checkStatus"] && $.addListener($.__views.__alloyId307, "touchend", checkStatus);
    _.extend($, exports);
}
