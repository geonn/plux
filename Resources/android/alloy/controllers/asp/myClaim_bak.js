...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId296;
    ...
    $.__views.myClaim.add($.__views.__alloyId298);
    ...
    $.__views.__alloyId302.add($.__views.claimContainer);
    ...
    $.__views.__alloyId303.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId302.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId304);
