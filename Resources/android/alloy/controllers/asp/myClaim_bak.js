...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId535;
    ...
    $.__views.myClaim.add($.__views.__alloyId537);
    ...
    $.__views.__alloyId537.add($.__views.__alloyId541);
    ...
    $.__views.__alloyId541.add($.__views.claimContainer);
    ...
    $.__views.__alloyId542.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: false,
        layout: "vertical"
    });
    $.__views.__alloyId541.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId543);
    ...
    $.__views.__alloyId544 = Ti.UI.createButton({
        borderRadius: 5,
        backgroundColor: "#CE1D1C",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId544);
    resendVerificationEmail ? $.addListener($.__views.__alloyId544, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId544!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId545 = Ti.UI.createButton({
        borderRadius: 5,
    ...
    $.__views.verifyContainer.add($.__views.__alloyId545);
    checkStatus ? $.addListener($.__views.__alloyId545, "touchend", checkStatus) : __defers["$.__views.__alloyId545!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId544!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId544, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId545!touchend!checkStatus"] && $.addListener($.__views.__alloyId545, "touchend", checkStatus);
    _.extend($, exports);
}
