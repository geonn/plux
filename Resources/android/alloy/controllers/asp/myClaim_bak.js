...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId520;
    ...
    $.__views.loadingBar.add($.__views.__alloyId521);
    ...
    $.__views.myClaim.add($.__views.__alloyId522);
    ...
    $.__views.__alloyId522.add($.__views.__alloyId526);
    ...
    $.__views.__alloyId526.add($.__views.claimContainer);
    ...
    $.__views.main.add($.__views.__alloyId527);
    ...
    $.__views.__alloyId527.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: false,
        layout: "vertical"
    });
    $.__views.__alloyId526.add($.__views.verifyContainer);
