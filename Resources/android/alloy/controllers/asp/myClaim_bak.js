...
<<<<<<< HEAD
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId503;
=======
...
<<<<<<< HEAD
    ...
    $.__views.loadingBar.add($.__views.__alloyId504);
    ...
    $.__views.myClaim.add($.__views.__alloyId505);
...
=======
    ...
    $.__views.myClaim.add($.__views.__alloyId493);
...
<<<<<<< HEAD
    $.__views.__alloyId507.add($.__views.btnBack);
=======
...
<<<<<<< HEAD
    $.__views.__alloyId509.add($.__views.claimContainer);
=======
    $.__views.__alloyId497.add($.__views.claimContainer);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId510.add($.__views.view_balance);
=======
    $.__views.__alloyId498.add($.__views.view_balance);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId509.add($.__views.verifyContainer);
    $.__views.__alloyId511 = Ti.UI.createImageView({
=======
    $.__views.__alloyId497.add($.__views.verifyContainer);
...
<<<<<<< HEAD
    ...
    $.__views.verifyContainer.add($.__views.__alloyId512);
