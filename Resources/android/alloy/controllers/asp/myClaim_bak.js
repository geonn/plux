...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId228;
    ...
    $.__views.myClaim.add($.__views.__alloyId230);
    ...
    $.__views.__alloyId234.add($.__views.claimContainer);
    ...
    $.__views.__alloyId235.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId234.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId236);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId237);
    resendVerificationEmail ? $.addListener($.__views.__alloyId237, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId237!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId238, "touchend", checkStatus) : __defers["$.__views.__alloyId238!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId237!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId237, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId238!touchend!checkStatus"] && $.addListener($.__views.__alloyId238, "touchend", checkStatus);
    _.extend($, exports);
}
