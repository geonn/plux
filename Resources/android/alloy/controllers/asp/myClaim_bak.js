...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId139;
    ...
    $.__views.myClaim.add($.__views.__alloyId141);
    ...
    $.__views.__alloyId143.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "90%"
    });
    $.__views.__alloyId142.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId144);
    ...
    $.__views.__alloyId145.add($.__views.claimContainer);
    ...
    $.__views.__alloyId146.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId145.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId147);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId148);
    resendVerificationEmail ? $.__views.__alloyId148.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId148!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId149);
    checkStatus ? $.__views.__alloyId149.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId149!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId148!touchend!resendVerificationEmail"] && $.__views.__alloyId148.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId149!touchend!checkStatus"] && $.__views.__alloyId149.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
