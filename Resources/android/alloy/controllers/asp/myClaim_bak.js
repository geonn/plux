...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId524;
    ...
    $.__views.myClaim.add($.__views.__alloyId526);
    ...
    $.__views.__alloyId526.add($.__views.__alloyId530);
    ...
    $.__views.__alloyId530.add($.__views.claimContainer);
    ...
    $.__views.main.add($.__views.__alloyId531);
    ...
    $.__views.__alloyId531.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: false,
        layout: "vertical"
    });
    $.__views.__alloyId530.add($.__views.verifyContainer);
