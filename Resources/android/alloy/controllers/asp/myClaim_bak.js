...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId474;
    ...
    $.__views.loadingBar.add($.__views.__alloyId475);
    ...
    $.__views.myClaim.add($.__views.__alloyId476);
    ...
    $.__views.__alloyId478.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId479);
    ...
    $.__views.__alloyId480.add($.__views.claimContainer);
    ...
    $.__views.__alloyId481.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: false,
        layout: "vertical"
    });
    $.__views.__alloyId480.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId482);
    ...
    $.__views.__alloyId483 = Ti.UI.createButton({
        borderRadius: 5,
        backgroundColor: "#CE1D1C",
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId483, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId483!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId484, "touchend", checkStatus) : __defers["$.__views.__alloyId484!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId483!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId483, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId484!touchend!checkStatus"] && $.addListener($.__views.__alloyId484, "touchend", checkStatus);
    _.extend($, exports);
}
