...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId376;
    ...
    $.__views.myClaim.add($.__views.__alloyId378);
    ...
    $.__views.__alloyId382.add($.__views.claimContainer);
    ...
    $.__views.__alloyId383.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId382.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId384);
    ...
    $.__views.__alloyId385 = Ti.UI.createButton({
        borderRadius: "5",
        backgroundColor: "#CE1D1C",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId385);
    resendVerificationEmail ? $.addListener($.__views.__alloyId385, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId385!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId386 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId386);
    checkStatus ? $.addListener($.__views.__alloyId386, "touchend", checkStatus) : __defers["$.__views.__alloyId386!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId385!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId385, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId386!touchend!checkStatus"] && $.addListener($.__views.__alloyId386, "touchend", checkStatus);
    _.extend($, exports);
}
