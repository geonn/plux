...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId230;
    ...
    $.__views.myClaim.add($.__views.__alloyId232);
    ...
    $.__views.__alloyId236.add($.__views.claimContainer);
    ...
    $.__views.__alloyId237.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId236.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId238);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId239);
    resendVerificationEmail ? $.addListener($.__views.__alloyId239, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId239!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId240);
    checkStatus ? $.addListener($.__views.__alloyId240, "touchend", checkStatus) : __defers["$.__views.__alloyId240!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId239!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId239, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId240!touchend!checkStatus"] && $.addListener($.__views.__alloyId240, "touchend", checkStatus);
    _.extend($, exports);
}
