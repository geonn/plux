...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId138;
    ...
    $.__views.myClaim.add($.__views.__alloyId140);
    ...
    $.__views.pageTitle.add($.__views.__alloyId143);
    ...
    $.__views.__alloyId144.add($.__views.claimContainer);
    ...
    $.__views.__alloyId145.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId144.add($.__views.verifyContainer);
    ...
    resendVerificationEmail ? $.__views.__alloyId147.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId147!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.__views.__alloyId148.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId148!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId147!touchend!resendVerificationEmail"] && $.__views.__alloyId147.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId148!touchend!checkStatus"] && $.__views.__alloyId148.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
