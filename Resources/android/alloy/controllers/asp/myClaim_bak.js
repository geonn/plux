...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId509;
    ...
    $.__views.loadingBar.add($.__views.__alloyId510);
    ...
    $.__views.myClaim.add($.__views.__alloyId511);
    ...
    $.__views.__alloyId511.add($.__views.__alloyId515);
    ...
    $.__views.__alloyId515.add($.__views.claimContainer);
    ...
    $.__views.main.add($.__views.__alloyId516);
    ...
    $.__views.__alloyId516.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: false,
        layout: "vertical"
    });
    $.__views.__alloyId515.add($.__views.verifyContainer);
