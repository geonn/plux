...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId225;
    ...
    $.__views.myClaim.add($.__views.__alloyId227);
    ...
    $.__views.__alloyId231.add($.__views.claimContainer);
    ...
    $.__views.__alloyId232.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId231.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId233);
    ...
    $.__views.__alloyId234 = Ti.UI.createButton({
        borderRadius: "5",
        backgroundColor: "#CE1D1C",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId234);
    resendVerificationEmail ? $.addListener($.__views.__alloyId234, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId234!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId235);
    checkStatus ? $.addListener($.__views.__alloyId235, "touchend", checkStatus) : __defers["$.__views.__alloyId235!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId234!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId234, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId235!touchend!checkStatus"] && $.addListener($.__views.__alloyId235, "touchend", checkStatus);
    _.extend($, exports);
}
