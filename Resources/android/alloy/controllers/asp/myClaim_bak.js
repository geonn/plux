...
function Controller() {
    ...
    $.__views.__alloyId501.add($.__views.view_balance);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId503, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId503!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId504 = Ti.UI.createButton({
        borderRadius: 5,
    ...
    $.__views.verifyContainer.add($.__views.__alloyId504);
    checkStatus ? $.addListener($.__views.__alloyId504, "touchend", checkStatus) : __defers["$.__views.__alloyId504!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId503!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId503, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId504!touchend!checkStatus"] && $.addListener($.__views.__alloyId504, "touchend", checkStatus);
    _.extend($, exports);
}
