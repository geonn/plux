...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId384;
    ...
    $.__views.loadingBar.add($.__views.__alloyId385);
    ...
    $.__views.myClaim.add($.__views.__alloyId386);
    ...
    $.__views.__alloyId386.add($.__views.__alloyId390);
    ...
    $.__views.__alloyId390.add($.__views.claimContainer);
    ...
    $.__views.main.add($.__views.__alloyId391);
    ...
    $.__views.__alloyId391.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId390.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId392);
    ...
    $.__views.__alloyId393 = Ti.UI.createButton({
        borderRadius: "5",
        backgroundColor: "#CE1D1C",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId393);
    resendVerificationEmail ? $.addListener($.__views.__alloyId393, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId393!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId394 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId394);
    checkStatus ? $.addListener($.__views.__alloyId394, "touchend", checkStatus) : __defers["$.__views.__alloyId394!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId393!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId393, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId394!touchend!checkStatus"] && $.addListener($.__views.__alloyId394, "touchend", checkStatus);
    _.extend($, exports);
}
