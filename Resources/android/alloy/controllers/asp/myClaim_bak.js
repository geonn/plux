...
function Controller() {
  ...
  $.__views.myClaim = Ti.UI.createWindow({ backgroundColor: "#ffffff", orientationModes: [Ti.UI.PORTRAIT], fullscreen: false, windowSoftInputMode: Ti.UI.Android.SOFT_INPUT_STATE_HIDDEN, title: "My Claim Details", id: "myClaim", backButtonTitle: "", navTintColor: "#CE1D1C" });
  $.__views.myClaim && $.addTopLevelView($.__views.myClaim);
  $.__views.__alloyId290 = Ti.UI.createView({ id: "__alloyId290" });
  $.__views.myClaim.rightNavButton = $.__views.__alloyId290;$.__views.loadingBar = Ti.UI.createView({ layout: "vertical", id: "loadingBar", height: 120, zIndex: 12, width: 120, borderRadius: 15, backgroundColor: "#2E2E2E" });
  ...
  $.__views.__alloyId291 = Ti.UI.createLabel({ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#ffffff", font: { fontSize: "16dp" }, top: 5, bottom: 5, text: "Loading", id: "__alloyId291" });
  $.__views.loadingBar.add($.__views.__alloyId291);
  $.__views.__alloyId292 = Ti.UI.createView({ layout: "vertical", backgroundColor: "#F6F6F6", height: "100%", id: "__alloyId292" });
  $.__views.myClaim.add($.__views.__alloyId292);
  if (true) {
    $.__views.__alloyId293 = Ti.UI.createView({ layout: "horizontal", height: 50, width: Ti.UI.FILL, backgroundColor: "#DEDEDE", id: "__alloyId293" });
    $.__views.__alloyId292.add($.__views.__alloyId293);
    $.__views.__alloyId294 = Ti.UI.createView({ left: 0, width: "10%", id: "__alloyId294" });
    ...
    $.__views.__alloyId295 = Ti.UI.createLabel({ width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'My Claim Details', textAlign: "center", id: "__alloyId295" });
    $.__views.pageTitle.add($.__views.__alloyId295);
  }
  $.__views.__alloyId296 = Ti.UI.createView({ height: Ti.UI.FILL, width: Ti.UI.FILL, id: "__alloyId296" });
  ...
  $.__views.main = Ti.UI.createScrollView({ backgroundColor: "#ffffff", id: "main", layout: "vertical", scrollType: "vertical" });
  ...
  $.__views.__alloyId297 = Ti.UI.createView({ left: 10, right: 10, top: 10, bottom: 10, height: Ti.UI.SIZE, width: Ti.UI.FILL, id: "__alloyId297" });
  $.__views.main.add($.__views.__alloyId297);
  $.__views.view_balance = Ti.UI.createView({ borderColor: "#000000", width: Ti.UI.FILL, height: Ti.UI.SIZE, layout: "vertical", id: "view_balance" });
  $.__views.__alloyId297.add($.__views.view_balance);
  $.__views.verifyContainer = Ti.UI.createView({ id: "verifyContainer", visible: false, layout: "vertical" });
  $.__views.__alloyId296.add($.__views.verifyContainer);
  $.__views.__alloyId298 = Ti.UI.createImageView({ width: "40%", borderRadius: 10, height: Ti.UI.SIZE, backgroundColor: "#ff0000", bottom: "30dp", top: "30dp", image: "/images/asp_logo.png", id: "__alloyId298" });
  $.__views.verifyContainer.add($.__views.__alloyId298);
  $.__views.description = Ti.UI.createLabel({ width: Titanium.UI.FILL, height: "80dp", color: "#6E6E6E", font: { fontSize: "16sp" }, bottom: "10dp", textAlign: "center", id: "description" });
  $.__views.verifyContainer.add($.__views.description);
  $.__views.__alloyId299 = Ti.UI.createButton({ borderRadius: 5, backgroundColor: "#CE1D1C", title: "Resend Verification", width: "70%", top: 10, height: 40, color: "#ffffff", id: "__alloyId299" });
  $.__views.verifyContainer.add($.__views.__alloyId299);
  resendVerificationEmail ? $.addListener($.__views.__alloyId299, 'touchend', resendVerificationEmail) : __defers['$.__views.__alloyId299!touchend!resendVerificationEmail'] = true;$.__views.__alloyId300 = Ti.UI.createButton({ borderRadius: 5, backgroundColor: "#7B7B7B", title: "Refresh", width: "70%", top: 10, height: 40, color: "#ffffff", id: "__alloyId300" });
