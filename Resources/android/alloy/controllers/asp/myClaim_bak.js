...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId543;
    ...
    $.__views.loadingBar.add($.__views.__alloyId544);
    ...
    $.__views.myClaim.add($.__views.__alloyId545);
    ...
    $.__views.__alloyId547.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "90%"
    });
    $.__views.__alloyId546.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId548);
    ...
    $.__views.__alloyId549.add($.__views.claimContainer);
    ...
    $.__views.__alloyId550.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: false,
        layout: "vertical"
    });
    $.__views.__alloyId549.add($.__views.verifyContainer);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId552, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId552!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId553);
    checkStatus ? $.addListener($.__views.__alloyId553, "touchend", checkStatus) : __defers["$.__views.__alloyId553!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId552!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId552, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId553!touchend!checkStatus"] && $.addListener($.__views.__alloyId553, "touchend", checkStatus);
    _.extend($, exports);
}
