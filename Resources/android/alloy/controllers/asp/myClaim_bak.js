...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId202;
    ...
    $.__views.loadingBar.add($.__views.__alloyId203);
    ...
    $.__views.myClaim.add($.__views.__alloyId204);
    ...
    $.__views.__alloyId208.add($.__views.claimContainer);
    ...
    $.__views.__alloyId209.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId208.add($.__views.verifyContainer);
    ...
    resendVerificationEmail ? $.__views.__alloyId211.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId211!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.__views.__alloyId212.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId212!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId211!touchend!resendVerificationEmail"] && $.__views.__alloyId211.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId212!touchend!checkStatus"] && $.__views.__alloyId212.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
