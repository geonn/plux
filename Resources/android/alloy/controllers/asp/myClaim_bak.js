...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId475;
    ...
    $.__views.loadingBar.add($.__views.__alloyId476);
    ...
    $.__views.myClaim.add($.__views.__alloyId477);
    ...
    $.__views.__alloyId479.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "90%"
    });
    $.__views.__alloyId478.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId480);
    $.__views.__alloyId481 = Ti.UI.createView({
        height: Ti.UI.FILL,
        width: Ti.UI.FILL,
        id: "__alloyId481"
    });
    $.__views.__alloyId477.add($.__views.__alloyId481);
    ...
    $.__views.__alloyId481.add($.__views.claimContainer);
    ...
    $.__views.main.add($.__views.__alloyId482);
    ...
    $.__views.__alloyId482.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: false,
        layout: "vertical"
    });
    $.__views.__alloyId481.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId483);
    ...
    $.__views.__alloyId484 = Ti.UI.createButton({
        borderRadius: 5,
        backgroundColor: "#CE1D1C",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId484);
    resendVerificationEmail ? $.addListener($.__views.__alloyId484, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId484!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId485);
    checkStatus ? $.addListener($.__views.__alloyId485, "touchend", checkStatus) : __defers["$.__views.__alloyId485!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId484!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId484, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId485!touchend!checkStatus"] && $.addListener($.__views.__alloyId485, "touchend", checkStatus);
    _.extend($, exports);
}
