...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId381;
    ...
    $.__views.loadingBar.add($.__views.__alloyId382);
    ...
    $.__views.myClaim.add($.__views.__alloyId383);
    ...
    $.__views.pageTitle.add($.__views.__alloyId386);
    ...
    $.__views.__alloyId387.add($.__views.claimContainer);
    ...
    $.__views.main.add($.__views.__alloyId388);
    ...
    $.__views.__alloyId388.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId387.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId389);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId390);
    resendVerificationEmail ? $.addListener($.__views.__alloyId390, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId390!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId391 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    $.__views.verifyContainer.add($.__views.__alloyId391);
    checkStatus ? $.addListener($.__views.__alloyId391, "touchend", checkStatus) : __defers["$.__views.__alloyId391!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId390!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId390, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId391!touchend!checkStatus"] && $.addListener($.__views.__alloyId391, "touchend", checkStatus);
    _.extend($, exports);
}
