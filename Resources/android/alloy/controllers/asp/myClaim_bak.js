...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId196;
    ...
    $.__views.myClaim.add($.__views.__alloyId198);
    ...
    $.__views.__alloyId200.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "90%"
    });
    $.__views.__alloyId199.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId201);
    ...
    $.__views.__alloyId202.add($.__views.claimContainer);
    ...
    $.__views.__alloyId203.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId202.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId205);
    resendVerificationEmail ? $.__views.__alloyId205.addEventListener("touchend", resendVerificationEmail) : __defers["$.__views.__alloyId205!touchend!resendVerificationEmail"] = true;
    ...
    $.__views.verifyContainer.add($.__views.__alloyId206);
    checkStatus ? $.__views.__alloyId206.addEventListener("touchend", checkStatus) : __defers["$.__views.__alloyId206!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId205!touchend!resendVerificationEmail"] && $.__views.__alloyId205.addEventListener("touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId206!touchend!checkStatus"] && $.__views.__alloyId206.addEventListener("touchend", checkStatus);
    _.extend($, exports);
}
