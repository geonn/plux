...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId473;
    ...
    $.__views.myClaim.add($.__views.__alloyId475);
    ...
    $.__views.__alloyId475.add($.__views.__alloyId479);
    ...
    $.__views.__alloyId479.add($.__views.claimContainer);
    ...
    $.__views.__alloyId480.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: false,
        layout: "vertical"
    });
    $.__views.__alloyId479.add($.__views.verifyContainer);
    ...
    $.__views.verifyContainer.add($.__views.__alloyId481);
    ...
    $.__views.__alloyId482 = Ti.UI.createButton({
        borderRadius: 5,
        backgroundColor: "#CE1D1C",
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId482, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId482!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId483, "touchend", checkStatus) : __defers["$.__views.__alloyId483!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId482!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId482, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId483!touchend!checkStatus"] && $.addListener($.__views.__alloyId483, "touchend", checkStatus);
    _.extend($, exports);
}
