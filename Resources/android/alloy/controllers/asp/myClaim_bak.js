...
function Controller() {
    ...
    $.__views.myClaim.rightNavButton = $.__views.__alloyId133;
    ...
    $.__views.myClaim.add($.__views.__alloyId135);
    ...
    $.__views.__alloyId136.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId138);
    ...
    $.__views.__alloyId139.add($.__views.claimContainer);
    ...
    $.__views.__alloyId140.add($.__views.view_balance);
    $.__views.verifyContainer = Ti.UI.createView({
        id: "verifyContainer",
        visible: "false",
        layout: "vertical"
    });
    $.__views.__alloyId139.add($.__views.verifyContainer);
