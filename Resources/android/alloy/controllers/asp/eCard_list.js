...
function Controller() {
    ...
    function render_ecard_list() {
        ...
        var x = 0;
        var dragStartTime = 0;
        scrollViewDrag.addEventListener("dblclick", function() {
            navToEcard();
        });
    ...
    navToEcard ? $.addListener($.__views.btnBack, "click", navToEcard) : __defers["$.__views.btnBack!click!navToEcard"] = true;
    $.__views.inner_box = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.FILL,
        id: "inner_box"
    });
    $.__views.__alloyId273.add($.__views.inner_box);
    ...
    __defers["$.__views.btnBack!click!navToEcard"] && $.addListener($.__views.btnBack, "click", navToEcard);
    _.extend($, exports);
}
