...
function Controller() {
    ...
    closeWindow ? $.addListener($.__views.__alloyId209, "click", closeWindow) : __defers["$.__views.__alloyId209!click!closeWindow"] = true;
    ...
    $.__views.__alloyId206.add($.__views.inner_box);
    ...
    __defers["$.__views.__alloyId209!click!closeWindow"] && $.addListener($.__views.__alloyId209, "click", closeWindow);
    _.extend($, exports);
}
