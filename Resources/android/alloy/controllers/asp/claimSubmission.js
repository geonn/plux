...
function Controller() {
    ...
    $.__views.tvrReceiptNo.add($.__views.__alloyId441);
    ...
    $.__views.__alloyId441.add($.__views.receipt_no);
    ...
    $.__views.tvrCategory.add($.__views.__alloyId444);
    ...
    $.__views.__alloyId446.add($.__views.category);
    ...
    $.__views.tvrClaimUnder.add($.__views.__alloyId448);
    ...
    $.__views.__alloyId450.add($.__views.claim_under);
    ...
    $.__views.tvrReceiptAmount.add($.__views.__alloyId452);
    ...
    $.__views.__alloyId452.add($.__views.receiptAmount);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId455);
    ...
    $.__views.__alloyId457.add($.__views.dateVisit);
    ...
    $.__views.tvrClinicVisit.add($.__views.__alloyId459);
    ...
    $.__views.__alloyId461.add($.__views.clinicName);
    ...
    $.__views.tvrRemark.add($.__views.__alloyId463);
    ...
    $.__views.__alloyId463.add($.__views.remark);
    ...
    $.__views.tvrGstAmount.add($.__views.__alloyId466);
    ...
    $.__views.__alloyId468.add($.__views.gstAmount);
    ...
    $.__views.tvrMc.add($.__views.__alloyId470);
    ...
    $.__views.__alloyId470.add($.__views.mc);
    ...
    $.__views.tvrDiagnosis.add($.__views.__alloyId473);
    ...
    $.__views.__alloyId473.add($.__views.diagnosis);
    ...
    $.__views.tvrGlAmount.add($.__views.__alloyId476);
    ...
    $.__views.__alloyId476.add($.__views.glamount);
    ...
    $.__views.__alloyId479.add($.__views.saveBtn);
