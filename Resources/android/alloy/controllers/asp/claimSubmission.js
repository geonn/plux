...
function Controller() {
  ...
  { backgroundColor: "#ffffff", orientationModes: [Ti.UI.PORTRAIT], fullscreen: false, windowSoftInputMode: Ti.UI.Android.SOFT_INPUT_STATE_HIDDEN, title: "Claim Submission", id: "win", backButtonTitle: "", navTintColor: "#CE1D1C" });
  ...
  if (true) {
    ...
    { layout: "horizontal", height: 50, width: Ti.UI.FILL, backgroundColor: "#DEDEDE", id: "__alloyId224" });

    $.__views.main.add($.__views.__alloyId224);
    $.__views.__alloyId225 = Ti.UI.createView(
    { left: 0, width: "10%", id: "__alloyId225" });
    ...
    { width: "90%", id: "__alloyId226" });

    $.__views.__alloyId224.add($.__views.__alloyId226);
    $.__views.pageTitle = Ti.UI.createLabel(
    { width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'Claim Submission', id: "pageTitle", textAlign: "center" });

    $.__views.__alloyId226.add($.__views.pageTitle);
  }
  $.__views.__alloyId227 = Ti.UI.createLabel(
  { width: Ti.UI.FILL, height: Titanium.UI.SIZE, color: "#606060", top: 10, left: 10, right: 10, bottom: 10, font: { fontSize: 14 }, text: "Please fill in below info to claim from ASP", id: "__alloyId227" });
  ...
  { id: "tvrReceiptNo", height: Ti.UI.SIZE, layout: "vertical", selectedBackgroundColor: "#ffffff" });

  $.__views.table.add($.__views.tvrReceiptNo);
  $.__views.__alloyId228 = Ti.UI.createView(
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, id: "__alloyId228" });

  $.__views.tvrReceiptNo.add($.__views.__alloyId228);
  $.__views.__alloyId229 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Receipt Number", top: 12, id: "__alloyId229" });

  $.__views.__alloyId228.add($.__views.__alloyId229);
  $.__views.receipt_no = Ti.UI.createTextField(
  { verticalAlign: Titanium.UI.TEXT_VERTICAL_ALIGNMENT_CENTER, height: "45dp", font: { fontSize: 12 }, color: "#222222", borderWidth: "1px", borderStyle: Titanium.UI.INPUT_BORDERSTYLE_ROUNDED, width: Ti.UI.FILL, backgroundColor: "#ffffff", borderColor: "#ffffff", id: "receipt_no", bottom: 5, right: 5, maxLength: 30, hintText: "Receipt Number" });

  $.__views.__alloyId228.add($.__views.receipt_no);
  $.__views.__alloyId230 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId230" });

  $.__views.tvrReceiptNo.add($.__views.__alloyId230);
  $.__views.tvrCategory = Ti.UI.createView(
  { id: "tvrCategory", height: Ti.UI.SIZE, layout: "vertical", selectedBackgroundColor: "#ffffff" });

  $.__views.table.add($.__views.tvrCategory);
  $.__views.__alloyId231 = Ti.UI.createView(
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, id: "__alloyId231" });

  $.__views.tvrCategory.add($.__views.__alloyId231);
  $.__views.__alloyId232 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Category", top: 12, id: "__alloyId232" });

  $.__views.__alloyId231.add($.__views.__alloyId232);
  $.__views.__alloyId233 = Ti.UI.createView(
  { height: Ti.UI.SIZE, skip_checking: 1, width: "auto", id: "__alloyId233" });
  ...
  $.__views.__alloyId233.add($.__views.category);
  $.__views.__alloyId234 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId234" });

  $.__views.tvrCategory.add($.__views.__alloyId234);
  $.__views.tvrClaimUnder = Ti.UI.createView(
  { id: "tvrClaimUnder", height: Ti.UI.SIZE, layout: "vertical", selectedBackgroundColor: "#ffffff" });

  $.__views.table.add($.__views.tvrClaimUnder);
  $.__views.__alloyId235 = Ti.UI.createView(
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, id: "__alloyId235" });

  $.__views.tvrClaimUnder.add($.__views.__alloyId235);
  $.__views.__alloyId236 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Claim Under", top: 12, id: "__alloyId236" });

  $.__views.__alloyId235.add($.__views.__alloyId236);
  $.__views.__alloyId237 = Ti.UI.createView(
  { height: Ti.UI.SIZE, skip_checking: 1, width: "auto", id: "__alloyId237" });
  ...
  $.__views.__alloyId237.add($.__views.claim_under);
  $.__views.__alloyId238 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId238" });

  $.__views.tvrClaimUnder.add($.__views.__alloyId238);
  $.__views.tvrReceiptAmount = Ti.UI.createView(
  { id: "tvrReceiptAmount", height: Ti.UI.SIZE, layout: "vertical", selectedBackgroundColor: "#ffffff" });

  $.__views.table.add($.__views.tvrReceiptAmount);
  $.__views.__alloyId239 = Ti.UI.createView(
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, id: "__alloyId239" });

  $.__views.tvrReceiptAmount.add($.__views.__alloyId239);
  $.__views.__alloyId240 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Receipt Amount", top: 12, id: "__alloyId240" });

  $.__views.__alloyId239.add($.__views.__alloyId240);
  $.__views.receiptAmount = Ti.UI.createTextField(
  { verticalAlign: Titanium.UI.TEXT_VERTICAL_ALIGNMENT_CENTER, height: "45dp", font: { fontSize: 12 }, color: "#222222", borderWidth: "1px", borderStyle: Titanium.UI.INPUT_BORDERSTYLE_ROUNDED, width: Ti.UI.FILL, backgroundColor: "#ffffff", borderColor: "#ffffff", id: "receiptAmount", bottom: 5, right: 5, horizontalWrap: true, keyboardType: Titanium.UI.KEYBOARD_DECIMAL_PAD, hintText: "Receipt amount in RM" });

  $.__views.__alloyId239.add($.__views.receiptAmount);
  $.__views.__alloyId241 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId241" });

  $.__views.tvrReceiptAmount.add($.__views.__alloyId241);
  ...
  showVisitPicker ? $.addListener($.__views.tvrDateVisit, 'click', showVisitPicker) : __defers['$.__views.tvrDateVisit!click!showVisitPicker'] = true;$.__views.__alloyId242 = Ti.UI.createView(
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, id: "__alloyId242" });

  $.__views.tvrDateVisit.add($.__views.__alloyId242);
  $.__views.__alloyId243 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Date of Visit", top: 12, id: "__alloyId243" });

  $.__views.__alloyId242.add($.__views.__alloyId243);
  $.__views.__alloyId244 = Ti.UI.createView(
  { height: Ti.UI.SIZE, skip_checking: 1, width: "auto", id: "__alloyId244" });
  ...
  $.__views.__alloyId244.add($.__views.dateVisit);
  $.__views.__alloyId245 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId245" });

  $.__views.table.add($.__views.__alloyId245);
  $.__views.tvrClinicVisit = Ti.UI.createView(
  { id: "tvrClinicVisit", height: Ti.UI.SIZE, layout: "vertical", selectedBackgroundColor: "#ffffff" });

  $.__views.table.add($.__views.tvrClinicVisit);
  $.__views.__alloyId246 = Ti.UI.createView(
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, id: "__alloyId246" });

  $.__views.tvrClinicVisit.add($.__views.__alloyId246);
  $.__views.__alloyId247 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Clinic/Hospital Name", top: 12, id: "__alloyId247" });

  $.__views.__alloyId246.add($.__views.__alloyId247);
  $.__views.clinicName = Ti.UI.createTextField(
  { verticalAlign: Titanium.UI.TEXT_VERTICAL_ALIGNMENT_CENTER, height: "45dp", font: { fontSize: 12 }, color: "#222222", borderWidth: "1px", borderStyle: Titanium.UI.INPUT_BORDERSTYLE_ROUNDED, width: Ti.UI.FILL, backgroundColor: "#ffffff", maxLength: 40, borderColor: "#ffffff", id: "clinicName", top: 5, bottom: 5, right: 5, hintText: "Clinic/Hospital Name" });

  $.__views.__alloyId246.add($.__views.clinicName);
  $.__views.__alloyId248 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId248" });

  $.__views.tvrClinicVisit.add($.__views.__alloyId248);
  $.__views.tvrRemark = Ti.UI.createView(
  { id: "tvrRemark", height: Ti.UI.SIZE, layout: "vertical", selectedBackgroundColor: "#ffffff" });

  $.__views.table.add($.__views.tvrRemark);
  $.__views.view_remark = Ti.UI.createView(
  { layout: "horizontal", width: Ti.UI.FILL, id: "view_remark", height: 85 });

  $.__views.tvrRemark.add($.__views.view_remark);
  $.__views.__alloyId249 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Remark", top: 12, id: "__alloyId249" });

  $.__views.view_remark.add($.__views.__alloyId249);
  $.__views.remark = Ti.UI.createTextField(
  { verticalAlign: Titanium.UI.TEXT_VERTICAL_ALIGNMENT_CENTER, height: "45dp", font: { fontSize: 12 }, color: "#222222", borderWidth: "1px", borderStyle: Titanium.UI.INPUT_BORDERSTYLE_ROUNDED, width: Ti.UI.FILL, backgroundColor: "#ffffff", borderColor: "#ffffff", compulsory: 0, id: "remark", bottom: 5, right: 5, hintText: "Claim remark" });

  $.__views.view_remark.add($.__views.remark);
  $.__views.__alloyId250 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId250" });

  $.__views.tvrRemark.add($.__views.__alloyId250);
  $.__views.tvrGstAmount = Ti.UI.createView(
  { id: "tvrGstAmount", height: Ti.UI.SIZE, layout: "vertical", selectedBackgroundColor: "#ffffff" });

  $.__views.table.add($.__views.tvrGstAmount);
  $.__views.__alloyId251 = Ti.UI.createView(
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, id: "__alloyId251" });

  $.__views.tvrGstAmount.add($.__views.__alloyId251);
  $.__views.__alloyId252 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "GST Amount", top: 12, id: "__alloyId252" });

  $.__views.__alloyId251.add($.__views.__alloyId252);
  $.__views.gstAmount = Ti.UI.createTextField(
  { verticalAlign: Titanium.UI.TEXT_VERTICAL_ALIGNMENT_CENTER, height: "45dp", font: { fontSize: 12 }, color: "#222222", borderWidth: "1px", borderStyle: Titanium.UI.INPUT_BORDERSTYLE_ROUNDED, width: Ti.UI.FILL, backgroundColor: "#ffffff", borderColor: "#ffffff", id: "gstAmount", bottom: 5, right: 5, horizontalWrap: true, keyboardType: Titanium.UI.KEYBOARD_DECIMAL_PAD, hintText: "GST Amount (If applicable)" });

  $.__views.__alloyId251.add($.__views.gstAmount);
  $.__views.__alloyId253 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId253" });

  $.__views.tvrGstAmount.add($.__views.__alloyId253);
  $.__views.tvrMc = Ti.UI.createView(
  { id: "tvrMc", height: Ti.UI.SIZE, layout: "vertical", selectedBackgroundColor: "#ffffff" });

  $.__views.table.add($.__views.tvrMc);
  $.__views.__alloyId254 = Ti.UI.createView(
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, id: "__alloyId254" });

  $.__views.tvrMc.add($.__views.__alloyId254);
  $.__views.__alloyId255 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "MC Issued", top: 12, id: "__alloyId255" });

  $.__views.__alloyId254.add($.__views.__alloyId255);
  $.__views.mc = Ti.UI.createTextField(
  { verticalAlign: Titanium.UI.TEXT_VERTICAL_ALIGNMENT_CENTER, height: "45dp", font: { fontSize: 12 }, color: "#222222", borderWidth: "1px", borderStyle: Titanium.UI.INPUT_BORDERSTYLE_ROUNDED, width: Ti.UI.FILL, backgroundColor: "#ffffff", borderColor: "#ffffff", id: "mc", bottom: 5, right: 5, horizontalWrap: true, keyboardType: Ti.UI.KEYBOARD_NUMBER_PAD, hintText: "MC Issued (Days)" });

  $.__views.__alloyId254.add($.__views.mc);
  $.__views.__alloyId256 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId256" });

  $.__views.tvrMc.add($.__views.__alloyId256);
  $.__views.tvrDiagnosis = Ti.UI.createView(
  { id: "tvrDiagnosis", height: Ti.UI.SIZE, layout: "vertical", selectedBackgroundColor: "#ffffff" });

  $.__views.table.add($.__views.tvrDiagnosis);
  $.__views.__alloyId257 = Ti.UI.createView(
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, id: "__alloyId257" });

  $.__views.tvrDiagnosis.add($.__views.__alloyId257);
  $.__views.__alloyId258 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Diagnosis", top: 12, id: "__alloyId258" });

  $.__views.__alloyId257.add($.__views.__alloyId258);
  $.__views.diagnosis = Ti.UI.createTextField(
  { verticalAlign: Titanium.UI.TEXT_VERTICAL_ALIGNMENT_CENTER, height: "45dp", font: { fontSize: 12 }, color: "#222222", borderWidth: "1px", borderStyle: Titanium.UI.INPUT_BORDERSTYLE_ROUNDED, width: Ti.UI.FILL, backgroundColor: "#ffffff", borderColor: "#ffffff", id: "diagnosis", bottom: 5, right: 5, hintText: "Diagnosis" });

  $.__views.__alloyId257.add($.__views.diagnosis);
  $.__views.__alloyId259 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId259" });

  $.__views.tvrDiagnosis.add($.__views.__alloyId259);
  $.__views.tvrGlAmount = Ti.UI.createView(
  { id: "tvrGlAmount", height: Ti.UI.SIZE, layout: "vertical", selectedBackgroundColor: "#ffffff" });

  $.__views.table.add($.__views.tvrGlAmount);
  $.__views.__alloyId260 = Ti.UI.createView(
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, id: "__alloyId260" });

  $.__views.tvrGlAmount.add($.__views.__alloyId260);
  $.__views.__alloyId261 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "GL Amount", top: 12, id: "__alloyId261" });

  $.__views.__alloyId260.add($.__views.__alloyId261);
  $.__views.glamount = Ti.UI.createTextField(
  { verticalAlign: Titanium.UI.TEXT_VERTICAL_ALIGNMENT_CENTER, height: "45dp", font: { fontSize: 12 }, color: "#222222", borderWidth: "1px", borderStyle: Titanium.UI.INPUT_BORDERSTYLE_ROUNDED, width: Ti.UI.FILL, backgroundColor: "#ffffff", borderColor: "#ffffff", id: "glamount", bottom: 5, right: 5, horizontalWrap: true, keyboardType: Titanium.UI.KEYBOARD_DECIMAL_PAD, hintText: "GL Amount (If applicable)" });

  $.__views.__alloyId260.add($.__views.glamount);
  $.__views.__alloyId262 = Ti.UI.createView(
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId262" });

  $.__views.tvrGlAmount.add($.__views.__alloyId262);
  $.__views.__alloyId263 = Ti.UI.createView(
  { width: Ti.UI.FILL, height: Ti.UI.SIZE, top: 10, id: "__alloyId263" });

  $.__views.table.add($.__views.__alloyId263);
  $.__views.saveBtn = Ti.UI.createButton(
  { id: "saveBtn", title: "Submit Claim", borderRadius: 5, backgroundColor: "#7B7B7B", width: "70%", height: 40, color: "#ffffff" });

  $.__views.__alloyId263.add($.__views.saveBtn);
  ...
  { height: 0, bottom: 0, id: "selectorView", zIndex: 99 });
