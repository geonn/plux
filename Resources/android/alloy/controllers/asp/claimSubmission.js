...
function Controller() {
    ...
    $.__views.main.add($.__views.__alloyId404);
    ...
    $.__views.tvrReceiptNo.add($.__views.__alloyId405);
    ...
    $.__views.__alloyId405.add($.__views.receipt_no);
    ...
    $.__views.tvrCategory.add($.__views.__alloyId408);
    ...
    $.__views.__alloyId410.add($.__views.category);
    ...
    $.__views.tvrClaimUnder.add($.__views.__alloyId412);
    ...
    $.__views.__alloyId414.add($.__views.claim_under);
    ...
    $.__views.table.add($.__views.__alloyId415);
    ...
    $.__views.tvrReceiptAmount.add($.__views.__alloyId416);
    ...
    $.__views.__alloyId416.add($.__views.receiptAmount);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId419);
    ...
    $.__views.__alloyId421.add($.__views.dateVisit);
    ...
    $.__views.tvrClinicVisit.add($.__views.__alloyId423);
    ...
    $.__views.__alloyId425.add($.__views.clinicName);
    ...
    $.__views.tvrRemark.add($.__views.__alloyId427);
    ...
    $.__views.__alloyId427.add($.__views.remark);
    ...
    $.__views.tvrGstAmount.add($.__views.__alloyId430);
    ...
    $.__views.__alloyId432.add($.__views.gstAmount);
    ...
    $.__views.tvrMc.add($.__views.__alloyId434);
    ...
    $.__views.__alloyId434.add($.__views.mc);
    ...
    $.__views.tvrDiagnosis.add($.__views.__alloyId437);
    ...
    $.__views.__alloyId437.add($.__views.diagnosis);
    ...
    $.__views.tvrGlAmount.add($.__views.__alloyId440);
    ...
    $.__views.__alloyId440.add($.__views.glamount);
    ...
    $.__views.__alloyId443.add($.__views.saveBtn);
