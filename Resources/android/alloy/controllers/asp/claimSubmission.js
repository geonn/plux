...
function Controller() {
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId228" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId231" });
  ...
  { height: Ti.UI.SIZE, textAlign: Titanium.UI.TEXT_ALIGNMENT_RIGHT, skip_checking: 1, width: "auto", id: "__alloyId233" });

  $.__views.__alloyId231.add($.__views.__alloyId233);
  $.__views.category = Ti.UI.createLabel(
  { width: Ti.UI.FILL, height: Titanium.UI.SIZE, color: "#C8C8CD", top: 12, left: 10, right: 10, bottom: 10, font: { fontSize: 12 }, textAlign: Titanium.UI.TEXT_ALIGNMENT_RIGHT, text: "Choose Category", id: "category" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId235" });
  ...
  { height: Ti.UI.SIZE, textAlign: Titanium.UI.TEXT_ALIGNMENT_RIGHT, skip_checking: 1, width: "auto", id: "__alloyId237" });

  $.__views.__alloyId235.add($.__views.__alloyId237);
  $.__views.claim_under = Ti.UI.createLabel(
  { width: Ti.UI.FILL, height: Titanium.UI.SIZE, color: "#C8C8CD", top: 12, left: 10, right: 10, bottom: 10, font: { fontSize: 12 }, textAlign: Titanium.UI.TEXT_ALIGNMENT_RIGHT, text: "Choose Claim Under", id: "claim_under" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId239" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId242" });
  ...
  { height: Ti.UI.SIZE, textAlign: Titanium.UI.TEXT_ALIGNMENT_RIGHT, skip_checking: 1, width: "auto", id: "__alloyId244" });

  $.__views.__alloyId242.add($.__views.__alloyId244);
  $.__views.dateVisit = Ti.UI.createLabel(
  { width: Ti.UI.FILL, height: Titanium.UI.SIZE, color: "#C8C8CD", top: 12, left: 10, right: 10, bottom: 10, font: { fontSize: 12 }, textAlign: Titanium.UI.TEXT_ALIGNMENT_RIGHT, text: "Date of visit a clinic", id: "dateVisit" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId246" });

  $.__views.tvrClinicVisit.add($.__views.__alloyId246);
  $.__views.__alloyId247 = Ti.UI.createLabel(
  { width: "40%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Clinic/Hospital Name", top: 12, id: "__alloyId247" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, id: "view_remark", height: 85, textAlign: "right" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId251" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId254" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId257" });
  ...
  { verticalAlign: Titanium.UI.TEXT_VERTICAL_ALIGNMENT_CENTER, height: "45dp", font: { fontSize: 12 }, color: "#222222", borderWidth: "1px", borderStyle: Titanium.UI.INPUT_BORDERSTYLE_ROUNDED, width: Ti.UI.FILL, backgroundColor: "#ffffff", borderColor: "#ffffff", id: "diagnosis", bottom: 5, right: 5, textAlign: "right", hintText: "Diagnosis" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId260" });
