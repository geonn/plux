...
function Controller() {
    ...
    $.__views.main.add($.__views.__alloyId406);
    ...
    $.__views.tvrReceiptNo.add($.__views.__alloyId407);
    ...
    $.__views.__alloyId407.add($.__views.receipt_no);
    ...
    $.__views.tvrCategory.add($.__views.__alloyId410);
    ...
    $.__views.__alloyId412.add($.__views.category);
    ...
    $.__views.tvrClaimUnder.add($.__views.__alloyId414);
    ...
    $.__views.__alloyId416.add($.__views.claim_under);
    ...
    $.__views.tvrReceiptAmount.add($.__views.__alloyId418);
    ...
    $.__views.__alloyId418.add($.__views.receiptAmount);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId421);
    ...
    $.__views.__alloyId423.add($.__views.dateVisit);
    ...
    $.__views.tvrClinicVisit.add($.__views.__alloyId425);
    ...
    $.__views.__alloyId427.add($.__views.clinicName);
    ...
    $.__views.tvrRemark.add($.__views.__alloyId429);
    ...
    $.__views.__alloyId429.add($.__views.remark);
    ...
    $.__views.tvrGstAmount.add($.__views.__alloyId432);
    ...
    $.__views.__alloyId434.add($.__views.gstAmount);
    ...
    $.__views.tvrMc.add($.__views.__alloyId436);
    ...
    $.__views.__alloyId436.add($.__views.mc);
    ...
    $.__views.tvrDiagnosis.add($.__views.__alloyId439);
    ...
    $.__views.__alloyId439.add($.__views.diagnosis);
    ...
    $.__views.tvrGlAmount.add($.__views.__alloyId442);
    ...
    $.__views.__alloyId442.add($.__views.glamount);
    ...
    $.__views.__alloyId445.add($.__views.saveBtn);
