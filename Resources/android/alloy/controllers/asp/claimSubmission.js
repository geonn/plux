...
function Controller() {
    ...
    $.__views.tvrReceiptNo.add($.__views.__alloyId442);
    ...
    $.__views.__alloyId442.add($.__views.receipt_no);
    ...
    $.__views.tvrCategory.add($.__views.__alloyId445);
    ...
    $.__views.__alloyId447.add($.__views.category);
    ...
    $.__views.tvrClaimUnder.add($.__views.__alloyId449);
    ...
    $.__views.__alloyId451.add($.__views.claim_under);
    ...
    $.__views.tvrReceiptAmount.add($.__views.__alloyId453);
    ...
    $.__views.__alloyId453.add($.__views.receiptAmount);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId456);
    ...
    $.__views.__alloyId458.add($.__views.dateVisit);
    ...
    $.__views.tvrClinicVisit.add($.__views.__alloyId460);
    ...
    $.__views.__alloyId462.add($.__views.clinicName);
    ...
    $.__views.tvrRemark.add($.__views.__alloyId464);
    ...
    $.__views.__alloyId464.add($.__views.remark);
    ...
    $.__views.tvrGstAmount.add($.__views.__alloyId467);
    ...
    $.__views.__alloyId469.add($.__views.gstAmount);
    ...
    $.__views.tvrMc.add($.__views.__alloyId471);
    ...
    $.__views.__alloyId471.add($.__views.mc);
    ...
    $.__views.tvrDiagnosis.add($.__views.__alloyId474);
    ...
    $.__views.__alloyId474.add($.__views.diagnosis);
    ...
    $.__views.tvrGlAmount.add($.__views.__alloyId477);
    ...
    $.__views.__alloyId477.add($.__views.glamount);
    ...
    $.__views.__alloyId480.add($.__views.saveBtn);
