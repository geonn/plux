...
function Controller() {
  ...
  if (true) {
    ...
    { layout: "horizontal", height: 50, width: Ti.UI.FILL, backgroundColor: "#DEDEDE", id: "__alloyId225" });

    $.__views.main.add($.__views.__alloyId225);
    $.__views.__alloyId226 = Ti.UI.createView(
    { left: 0, width: "10%", id: "__alloyId226" });
  ...
  { width: Ti.UI.FILL, height: Titanium.UI.SIZE, color: "#606060", top: 10, left: 10, right: 10, bottom: 10, font: { fontSize: 14 }, text: "Please fill in below info to claim from ASP", id: "__alloyId228" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId229" });

  $.__views.tvrReceiptNo.add($.__views.__alloyId229);
  $.__views.__alloyId230 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Receipt Number", top: 12, id: "__alloyId230" });
  ...
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId231" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId232" });

  $.__views.tvrCategory.add($.__views.__alloyId232);
  $.__views.__alloyId233 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Category", top: 12, id: "__alloyId233" });

  $.__views.__alloyId232.add($.__views.__alloyId233);
  $.__views.__alloyId234 = Ti.UI.createView(
  { height: Ti.UI.SIZE, textAlign: Titanium.UI.TEXT_ALIGNMENT_RIGHT, skip_checking: 1, width: "auto", id: "__alloyId234" });
  ...
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId235" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId236" });

  $.__views.tvrClaimUnder.add($.__views.__alloyId236);
  $.__views.__alloyId237 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Claim Under", top: 12, id: "__alloyId237" });

  $.__views.__alloyId236.add($.__views.__alloyId237);
  $.__views.__alloyId238 = Ti.UI.createView(
  { height: Ti.UI.SIZE, textAlign: Titanium.UI.TEXT_ALIGNMENT_RIGHT, skip_checking: 1, width: "auto", id: "__alloyId238" });
  ...
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId239" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId240" });

  $.__views.tvrReceiptAmount.add($.__views.__alloyId240);
  $.__views.__alloyId241 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Receipt Amount", top: 12, id: "__alloyId241" });
  ...
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId242" });
  ...
  showVisitPicker ? $.addListener($.__views.tvrDateVisit, 'click', showVisitPicker) : __defers['$.__views.tvrDateVisit!click!showVisitPicker'] = true;$.__views.__alloyId243 = Ti.UI.createView(
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId243" });

  $.__views.tvrDateVisit.add($.__views.__alloyId243);
  $.__views.__alloyId244 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Date of Visit", top: 12, id: "__alloyId244" });

  $.__views.__alloyId243.add($.__views.__alloyId244);
  $.__views.__alloyId245 = Ti.UI.createView(
  { height: Ti.UI.SIZE, textAlign: Titanium.UI.TEXT_ALIGNMENT_RIGHT, skip_checking: 1, width: "auto", id: "__alloyId245" });
  ...
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId246" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId247" });

  $.__views.tvrClinicVisit.add($.__views.__alloyId247);
  $.__views.__alloyId248 = Ti.UI.createLabel(
  { width: "40%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Clinic/Hospital Name", top: 12, id: "__alloyId248" });
  ...
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId249" });
  ...
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Remark", top: 12, id: "__alloyId250" });
  ...
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId251" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId252" });

  $.__views.tvrGstAmount.add($.__views.__alloyId252);
  $.__views.__alloyId253 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "GST Amount", top: 12, id: "__alloyId253" });
  ...
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId254" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId255" });

  $.__views.tvrMc.add($.__views.__alloyId255);
  $.__views.__alloyId256 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "MC Issued", top: 12, id: "__alloyId256" });
  ...
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId257" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId258" });

  $.__views.tvrDiagnosis.add($.__views.__alloyId258);
  $.__views.__alloyId259 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "Diagnosis", top: 12, id: "__alloyId259" });
  ...
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId260" });
  ...
  { layout: "horizontal", width: Ti.UI.FILL, height: 45, textAlign: "right", id: "__alloyId261" });

  $.__views.tvrGlAmount.add($.__views.__alloyId261);
  $.__views.__alloyId262 = Ti.UI.createLabel(
  { width: "35%", height: Titanium.UI.SIZE, color: "#CE1D1C", font: { fontSize: 14 }, left: 10, text: "GL Amount", top: 12, id: "__alloyId262" });
  ...
  { backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId263" });

  $.__views.tvrGlAmount.add($.__views.__alloyId263);
  $.__views.__alloyId264 = Ti.UI.createView(
  { width: Ti.UI.FILL, height: Ti.UI.SIZE, top: 10, id: "__alloyId264" });
