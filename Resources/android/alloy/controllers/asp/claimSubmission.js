...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId449);
    ...
    $.__views.__alloyId451.add($.__views.btnBack);
    ...
    $.__views.main.add($.__views.__alloyId453);
    ...
    $.__views.tvrReceiptNo.add($.__views.__alloyId454);
    ...
    $.__views.__alloyId454.add($.__views.receipt_no);
    ...
    $.__views.tvrCategory.add($.__views.__alloyId457);
    ...
    $.__views.__alloyId459.add($.__views.category);
    ...
    $.__views.tvrClaimUnder.add($.__views.__alloyId461);
    ...
    $.__views.__alloyId463.add($.__views.claim_under);
    ...
    $.__views.tvrReceiptAmount.add($.__views.__alloyId465);
    ...
    $.__views.__alloyId465.add($.__views.receiptAmount);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId468);
    ...
    $.__views.__alloyId470.add($.__views.dateVisit);
    ...
    $.__views.tvrClinicVisit.add($.__views.__alloyId472);
    ...
    $.__views.__alloyId474.add($.__views.clinicName);
    ...
    $.__views.tvrRemark.add($.__views.__alloyId476);
    ...
    $.__views.__alloyId476.add($.__views.remark);
    ...
    $.__views.tvrGstAmount.add($.__views.__alloyId479);
    ...
    $.__views.__alloyId481.add($.__views.gstAmount);
    ...
    $.__views.tvrMc.add($.__views.__alloyId483);
    ...
    $.__views.__alloyId483.add($.__views.mc);
    ...
    $.__views.tvrDiagnosis.add($.__views.__alloyId486);
    ...
    $.__views.__alloyId486.add($.__views.diagnosis);
    ...
    $.__views.tvrGlAmount.add($.__views.__alloyId489);
    ...
    $.__views.__alloyId489.add($.__views.glamount);
    ...
    $.__views.__alloyId492.add($.__views.saveBtn);
