...
function Controller() {
    ...
    $.__views.__alloyId420.add($.__views.btnBack);
    ...
    $.__views.tvrReceiptNo.add($.__views.__alloyId423);
    ...
    $.__views.__alloyId423.add($.__views.receipt_no);
    ...
    $.__views.tvrCategory.add($.__views.__alloyId426);
    ...
    $.__views.__alloyId428.add($.__views.category);
    ...
    $.__views.tvrClaimUnder.add($.__views.__alloyId430);
    ...
    $.__views.__alloyId432.add($.__views.claim_under);
    ...
    $.__views.tvrReceiptAmount.add($.__views.__alloyId434);
    ...
    $.__views.__alloyId434.add($.__views.receiptAmount);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId437);
    ...
    $.__views.__alloyId439.add($.__views.dateVisit);
    ...
    $.__views.tvrClinicVisit.add($.__views.__alloyId441);
    ...
    $.__views.__alloyId443.add($.__views.clinicName);
    ...
    $.__views.tvrRemark.add($.__views.__alloyId445);
    ...
    $.__views.__alloyId445.add($.__views.remark);
    ...
    $.__views.tvrGstAmount.add($.__views.__alloyId448);
    ...
    $.__views.__alloyId450.add($.__views.gstAmount);
    ...
    $.__views.tvrMc.add($.__views.__alloyId452);
    ...
    $.__views.__alloyId452.add($.__views.mc);
    ...
    $.__views.tvrDiagnosis.add($.__views.__alloyId455);
    ...
    $.__views.__alloyId455.add($.__views.diagnosis);
    ...
    $.__views.tvrGlAmount.add($.__views.__alloyId458);
    ...
    $.__views.__alloyId458.add($.__views.glamount);
    ...
    $.__views.__alloyId461.add($.__views.saveBtn);
