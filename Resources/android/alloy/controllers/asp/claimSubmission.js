...
function Controller() {
    ...
    $.__views.tvrReceiptNo.add($.__views.__alloyId404);
    ...
    $.__views.__alloyId404.add($.__views.receipt_no);
    ...
    $.__views.tvrCategory.add($.__views.__alloyId407);
    ...
    $.__views.__alloyId409.add($.__views.category);
    ...
    $.__views.tvrClaimUnder.add($.__views.__alloyId411);
    ...
    $.__views.__alloyId413.add($.__views.claim_under);
    ...
    $.__views.tvrReceiptAmount.add($.__views.__alloyId415);
    ...
    $.__views.__alloyId415.add($.__views.receiptAmount);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId418);
    ...
    $.__views.__alloyId420.add($.__views.dateVisit);
    ...
    $.__views.tvrClinicVisit.add($.__views.__alloyId422);
    ...
    $.__views.__alloyId424.add($.__views.clinicName);
    ...
    $.__views.tvrRemark.add($.__views.__alloyId426);
    ...
    $.__views.__alloyId426.add($.__views.remark);
    ...
    $.__views.tvrGstAmount.add($.__views.__alloyId429);
    ...
    $.__views.__alloyId431.add($.__views.gstAmount);
    ...
    $.__views.tvrMc.add($.__views.__alloyId433);
    ...
    $.__views.__alloyId433.add($.__views.mc);
    ...
    $.__views.tvrDiagnosis.add($.__views.__alloyId436);
    ...
    $.__views.__alloyId436.add($.__views.diagnosis);
    ...
    $.__views.tvrGlAmount.add($.__views.__alloyId439);
    ...
    $.__views.__alloyId439.add($.__views.glamount);
    ...
    $.__views.__alloyId442.add($.__views.saveBtn);
