...
function Controller() {
    ...
    $.__views.__alloyId230.add($.__views.btnBack);
    ...
    $.__views.tvrReceiptNo.add($.__views.__alloyId233);
    ...
    $.__views.__alloyId233.add($.__views.receipt_no);
    ...
    $.__views.table.add($.__views.__alloyId235);
    ...
    $.__views.tvrCategory.add($.__views.__alloyId236);
    ...
    $.__views.__alloyId238.add($.__views.category);
    ...
    $.__views.tvrClaimUnder.add($.__views.__alloyId240);
    ...
    $.__views.__alloyId242.add($.__views.claim_under);
    ...
    $.__views.tvrReceiptAmount.add($.__views.__alloyId244);
    ...
    $.__views.__alloyId244.add($.__views.receiptAmount);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId247);
    ...
    $.__views.__alloyId249.add($.__views.dateVisit);
    ...
    $.__views.tvrClinicVisit.add($.__views.__alloyId251);
    ...
    $.__views.__alloyId253.add($.__views.clinicName);
    ...
    $.__views.tvrRemark.add($.__views.__alloyId255);
    ...
    $.__views.__alloyId255.add($.__views.remark);
    ...
    $.__views.tvrGstAmount.add($.__views.__alloyId258);
    ...
    $.__views.__alloyId260.add($.__views.gstAmount);
    ...
    $.__views.table.add($.__views.__alloyId261);
    ...
    $.__views.tvrMc.add($.__views.__alloyId262);
    ...
    $.__views.__alloyId262.add($.__views.mc);
    ...
    $.__views.tvrDiagnosis.add($.__views.__alloyId265);
    ...
    $.__views.__alloyId265.add($.__views.diagnosis);
    ...
    $.__views.tvrGlAmount.add($.__views.__alloyId268);
    ...
    $.__views.__alloyId268.add($.__views.glamount);
    ...
    $.__views.__alloyId271.add($.__views.saveBtn);
