...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId434);
    ...
    $.__views.tvrReceiptNo.add($.__views.__alloyId439);
    ...
    $.__views.__alloyId439.add($.__views.receipt_no);
    ...
    $.__views.tvrCategory.add($.__views.__alloyId442);
    ...
    $.__views.__alloyId444.add($.__views.category);
    ...
    $.__views.tvrClaimUnder.add($.__views.__alloyId446);
    ...
    $.__views.__alloyId448.add($.__views.claim_under);
    ...
    $.__views.tvrReceiptAmount.add($.__views.__alloyId450);
    ...
    $.__views.__alloyId450.add($.__views.receiptAmount);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId453);
    ...
    $.__views.__alloyId455.add($.__views.dateVisit);
    ...
    $.__views.tvrClinicVisit.add($.__views.__alloyId457);
    ...
    $.__views.__alloyId459.add($.__views.clinicName);
    ...
    $.__views.tvrRemark.add($.__views.__alloyId461);
    ...
    $.__views.__alloyId461.add($.__views.remark);
    ...
    $.__views.tvrGstAmount.add($.__views.__alloyId464);
    ...
    $.__views.__alloyId466.add($.__views.gstAmount);
    ...
    $.__views.tvrMc.add($.__views.__alloyId468);
    ...
    $.__views.__alloyId468.add($.__views.mc);
    ...
    $.__views.tvrDiagnosis.add($.__views.__alloyId471);
    ...
    $.__views.__alloyId471.add($.__views.diagnosis);
    ...
    $.__views.tvrGlAmount.add($.__views.__alloyId474);
    ...
    $.__views.__alloyId474.add($.__views.glamount);
    ...
    $.__views.__alloyId477.add($.__views.saveBtn);
