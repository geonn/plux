...
function Controller() {
    ...
    $.__views.eCardWin.add($.__views.__alloyId173);
    ...
    $.__views.__alloyId175.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: Ti.UI.FILL
    });
    $.__views.__alloyId174.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId176);
    $.__views.mainContainer = Ti.UI.createView({
        id: "mainContainer",
        height: Ti.UI.SIZE,
        width: Ti.UI.FILL
    });
    $.__views.__alloyId173.add($.__views.mainContainer);
    ...
    $.__views.unverified.add($.__views.__alloyId178);
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId179, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId179!touchend!resendVerificationEmail"] = true;
    ...
    checkStatus ? $.addListener($.__views.__alloyId180, "touchend", checkStatus) : __defers["$.__views.__alloyId180!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId179!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId179, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId180!touchend!checkStatus"] && $.addListener($.__views.__alloyId180, "touchend", checkStatus);
    _.extend($, exports);
}
