...
function Controller() {
    ...
    $.__views.unverified.add($.__views.__alloyId357);
    $.__views.__alloyId358 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    resendVerificationEmail ? $.addListener($.__views.__alloyId358, "touchend", resendVerificationEmail) : __defers["$.__views.__alloyId358!touchend!resendVerificationEmail"] = true;
    $.__views.__alloyId359 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    checkStatus ? $.addListener($.__views.__alloyId359, "touchend", checkStatus) : __defers["$.__views.__alloyId359!touchend!checkStatus"] = true;
    ...
    __defers["$.__views.__alloyId358!touchend!resendVerificationEmail"] && $.addListener($.__views.__alloyId358, "touchend", resendVerificationEmail);
    __defers["$.__views.__alloyId359!touchend!checkStatus"] && $.addListener($.__views.__alloyId359, "touchend", checkStatus);
    _.extend($, exports);
}
