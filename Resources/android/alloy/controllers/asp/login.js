...
function Controller() {
		...
		$.__views.aspLoginWin = Ti.UI.createWindow({ backgroundColor: "#ffffff", orientationModes: [Ti.UI.PORTRAIT], fullscreen: false, windowSoftInputMode: Ti.UI.Android.SOFT_INPUT_STATE_HIDDEN, navTintColor: "#CE1D1C", title: "Login", id: "aspLoginWin", layout: "vertical" });
		$.__views.aspLoginWin && $.addTopLevelView($.__views.aspLoginWin);
		$.__views.__alloyId275 = Ti.UI.createView({ id: "__alloyId275" });
		$.__views.aspLoginWin.add($.__views.__alloyId275);
		...
		$.__views.__alloyId276 = Ti.UI.createLabel({ width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#ffffff", top: 5, bottom: 10, text: "Loading", id: "__alloyId276" });
		$.__views.loadingBar.add($.__views.__alloyId276);
		$.__views.__alloyId277 = Ti.UI.createView({ layout: "vertical", id: "__alloyId277" });
		$.__views.__alloyId275.add($.__views.__alloyId277);
		if (true) {
				$.__views.__alloyId278 = Ti.UI.createView({ layout: "horizontal", height: 50, width: "100%", backgroundColor: "#DEDEDE", id: "__alloyId278" });
				$.__views.__alloyId277.add($.__views.__alloyId278);
				$.__views.__alloyId279 = Ti.UI.createView({ left: 0, width: "10%", id: "__alloyId279" });
				...
				$.__views.__alloyId279.add($.__views.btnBack);
				$.__views.pageTitle = Ti.UI.createView({ id: "pageTitle", width: Ti.UI.FILL });
				$.__views.__alloyId278.add($.__views.pageTitle);
				$.__views.__alloyId280 = Ti.UI.createLabel({ width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'ASP Login', textAlign: "center", id: "__alloyId280" });
				$.__views.pageTitle.add($.__views.__alloyId280);
		}
		$.__views.main = Ti.UI.createScrollView({ id: "main", layout: "vertical", height: "100%", contentHeight: Ti.UI.SIZE });
		$.__views.__alloyId277.add($.__views.main);
		$.__views.__alloyId281 = Ti.UI.createImageView({ width: 120, borderRadius: 10, height: 120, backgroundColor: "#ff0000", bottom: "50dp", top: "50dp", image: "/images/asp_logo.png", id: "__alloyId281" });
		$.__views.main.add($.__views.__alloyId281);
		$.__views.username = Ti.UI.createTextField({ verticalAlign: Titanium.UI.TEXT_VERTICAL_ALIGNMENT_CENTER, height: "50dp", font: { fontSize: "14dp" }, color: "#000000", borderWidth: "1px", borderStyle: Titanium.UI.INPUT_BORDERSTYLE_ROUNDED, width: "90%", backgroundColor: "#fff", borderColor: "#cccccc", paddingLeft: "20dp", paddingRight: "20dp", bottom: "5dp", keyboardType: Titanium.UI.KEYBOARD_DEFAULT, returnKeyType: Titanium.UI.RETURNKEY_NEXT, id: "username", hintText: "Enter Username", value: "" });
		...
		doLogin ? $.addListener($.__views.loginAccountButton, 'touchend', doLogin) : __defers['$.__views.loginAccountButton!touchend!doLogin'] = true;$.__views.registerAccountButton = Ti.UI.createButton({ id: "registerAccountButton", borderRadius: 5, backgroundColor: "#7B7B7B", title: "Register for ASP", width: "70%", top: 5, height: 40, color: "#ffffff" });
