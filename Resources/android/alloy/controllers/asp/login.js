...
function Controller() {
    ...
    $.__views.aspLoginWin.add($.__views.__alloyId455);
    ...
    $.__views.__alloyId455.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId456);
    ...
    $.__views.__alloyId457.add($.__views.main);
    $.__views.__alloyId461 = Ti.UI.createImageView({
        width: 120,
        borderRadius: 10,
        height: 120,
