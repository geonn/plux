...
function Controller() {
    ...
    $.__views.btnBack.add($.__views.__alloyId541);
    ...
    $.__views.__alloyId542.add($.__views.titleLbl);
    $.__views.__alloyId543 = Ti.UI.createView({
        id: "__alloyId543"
    });
    $.__views.aspSignUpWin.add($.__views.__alloyId543);
    ...
    $.__views.__alloyId543.add($.__views.loadingBar);
    ...
    $.__views.__alloyId544.add($.__views.main);
