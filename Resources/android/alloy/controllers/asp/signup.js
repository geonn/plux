...
function Controller() {
    ...
    $.__views.btnBack.add($.__views.__alloyId502);
    ...
    $.__views.__alloyId503.add($.__views.titleLbl);
    $.__views.__alloyId504 = Ti.UI.createView({
        id: "__alloyId504"
    });
    $.__views.aspSignUpWin.add($.__views.__alloyId504);
    ...
    $.__views.__alloyId505.add($.__views.main);
