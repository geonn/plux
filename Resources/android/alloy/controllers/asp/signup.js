...
function Controller() {
    ...
    $.__views.btnBack.add($.__views.__alloyId572);
    ...
    $.__views.__alloyId573.add($.__views.titleLbl);
    $.__views.__alloyId574 = Ti.UI.createView({
        id: "__alloyId574"
    });
    $.__views.aspSignUpWin.add($.__views.__alloyId574);
    ...
    $.__views.__alloyId574.add($.__views.loadingBar);
