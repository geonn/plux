...
function Controller() {
    ...
    $.__views.aspSignUpWin.add($.__views.__alloyId247);
    ...
    $.__views.__alloyId251.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: Ti.UI.FILL
    });
    $.__views.__alloyId250.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId252);
