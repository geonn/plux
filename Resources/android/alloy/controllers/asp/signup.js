...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId323);
    ...
    $.__views.__alloyId326.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: Ti.UI.FILL
    });
    $.__views.__alloyId325.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId327);
