...
function Controller() {
    ...
    $.__views.aspSignUpWin.add($.__views.__alloyId407);
    ...
    $.__views.__alloyId407.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId408);
    ...
    $.__views.__alloyId410.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId412);
    ...
    $.__views.__alloyId409.add($.__views.main);
    $.__views.__alloyId413 = Ti.UI.createImageView({
        width: "120",
        borderRadius: "10",
        height: "120",
