...
function Controller() {
    ...
    $.__views.aspSignUpWin.add($.__views.__alloyId252);
    ...
    $.__views.__alloyId252.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId253);
    ...
    $.__views.__alloyId256.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: Ti.UI.FILL
    });
    $.__views.__alloyId255.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId257);
    ...
    $.__views.__alloyId254.add($.__views.main);
