...
function Controller() {
    ...
    $.__views.changePasswordWin.add($.__views.__alloyId296);
    ...
    submitPassword ? $.addListener($.__views.__alloyId301, "touchend", submitPassword) : __defers["$.__views.__alloyId301!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId301!touchend!submitPassword"] && $.addListener($.__views.__alloyId301, "touchend", submitPassword);
    _.extend($, exports);
}
