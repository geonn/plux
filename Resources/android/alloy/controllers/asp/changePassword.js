...
function Controller() {
    ...
    $.__views.changePasswordWin.add($.__views.__alloyId389);
    ...
    submitPassword ? $.addListener($.__views.__alloyId394, "touchend", submitPassword) : __defers["$.__views.__alloyId394!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId394!touchend!submitPassword"] && $.addListener($.__views.__alloyId394, "touchend", submitPassword);
    _.extend($, exports);
}
