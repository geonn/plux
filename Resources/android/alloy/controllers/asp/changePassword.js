...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId387);
    $.__views.__alloyId388 = Ti.UI.createView({
        layout: "vertical",
        height: "100%",
        id: "__alloyId388"
    });
    $.__views.changePasswordWin.add($.__views.__alloyId388);
    ...
    submitPassword ? $.addListener($.__views.__alloyId393, "touchend", submitPassword) : __defers["$.__views.__alloyId393!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId393!touchend!submitPassword"] && $.addListener($.__views.__alloyId393, "touchend", submitPassword);
    _.extend($, exports);
}
