...
function Controller() {
    ...
    $.__views.changePasswordWin.add($.__views.__alloyId295);
    ...
    $.__views.__alloyId300 = Ti.UI.createButton({
        borderRadius: "5",
    ...
    submitPassword ? $.addListener($.__views.__alloyId300, "touchend", submitPassword) : __defers["$.__views.__alloyId300!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId300!touchend!submitPassword"] && $.addListener($.__views.__alloyId300, "touchend", submitPassword);
    _.extend($, exports);
}
