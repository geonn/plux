...
function Controller() {
    ...
    $.__views.changePasswordWin.add($.__views.__alloyId215);
    ...
    submitPassword ? $.addListener($.__views.__alloyId220, "touchend", submitPassword) : __defers["$.__views.__alloyId220!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId220!touchend!submitPassword"] && $.addListener($.__views.__alloyId220, "touchend", submitPassword);
    _.extend($, exports);
}
