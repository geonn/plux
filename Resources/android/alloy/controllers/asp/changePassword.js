...
function Controller() {
  ...
  { backgroundColor: "#535a74", orientationModes: [Ti.UI.PORTRAIT], fullscreen: false, windowSoftInputMode: Ti.UI.Android.SOFT_INPUT_STATE_HIDDEN, width: Ti.UI.FILL, height: Ti.UI.FILL, navTintColor: "#CE1D1C", title: "Change Password", id: "win" });

  $.__views["win"] && $.addTopLevelView($.__views["win"]);
  $.__views["__alloyId170"] = Ti.UI.createView(
  { borderWidth: 0, layout: "vertical", width: Ti.UI.FILL, height: Ti.UI.FILL, id: "__alloyId170" });

  $.__views["win"].add($.__views["__alloyId170"]);
  if (true) {
    $.__views["__alloyId171"] = Ti.UI.createView(
    { borderWidth: 0, layout: "horizontal", height: 50, width: "100%", backgroundColor: "#DEDEDE", id: "__alloyId171" });

    $.__views["__alloyId170"].add($.__views["__alloyId171"]);
    $.__views["__alloyId172"] = Ti.UI.createView(
    { borderWidth: 0, left: 0, width: "20%", id: "__alloyId172" });
    ...
    { width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#111111", font: { fontFamily: "Roboto-Regular, arial", fontSize: "16dp" }, text: 'Change Password', textAlign: "center", id: "__alloyId173" });
  ...
  { width: 120, borderRadius: 10, height: 120, backgroundColor: "#ff0000", bottom: "30dp", top: "30dp", image: "/images/asp_logo.png", id: "__alloyId174" });
  ...
  { borderRadius: 5, backgroundColor: "#7B7B7B", height: 40, color: "#ffffff", width: "70%", title: "Change Password", top: 10, id: "__alloyId175" });

  $.__views["main"].add($.__views["__alloyId175"]);
  submitPassword ? $.addListener($.__views["__alloyId175"], 'touchend', submitPassword) : __defers['$.__views["__alloyId175"]!touchend!submitPassword'] = true;exports.destroy = function () {};
  ...
  // is executed.
  __defers['$.__views["__alloyId175"]!touchend!submitPassword'] && $.addListener($.__views["__alloyId175"], 'touchend', submitPassword);
