...
function Controller() {
    ...
    $.__views.changePasswordWin.add($.__views.__alloyId110);
    ...
    $.__views.__alloyId112.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId111.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId113);
    ...
    submitPassword ? $.__views.__alloyId115.addEventListener("touchend", submitPassword) : __defers["$.__views.__alloyId115!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId115!touchend!submitPassword"] && $.__views.__alloyId115.addEventListener("touchend", submitPassword);
    _.extend($, exports);
}
