...
function Controller() {
    ...
    $.__views.changePasswordWin.add($.__views.__alloyId193);
    ...
    submitPassword ? $.addListener($.__views.__alloyId198, "touchend", submitPassword) : __defers["$.__views.__alloyId198!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId198!touchend!submitPassword"] && $.addListener($.__views.__alloyId198, "touchend", submitPassword);
    _.extend($, exports);
}
