...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId404);
    $.__views.__alloyId405 = Ti.UI.createView({
        layout: "vertical",
        height: "100%",
        id: "__alloyId405"
    });
    $.__views.changePasswordWin.add($.__views.__alloyId405);
    ...
    $.__views.__alloyId407.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId406.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId408);
    ...
    $.__views.__alloyId405.add($.__views.main);
    $.__views.__alloyId409 = Ti.UI.createImageView({
        width: 120,
        borderRadius: 10,
        height: 120,
    ...
    $.__views.main.add($.__views.__alloyId409);
    ...
    $.__views.__alloyId410 = Ti.UI.createButton({
        borderRadius: 5,
    ...
    $.__views.main.add($.__views.__alloyId410);
    submitPassword ? $.addListener($.__views.__alloyId410, "touchend", submitPassword) : __defers["$.__views.__alloyId410!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId410!touchend!submitPassword"] && $.addListener($.__views.__alloyId410, "touchend", submitPassword);
    _.extend($, exports);
}
