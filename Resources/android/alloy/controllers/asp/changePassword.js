...
function Controller() {
    ...
    $.__views.loadingBar.add($.__views.__alloyId420);
    $.__views.__alloyId421 = Ti.UI.createView({
        layout: "vertical",
        height: "100%",
        id: "__alloyId421"
    });
    $.__views.changePasswordWin.add($.__views.__alloyId421);
    ...
    $.__views.__alloyId421.add($.__views.main);
    ...
    submitPassword ? $.addListener($.__views.__alloyId426, "touchend", submitPassword) : __defers["$.__views.__alloyId426!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId426!touchend!submitPassword"] && $.addListener($.__views.__alloyId426, "touchend", submitPassword);
    _.extend($, exports);
}
