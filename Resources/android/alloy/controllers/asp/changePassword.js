...
function Controller() {
    ...
    $.__views.changePasswordWin.add($.__views.__alloyId85);
    ...
    $.__views.__alloyId85.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId86);
    ...
    $.__views.__alloyId85.add($.__views.main);
    ...
    submitPassword ? $.__views.__alloyId88.addEventListener("touchend", submitPassword) : __defers["$.__views.__alloyId88!touchend!submitPassword"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    arguments[0] || {};
    var loginId = Ti.App.Properties.getString("asp_email");
    $.description.text = "You are about to change password for " + loginId;
    __defers["$.__views.__alloyId88!touchend!submitPassword"] && $.__views.__alloyId88.addEventListener("touchend", submitPassword);
    _.extend($, exports);
}
