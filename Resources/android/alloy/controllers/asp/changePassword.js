...
function Controller() {
    ...
    $.__views.changePasswordWin.add($.__views.__alloyId216);
    ...
    submitPassword ? $.addListener($.__views.__alloyId221, "touchend", submitPassword) : __defers["$.__views.__alloyId221!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId221!touchend!submitPassword"] && $.addListener($.__views.__alloyId221, "touchend", submitPassword);
    _.extend($, exports);
}
