...
function Controller() {
    ...
    $.__views.changePasswordWin.add($.__views.__alloyId436);
    ...
    $.__views.__alloyId441 = Ti.UI.createButton({
        borderRadius: 5,
    ...
    submitPassword ? $.addListener($.__views.__alloyId441, "touchend", submitPassword) : __defers["$.__views.__alloyId441!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId441!touchend!submitPassword"] && $.addListener($.__views.__alloyId441, "touchend", submitPassword);
    _.extend($, exports);
}
