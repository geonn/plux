...
function Controller() {
    ...
    $.__views.changePasswordWin.add($.__views.__alloyId293);
    ...
    $.__views.__alloyId295.add($.__views.btnBack);
    $.__views.pageTitle = Ti.UI.createView({
        id: "pageTitle",
        width: "60%"
    });
    $.__views.__alloyId294.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId296);
    ...
    submitPassword ? $.addListener($.__views.__alloyId298, "touchend", submitPassword) : __defers["$.__views.__alloyId298!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId298!touchend!submitPassword"] && $.addListener($.__views.__alloyId298, "touchend", submitPassword);
    _.extend($, exports);
}
