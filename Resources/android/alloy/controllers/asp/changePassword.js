...
function Controller() {
    ...
    $.__views.changePasswordWin.add($.__views.__alloyId164);
    ...
    $.__views.pageTitle.add($.__views.__alloyId167);
    ...
    submitPassword ? $.__views.__alloyId169.addEventListener("touchend", submitPassword) : __defers["$.__views.__alloyId169!touchend!submitPassword"] = true;
    ...
    __defers["$.__views.__alloyId169!touchend!submitPassword"] && $.__views.__alloyId169.addEventListener("touchend", submitPassword);
    _.extend($, exports);
}
