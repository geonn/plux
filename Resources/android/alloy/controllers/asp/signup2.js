...
<<<<<<< HEAD
    ...
    $.__views.aspSignUpWin.add($.__views.__alloyId575);
=======
...
<<<<<<< HEAD
    ...
    $.__views.btnBack.add($.__views.__alloyId576);
...
=======
    ...
    $.__views.btnBack.add($.__views.__alloyId574);
    $.__views.__alloyId575 = Ti.UI.createView({
        id: "__alloyId575"
    });
...
<<<<<<< HEAD
    $.__views.__alloyId577.add($.__views.titleLbl);
    $.__views.__alloyId578 = Ti.UI.createView({
        id: "__alloyId578"
    });
    $.__views.aspSignUpWin.add($.__views.__alloyId578);
=======
    $.__views.__alloyId575.add($.__views.titleLbl);
    $.__views.__alloyId576 = Ti.UI.createView({
        id: "__alloyId576"
    });
    $.__views.aspSignUpWin.add($.__views.__alloyId576);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId578.add($.__views.loadingBar);
=======
    $.__views.__alloyId576.add($.__views.loadingBar);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId579.add($.__views.main);
    $.__views.__alloyId580 = Ti.UI.createImageView({
=======
    $.__views.__alloyId577.add($.__views.main);
