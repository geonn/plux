...
function Controller() {
    ...
    $.__views.aspSignUpWin.add($.__views.__alloyId545);
    ...
    $.__views.__alloyId545.add($.__views.btnBack);
    ...
    $.__views.btnBack.add($.__views.__alloyId546);
    ...
    $.__views.__alloyId547.add($.__views.titleLbl);
    $.__views.__alloyId548 = Ti.UI.createView({
        id: "__alloyId548"
    });
    $.__views.aspSignUpWin.add($.__views.__alloyId548);
    ...
    $.__views.__alloyId548.add($.__views.loadingBar);
    ...
    $.__views.__alloyId549.add($.__views.main);
