...
<<<<<<< HEAD
    ...
    $.__views.aspSignUpWin.add($.__views.__alloyId535);
=======
    ...
    $.__views.aspSignUpWin.add($.__views.__alloyId523);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.btnBack.add($.__views.__alloyId536);
...
=======
    ...
    $.__views.btnBack.add($.__views.__alloyId524);
...
<<<<<<< HEAD
    $.__views.__alloyId537.add($.__views.titleLbl);
    $.__views.__alloyId538 = Ti.UI.createView({
        id: "__alloyId538"
    });
    $.__views.aspSignUpWin.add($.__views.__alloyId538);
=======
    $.__views.__alloyId525.add($.__views.titleLbl);
    $.__views.__alloyId526 = Ti.UI.createView({
        id: "__alloyId526"
    });
    $.__views.aspSignUpWin.add($.__views.__alloyId526);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId538.add($.__views.loadingBar);
=======
    $.__views.__alloyId526.add($.__views.loadingBar);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId539.add($.__views.main);
    $.__views.__alloyId540 = Ti.UI.createImageView({
=======
    $.__views.__alloyId527.add($.__views.main);
