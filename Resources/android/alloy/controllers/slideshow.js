...
function Controller() {
    function __alloyId265() {
        $.__views.win.removeEventListener("open", __alloyId265);
    ...
    $.__views.win.addEventListener("open", __alloyId265);
    ...
    $.__views.win.add($.__views.__alloyId266);
    ...
    $.__views.win.add($.__views.__alloyId267);
    var __alloyId268 = [];
    ...
    __alloyId268.push($.__views.__alloyId269);
    ...
    __alloyId268.push($.__views.__alloyId274);
    ...
    __alloyId268.push($.__views.__alloyId279);
    ...
    __alloyId268.push($.__views.__alloyId284);
    ...
    $.__views.__alloyId267.add($.__views.slogan);
    $.__views.__alloyId289 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.SIZE,
        id: "__alloyId289"
    });
    $.__views.__alloyId267.add($.__views.__alloyId289);
    ...
    do_continue ? $.addListener($.__views.__alloyId290, "click", do_continue) : __defers["$.__views.__alloyId290!click!do_continue"] = true;
    ...
    __defers["$.__views.__alloyId290!click!do_continue"] && $.addListener($.__views.__alloyId290, "click", do_continue);
    _.extend($, exports);
}
