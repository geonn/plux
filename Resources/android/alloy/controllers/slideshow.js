...
function Controller() {
    function __alloyId264() {
        $.__views.win.removeEventListener("open", __alloyId264);
    ...
    $.__views.win.addEventListener("open", __alloyId264);
    ...
    __alloyId267.push($.__views.__alloyId273);
    ...
    __alloyId267.push($.__views.__alloyId283);
    ...
    $.__views.__alloyId266.add($.__views.slogan);
    $.__views.__alloyId288 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.SIZE,
        id: "__alloyId288"
    });
    $.__views.__alloyId266.add($.__views.__alloyId288);
    $.__views.__alloyId289 = Ti.UI.createButton({
        font: {
            fontWeight: "bold"
        },
        height: 40,
    ...
    do_continue ? $.addListener($.__views.__alloyId289, "click", do_continue) : __defers["$.__views.__alloyId289!click!do_continue"] = true;
    ...
    __defers["$.__views.__alloyId289!click!do_continue"] && $.addListener($.__views.__alloyId289, "click", do_continue);
    _.extend($, exports);
}
