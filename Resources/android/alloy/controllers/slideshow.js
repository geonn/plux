...
function Controller() {
    ...
    __alloyId284.push($.__views.__alloyId290);
    ...
    __alloyId284.push($.__views.__alloyId295);
    ...
    __alloyId284.push($.__views.__alloyId300);
    ...
    $.__views.__alloyId283.add($.__views.slogan);
    $.__views.__alloyId305 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.SIZE,
        id: "__alloyId305"
    });
    $.__views.__alloyId283.add($.__views.__alloyId305);
    ...
    do_continue ? $.addListener($.__views.__alloyId306, "click", do_continue) : __defers["$.__views.__alloyId306!click!do_continue"] = true;
    ...
    __defers["$.__views.__alloyId306!click!do_continue"] && $.addListener($.__views.__alloyId306, "click", do_continue);
    _.extend($, exports);
}
