...
function Controller() {
    function __alloyId212() {
        $.__views.win.removeEventListener("open", __alloyId212);
    ...
    $.__views.win.addEventListener("open", __alloyId212);
    ...
    $.__views.win.add($.__views.__alloyId213);
    ...
    $.__views.win.add($.__views.__alloyId214);
    var __alloyId215 = [];
    ...
    __alloyId215.push($.__views.__alloyId226);
    ...
    __alloyId215.push($.__views.__alloyId231);
    ...
    $.__views.__alloyId214.add($.__views.slogan);
    $.__views.__alloyId236 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.SIZE,
        id: "__alloyId236"
    });
    $.__views.__alloyId214.add($.__views.__alloyId236);
    ...
    do_continue ? $.addListener($.__views.__alloyId237, "click", do_continue) : __defers["$.__views.__alloyId237!click!do_continue"] = true;
    ...
    __defers["$.__views.__alloyId237!click!do_continue"] && $.addListener($.__views.__alloyId237, "click", do_continue);
    _.extend($, exports);
}
