...
function Controller() {
    ...
    $.__views.win.add($.__views.__alloyId309);
    var __alloyId310 = [];
    ...
    __alloyId310.push($.__views.__alloyId311);
    ...
    __alloyId310.push($.__views.__alloyId321);
    ...
    __alloyId310.push($.__views.__alloyId326);
    ...
    $.__views.__alloyId309.add($.__views.slogan);
    $.__views.__alloyId331 = Ti.UI.createView({
        width: Ti.UI.FILL,
        height: Ti.UI.SIZE,
        id: "__alloyId331"
    });
    $.__views.__alloyId309.add($.__views.__alloyId331);
    ...
    do_continue ? $.addListener($.__views.__alloyId332, "click", do_continue) : __defers["$.__views.__alloyId332!click!do_continue"] = true;
    ...
    __defers["$.__views.__alloyId332!click!do_continue"] && $.addListener($.__views.__alloyId332, "click", do_continue);
    _.extend($, exports);
}
