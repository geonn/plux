...
function Controller() {
  ...
  this.__controllerPath = 'home_1.1.990.1000';
  ...
  if (true) {
    ...
    { borderWidth: 0, id: "main" });

    $.__views.win.add($.__views.main);
    $.__views.daily_background = Ti.UI.createView(
    { borderWidth: 0, id: "daily_background", width: Ti.UI.FILL, height: Ti.UI.FILL });

    $.__views.main.add($.__views.daily_background);
    $.__views.__alloyId626 = Ti.UI.createView(
    { borderWidth: 0, width: Ti.UI.FILL, height: Ti.UI.FILL, id: "__alloyId626" });

    $.__views.main.add($.__views.__alloyId626);
    $.__views.logo = Ti.UI.createImageView(
    { id: "logo", borderRadius: 10, width: 100, height: 100, top: 10, left: 10, image: "/images/logo_plux.png", zIndex: 5 });

    $.__views.__alloyId626.add($.__views.logo);
    $.__views.myinfo_view = Ti.UI.createView(
    { borderWidth: 0, zIndex: 4, id: "myinfo_view", left: 110, width: Ti.UI.FILL, height: Ti.UI.SIZE, top: 20, backgroundColor: "#B3000000" });

    $.__views.__alloyId626.add($.__views.myinfo_view);
    $.__views.myInfo = Ti.UI.createView(
    { borderWidth: 0, width: Ti.UI.FILL, top: 10, bottom: 10, height: 60, id: "myInfo" });

    $.__views.myinfo_view.add($.__views.myInfo);
    $.__views.loadingBar = Ti.UI.createView(
    { borderWidth: 0, layout: "vertical", id: "loadingBar", height: 0, width: 120, borderRadius: 15, top: 0, opacity: 0, backgroundColor: "#2E2E2E" });

    $.__views.__alloyId626.add($.__views.loadingBar);
    $.__views.activityIndicator = Ti.UI.createActivityIndicator(
    { top: 10, left: 30, width: 60, id: "activityIndicator" });

    $.__views.loadingBar.add($.__views.activityIndicator);
    $.__views.__alloyId627 = Ti.UI.createLabel(
    { width: Titanium.UI.SIZE, height: Titanium.UI.SIZE, color: "#ffffff", top: 5, bottom: 10, text: "Loading", id: "__alloyId627" });

    $.__views.loadingBar.add($.__views.__alloyId627);
    ...
    $.__views.__alloyId626.add($.__views.scrollboard1);
    $.__views.scrollboard = Ti.UI.createView(
    { borderWidth: 0, layout: "horizontal", id: "scrollboard", height: Ti.UI.SIZE, zIndex: 3 });
  ...
  function loadHomePageItem() {
    menu_info = [{ mod: "feedback", image: "/images/btn/btn_feedback.png" }, { mod: "hra", image: "/images/btn/btn_hra.png" }, { mod: "myHealth", image: "/images/btn/btn_my_health.png" }, { mod: "profile", image: "/images/btn/btn_profile.png" }, { mod: "clinicLocator", image: "/images/btn/btn_clinic_location.png" }, { mod: "myMedicalRecord", image: "/images/btn/btn_my_medical_record.png" }];
