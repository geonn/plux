...
function Controller() {
    ...
    $.__views.__alloyId89.add($.__views.__alloyId100);
    ...
    $.__views.__alloyId89.add($.__views.__alloyId101);
    ...
    navWindow ? $.addListener($.__views.__alloyId102, "click", navWindow) : __defers["$.__views.__alloyId102!click!navWindow"] = true;
    ...
    $.__views.__alloyId101.add($.__views.notificationIcon);
    ...
    __defers["$.__views.__alloyId102!click!navWindow"] && $.addListener($.__views.__alloyId102, "click", navWindow);
    _.extend($, exports);
}
