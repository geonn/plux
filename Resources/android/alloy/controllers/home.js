...
function Controller() {
    ...
    function updateNotification(e) {
        ...
        "helpline" == e.target ? label_helpline.text = unread_no : label_notification.text = unread_no;
    }
    ...
    function navWindow(e) {
        ...
        } else if ("conversation" == e.source.mod) nav.navigationWindow(target, 1); else if ("profile" == e.source.mod) {
            var empno = Ti.App.Properties.getString("empno");
            "undefined" != typeof empno && "" != empno ? nav.navigationWindow("asp/profile", 1) : nav.navigationWindow("plux_profile");
        } else {
            console.log(target + " target");
