...
function Controller() {
    ...
    $.__views.__alloyId55.add($.__views.logo);
    ...
    $.__views.__alloyId55.add($.__views.myinfo_view);
    ...
    $.__views.__alloyId55.add($.__views.loadingBar);
    ...
    $.__views.loadingBar.add($.__views.__alloyId56);
    ...
    $.__views.__alloyId55.add($.__views.scrollboard);
    ...
    navWindow ? $.addListener($.__views.__alloyId64, "click", navWindow) : __defers["$.__views.__alloyId64!click!navWindow"] = true;
    ...
    $.__views.__alloyId57.add($.__views.__alloyId65);
    navWindow ? $.addListener($.__views.__alloyId65, "click", navWindow) : __defers["$.__views.__alloyId65!click!navWindow"] = true;
    ...
    $.__views.__alloyId57.add($.__views.__alloyId66);
    navWindow ? $.addListener($.__views.__alloyId66, "click", navWindow) : __defers["$.__views.__alloyId66!click!navWindow"] = true;
    ...
    __defers["$.__views.__alloyId64!click!navWindow"] && $.addListener($.__views.__alloyId64, "click", navWindow);
    __defers["$.__views.__alloyId65!click!navWindow"] && $.addListener($.__views.__alloyId65, "click", navWindow);
    __defers["$.__views.__alloyId66!click!navWindow"] && $.addListener($.__views.__alloyId66, "click", navWindow);
    _.extend($, exports);
}
