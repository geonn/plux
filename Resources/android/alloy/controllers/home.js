...
function Controller() {
    ...
    function navWindow(e) {
        ...
        "eCard" == e.source.mod || "eCard_list" == e.source.mod || "myClaim" == e.source.mod ? nav.navigationWindow("asp/" + target, 1) : "myHealth" == e.source.mod ? nav.navigationWindow(target + "/main") : "clinicLocator" == e.source.mod ? nav.navigateWithArgs("clinic/listing", 1) : nav.navigationWindow(target);
    }
    function logoutUser() {
    ...
    $.__views.__alloyId55.add($.__views.__alloyId65);
