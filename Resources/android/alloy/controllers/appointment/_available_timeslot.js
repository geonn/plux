...
<<<<<<< HEAD
    $.__views.__alloyId381 = Ti.UI.createScrollView({
=======
    $.__views.__alloyId379 = Ti.UI.createScrollView({
>>>>>>> origin/master
        width: Ti.UI.FILL,
        height: Ti.UI.FILL,
...
<<<<<<< HEAD
    ...
    $.__views.inner_box.add($.__views.__alloyId381);
=======
        id: "__alloyId379"
    });
    $.__views.inner_box.add($.__views.__alloyId379);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId381.add($.__views.timeslot);
=======
    $.__views.__alloyId379.add($.__views.timeslot);
>>>>>>> origin/master
