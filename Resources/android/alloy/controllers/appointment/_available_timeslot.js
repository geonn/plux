...
<<<<<<< HEAD
    $.__views.__alloyId361 = Ti.UI.createScrollView({
=======
    $.__views.__alloyId363 = Ti.UI.createScrollView({
>>>>>>> origin/master
        width: Ti.UI.FILL,
        height: Ti.UI.FILL,
...
<<<<<<< HEAD
    ...
    $.__views.inner_box.add($.__views.__alloyId361);
=======
        id: "__alloyId363"
    });
    $.__views.inner_box.add($.__views.__alloyId363);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId361.add($.__views.timeslot);
=======
    $.__views.__alloyId363.add($.__views.timeslot);
>>>>>>> origin/master
