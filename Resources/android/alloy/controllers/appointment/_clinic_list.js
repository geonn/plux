...
function Controller() {
  ...
  { borderWidth: 0, width: Ti.UI.FILL, height: Ti.UI.FILL, id: "_clinic_list" });
  ...
  { borderWidth: 0, layout: "vertical", width: Ti.UI.FILL, height: Ti.UI.SIZE, zIndex: 10, bottom: 0, backgroundColor: "#e1e2e2", id: "clinic" });

  $.__views._clinic_list.add($.__views.clinic);
  $.__views.__alloyId141 = Ti.UI.createLabel(
  { width: Ti.UI.FILL, height: Ti.UI.SIZE, color: "#cd1a19", top: 10, left: 10, right: 10, bottom: 10, text: 'Select the panel', textAlign: "center", id: "__alloyId141" });

  $.__views.clinic.add($.__views.__alloyId141);
