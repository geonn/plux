...
function Controller() {
    ...
    $.__views.win.add($.__views.__alloyId374);
    ...
    closeWindow ? $.addListener($.__views.__alloyId377, "click", closeWindow) : __defers["$.__views.__alloyId377!click!closeWindow"] = true;
    $.__views.__alloyId378 = Ti.UI.createView({
        width: "60%",
        id: "__alloyId378"
    });
    $.__views.__alloyId375.add($.__views.__alloyId378);
    ...
    $.__views.__alloyId374.add($.__views.__alloyId379);
    ...
    $.__views.__alloyId381.add($.__views.sub_back);
    ...
    $.__views.__alloyId381.add($.__views.sub_title);
    ...
    $.__views.__alloyId374.add($.__views.inner_box);
    ...
    __defers["$.__views.__alloyId377!click!closeWindow"] && $.addListener($.__views.__alloyId377, "click", closeWindow);
    _.extend($, exports);
}
