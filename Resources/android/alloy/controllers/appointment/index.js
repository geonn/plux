...
function Controller() {
    ...
    closeWindow ? $.addListener($.__views.__alloyId282, "click", closeWindow) : __defers["$.__views.__alloyId282!click!closeWindow"] = true;
    ...
    $.__views.__alloyId283.add($.__views.pageTitle);
    ...
    $.__views.__alloyId286.add($.__views.sub_back);
    ...
    $.__views.__alloyId286.add($.__views.sub_title);
    ...
    $.__views.__alloyId279.add($.__views.inner_box);
    ...
    __defers["$.__views.__alloyId282!click!closeWindow"] && $.addListener($.__views.__alloyId282, "click", closeWindow);
    _.extend($, exports);
}
