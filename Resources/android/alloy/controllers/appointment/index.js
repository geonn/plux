...
<<<<<<< HEAD
    ...
    $.__views.win.add($.__views.__alloyId383);
...
=======
    ...
    $.__views.win.add($.__views.__alloyId381);
...
=======
    ...
    $.__views.__alloyId384 = Ti.UI.createImageView({
>>>>>>> origin/master
        left: 10,
        width: 25,
        height: 25,
...
<<<<<<< HEAD
    ...
    closeWindow ? $.addListener($.__views.__alloyId386, "click", closeWindow) : __defers["$.__views.__alloyId386!click!closeWindow"] = true;
...
=======
    ...
    $.__views.__alloyId383.add($.__views.__alloyId384);
    closeWindow ? $.addListener($.__views.__alloyId384, "click", closeWindow) : __defers["$.__views.__alloyId384!click!closeWindow"] = true;
    $.__views.__alloyId385 = Ti.UI.createView({
        width: "60%",
        id: "__alloyId385"
    });
...
=======
    $.__views.__alloyId385.add($.__views.pageTitle);
...
=======
    ...
    $.__views.__alloyId381.add($.__views.__alloyId386);
    $.__views.__alloyId387 = Ti.UI.createView({
        backgroundColor: "#ececec",
        width: Ti.UI.FILL,
        height: 1,
...
<<<<<<< HEAD
    $.__views.__alloyId390.add($.__views.sub_back);
=======
    $.__views.__alloyId388.add($.__views.sub_back);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId390.add($.__views.sub_title);
    ...
    __alloyId392.push($.__views._specialty_list.getViewEx({
=======
    $.__views.__alloyId388.add($.__views.sub_title);
    $.__views.__alloyId389 = Ti.UI.createView({
        backgroundColor: "#ececec",
        width: Ti.UI.FILL,
        height: 1,
    ...
    __alloyId390.push($.__views._specialty_list.getViewEx({
>>>>>>> origin/master
        recurse: true
    }));
...
<<<<<<< HEAD
    __alloyId392.push($.__views._clinic_list.getViewEx({
=======
    __alloyId390.push($.__views._clinic_list.getViewEx({
>>>>>>> origin/master
        recurse: true
    }));
...
<<<<<<< HEAD
    __alloyId392.push($.__views._available_timeslot.getViewEx({
=======
    __alloyId390.push($.__views._available_timeslot.getViewEx({
>>>>>>> origin/master
        recurse: true
    }));
...
<<<<<<< HEAD
    __alloyId392.push($.__views._appointment_form.getViewEx({
        recurse: true
    }));
    ...
    $.__views.__alloyId383.add($.__views.inner_box);
=======
    __alloyId390.push($.__views._appointment_form.getViewEx({
        recurse: true
    }));
    $.__views.inner_box = Ti.UI.createScrollableView({
        views: __alloyId390,
    ...
    $.__views.__alloyId381.add($.__views.inner_box);
>>>>>>> origin/master
...
<<<<<<< HEAD
    __defers["$.__views.__alloyId386!click!closeWindow"] && $.addListener($.__views.__alloyId386, "click", closeWindow);
=======
    __defers["$.__views.__alloyId384!click!closeWindow"] && $.addListener($.__views.__alloyId384, "click", closeWindow);
>>>>>>> origin/master
    _.extend($, exports);
}
