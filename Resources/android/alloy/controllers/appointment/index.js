...
function Controller() {
    ...
    $.__views.win.add($.__views.__alloyId384);
    ...
    closeWindow ? $.addListener($.__views.__alloyId387, "click", closeWindow) : __defers["$.__views.__alloyId387!click!closeWindow"] = true;
    ...
    $.__views.__alloyId391.add($.__views.sub_back);
    ...
    $.__views.__alloyId391.add($.__views.sub_title);
    ...
    $.__views.__alloyId384.add($.__views.inner_box);
    ...
    __defers["$.__views.__alloyId387!click!closeWindow"] && $.addListener($.__views.__alloyId387, "click", closeWindow);
    _.extend($, exports);
}
