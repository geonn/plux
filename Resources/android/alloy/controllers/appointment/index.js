...
function Controller() {
    ...
    closeWindow ? $.addListener($.__views.__alloyId280, "click", closeWindow) : __defers["$.__views.__alloyId280!click!closeWindow"] = true;
    ...
    $.__views.__alloyId284.add($.__views.sub_back);
    ...
    $.__views.__alloyId284.add($.__views.sub_title);
    ...
    $.__views.__alloyId277.add($.__views.inner_box);
    ...
    __defers["$.__views.__alloyId280!click!closeWindow"] && $.addListener($.__views.__alloyId280, "click", closeWindow);
    _.extend($, exports);
}
