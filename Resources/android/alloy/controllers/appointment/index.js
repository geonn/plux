...
function Controller() {
    ...
    $.__views.win.add($.__views.__alloyId389);
    ...
    closeWindow ? $.addListener($.__views.__alloyId392, "click", closeWindow) : __defers["$.__views.__alloyId392!click!closeWindow"] = true;
    ...
    $.__views.__alloyId396.add($.__views.sub_back);
    ...
    $.__views.__alloyId396.add($.__views.sub_title);
    ...
    $.__views.__alloyId389.add($.__views.inner_box);
    ...
    __defers["$.__views.__alloyId392!click!closeWindow"] && $.addListener($.__views.__alloyId392, "click", closeWindow);
    _.extend($, exports);
}
