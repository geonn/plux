...
function Controller() {
    ...
    $.__views.win.add($.__views.__alloyId387);
    ...
    closeWindow ? $.addListener($.__views.__alloyId390, "click", closeWindow) : __defers["$.__views.__alloyId390!click!closeWindow"] = true;
    ...
    $.__views.__alloyId394.add($.__views.sub_back);
    ...
    $.__views.__alloyId394.add($.__views.sub_title);
    ...
    $.__views.__alloyId387.add($.__views.inner_box);
    ...
    __defers["$.__views.__alloyId390!click!closeWindow"] && $.addListener($.__views.__alloyId390, "click", closeWindow);
    _.extend($, exports);
}
