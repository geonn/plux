...
function Controller() {
    ...
    $.__views.win.add($.__views.__alloyId369);
    ...
    closeWindow ? $.addListener($.__views.__alloyId372, "click", closeWindow) : __defers["$.__views.__alloyId372!click!closeWindow"] = true;
    ...
    $.__views.__alloyId376.add($.__views.sub_back);
    ...
    $.__views.__alloyId376.add($.__views.sub_title);
    ...
    $.__views.__alloyId369.add($.__views.inner_box);
    ...
    __defers["$.__views.__alloyId372!click!closeWindow"] && $.addListener($.__views.__alloyId372, "click", closeWindow);
    _.extend($, exports);
}
