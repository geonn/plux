...
=======
    ...
    $.__views.win.add($.__views.__alloyId353);
...
=======
    ...
    closeWindow ? $.addListener($.__views.__alloyId356, "click", closeWindow) : __defers["$.__views.__alloyId356!click!closeWindow"] = true;
...
=======
    $.__views.__alloyId360.add($.__views.sub_back);
>>>>>>> origin/master
...
=======
    $.__views.__alloyId360.add($.__views.sub_title);
    ...
    __alloyId362.push($.__views._specialty_list.getViewEx({
>>>>>>> origin/master
        recurse: true
    }));
...
=======
    __alloyId362.push($.__views._clinic_list.getViewEx({
>>>>>>> origin/master
        recurse: true
    }));
...
=======
    __alloyId362.push($.__views._available_timeslot.getViewEx({
>>>>>>> origin/master
        recurse: true
    }));
...
=======
    __alloyId362.push($.__views._appointment_form.getViewEx({
        recurse: true
    }));
    $.__views.inner_box = Ti.UI.createScrollableView({
        views: __alloyId362,
    ...
    $.__views.__alloyId353.add($.__views.inner_box);
>>>>>>> origin/master
...
=======
    __defers["$.__views.__alloyId356!click!closeWindow"] && $.addListener($.__views.__alloyId356, "click", closeWindow);
>>>>>>> origin/master
    _.extend($, exports);
}
