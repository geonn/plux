...
function Controller() {
    ...
    $.__views.win.add($.__views.__alloyId282);
    ...
    closeWindow ? $.addListener($.__views.__alloyId285, "click", closeWindow) : __defers["$.__views.__alloyId285!click!closeWindow"] = true;
    $.__views.__alloyId286 = Ti.UI.createView({
        width: "60%",
        id: "__alloyId286"
    });
    $.__views.__alloyId283.add($.__views.__alloyId286);
    ...
    $.__views.__alloyId286.add($.__views.pageTitle);
    ...
    $.__views.__alloyId289.add($.__views.sub_back);
    ...
    $.__views.__alloyId289.add($.__views.sub_title);
    ...
    $.__views.__alloyId282.add($.__views.inner_box);
    ...
    __defers["$.__views.__alloyId285!click!closeWindow"] && $.addListener($.__views.__alloyId285, "click", closeWindow);
    _.extend($, exports);
}
