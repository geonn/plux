...
function Controller() {
    ...
    $.__views.win.add($.__views.__alloyId372);
    ...
    closeWindow ? $.addListener($.__views.__alloyId375, "click", closeWindow) : __defers["$.__views.__alloyId375!click!closeWindow"] = true;
    ...
    $.__views.__alloyId372.add($.__views.__alloyId377);
    ...
    $.__views.__alloyId379.add($.__views.sub_back);
    ...
    $.__views.__alloyId379.add($.__views.sub_title);
    ...
    $.__views.__alloyId372.add($.__views.inner_box);
    ...
    __defers["$.__views.__alloyId375!click!closeWindow"] && $.addListener($.__views.__alloyId375, "click", closeWindow);
    _.extend($, exports);
}
