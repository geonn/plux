...
function Controller() {
    ...
    $.__views.win.add($.__views.__alloyId366);
    ...
    closeWindow ? $.addListener($.__views.__alloyId369, "click", closeWindow) : __defers["$.__views.__alloyId369!click!closeWindow"] = true;
    $.__views.__alloyId370 = Ti.UI.createView({
        width: "60%",
        id: "__alloyId370"
    });
    $.__views.__alloyId367.add($.__views.__alloyId370);
    ...
    $.__views.__alloyId366.add($.__views.__alloyId371);
    ...
    $.__views.__alloyId373.add($.__views.sub_back);
    ...
    $.__views.__alloyId373.add($.__views.sub_title);
    ...
    $.__views.__alloyId366.add($.__views.inner_box);
    ...
    __defers["$.__views.__alloyId369!click!closeWindow"] && $.addListener($.__views.__alloyId369, "click", closeWindow);
    _.extend($, exports);
}
