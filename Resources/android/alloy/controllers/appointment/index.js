...
function Controller() {
  ...
  $.__views.win = Ti.UI.createWindow({ backgroundColor: "#ffffff", orientationModes: [Ti.UI.PORTRAIT], fullscreen: false, windowSoftInputMode: Ti.UI.Android.SOFT_INPUT_STATE_HIDDEN, id: "win", title: "Appointment Form", backButtonTitle: "", navTintColor: "#CE1D1C" });
  $.__views.win && $.addTopLevelView($.__views.win);
  $.__views.__alloyId131 = Ti.UI.createView({ layout: "vertical", width: Ti.UI.FILL, height: Ti.UI.FILL, id: "__alloyId131" });
  $.__views.win.add($.__views.__alloyId131);
  if (true) {
    $.__views.__alloyId132 = Ti.UI.createView({ layout: "horizontal", height: 50, width: Ti.UI.FILL, backgroundColor: "#DEDEDE", id: "__alloyId132" });
    $.__views.__alloyId131.add($.__views.__alloyId132);
    $.__views.__alloyId133 = Ti.UI.createView({ left: 0, width: "20%", id: "__alloyId133" });
    $.__views.__alloyId132.add($.__views.__alloyId133);
    $.__views.__alloyId134 = Ti.UI.createImageView({ left: 10, width: 25, height: 25, image: "/images/btn-back.png", id: "__alloyId134" });
    $.__views.__alloyId133.add($.__views.__alloyId134);
    closeWindow ? $.addListener($.__views.__alloyId134, 'click', closeWindow) : __defers['$.__views.__alloyId134!click!closeWindow'] = true;$.__views.__alloyId135 = Ti.UI.createView({ width: "60%", id: "__alloyId135" });
    $.__views.__alloyId132.add($.__views.__alloyId135);
    $.__views.pageTitle = Ti.UI.createLabel({ width: Titanium.UI.SIZE, height: Ti.UI.SIZE, color: "#606060", font: { fontSize: "16dp" }, text: 'New Appointment', id: "pageTitle", textAlign: "center" });
    $.__views.__alloyId135.add($.__views.pageTitle);
  }
  $.__views.__alloyId136 = Ti.UI.createView({ layout: "vertical", width: Ti.UI.FILL, height: Ti.UI.SIZE, backgroundColor: "#f0f5f8", id: "__alloyId136" });
  $.__views.__alloyId131.add($.__views.__alloyId136);
  $.__views.__alloyId137 = Ti.UI.createView({ backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId137" });
  $.__views.__alloyId136.add($.__views.__alloyId137);
  $.__views.__alloyId138 = Ti.UI.createView({ top: 10, left: 10, right: 10, bottom: 10, width: Ti.UI.FILL, height: Ti.UI.SIZE, id: "__alloyId138" });
  $.__views.__alloyId136.add($.__views.__alloyId138);
  $.__views.sub_back = Ti.UI.createImageView({ left: 10, id: "sub_back", width: 25, height: 25, image: "/images/btn-back.png" });
  $.__views.__alloyId138.add($.__views.sub_back);
  $.__views.sub_title = Ti.UI.createLabel({ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#2a363a", font: { fontSize: 14 }, text: 'SELECT A SPECIALTY', id: "sub_title", top: 10, bottom: 10, textAlign: "center" });
  $.__views.__alloyId138.add($.__views.sub_title);
  $.__views.__alloyId139 = Ti.UI.createView({ backgroundColor: "#ececec", width: Ti.UI.FILL, height: 1, id: "__alloyId139" });
  ...
  __alloyId140.push($.__views._specialty_list.getViewEx({ recurse: true }));
  $.__views._clinic_list = Alloy.createController('appointment/_clinic_list', { id: "_clinic_list" });
  __alloyId140.push($.__views._clinic_list.getViewEx({ recurse: true }));
  $.__views._available_timeslot = Alloy.createController('appointment/_available_timeslot', { id: "_available_timeslot" });
  __alloyId140.push($.__views._available_timeslot.getViewEx({ recurse: true }));
  $.__views._appointment_form = Alloy.createController('appointment/_appointment_form', { id: "_appointment_form" });
  __alloyId140.push($.__views._appointment_form.getViewEx({ recurse: true }));
  $.__views.inner_box = Ti.UI.createScrollableView({ views: __alloyId140, id: "inner_box", scrollingEnabled: false });
  $.__views.__alloyId131.add($.__views.inner_box);
  ...
  if (true) {
    __defers['$.__views.__alloyId134!click!closeWindow'] && $.addListener($.__views.__alloyId134, 'click', closeWindow);
  }
