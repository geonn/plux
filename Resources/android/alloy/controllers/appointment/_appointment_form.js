...
<<<<<<< HEAD
    ...
    $.__views.tvrName.add($.__views.__alloyId353);
    $.__views.__alloyId354 = Ti.UI.createLabel({
=======
        id: "__alloyId351"
    });
    $.__views.tvrName.add($.__views.__alloyId351);
...
<<<<<<< HEAD
    $.__views.__alloyId355.add($.__views.patient_name);
...
=======
    $.__views.__alloyId353.add($.__views.patient_name);
    ...
    $.__views.aView.add($.__views.__alloyId354);
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    $.__views.tvrEmail.add($.__views.__alloyId357);
    $.__views.__alloyId358 = Ti.UI.createLabel({
=======
        id: "__alloyId355"
    });
    $.__views.tvrEmail.add($.__views.__alloyId355);
...
<<<<<<< HEAD
    $.__views.__alloyId359.add($.__views.patient_email);
...
=======
    $.__views.__alloyId357.add($.__views.patient_email);
...
<<<<<<< HEAD
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId361);
    $.__views.__alloyId362 = Ti.UI.createLabel({
=======
        id: "__alloyId359"
    });
    $.__views.tvrDateVisit.add($.__views.__alloyId359);
...
<<<<<<< HEAD
    $.__views.__alloyId363.add($.__views.appointment_datetime);
    ...
    $.__views.aView.add($.__views.__alloyId365);
    $.__views.__alloyId366 = Ti.UI.createView({
=======
    $.__views.__alloyId361.add($.__views.appointment_datetime);
...
<<<<<<< HEAD
    $.__views.__alloyId368.add($.__views.appointment_clinic);
...
=======
    $.__views.__alloyId366.add($.__views.appointment_clinic);
...
<<<<<<< HEAD
    $.__views.__alloyId373.add($.__views.specialty);
...
=======
    $.__views.__alloyId371.add($.__views.specialty);
...
<<<<<<< HEAD
    $.__views.__alloyId376.add($.__views.remarkTextArea);
...
=======
    $.__views.__alloyId374.add($.__views.remarkTextArea);
    $.__views.__alloyId376 = Ti.UI.createView({
        backgroundColor: "#ececec",
        width: Ti.UI.FILL,
        height: 1,
...
<<<<<<< HEAD
    ...
    $.__views.__alloyId380 = Ti.UI.createButton({
=======
        id: "__alloyId377"
    });
    $.__views.aView.add($.__views.__alloyId377);
    $.__views.__alloyId378 = Ti.UI.createButton({
>>>>>>> origin/master
...
<<<<<<< HEAD
    ...
    saveRecord ? $.addListener($.__views.__alloyId380, "click", saveRecord) : __defers["$.__views.__alloyId380!click!saveRecord"] = true;
=======
        id: "__alloyId378"
    });
    $.__views.__alloyId377.add($.__views.__alloyId378);
    saveRecord ? $.addListener($.__views.__alloyId378, "click", saveRecord) : __defers["$.__views.__alloyId378!click!saveRecord"] = true;
>>>>>>> origin/master
...
<<<<<<< HEAD
    __defers["$.__views.__alloyId380!click!saveRecord"] && $.addListener($.__views.__alloyId380, "click", saveRecord);
=======
    __defers["$.__views.__alloyId378!click!saveRecord"] && $.addListener($.__views.__alloyId378, "click", saveRecord);
>>>>>>> origin/master
    _.extend($, exports);
}
