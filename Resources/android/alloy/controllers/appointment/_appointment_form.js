...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId342);
    ...
    $.__views.__alloyId344.add($.__views.patient_name);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId346);
    ...
    $.__views.__alloyId348.add($.__views.patient_email);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId350);
    ...
    $.__views.__alloyId352.add($.__views.appointment_datetime);
    ...
    $.__views.__alloyId357.add($.__views.appointment_clinic);
    ...
    $.__views.__alloyId362.add($.__views.specialty);
    ...
    $.__views.__alloyId365.add($.__views.remarkTextArea);
    ...
    $.__views.__alloyId369 = Ti.UI.createButton({
    ...
    saveRecord ? $.addListener($.__views.__alloyId369, "click", saveRecord) : __defers["$.__views.__alloyId369!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId369!click!saveRecord"] && $.addListener($.__views.__alloyId369, "click", saveRecord);
    _.extend($, exports);
}
