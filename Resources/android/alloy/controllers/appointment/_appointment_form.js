...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId350);
    ...
    $.__views.__alloyId352.add($.__views.patient_name);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId354);
    ...
    $.__views.__alloyId356.add($.__views.patient_email);
    ...
    $.__views.__alloyId360.add($.__views.appointment_datetime);
    ...
    $.__views.__alloyId365.add($.__views.appointment_clinic);
    ...
    $.__views.__alloyId370.add($.__views.specialty);
    ...
    $.__views.__alloyId373.add($.__views.remarkTextArea);
    ...
    saveRecord ? $.addListener($.__views.__alloyId377, "click", saveRecord) : __defers["$.__views.__alloyId377!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId377!click!saveRecord"] && $.addListener($.__views.__alloyId377, "click", saveRecord);
    _.extend($, exports);
}
