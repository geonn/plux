...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId250);
    ...
    $.__views.__alloyId252.add($.__views.patient_name);
    ...
    $.__views.aView.add($.__views.__alloyId253);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId254);
    ...
    $.__views.__alloyId256.add($.__views.patient_email);
    ...
    $.__views.aView.add($.__views.__alloyId257);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId258);
    ...
    $.__views.__alloyId260.add($.__views.appointment_datetime);
    ...
    $.__views.aView.add($.__views.__alloyId261);
    ...
    $.__views.aView.add($.__views.__alloyId262);
    ...
    $.__views.__alloyId265.add($.__views.appointment_clinic);
    ...
    $.__views.aView.add($.__views.__alloyId266);
    ...
    $.__views.aView.add($.__views.__alloyId267);
    ...
    $.__views.__alloyId270.add($.__views.specialty);
    ...
    $.__views.aView.add($.__views.__alloyId271);
    ...
    $.__views.aView.add($.__views.__alloyId272);
    ...
    $.__views.__alloyId273.add($.__views.remarkTextArea);
    ...
    $.__views.aView.add($.__views.__alloyId275);
    ...
    $.__views.aView.add($.__views.__alloyId276);
    $.__views.__alloyId277 = Ti.UI.createButton({
    ...
    saveRecord ? $.addListener($.__views.__alloyId277, "click", saveRecord) : __defers["$.__views.__alloyId277!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId277!click!saveRecord"] && $.addListener($.__views.__alloyId277, "click", saveRecord);
    _.extend($, exports);
}
