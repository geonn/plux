...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId253);
    ...
    $.__views.__alloyId255.add($.__views.patient_name);
    ...
    $.__views.aView.add($.__views.__alloyId256);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId257);
    ...
    $.__views.__alloyId259.add($.__views.patient_email);
    ...
    $.__views.aView.add($.__views.__alloyId260);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId261);
    ...
    $.__views.__alloyId263.add($.__views.appointment_datetime);
    ...
    $.__views.aView.add($.__views.__alloyId265);
    ...
    $.__views.__alloyId268.add($.__views.appointment_clinic);
    ...
    $.__views.aView.add($.__views.__alloyId270);
    ...
    $.__views.__alloyId273.add($.__views.specialty);
    ...
    $.__views.__alloyId276.add($.__views.remarkTextArea);
    ...
    $.__views.aView.add($.__views.__alloyId279);
    ...
    saveRecord ? $.addListener($.__views.__alloyId280, "click", saveRecord) : __defers["$.__views.__alloyId280!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId280!click!saveRecord"] && $.addListener($.__views.__alloyId280, "click", saveRecord);
    _.extend($, exports);
}
