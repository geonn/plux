...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId181);
    ...
    $.__views.__alloyId183.add($.__views.patient_name);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId185);
    ...
    $.__views.__alloyId187.add($.__views.patient_email);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId189);
    ...
    $.__views.__alloyId191.add($.__views.appointment_datetime);
    ...
    $.__views.aView.add($.__views.__alloyId192);
    ...
    $.__views.tvrClinicVisit.add($.__views.__alloyId193);
    ...
    $.__views.__alloyId195.add($.__views.appointment_clinic);
    ...
    $.__views.tvrRemark.add($.__views.__alloyId197);
    ...
    $.__views.__alloyId197.add($.__views.remarkTextArea);
    ...
    $.__views.aView.add($.__views.__alloyId199);
    ...
    $.__views.__alloyId200.add($.__views.saveRecord);
