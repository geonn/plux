...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId344);
    ...
    $.__views.__alloyId346.add($.__views.patient_name);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId348);
    ...
    $.__views.__alloyId350.add($.__views.patient_email);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId352);
    ...
    $.__views.__alloyId354.add($.__views.appointment_datetime);
    ...
    $.__views.__alloyId359.add($.__views.appointment_clinic);
    ...
    $.__views.__alloyId364.add($.__views.specialty);
    ...
    $.__views.__alloyId367.add($.__views.remarkTextArea);
    ...
    $.__views.__alloyId371 = Ti.UI.createButton({
    ...
    saveRecord ? $.addListener($.__views.__alloyId371, "click", saveRecord) : __defers["$.__views.__alloyId371!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId371!click!saveRecord"] && $.addListener($.__views.__alloyId371, "click", saveRecord);
    _.extend($, exports);
}
