...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId339);
    ...
    $.__views.__alloyId341.add($.__views.patient_name);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId343);
    ...
    $.__views.__alloyId345.add($.__views.patient_email);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId347);
    ...
    $.__views.__alloyId349.add($.__views.appointment_datetime);
    ...
    $.__views.__alloyId354.add($.__views.appointment_clinic);
    ...
    $.__views.__alloyId359.add($.__views.specialty);
    ...
    $.__views.__alloyId362.add($.__views.remarkTextArea);
    ...
    $.__views.__alloyId366 = Ti.UI.createButton({
    ...
    saveRecord ? $.addListener($.__views.__alloyId366, "click", saveRecord) : __defers["$.__views.__alloyId366!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId366!click!saveRecord"] && $.addListener($.__views.__alloyId366, "click", saveRecord);
    _.extend($, exports);
}
