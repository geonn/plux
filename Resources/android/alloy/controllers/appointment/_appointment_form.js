...
function Controller() {
    ...
    $.__views.tvrName.add($.__views.__alloyId328);
    ...
    $.__views.__alloyId330.add($.__views.patient_name);
    ...
    $.__views.tvrEmail.add($.__views.__alloyId332);
    ...
    $.__views.__alloyId334.add($.__views.patient_email);
    ...
    $.__views.tvrDateVisit.add($.__views.__alloyId336);
    ...
    $.__views.__alloyId338.add($.__views.appointment_datetime);
    ...
    $.__views.__alloyId343.add($.__views.appointment_clinic);
    ...
    $.__views.__alloyId348.add($.__views.specialty);
    ...
    $.__views.__alloyId351.add($.__views.remarkTextArea);
    ...
    $.__views.__alloyId355 = Ti.UI.createButton({
    ...
    saveRecord ? $.addListener($.__views.__alloyId355, "click", saveRecord) : __defers["$.__views.__alloyId355!click!saveRecord"] = true;
    ...
    __defers["$.__views.__alloyId355!click!saveRecord"] && $.addListener($.__views.__alloyId355, "click", saveRecord);
    _.extend($, exports);
}
