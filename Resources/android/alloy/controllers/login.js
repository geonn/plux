...
function Controller() {
    ...
    $.__views.win.leftNavButton = $.__views.__alloyId186;
    ...
    $.__views.forgetPasswordBox.add($.__views.__alloyId187);
    ...
    $.__views.__alloyId187.add($.__views.addbox_title);
    ...
    closeBox ? $.addListener($.__views.__alloyId188, "click", closeBox) : __defers["$.__views.__alloyId188!click!closeBox"] = true;
    ...
    $.__views.forgetPasswordBox.add($.__views.__alloyId189);
    doForgotPassword ? $.addListener($.__views.__alloyId189, "click", doForgotPassword) : __defers["$.__views.__alloyId189!click!doForgotPassword"] = true;
    ...
    showForgetPassword ? $.addListener($.__views.__alloyId194, "touchend", showForgetPassword) : __defers["$.__views.__alloyId194!touchend!showForgetPassword"] = true;
    ...
    __defers["$.__views.__alloyId188!click!closeBox"] && $.addListener($.__views.__alloyId188, "click", closeBox);
    __defers["$.__views.__alloyId189!click!doForgotPassword"] && $.addListener($.__views.__alloyId189, "click", doForgotPassword);
    ...
    __defers["$.__views.__alloyId194!touchend!showForgetPassword"] && $.addListener($.__views.__alloyId194, "touchend", showForgetPassword);
    _.extend($, exports);
}
