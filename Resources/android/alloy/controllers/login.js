...
function Controller() {
    ...
    $.__views.win.leftNavButton = $.__views.__alloyId189;
    ...
    $.__views.__alloyId190.add($.__views.addbox_title);
    ...
    closeBox ? $.addListener($.__views.__alloyId191, "click", closeBox) : __defers["$.__views.__alloyId191!click!closeBox"] = true;
    ...
    doForgotPassword ? $.addListener($.__views.__alloyId192, "click", doForgotPassword) : __defers["$.__views.__alloyId192!click!doForgotPassword"] = true;
    ...
    showForgetPassword ? $.addListener($.__views.__alloyId197, "touchend", showForgetPassword) : __defers["$.__views.__alloyId197!touchend!showForgetPassword"] = true;
    ...
    __defers["$.__views.__alloyId191!click!closeBox"] && $.addListener($.__views.__alloyId191, "click", closeBox);
    __defers["$.__views.__alloyId192!click!doForgotPassword"] && $.addListener($.__views.__alloyId192, "click", doForgotPassword);
    ...
    __defers["$.__views.__alloyId197!touchend!showForgetPassword"] && $.addListener($.__views.__alloyId197, "touchend", showForgetPassword);
    _.extend($, exports);
}
