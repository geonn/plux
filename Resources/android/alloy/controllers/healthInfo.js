...
<<<<<<< HEAD
    ...
    $.__views.healthInfoWindow.add($.__views.__alloyId62);
...
=======
    ...
    $.__views.healthInfoWindow.add($.__views.__alloyId37);
...
<<<<<<< HEAD
    $.__views.__alloyId64.add($.__views.btnBack);
=======
    $.__views.__alloyId39.add($.__views.btnBack);
>>>>>>> origin/master
...
<<<<<<< HEAD
    $.__views.__alloyId63.add($.__views.pageTitle);
    $.__views.__alloyId65 = Ti.UI.createLabel({
=======
    $.__views.__alloyId38.add($.__views.pageTitle);
...
<<<<<<< HEAD
    ...
    $.__views.pageTitle.add($.__views.__alloyId65);
    $.__views.healthInfoView = Ti.UI.createView({
        id: "healthInfoView"
    });
    $.__views.__alloyId62.add($.__views.healthInfoView);
=======
        id: "__alloyId40"
    });
    $.__views.pageTitle.add($.__views.__alloyId40);
    $.__views.healthInfoView = Ti.UI.createView({
        id: "healthInfoView"
    });
    $.__views.__alloyId37.add($.__views.healthInfoView);
>>>>>>> origin/master
