...
function Controller() {
    ...
    $.__views.pluxProfileWin.add($.__views.__alloyId236);
    ...
    $.__views.__alloyId236.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId238);
    $.__views.__alloyId239 = Ti.UI.createView({
        layout: "vertical",
        id: "__alloyId239"
    });
    $.__views.pluxProfileWin.add($.__views.__alloyId239);
    $.__views.profileData = Ti.UI.createScrollView({
        id: "profileData",
        height: "90%"
    });
    $.__views.__alloyId239.add($.__views.profileData);
