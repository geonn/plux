...
function Controller() {
    ...
    $.__views.pluxProfileWin.add($.__views.__alloyId240);
    ...
    $.__views.__alloyId240.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId242);
    $.__views.__alloyId243 = Ti.UI.createView({
        layout: "vertical",
        id: "__alloyId243"
    });
    $.__views.pluxProfileWin.add($.__views.__alloyId243);
    $.__views.profileData = Ti.UI.createScrollView({
        id: "profileData",
        height: "90%"
    });
    $.__views.__alloyId243.add($.__views.profileData);
