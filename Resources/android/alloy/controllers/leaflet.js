...
function Controller() {
    ...
    $.__views.leaftletWin.add($.__views.__alloyId64);
    ...
    $.__views.__alloyId64.add($.__views.brochureView);
    ...
    $.__views.brochureView.add($.__views.__alloyId68);
    $.__views.scrollview = Ti.UI.createScrollView({
        top: "15",
        id: "scrollview",
        layout: "vertical"
    });
    $.__views.__alloyId68.add($.__views.scrollview);
