...
function Controller() {
    ...
    $.__views.leaftletWin.add($.__views.__alloyId193);
    ...
    $.__views.__alloyId193.add($.__views.brochureView);
    ...
    $.__views.brochureView.add($.__views.__alloyId197);
    $.__views.scrollview = Ti.UI.createScrollView({
        top: 15,
        id: "scrollview",
        layout: "vertical"
    });
    $.__views.__alloyId197.add($.__views.scrollview);
