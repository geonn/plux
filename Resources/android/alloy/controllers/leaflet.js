...
function Controller() {
    ...
    $.__views.leaftletWin.add($.__views.__alloyId86);
    ...
    $.__views.pageTitle.add($.__views.__alloyId89);
    $.__views.brochureView = Ti.UI.createView({
        id: "brochureView",
        backgroundColor: "#828282"
    });
    $.__views.__alloyId86.add($.__views.brochureView);
    ...
    $.__views.brochureView.add($.__views.__alloyId90);
