...
function Controller() {
    ...
    $.__views.leaftletWin.add($.__views.__alloyId194);
    ...
    $.__views.__alloyId194.add($.__views.brochureView);
    ...
    $.__views.brochureView.add($.__views.__alloyId198);
    $.__views.scrollview = Ti.UI.createScrollView({
        top: 15,
        id: "scrollview",
        layout: "vertical"
    });
    $.__views.__alloyId198.add($.__views.scrollview);
