...
function Controller() {
    ...
    $.__views.leaftletWin.add($.__views.__alloyId87);
    ...
    $.__views.__alloyId88.add($.__views.pageTitle);
    ...
    $.__views.pageTitle.add($.__views.__alloyId90);
    $.__views.brochureView = Ti.UI.createView({
        id: "brochureView",
        backgroundColor: "#828282"
    });
    $.__views.__alloyId87.add($.__views.brochureView);
    ...
    $.__views.brochureView.add($.__views.__alloyId91);
    $.__views.scrollview = Ti.UI.createScrollView({
        top: "15",
        id: "scrollview",
        layout: "vertical"
    });
    $.__views.__alloyId91.add($.__views.scrollview);
