...
function Controller() {
    ...
    $.__views.leaftletWin.add($.__views.__alloyId120);
    ...
    $.__views.__alloyId122.add($.__views.btnBack);
    ...
    $.__views.pageTitle.add($.__views.__alloyId123);
    $.__views.brochureView = Ti.UI.createView({
        id: "brochureView",
        backgroundColor: "#828282"
    });
    $.__views.__alloyId120.add($.__views.brochureView);
    ...
    $.__views.brochureView.add($.__views.__alloyId124);
    $.__views.scrollview = Ti.UI.createScrollView({
        top: "15",
        id: "scrollview",
        layout: "vertical"
    });
    $.__views.__alloyId124.add($.__views.scrollview);
