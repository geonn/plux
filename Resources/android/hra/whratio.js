...
function formular() {
    ...
    .75 >= result ? resultPopUp("RESULT", "Your Waist-To-Hip Ratio " + result + " \n\nEXECELLENT\n\nYour waist to hips circumference is within the ideal range. Well done. But it can be easy to let yourself slip so try to stay within this range and maintain a healthy weight to help keep your chances of developing heart disease and diabetes low.") : .8 >= result ? resultPopUp("RESULT", "Your Waist-To-Hip Ratio " + result + " \n\nGOOD\n\nYour waist to hips circumference is within the ideal range. Well done. But it can be easy to let yourself slip so try to stay within this range and maintain a healthy weight to help keep your chances of developing heart disease and diabetes low. ") : .85 >= result ? resultPopUp("RESULT", "Your Waist-To-Hip Ratio " + result + " \n\nAVERAGE\n\nYour waist to hip circumference is slightly above the ideal range. However these ratings may not be appropriate for all age and ethnic groups. Whether you are in doubt or have an increased risk, speak to your doctor to make sure and learn more about how you can lower your risks of developing conditions such as heart disease and diabetes.") : .9 >= result ? resultPopUp("RESULT", "Your Waist-To-Hip Ratio " + result + " \n\nHIGH\n\nYour waist to hip circumference suggests your body shape and weight are putting you at increased risk of developing conditions such as heart disease and diabetes. We hope you take this opportunity to talk to your doctor about how you can take steps to reach and maintain a healthy weight and improve your heart health risk with healthy eating and regular physical activity.") : resultPopUp("RESULT", "Your Waist-To-Hip Ratio " + result + " \n\nEXTREME\n\nYour waist to hip circumference suggests your body shape and weight are putting you at increased risk of developing conditions such as heart disease and diabetes. We hope you take this opportunity to talk to your doctor about how you can take steps to reach and maintain a healthy weight and improve your heart health risk with healthy eating and regular physical activity. ");
}
